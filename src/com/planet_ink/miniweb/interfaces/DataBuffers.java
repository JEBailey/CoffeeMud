...
public interface DataBuffers extends Iterator<ByteBuffer> {
	...
	/**
	 * Close out and clear all internal data buffers This is a required
	 * operation, which is done automatically if all data is iterated through,
	 * but should be done manually otherwise.
	 */
	public void close();

	/**
	 * Flushes all internet bytebuffers to a single one. This can be an
	 * expensive operation, but will call close() on completion.
	 * 
	 ...
	 *            the last modified date of the data, or 0 to ignore
	 */
	 ...
	 *            the last modified date of the data, or 0 to ignore
	 */
	public void insertTop(final RandomAccessFile file,
	...
	/**
	 * Reconfigure this databuffer to return the given ranges Each range is 2
	 * dimentional int array, startpos, endpos.
	 * 
	 * @param ranges
	 *            the list of ranges
	 */
