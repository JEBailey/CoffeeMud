...
public interface HTTPRequest {
	...
	/**
	 * Gets the entire url path as supplied by the client, including request
	 * parameters
	 * 
	 * @return The host
	 */
	...
	/**
	 * Access the body of the request as an input stream The body will be
	 * unavailable is already processed (ie urlencoded parameters)
	 * 
	...
	/**
	 * Returns a list of multi-part sections from this request, or NULL if
	 * either the data was not in multi-part form, or was parsed another way.
	 * Keep in mind that multipart/form-data is places into UrlParameters, along
	 * with urlencoded body data.
	 * 
	...
	/**
	 * Adds a new url parameter keypair, just as if it had been sent by the
	 * client. Like the RequestObjects set, this can be used for inter-component
	...
	/**
	 * Gets a map of specific objects associated with this request. These are
	 * definitely for inter-servlet-component communication, but are not
	 * reflected in full urls, and don't appear as url parameters.
	 * 
