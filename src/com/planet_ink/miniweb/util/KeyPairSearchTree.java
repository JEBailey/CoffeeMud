...
/**
 * A quick prefix lookup tree that takes a lot of memory, but is worth it in
 * speed. It stores key/pairs, and can be asked if a string starts with one of
 * the keys. If it does, it returns the value of the pair.
 * 
 * @author Bo Zimmerman
 * 
 */
public class KeyPairSearchTree<V> {
	...
	/**
	 * Retreive teh value for the longest key that the given string starts with
	 * 
	 * @param fullStr
	 *            the string that might start with a key
	 * @return the value
	 */
