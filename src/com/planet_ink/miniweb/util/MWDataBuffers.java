...
public class MWDataBuffers implements DataBuffers {
	...
	public MWDataBuffers(final RandomAccessFile file,
	...
	public void addFlush(final MWDataBuffers buffers) {
		...
		buffers.list.clear();
		buffers.length = 0;
		if ((buffers.lastModifiedTime > this.lastModifiedTime)
				&& (buffers.lastModifiedTime > 0))
