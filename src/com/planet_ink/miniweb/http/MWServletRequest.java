...
/**
 * This class is instantiated as an means for servlets to get input from the
 * request. It is generally a wrapper for the internal class HTTPRequest, but
 * with more guards against some idiosyncracies of that class.
 * 
...
public class MWServletRequest implements SimpleServletRequest {
	 ...
	 * 
	 * @param session
	 *            the session assigned to the request
	 * @param request
