...
public class ResultSet implements java.sql.ResultSet {
	...
	ResultSet(Statement stmt, Backend.FakeTable table, int[] showCols,
			List<FakeCondition> conditions, int[] orderByKeyDexCols,
		...
		this.iter = table.indexIterator(this.orderByKeyDexCols,
		...
		for (int s = 0; s < showCols.length; s++)
			if (showCols[s] == FakeColumn.INDEX_COUNT) {
				showColMap
						.put("COUNT", Integer.valueOf(FakeColumn.INDEX_COUNT));
				int ct = 0;
				while (iter.hasNext()) {
					iter.next();
					ct++;
				...
				showColMap.put(table.getColumnName(showCols[s]),
						Integer.valueOf(s));
	}
	...
	public boolean next() throws java.sql.SQLException {
		while (true) {
			...
			if (conditions.size() > 0) {
				...
				dataLoaded[0] = false;
				if (!fakeTable.recordCompare(rowInfo, conditions, dataLoaded,
						values))
					continue;
				currentRow++;
				if (!dataLoaded[0])
	...
	public java.sql.Array getArray(String columnName)
			throws java.sql.SQLException {
		return getArray(findColumn(columnName));
	}

	public java.sql.Blob getBlob(String columnName)
			throws java.sql.SQLException {
		return getBlob(findColumn(columnName));
	}

	public java.sql.Clob getClob(String columnName)
			throws java.sql.SQLException {
	...
	public java.sql.Date getDate(int columnName, java.util.Calendar c)
			throws java.sql.SQLException {
		return getDate(columnName);
	}

	public java.sql.Date getDate(String columnName, java.util.Calendar c)
			throws java.sql.SQLException {
		return getDate(findColumn(columnName));
	}
	...
	public java.sql.Time getTime(int columnName, java.util.Calendar c)
			throws java.sql.SQLException {
		return getTime(columnName);
	}

	public java.sql.Time getTime(String columnName, java.util.Calendar c)
			throws java.sql.SQLException {
		return getTime(findColumn(columnName));
	}
	...
	public java.sql.Timestamp getTimestamp(int columnName, java.util.Calendar c)
			throws java.sql.SQLException {
		return getTimestamp(columnName);
	}

	public java.sql.Timestamp getTimestamp(String columnName,
			java.util.Calendar c) throws java.sql.SQLException {
		return getTimestamp(findColumn(columnName));
	}
	...
	public java.sql.ResultSetMetaData getMetaData()
		...
		return new java.sql.ResultSetMetaData() {
			...
			public int isNullable(int column) throws SQLException {
				...
				return fakeTable.getColumnInfo(showCols[column - 1]).canNull ? columnNullable
						: columnNoNulls;
			}
	...
	public void beforeFirst() throws java.sql.SQLException {
		if (fakeTable == null)
			throw new java.sql.SQLException();
		iter = fakeTable.indexIterator(this.orderByKeyDexCols,
				this.orderByConditions);
		currentRow = 0;
	}
