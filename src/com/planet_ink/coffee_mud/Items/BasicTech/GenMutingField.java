...
public class GenMutingField extends GenPersonalShield {
	...
	protected String fieldOnStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "An dense field surrounds <O-NAME>."
				: "An dense field surrounds <T-NAME>.";
	}

	@Override
	protected String fieldDeadStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "The dense field around <O-NAME> flickers and dies out."
				...
				if (s.indexOf("<DAMAGE> <T-HIM-HER>") > 0)
					mob.location().show(
							...
							CMStrings.replaceAll(s, "<DAMAGE>",
									"it`s absorbed by the shield around"));
