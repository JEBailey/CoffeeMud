...
public class GenReflectionShield extends GenPersonalShield {
	...
	protected String fieldOnStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "A reflecting field of energy surrounds <O-NAME>."
				: "A reflecting field of energy surrounds <T-NAME>.";
	}

	@Override
	protected String fieldDeadStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "The reflecting field around <O-NAME> flickers and dies out."
