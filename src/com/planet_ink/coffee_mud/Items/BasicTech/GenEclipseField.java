...
public class GenEclipseField extends GenTickerShield {
	...
	protected String fieldOnStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "An eclipsing field surrounds <O-NAME>."
				: "An eclipsing field surrounds <T-NAME>.";
	}

	@Override
	protected String fieldDeadStr(MOB viewerM) {
		return (owner() instanceof MOB) ? "The eclipsing field around <O-NAME> flickers and dies out as <O-HE-SHE> fade(s) back into view."
