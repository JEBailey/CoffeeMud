...
public interface RawMaterial extends Item {
	...
	public static enum Material {
		UNKNOWN("Unknown material"), CLOTH("Cloth"), LEATHER("Leather"), METAL(
				"Metal"), MITHRIL("Metal"), WOODEN("Wood"), GLASS("Glass"), VEGETATION(
				"Vegetation"), FLESH("Flesh"), PAPER("Paper"), ROCK("Rock"), LIQUID(
				"Liquid"), PRECIOUS("Stone"), ENERGY("Energy"), SYNTHETIC(
				"Plastic"), GAS("Gas");
		...
		public static Material findByMask(int mask) {
			int maskOrdinal = (mask < size()) ? mask
					: (mask & MATERIAL_MASK) >> 8;
	...
	public static enum DefResource {
		NOTHING(RESOURCE_NOTHING, 0, 0, 0, 0, "", "", null), MEAT(
				RESOURCE_MEAT, 4, 20, 1, 3000, "", "", null), BEEF(
				RESOURCE_BEEF, 6, 20, 1, 3000, "", "", null), PORK(
				RESOURCE_PORK, 8, 20, 1, 2500, "", "", null), POULTRY(
				RESOURCE_POULTRY, 3, 20, 1, 2000, "", "", null), MUTTON(
				RESOURCE_MUTTON, 4, 20, 1, 2800, "", "", null), FISH(
				RESOURCE_FISH, 5, 100, 1, 590, "strong fishy", "",
				ResourceFlag.FISH), WHEAT(RESOURCE_WHEAT, 1, 20, 1, 770, "",
				"", null), CORN(RESOURCE_CORN, 1, 20, 1, 720, "", "", null), RICE(
				RESOURCE_RICE, 1, 20, 1, 750, "", "", null), CARROTS(
				RESOURCE_CARROTS, 1, 5, 1, 720, "", "", null), TOMATOES(
				RESOURCE_TOMATOES, 1, 5, 1, 640, "", "", null), PEPPERS(
				RESOURCE_PEPPERS, 1, 5, 1, 640, "spicy", "", null), GREENS(
				RESOURCE_GREENS, 1, 5, 1, 540, "very mild", "", null), FRUIT(
				RESOURCE_FRUIT, 2, 10, 1, 720, "sweet and fruity", "", null), APPLES(
				RESOURCE_APPLES, 2, 10, 1, 640, "sweet apply", "", null), BERRIES(
				RESOURCE_BERRIES, 2, 15, 1, 720, "sweet berry", "",
				ResourceFlag.BERRY), ORANGES(RESOURCE_ORANGES, 2, 10, 1, 640,
				"citrusy", "", null), LEMONS(RESOURCE_LEMONS, 2, 10, 1, 480,
				"strong citrusy", "Prop_UseSpellCast2(Spell_ShrinkMouth)", null), GRAPES(
				RESOURCE_GRAPES, 3, 5, 1, 680, "mild sweet", "", null), OLIVES(
				RESOURCE_OLIVES, 2, 5, 1, 640, "pickly olive", "", null), POTATOES(
				RESOURCE_POTATOES, 1, 5, 1, 770, "", "", null), CACTUS(
				RESOURCE_CACTUS, 2, 5, 1, 680, "", "", null), DATES(
				RESOURCE_DATES, 2, 2, 1, 720, "sweet plumy", "", null), SEAWEED(
				RESOURCE_SEAWEED, 1, 50, 1, 540, "", "", null), STONE(
				RESOURCE_STONE, 1, 80, 5, 2500, "mild musty", "", null), LIMESTONE(
				RESOURCE_LIMESTONE, 1, 20, 4, 1550, "", "", null), FLINT(
				RESOURCE_FLINT, 1, 10, 4, 2600, "", "", null), GRANITE(
				RESOURCE_GRANITE, 2, 10, 6, 2690, "", "", null), OBSIDIAN(
				RESOURCE_OBSIDIAN, 10, 5, 6, 2650, "", "", null), MARBLE(
				RESOURCE_MARBLE, 20, 5, 5, 2560, "", "", null), SAND(
				RESOURCE_SAND, 1, 50, 1, 1600, "", "", null), JADE(
				RESOURCE_JADE, 50, 2, 5, 3800, "", "", null), IRON(
				RESOURCE_IRON, 20, 10, 6, 7900, "", "", null), LEAD(
				RESOURCE_LEAD, 10, 10, 4, 11300, "", "", null), BRONZE(
				RESOURCE_BRONZE, 10, 10, 5, 8100, "", "", null), SILVER(
				RESOURCE_SILVER, 30, 2, 5, 10500, "", "", null), GOLD(
				RESOURCE_GOLD, 150, 1, 5, 19320, "", "", null), ZINC(
				RESOURCE_ZINC, 10, 5, 5, 7100, "", "", null), COPPER(
				RESOURCE_COPPER, 10, 10, 5, 8900, "", "", null), TIN(
				RESOURCE_TIN, 10, 10, 4, 7300, "", "", null), MITHRIL(
				RESOURCE_MITHRIL, 100, 1, 9, 3990, "", "", null), ADAMANTITE(
				RESOURCE_ADAMANTITE, 175, 1, 10, 4500, "", "", null), STEEL(
				RESOURCE_STEEL, 75, 0, 8, 7840, "", "", null), BRASS(
				RESOURCE_BRASS, 120, 0, 6, 5500, "", "", null), WOOD(
				RESOURCE_WOOD, 2, 10, 3, 920, "", "", null), PINE(
				RESOURCE_PINE, 4, 10, 3, 650, "fresh, clean piney", "", null), BALSA(
				RESOURCE_BALSA, 1, 5, 2, 130, "", "", null), OAK(RESOURCE_OAK,
				5, 10, 3, 720, "rich oaky", "", null), MAPLE(RESOURCE_MAPLE,
				10, 5, 3, 689, "mild maply", "", null), REDWOOD(
				RESOURCE_REDWOOD, 20, 2, 3, 450, "", "", null), HICKORY(
				RESOURCE_HICKORY, 5, 5, 3, 830, "", "", null), SCALES(
				RESOURCE_SCALES, 10, 20, 4, 1800, "", "", null), FUR(
				RESOURCE_FUR, 20, 20, 2, 890, "musky", "", null), LEATHER(
				RESOURCE_LEATHER, 10, 20, 2, 945, "strong leathery", "", null), HIDE(
				RESOURCE_HIDE, 4, 20, 2, 920, "mild stinky", "", null), WOOL(
				RESOURCE_WOOL, 10, 20, 1, 1310, "", "", null), FEATHERS(
				RESOURCE_FEATHERS, 10, 20, 1, 20, "", "", null), COTTON(
				RESOURCE_COTTON, 5, 20, 1, 590, "", "", null), HEMP(
				RESOURCE_HEMP, 4, 10, 1, 720, "grassy", "", null), WATER(
				RESOURCE_FRESHWATER, 0, 100, 0, 1000, "", "", null), SALT_WATER(
				RESOURCE_SALTWATER, 0, 100, 0, 1030, "", "", null), LIQUID(
				RESOURCE_DRINKABLE, 0, 1, 0, 1000, "", "", null), GLASS(
				RESOURCE_GLASS, 10, 0, 3, 2800, "", "", null), PAPER(
				RESOURCE_PAPER, 10, 0, 0, 920, "", "", null), CLAY(
				RESOURCE_CLAY, 1, 50, 1, 1750, "mild dusty", "", null), CHINA(
				RESOURCE_CHINA, 30, 0, 3, 2400, "", "", null), DIAMOND(
				RESOURCE_DIAMOND, 500, 1, 9, 3510, "", "", null), CRYSTAL(
				RESOURCE_CRYSTAL, 10, 5, 3, 2200, "", "", null), GEM(
				RESOURCE_GEM, 100, 1, 3, 3500, "", "", null), PEARL(
				RESOURCE_PEARL, 380, 1, 4, 2000, "", "", null), PLATINUM(
				RESOURCE_PLATINUM, 80, 1, 6, 21450, "", "", null), MILK(
				RESOURCE_MILK, 2, 10, 0, 1020, "mild milky", "", null), EGGS(
				RESOURCE_EGGS, 2, 10, 0, 1120, "", "", null), HOPS(
				RESOURCE_HOPS, 2, 20, 1, 340, "mild grainy", "", null), COFFEEBEANS(
				RESOURCE_COFFEEBEANS, 2, 10, 1, 560, "mild coffee",
				"Poison_Caffeine", null), COFFEE(RESOURCE_COFFEE, 0, 10, 0,
				430, "rich coffee", "Poison_Caffeine", null), OPAL(
				RESOURCE_OPAL, 80, 2, 5, 2250, "", "", null), TOPAZ(
				RESOURCE_TOPAZ, 200, 2, 5, 3570, "", "", null), AMETHYST(
				RESOURCE_AMETHYST, 300, 2, 5, 2651, "", "", null), GARNET(
				RESOURCE_GARNET, 70, 2, 5, 3870, "", "", null), AMBER(
				RESOURCE_AMBER, 80, 5, 5, 2500, "", "", null), AQUAMARINE(
				RESOURCE_AQUAMARINE, 50, 2, 5, 2800, "", "", null), CRYSOBERYL(
				RESOURCE_CRYSOBERYL, 50, 2, 5, 2800, "", "", null), IRONWOOD(
				RESOURCE_IRONWOOD, 25, 5, 4, 990, "", "", null), SILK(
				RESOURCE_SILK, 200, 5, 1, 1100, "", "", null), COCOA(
				RESOURCE_COCOA, 4, 5, 0, 590, "", "", null), BLOOD(
				RESOURCE_BLOOD, 1, 100, 0, 1025, "strong salty", "", null), BONE(
				RESOURCE_BONE, 1, 100, 5, 1600, "", "", null), COAL(
				RESOURCE_COAL, 1, 50, 1, 1800, "chalky", "", null), LAMP_OIL(
				RESOURCE_LAMPOIL, 1, 10, 1, 880, "light oily", "L", null), POISON(
				RESOURCE_POISON, 1, 1, 1, 1000, "", "", null), LIQUOR(
				RESOURCE_LIQUOR, 10, 1, 1, 790, "alcohol", "", null), SUGAR(
				RESOURCE_SUGAR, 1, 50, 1, 1600, "", "", null), HONEY(
				RESOURCE_HONEY, 1, 50, 1, 1600, "", "", null), BARLEY(
				RESOURCE_BARLEY, 1, 20, 1, 610, "", "", null), MUSHROOMS(
				RESOURCE_MUSHROOMS, 1, 20, 1, 500, "", "", null), HERBS(
				RESOURCE_HERBS, 1, 10, 1, 770, "fresh herbal", "", null), VINE(
				RESOURCE_VINE, 1, 10, 1, 880, "rich green", "", null), FLOWERS(
				RESOURCE_FLOWERS, 1, 10, 1, 720, "nice floral", "", null), PLASTIC(
				RESOURCE_PLASTIC, 25, 0, 4, 950, "", "", null), RUBBER(
				RESOURCE_RUBBER, 25, 0, 1, 1506, "sour rubbery", "", null), EBONY(
				RESOURCE_EBONY, 5, 5, 5, 2910, "", "", null), IVORY(
				RESOURCE_IVORY, 5, 5, 3, 1840, "", "", null), WAX(RESOURCE_WAX,
				1, 0, 0, 900, "", "", null), NUTS(RESOURCE_NUTS, 0, 20, 0, 640,
				"mild nutty", "", null), BREAD(RESOURCE_BREAD, 3, 0, 0, 660,
				"", "", null), CRACKER(RESOURCE_CRACKER, 2, 0, 0, 200, "", "",
				null), YEW(RESOURCE_YEW, 15, 2, 5, 850, "", "", null), DUST(
				RESOURCE_DUST, 0, 20, 0, 1120, "dusty", "", null), PIPEWEED(
				RESOURCE_PIPEWEED, 3, 10, 1, 320, "strong grassy", "", null), ENERGY(
				RESOURCE_ENERGY, 30, 0, 4, 0, "", "", null), STRAWBERRIES(
				RESOURCE_STRAWBERRIES, 10, 1, 1, 750, "sweet berry", "",
				ResourceFlag.BERRY), BLUEBERRIES(RESOURCE_BLUEBERRIES, 10, 1,
				1, 750, "sweet berry", "", ResourceFlag.BERRY), RASPBERRIES(
				RESOURCE_RASPBERRIES, 10, 1, 1, 750, "sweet berry", "",
				ResourceFlag.BERRY), BOYSENBERRIES(RESOURCE_BOYSENBERRIES, 10,
				1, 1, 750, "sweet berry", "", ResourceFlag.BERRY), BLACKBERRIES(
				RESOURCE_BLACKBERRIES, 10, 1, 1, 750, "sweet berry", "",
				ResourceFlag.BERRY), SMURFBERRIES(RESOURCE_SMURFBERRIES, 10, 1,
				1, 750, "sweet berry", "", ResourceFlag.BERRY), PEACHES(
				RESOURCE_PEACHES, 10, 1, 1, 700, "peachy", "", null), PLUMS(
				RESOURCE_PLUMS, 10, 1, 1, 710, "sweey plumy", "", null), ONIONS(
				RESOURCE_ONIONS, 10, 1, 1, 760, "stinging oniony", "", null), CHERRIES(
				RESOURCE_CHERRIES, 10, 1, 1, 810, "cherry", "", null), GARLIC(
				RESOURCE_GARLIC, 10, 1, 1, 815, "", "", null), PINEAPPLES(
				RESOURCE_PINEAPPLES, 10, 1, 1, 500, "fruity", "", null), COCONUTS(
				RESOURCE_COCONUTS, 10, 1, 2, 250, "", "", null), BANANAS(
				RESOURCE_BANANAS, 10, 1, 1, 790, "pungent banana", "", null), LIMES(
				RESOURCE_LIMES, 10, 1, 1, 690, "citrusy", "", null), SAP(
				RESOURCE_SAP, 10, 1, 1, 1600, "strong maply", "", null), ONYX(
				RESOURCE_ONYX, 70, 1, 8, 3300, "", "", null), TURQUOISE(
				RESOURCE_TURQUOISE, 70, 1, 8, 3300, "", "", null), PERIDOT(
				RESOURCE_PERIDOT, 65, 1, 6, 3300, "", "", null), QUARTZ(
				RESOURCE_QUARTZ, 25, 1, 5, 3300, "", "", null), LAPIS(
				RESOURCE_LAPIS, 70, 1, 6, 3300, "", "", null), BLOODSTONE(
				RESOURCE_BLOODSTONE, 85, 1, 8, 3300, "", "", null), MOONSTONE(
				RESOURCE_MOONSTONE, 90, 1, 8, 3300, "", "", null), ALEXANDRITE(
				RESOURCE_ALEXANDRITE, 95, 1, 9, 3300, "", "", null), TEAK(
				RESOURCE_TEAK, 20, 2, 3, 1000, "", "", null), CEDAR(
				RESOURCE_CEDAR, 15, 2, 3, 900, "strong cedar", "", null), ELM(
				RESOURCE_ELM, 15, 2, 3, 1100, "", "", null), CHERRYWOOD(
				RESOURCE_CHERRYWOOD, 17, 2, 3, 900, "", "", null), BEECHWOOD(
				RESOURCE_BEECHWOOD, 12, 2, 3, 975, "", "", null), WILLOW(
				RESOURCE_WILLOW, 12, 2, 1, 1000, "", "", null), SYCAMORE(
				RESOURCE_SYCAMORE, 11, 2, 2, 1000, "", "", null), SPRUCE(
				RESOURCE_SPRUCE, 12, 2, 3, 990, "", "", null), MESQUITE(
				RESOURCE_MESQUITE, 9, 2, 3, 1150, "rich mesquite", "", null), BASALT(
				RESOURCE_BASALT, 10, 2, 4, 3300, "", "", null), SHALE(
				RESOURCE_SHALE, 5, 2, 2, 1200, "", "", null), PUMICE(
				RESOURCE_PUMICE, 5, 2, 4, 600, "", "", null), SANDSTONE(
				RESOURCE_SANDSTONE, 10, 2, 2, 3500, "", "", null), SOAPSTONE(
				RESOURCE_SOAPSTONE, 60, 2, 5, 3600, "", "", null), SALMON(
				RESOURCE_SALMON, 6, 1, 1, 1000, "strong fishy", "",
				ResourceFlag.FISH), CARP(RESOURCE_CARP, 6, 1, 1, 1000,
				"strong fishy", "", ResourceFlag.FISH), TROUT(RESOURCE_TROUT,
				6, 1, 1, 1000, "strong fishy", "", ResourceFlag.FISH), SHRIMP(
				RESOURCE_SHRIMP, 6, 1, 1, 1000, "mild fishy", "",
				ResourceFlag.FISH), TUNA(RESOURCE_TUNA, 6, 1, 1, 1000,
				"strong fishy", "", ResourceFlag.FISH), CATFISH(
				RESOURCE_CATFISH, 6, 1, 1, 1000, "strong fishy", "",
				ResourceFlag.FISH), BAMBOO(RESOURCE_BAMBOO, 15, 10, 4, 120, "",
				"", null), SOAP(RESOURCE_SOAP, 1, 0, 1, 430, "light fragrant",
				"", null), SPIDERSTEEL(RESOURCE_SPIDERSTEEL, 150, 0, 2, 630,
				"", "", null), ASH(RESOURCE_ASH, 1, 0, 0, 50, "dusty", "", null), PERFUME(
				RESOURCE_PERFUME, 1, 1, 1, 1000, "strong fragrant", "", null), ATLANTITE(
				RESOURCE_ATLANTITE, 200, 1, 6, 850, "", "", null), CHEESE(
				RESOURCE_CHEESE, 25, 0, 1, 640, "mild cheesy", "", null), BEANS(
				RESOURCE_BEANS, 1, 15, 1, 750, "", "", null), CRANBERRIES(
				RESOURCE_CRANBERRIES, 10, 1, 1, 750, "sweet berry", "",
				ResourceFlag.BERRY), DRAGONBLOOD(RESOURCE_DRAGONBLOOD, 10, 100,
				0, 1025, "mild salty",
				"Prop_UseSpellCast2(Prayer_MinorInfusion)", null), DRAGONMEAT(
				RESOURCE_DRAGONMEAT, 40, 20, 1, 3000, "mild salty", "", null), RUBY(
				RESOURCE_RUBY, 300, 1, 3, 3500, "", "", null), EMERALD(
				RESOURCE_EMERALD, 200, 1, 3, 3500, "", "", null), SAPPHIRE(
				RESOURCE_SAPPHIRE, 180, 1, 3, 3500, "", "", null), AGATE(
				RESOURCE_AGATE, 100, 1, 3, 3500, "", "", null), CITRINE(
				RESOURCE_CITRINE, 100, 1, 3, 3500, "", "", null), REED(
				RESOURCE_REED, 1, 50, 3, 830, "", "", null), ALABASTER(
				RESOURCE_ALABASTER, 5, 10, 4, 1550, "", "", null), CHROMIUM(
				RESOURCE_CHROMIUM, 80, 1, 6, 1550, "", "", null), WHITE_GOLD(
				RESOURCE_WHITE_GOLD, 150, 1, 5, 1450, "", "", null), DRAGONSCALES(
				RESOURCE_DRAGONSCALES, 50, 1, 6, 800, "", "", null), PLASMA(
				RESOURCE_PLASMA, 100, 0, 0, 0, "", "", null), ELECTRICITY(
				RESOURCE_ELECTRICITY, 100, 0, 0, 0, "", "", null), DEUTERIUM(
				RESOURCE_DEUTERIUM, 100, 0, 0, 0, "", "", null), SLIME(
				RESOURCE_SLIME, 5, 10, 1, 750, "horridly acidic",
				"Prop_UseSpellCast2(Spell_AcidSpray)", null), AIR(RESOURCE_AIR,
				0, 100, 0, 0, "", "", null), OXYGEN(RESOURCE_OXYGEN, 10, 100,
				0, 0, "", "", null), HYDROGEN(RESOURCE_HYDROGEN, 20, 100, 0, 0,
				"", "", null), FLOURINE(RESOURCE_FLOURINE, 60, 40, 0, 0,
				"strong pungent smell", "", null), NITROGEN(RESOURCE_NITROGEN,
				10, 100, 0, 0, "", "", null);
		...
		private DefResource(int cod, int val, int freq, int hard, int bou,
				String sniff, String eff, ResourceFlag flg) {
			code = cod;
			value = val;
			frequency = freq;
			hardness = hard;
	...
	public class CODES {
		public CODES() {
			...
			synchronized (this) {
				...
				for (DefResource d : DefResource.values()) {
					...
					add(material, d.desc, d.smell, d.value, d.frequency,
							d.hardness, d.bouancy, d.flag == ResourceFlag.FISH,
							d.flag == ResourceFlag.BERRY, d.effect);
				}
				for (int i = 0; i < addExtra.length + repExtra.length; i++) {
					...
					if (V.size() != 8) {
						Log.errOut("RawMaterial",
								"Bad coffeemud.ini material row (requires 8 elements, separated by ,): "
										+ p);
						continue;
					}
					String type = "ADD";
					...
					if (replace) {
						DefResource r = (DefResource) CMath.s_valueOf(
								DefResource.class, stat.toUpperCase().trim()
										.replace(' ', '_'));
						if (r != null) {
							...
							Log.errOut("RawMaterial",
									"Unknown replaceable resource in coffeemud.ini: "
											+ stat);
							continue;
						}
					}
					...
					if (material == null) {
						Log.errOut("RawMaterial",
								"Unknown material code in coffeemud.ini: "
										+ matStr);
						continue;
					}
					if (type.equalsIgnoreCase("ADD"))
						add(material.mask(), stat, smell, value, frequ,
								hardness, bouancy, fish, berry, abilityID);
					else if (type.equalsIgnoreCase("REPLACE")
							&& (oldResourceCode >= 0))
						replace(oldResourceCode, material.mask(), stat, smell,
								value, frequ, hardness, bouancy, fish, berry,
								abilityID);
				}
		...
		public static boolean IS_VALID(int code) {
			return (code >= 0)
					&& ((code & RawMaterial.RESOURCE_MASK) < c().total());
		}
		...
		public static Ability[] EFFECTA(int code) {
			...
			synchronized (c.effectAs) {
				...
				if (As != null)
					return As;
				List<String> effectsV = CMParms.parseSafeSemicolonList(
						c.effect(code), true);
				if (effectsV.size() == 0)
					...
					for (Iterator<String> e = effectsV.iterator(); e.hasNext();) {
						...
						if (A == null)
							Log.errOut("RawMaterial", "Unknown ability "
									+ abilityID + " in " + c.effect(code));
						else {
							A.setMiscText(parms);
							listA.add(A);
						}
				...
				for (int matIndex = 0; matIndex < numMaterials; matIndex++) {
					...
					for (int i = 0; i < total(); i++) {
						...
						if ((resourceCode & RawMaterial.MATERIAL_MASK) == matCode) {
							...
							newBucket.add(new Pair<Integer, Double>(Integer
									.valueOf(resourceCode), Double
									.valueOf(resourceValue)));
						}
					}
					PairSVector<Integer, Double> finalBucket = new PairSVector<Integer, Double>();
					final double pieceSize = 1.0 / newBucket.size();
					double currValue = 0.0;
					for (Iterator<Pair<Integer, Double>> i = newBucket
							.iterator(); i.hasNext();) {
		...
		public synchronized void add(int material, String name, String smell,
				int value, int frequ, int hardness, int bouancy, boolean fish,
				boolean berry, String abilityID) {
		...
		public synchronized void replace(int resourceCode, int material,
				String name, String smell, int value, int frequ, int hardness,
				int bouancy, boolean fish, boolean berry, String abilityID) {
