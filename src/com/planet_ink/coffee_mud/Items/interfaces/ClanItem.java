...
public interface ClanItem extends Item {
	...
	public final static String[] CI_DESC = { "FLAG", "BANNER", "GAVEL",
			"PROPAGANDA", "GATHERITEM", "CRAFTITEM", "SPECIALSCALES",
			"SPECIALSCAVENGER", "SPECIALOTHER", "SPECIALTAXER",
			"DONATIONJOURNAL", "ANTI-PROPAGANDA", "SPECIALAPRON", "LEGALBADGE" };
