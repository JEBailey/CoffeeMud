	...
	public void executeMsg(final Environmental myHost, final CMMsg msg) {
		...
		// msg.addTrailerMsg(CMClass.getMsg(msg.source(),this,CMMsg.MSG_DROP,null));
			...
			msg.addTrailerMsg(CMClass.getMsg(msg.source(), this,
					CMMsg.MASK_ALWAYS | CMMsg.MSG_DROP, null));
			msg.addTrailerMsg(CMClass.getMsg((MOB) msg.target(), this,
					CMMsg.MASK_ALWAYS | CMMsg.MSG_GET, null));
			msg.addTrailerMsg(CMClass.getMsg(msg.source(), msg.target(), this,
					CMMsg.MASK_ALWAYS | CMMsg.TYP_GENERAL, null));
		} else if ((msg.tool() == this) && (msg.target() instanceof MOB)
			...
			if (A != null) {
				...
				A.invoke(msg.source(), (MOB) msg.target(), true, phyStats()
						.level());
			}
		} else
