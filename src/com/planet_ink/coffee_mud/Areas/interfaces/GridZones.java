 ...
 */
/**
 * GridZones is a cross-object interface that applies both to Areas, and
 * Locales. It represents an area (or room) organized like a Grid.
 * 
 * @author Bo Zimmerman
 */
public interface GridZones extends Environmental {
	/**
	 * Returns whether the given Room is a child of this particular Grid
	 * instance.
	 * 
	...
	/**
	 * Returns the XY coordinates of the Room with the given roomID in XYVector
	 * format.
	 * 
	 * @see XYVector
	 * @param roomID
	...
	/**
	 * Returns the XY coordinates of the Room, if a child of this gridzone, in
	 * XYVector format.
	 * 
	 * @see XYVector
	 * @param room
	...
	/**
	 * A class for holding x/y coordinates. Used by GridZones as a way to hold
	 * such coordinates in a single place, and easily compare them to each
	 * other.
	 * 
	 * @author bzimmerman
	 */
