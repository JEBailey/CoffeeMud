 ...
 */
/**
 * AutoGenAreas are areas that utilize the random area generation system
 * (percolator) to generate their rooms. As such, the common parameters for the
 * auto gen system are herein exposed
 * 
 * @author Bo Zimmerman
 */
public interface AutoGenArea extends Area {
	...
	/**
	 * Get a miscellaneous, xml-specific set of other vars to set when
	 * generating a new area
	 * 
	...
	/**
	 * Set a miscellaneous, xml-specific set of other vars to set when
	 * generating a new area
	 * 
	 * @param vars
	...
	/**
	 * Set a miscellaneous, xml-specific set of other vars to set when
	 * generating a new area. Format is VAR=VALUE VAR2="VALUE"
	 * 
	 * @param vars
	 *            the variable mappings
	 */
