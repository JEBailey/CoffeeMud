 ...
 */
/**
 * An Area is an abstract collection of rooms organized together under a single
 * name in order to share attributes or give some common functionality. Areas
 * can also include other areas in a parent->child relationship.
 * 
...
public interface Area extends Economics, PhysicalAgent, Places {
	 ...
	 * rooms within this area will be affected by the results of this flag. May
	 * return THEME_INHERIT if the area inherits a theme from above.
	 * 
	 ...
	 * Returns the technology level supported by this area. Activities within
	 * rooms within this area will be affected by the results of this flag. May
	 * result in consulting parent areas to determine a theme
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#THEME_FANTASY
	 * @return a bitmap of the themes supported by this area.
	 */
	...
	/**
	 * Sets the technology level supported by this area. Activities within rooms
	 * within this area will be affected by the results of this flag.
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#THEME_FANTASY
	 * @param level
	 *            the bitmap representing the tech level
	 */
	public void setTheme(int level);

	/**
	 * Returns the coffeemud .cmare filename that will be used when the EXPORT
	 * command is used in such a way as to auto-generate filenames.
	 * 
	...
	/**
	 * Sets the coffeemud .cmare filename that will be used when the EXPORT
	 * command is used in such a way as to auto-generate filenames.
	 * 
	 * @param pathFile
	...
	/**
	 * Returns a reference to the Climate object that represents the current and
	 * future weather for this area.
	 * 
	...
	/**
	 * Sets a reference to the Climate object that represents the current and
	 * future weather for this area.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Climate
	 * @param obj
	...
	/**
	 * Returns a reference to the TimeClock object that represents the calendar
	 * and date/time for this area. May be shared by numerous areas.
	 * 
	...
	/**
	 * Sets a reference to the TimeClock object that represents the calendar and
	 * date/time for this area. May be shared by numerous areas.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock
	 * @param obj
	...
	/**
	 * A blurb flag is a run-time modifiable set of strings that can be added to
	 * an area in order to display them in the HELP entry for an area.
	 * 
	...
	/**
	 * A blurb flag is a run-time modifiable set of strings that can be added to
	 * an area in order to display them in the HELP entry for an area. This
	 * method returns the definition of a named flag
	 * 
	 * @param flag
	 ...
	 * A blurb flag is a run-time modifiable set of strings that can be added to
	 * an area in order to display them in the HELP entry for an area. This
	 * method returns the name of an enumerated flag.
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#getBlurbFlag(String)
	 * @return enumeration of blurb flag keys, call getBlurbFlag(String) for the
	 *         value
	 */
	 ...
	 * A blurb flag is a run-time modifiable set of strings that can be added to
	 * an area in order to display them in the HELP entry for an area. This
	 * method adds a new flag.
	 * 
	 * @param flagPlusDesc
	 *            the flag name, space, followed by definition
	 */
	 ...
	 * A blurb flag is a run-time modifiable set of strings that can be added to
	 * an area in order to display them in the HELP entry for an area. This
	 * method deletes an existing flag by name.
	 * 
	 * @param flagOnly
	 ...
	 * run-time generated Skys to be re-generated. It is called at boot-time and
	 * when areas are reset or re-generated.
	 */
	public void fillInAreaRooms();

	/**
	 * This method causes a given room to have its run-time generated Skys to be
	 * re-generated.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param R
	 *            the Room object to "fill-in"
	 */
	public void fillInAreaRoom(Room R);

	/**
	 * This method adds a new Room to this area. It is called by the
	 * Room.setArea( method, and should rarely if ever be called directly. It
	 * calls addMetroRoom on all parent areas to make them aware of it as well.
	 * 
	...
	/**
	 * Returns a room of the given roomID, if it has already been added by
	 * calling addProperRoom.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param roomID
	 *            the roomID of the room to return.
	 * @return a reference to the room that the id refers to, IF the room
	 *         belongs here.
	 */
	 ...
	 * Room object properly has not been loaded yet (due to the area being
	 * thin).
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param R
	...
	/**
	 * Returns an enumerator for all previously loaded rooms that properly
	...
	/**
	 * Returns an enumerator for all previously loaded rooms that properly
	 * belongs to this area, along with their skys or underwater add-ons.
	 * 
	 ...
	 * 
	 * @param roomID
	 *            the roomID of a room which should belong to this Area.
	 */
	 ...
	 * 
	 * @param roomID
	 *            the roomID of a room which should no longer belong to this
	 *            Area.
	 */
	 ...
	 * Enumerator returned is thus a more complete set than returned by
	 * getProperMap
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#getProperMap()
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 ...
	 * @return a com.planet_ink.coffee_mud.Common.interfaces.RoomnumberSet
	 *         object
	 */
	public RoomnumberSet getProperRoomnumbers();

	/**
	 * Sets the RoomnumberSet for all rooms that properly belong to this area,
	 * including those not yet loaded.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.RoomnumberSet
	 * @param set
	 *            a com.planet_ink.coffee_mud.Common.interfaces.RoomnumberSet
	 *            object
	 */
	...
	/**
	 * Returns a count of all cached rooms that belong to this area, excluding
	 * skys and auto-generated rooms.
	 * 
	...
	/**
	 * Returns a count of all cached rooms that belong to this area, which have
	 * been loaded.
	 * 
	...
	/**
	 * Returns an enumerator for all previously loaded rooms that properly
	 * belongs to this area AND to any child areas.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @return an enumerator of Room objects
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param R
	 *            a Room object from one of this areas child areas.
	 */
	public void addMetroRoom(Room R);

	/**
	 * Designates that a given Room object no longer belongs to one of this
	 * areas children.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param R
	 *            a Room object formerly from one of this areas child areas.
	 */
	public void delMetroRoom(Room R);

	/**
	 * Designates that a given roomid represents a room which belongs to one of
	 * this areas children.
	 * 
	 * @param roomID
	 *            a roomid for a room
	...
	/**
	 * Designates that a given roomid represents a room which no longer belongs
	 * to one of this areas children.
	 * 
	 * @param roomID
	 *            a roomid for a former room
	 */
	public void delMetroRoomnumber(String roomID);

	/**
	 * Returns a count of all cached rooms that belong to this area, or to a
	 * child area, which have been loaded.
	 * 
	...
	/**
	 * Returns whether the given Area object is either THIS area, a child of
	 * this area, or a decendent.
	 * 
	 * @param A
	 *            an Area object
	...
	/**
	 * Returns a random room from this area, or one of its children, loading it
	 * if necessary.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 ...
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param startRoom
	 *            the room connected to the upcoming new one (or null)
	 * @param direction
	 ...
	 * upon how the engine is operating on this area or its content. This method
	 * changes the state.
	 * 
	...
	/**
	 * Adds a SubOp to this area. This must be a valid Player Name. A Player
	 * with this designation will have their AREA security flags activated when
	 * in this area.
	 * 
	...
	/**
	 * Returns whether the given player name is a SubOp to this area. This must
	 * be a valid Player Name. A Player with this designation will have their
	...
	/**
	 * Returns a semicolon delimited list of player Names that represent the
	 * SubOp list for this area. A Player with this designation will have their
	 * AREA_ security flags activated when in this area.
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#addSubOp(String)
	...
	/**
	 * Sets the semicolon delimited list of player Names that represent the
	 * SubOp list for this area. A Player with this designation will have their
	 * AREA_ security flags activated when in this area.
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#addSubOp(String)
	...
	/**
	 * Returns a enumeration of player Names that represent the SubOp list for
	 * this area. A Player with this designation will have their AREA_ security
	 * flags activated when in this area.
	 * 
	...
	/**
	 * Returns an integer array of statistics about this area based on a
	 * snapshot generated the first time it is called. This array is the cached
	 * for future calls, but can be unloaded from resources using the UNLOAD
	 * command, to force a re-generation. The array is dereferenced using
	 * AREASTAT_ constants.
	 * 
	...
	/**
	 * An enumerator list of Area objects representing the Children Areas of
	 * this Area. A Child Area inherets certain behaviors and property effects
	 * from its parents
	 * 
	...
	/**
	 * Returns the named Child Area object for this Area A Child Area inherets
	 * certain behaviors and property effects from its Parents
	 * 
	 * @param named
	 *            the name of an Area
	...
	/**
	 * Returns whether the Area is a child of this Area A Child Area inherets
	 * certain behaviors and property effects from its Parents
	 * 
	 * @param area
	 *            an Area object
	...
	/**
	 * Returns whether the Area named is a child of this Area A Child Area
	 * inherets certain behaviors and property effects from its Parents
	 * 
	 * @param named
	 *            the name of an Area
	...
	/**
	 * Designates the given Area object as a Child of this one. A Child Area
	 * inherets certain behaviors and property effects from its Parents
	 * 
	 * @param area
	 *            an Area object
	...
	/**
	 * Designates the given Area object as no longer being Child of this one. A
	 * Child Area inherets certain behaviors and property effects from its
	 * Parents
	 * 
	 * @param area
	 *            an Area object
	 ...
	 * A Child Area inherets certain behaviors and property effects from its
	 * Parents
	 * 
	 * @param area
	 *            an Area to check
	 ...
	 * Area. A Parent Area passes down certain behaviors and property effects to
	 * its children
	 * 
	 * @return an enumerator of Area objects
	 */
	...
	/**
	 * Returns the named Parent Area object for this Area A Parent Area passes
	 * down certain behaviors and property effects to its children
	 * 
	 * @param named
	 *            the name of an Area
	...
	/**
	 * Returns a Vector of all Parent Area objects to this one, recursively A
	 * Parent Area passes down certain behaviors and property effects to its
	 * children
	 * 
	...
	/**
	 * Returns whether the Area is a Parent of this Area A Parent Area passes
	 * down certain behaviors and property effects to its children
	 * 
	 * @param area
	 *            an Area object
	...
	/**
	 * Returns whether the Area named is a Parent of this Area A Parent Area
	 * passes down certain behaviors and property effects to its children
	 * 
	 * @param named
	 *            the name of an Area
	...
	/**
	 * Designates the given Area object as a Parent of this one. A Parent Area
	 * passes down certain behaviors and property effects to its children
	 * 
	 * @param area
	 *            an Area object
	...
	/**
	 * Designates the given Area object as no longer being Parent of this one. A
	 * Parent Area passes down certain behaviors and property effects to its
	 * children
	 * 
	 * @param area
	 ...
	 * A Parent Area passes down certain behaviors and property effects to its
	 * children
	 * 
	 * @param newParent
	 *            an Area to check
	...
	/**
	 * Class to hold a reference to a child area instance, and the inhabitants
	 * who belong there.
	 * 
	 * @author Bo Zimmerman
	 */
	public static class AreaInstanceChild {
		...
		public AreaInstanceChild(final Area A,
				final List<WeakReference<MOB>> mobs) {
			this.A = A;
			this.mobs = mobs;
	...
	public final static String[] THEME_BIT_NAMES = { "FANTASY", "TECH",
			"HEROIC", "SKILLONLY" };
	/**
	 * Bitmap flag meaning that the object supports magic. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#getTheme()
	 */
	...
	/**
	 * Bitmap flag meaning that the object supports technology. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#getTheme()
	 */
	public final static int THEME_TECHNOLOGY = 2;
	/**
	 * Bitmap flag meaning that the object supports super powers. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#getTheme()
	 */
	public final static int THEME_HEROIC = 4;
	/**
	 * Bitmap flag meaning that the object only supports usage of above in
	 * Skills. @see com.planet_ink.coffee_mud.Areas.interfaces.Area#getTheme()
	 */
	public final static int THEME_SKILLONLYMASK = 8;
	/**
	 * Indexed description of the THEME_ bitmap constants in all possible
	 * combinations -- in upper/single word format
	 */
	public final static String[] THEME_NAMES = { "INHERITED", "FANTASY",
			"TECH", "FANTAST+TECH", "HEROIC", "HEROIC+FANTASY", "HEROIC+TECH",
			"ALL", "SKILLONLY" };
	/**
	 * Indexed description of the THEME_ bitmap constants in all possible
	 * combinations. In readable format.
	 * 
	 * @see com.planet_ink.coffee_mud.Areas.interfaces.Area#THEME_FANTASY
	 */
	...
	/**
	 * Indexed extended description of the THEME_ bitmap constants in all
	...
	/**
	 * State flag meaning this area is a THIN type area. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#flags()
	 */
	public final static int FLAG_THIN = 1;
	/**
	 * State flag meaning this area is a INSTANCE parent type area. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#flags()
	 */
	public final static int FLAG_INSTANCE_PARENT = 2;
	/**
	 * State flag meaning this area is a INSTANCE child type area. @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#flags()
	 */
	public final static int FLAG_INSTANCE_CHILD = 4;

	/**
	 * Various area IStat constants.. see @see
	 * com.planet_ink.coffee_mud.Areas.interfaces.Area#getAreaIStats()
	 */
	...
	public static enum State {
		...
		STOPPED
		/** Area is neither threaded, running, nor mobile */

	}

	/**
	 * Amount of time of player absence before an area automatically goes from
	 * Active to passive
	 */
	public final static long TIME_PASSIVE_LAPSE = 60 * 1000 * 30; // 30 mins

	/**
	 * @author Owner This enumerator is for loading any rooms not yet loaded,
	 *         all at enumeration-time.
	 */
	...
	/**
	 * @author Owner This class implements the getCompleteMap() method by
	 *         enumerating through the complete list of roomIDs for this area
	 *         and loading any rooms not yet loaded, all at enumeration-time.
	 */
	public class CompleteRoomEnumerator implements Enumeration<Room> {
		...
		public Room nextElement() {
			...
			if (room instanceof GridLocale)
				roomEnumerators.addEnumeration(new IteratorEnumeration<Room>(
						((GridLocale) room).getAllRooms().iterator()));
