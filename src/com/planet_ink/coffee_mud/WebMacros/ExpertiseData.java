		...
		if (last.length() > 0) {
			...
			if (E != null) {
				...
				if (parms.containsKey("HELP")) {
					StringBuilder s = CMLib.help().getHelpText(E.ID, null,
							false);
					if (s == null)
				...
				if (parms.containsKey("SHORTHELP")) {
					String s = CMLib.help().getHelpFile()
							.getProperty(E.ID.toUpperCase());
					if (s == null)
						s = CMLib.help().getArcHelpFile()
								.getProperty(E.ID.toUpperCase());
					if (s == null)
						s = CMLib
								.help()
					...
					if (s != null) {
						...
						StringBuilder s2 = CMLib.help().getHelpText(E.ID, null,
								false);
						if (s2 == null)
				...
				if (parms.containsKey("ALLOWS")) {
					...
					for (Iterator<String> i = CMLib.ableMapper()
							.getAbilityAllowsList(E.ID); i.hasNext();) {
