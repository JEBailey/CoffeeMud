...
public class ExitData extends StdWebMacro {
	...
	private static final String[] okparms = { "NAME", "CLASSES", "DISPLAYTEXT",
			"DESCRIPTION", "LEVEL", "LEVELRESTRICTED", "ISTRAPPED", "HASADOOR",
			...
			"ISALIGNMENTRESTRICTED", "RESTRICTEDALIGNMENTS", "MISCTEXT",
			"ISGENERIC", "DOORNAME", "IMAGE", "OPENTICKS" };

	public static String dispositions(Physical P, boolean firstTime,
	...
	public String runMacro(HTTPRequest httpReq, String parm) {
		...
		boolean firstTime = (!httpReq.isUrlParameter("ACTION"))
				...
				|| (((httpReq.isUrlParameter("CHANGEDCLASS")) && (httpReq
			...
			if (parms.containsKey(okparms[o])) {
				...
				case 1: // classes
				{
					...
					Object[] sorted = (Object[]) Resources
							.getResource("MUDGRINDER-EXITS");
					if (sorted == null) {
						Vector sortMe = new Vector();
						for (Enumeration e = CMClass.exits(); e
								.hasMoreElements();)
