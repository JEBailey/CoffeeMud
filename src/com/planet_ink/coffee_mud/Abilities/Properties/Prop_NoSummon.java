...
public class Prop_NoSummon extends Property {
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		if ((msg.tool() != null)
				...
				&& ((msg.source().location() == affected) || ((affected instanceof Area) && (((Area) affected)
						.inMyMetroArea(msg.source().location().getArea()))))
				&& ((!nonAggroOK) || (!(msg.target() instanceof MOB)) || (!CMLib
						.flags().isAggressiveTo((MOB) msg.target(), null)))
