...
public class Skill_Joke extends BardSkill {
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			if (auto)
				str = "<T-NAME> remember(s) a joke!";
			else {
				List<String> insultd = Resources.getFileLineVector(Resources
						.getFileResource("skills/insultd.txt", true));
				List<String> insulto = Resources.getFileLineVector(Resources
						.getFileResource("skills/insulto.txt", true));
				String[] ob = new String[5];
				String[] de = new String[5];
				for (int cnt = 1; cnt < 4; cnt++) {
					ob[cnt] = insulto.get(CMLib.dice().roll(1, insulto.size(),
							-1));
					de[cnt] = insultd.get(CMLib.dice().roll(1, insultd.size(),
							-1));
				}
				String joke = null;
				switch (CMLib.dice().roll(1, 7, 0)) {
				case 1:
					joke = "Q: What do you get if you cross a " + ob[1]
							+ " with a " + ob[2] + "?\n\r" + "A: " + de[1]
							+ " " + ob[3] + "!";
					break;
				case 2:
				...
				case 4:
					joke = "Q: What's the difference between a " + ob[1]
							+ " and a " + ob[2] + "?\n\r" + "A: A " + ob[1]
							+ " is " + de[1] + " " + ob[3] + "!";
					break;
				case 5:
					joke = "Q: What did the big " + ob[1]
							+ " say to the little " + ob[1] + "?\n\r"
							+ "A: 'You are " + de[1] + " " + ob[2] + "!'";
					break;
				case 6:
					joke = "Q: What do you call " + de[1] + " " + ob[1]
							+ " without " + de[2] + " " + ob[2] + "?\n\r"
							+ "A: " + CMStrings.capitalizeAndLower(de[3]) + " "
							+ ob[3] + "!";
					break;
				case 7:
					joke = "Q: When is " + de[1] + " " + ob[1] + " not "
							+ de[1] + " " + ob[1] + "?\n\r" + "A: When it's "
							+ de[2] + " " + ob[2] + "!'";
					break;
				}
			...
			return beneficialVisualFizzle(mob, target,
					"<S-NAME> attempt(s) to think up a joke for <T-NAMESELF>, but fail(s).");
