...
public class Song_SingleMindedness extends Song {
	...
	public void executeMsg(Environmental ticking, CMMsg msg) {
		...
		if ((themsg == null) && (msg.source() != invoker())
				&& (msg.source() == affected) && (msg.sourceMessage() != null)
	...
	public boolean okMessage(Environmental ticking, CMMsg msg) {
		if ((themsg != null) && (msg.source() != invoker())
			...
			msg.source().tell(
					...
					null,
					null,
					"The only thing you have a mind to do is '"
							+ themsg.sourceMessage() + "'.");
			return false;
		}
