...
public class MasterWeaponsmithing extends Weaponsmithing implements ItemCraftor {
	...
	public String name() {
		return "Master Weaponsmithing";
	}

	private static final String[] triggerStrings = { "MWEAPONSMITH",
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (commands.size() == 0) {
			commonTell(
					mob,
					"Make what? Enter \"mweaponsmith list\" for a list, \"mweaponsmith scan\", \"mweaponsmith learn <item>\", \"mweaponsmith mend <item>\", or \"mweaponsmith stop\" to cancel.");
			return false;
		}
