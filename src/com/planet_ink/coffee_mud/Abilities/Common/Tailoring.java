...
public class Tailoring extends EnhancedCraftingSkill implements ItemCraftor,
	...
	private static final String[] triggerStrings = { "KNIT", "TAILOR",
			"TAILORING" };
	...
	public boolean mayICraft(final Item I) {
		...
		if (I instanceof Armor) {
			final long nonWearablePlaces = Wearable.WORN_FEET
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (commands.size() == 0) {
			commonTell(
					mob,
					"Knit what? Enter \"knit list\" for a list, \"knit refit <item>\" to resize, \"knit learn <item>\", \"knit scan\", \"knit mend <item>\", or \"knit stop\" to cancel.");
			return false;
		}
		if ((!auto)
				&& (commands.size() > 0)
		...
		if (str.equalsIgnoreCase("list")) {
			...
			if (foundRecipe == null) {
				commonTell(mob, "You don't know how to knit a '" + recipeName
