...
public class Speculate extends CommonSkill {
					...
					if (RawMaterial.CODES.IS_VALID(resource)) {
						...
						for (int d = Directions.NUM_DIRECTIONS() - 1; d >= 0; d--) {
							...
							if ((room2 != null)
								...
								resource = room2.myResource()
										& RawMaterial.RESOURCE_MASK;
								if (RawMaterial.CODES.IS_VALID(resource)) {
									resourceStr = RawMaterial.CODES
											.NAME(resource);
						...
						commonTell(mob,
								"You don't find any good resources around here.");
				}
			}
		}
		super.unInvoke();
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		CMMsg msg = CMClass.getMsg(mob, null, this, getActivityMessageType(),
				"<S-NAME> start(s) speculating on this area.");
