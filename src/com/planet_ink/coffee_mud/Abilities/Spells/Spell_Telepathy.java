	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			...
			if (mob.location().okMessage(mob, msg)) {
				...
				else if (target.charStats()
						.getStat(CharStats.STAT_INTELLIGENCE) >= 13)
					adjective += "very intelligent, ";
				else if (target.charStats()
						.getStat(CharStats.STAT_INTELLIGENCE) > 10)
					adjective += "intelligent, ";
				else if (target.charStats()
						.getStat(CharStats.STAT_INTELLIGENCE) <= 3)
					adjective += "instinctual, ";
				else if (target.charStats()
						.getStat(CharStats.STAT_INTELLIGENCE) < 7)
					adjective += "stupid, ";
				else if (target.charStats()
						.getStat(CharStats.STAT_INTELLIGENCE) < 10)
				...
				mob.tell(target.Name() + " is a " + adjective
