			...
			if ((msg.tool().ID().equals("Fighter_SmokeSignals"))
				...
				msg.addTrailerMsg(CMClass.getMsg(msg.source(), null, null,
						CMMsg.MSG_OK_VISUAL, "The smoke signals seem to say '"
								+ msg.othersMessage() + "'.", CMMsg.NO_EFFECT,
						null, CMMsg.NO_EFFECT, null));
			else if (((msg.sourceMinor() == CMMsg.TYP_SPEAK)
					|| (msg.sourceMinor() == CMMsg.TYP_TELL) || (CMath.bset(
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (target.fetchEffect(ID()) != null) {
			mob.tell(target, null, null,
					"<S-NAME> already <S-HAS-HAVE> comprehension.");
			return false;
		}
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "<T-NAME> feel(s) more comprehending."
									: "^S<S-NAME> invoke(s) the power of comprehension!^?");
