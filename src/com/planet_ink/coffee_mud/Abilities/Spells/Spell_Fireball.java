		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							(auto ? "A huge fireball appears and blazes towards <T-NAME>!"
									: "^S<S-NAME> point(s) at <T-NAMESELF>, shooting forth a blazing fireball!^?")
			...
			return maliciousFizzle(mob, target,
					"<S-NAME> point(s) at <T-NAMESELF>, but nothing more happens.");
