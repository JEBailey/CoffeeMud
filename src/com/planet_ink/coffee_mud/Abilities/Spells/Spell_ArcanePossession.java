...
public class Spell_ArcanePossession extends Spell {
	...
	public boolean okMessage(Environmental host, CMMsg msg) {
		...
		if ((msg.tool() == affected) && (msg.sourceMinor() == CMMsg.TYP_SELL)) {
			...
			msg.source()
					.location()
					.show(msg.source(), null, affected, CMMsg.MSG_OK_ACTION,
							"<O-NAME> flashes and flies out of <S-HIS-HER> hands!");
		...
		if (success) {
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? ""
									: "^S<S-NAME> hold(s) a <T-NAMESELF> tightly and cast(s) a spell.^?");
