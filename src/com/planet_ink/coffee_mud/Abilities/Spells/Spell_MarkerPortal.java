...
public class Spell_MarkerPortal extends Spell {
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if ((success)
			...
			CMMsg msg = CMClass.getMsg(mob, oldRoom, this,
					verbalCastCode(mob, oldRoom, auto),
					"^S<S-NAME> conjur(s) a blinding, swirling portal here.^?");
			...
			beneficialWordsFizzle(mob, null,
					"<S-NAME> attempt(s) to conjur a portal, but fizzle(s) the spell.");
