...
public class Spell_WallOfAir extends Spell {
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		if ((invoker != null)
			...
			mob.location()
					.show(mob, invoker, msg.tool(), CMMsg.MSG_OK_VISUAL,
							"<S-NAME> fire(s) <O-NAME> at <T-NAME>.  The missile enters the wall of air.");
		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "An swirling wall of air appears!"
									: "^S<S-NAME> conjur(s) up a swirling wall of air!^?");
