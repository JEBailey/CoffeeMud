	...
	public int castingQuality(MOB mob, Physical target) {
		if (mob != null) {
			if (target instanceof MOB) {
				...
				if ((victim != null)
						&& (victim.fetchAbility("Spell_MagicMissile") == null))
		...
		if (success) {
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "<T-NAME> feel(s) magically protected."
			...
			beneficialWordsFizzle(mob, target,
					"<S-NAME> attempt(s) to invoke an absorbing barrier, but fail(s).");
