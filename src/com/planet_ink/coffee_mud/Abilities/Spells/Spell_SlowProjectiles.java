	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		if ((msg.targetMinor() == CMMsg.TYP_DAMAGE)
				...
				&& (((((Weapon) msg.tool()).weaponClassification() == Weapon.CLASS_RANGED)
						...
						&& (((AmmunitionWeapon) msg.tool())
								.requiresAmmunition()) || (((Weapon) msg.tool())
			...
			if (((Weapon) msg.tool()).weaponClassification() == Weapon.CLASS_THROWN)
				msg.source()
						.location()
						.show(msg.source(), null, msg.tool(),
								CMMsg.MSG_OK_VISUAL,
								"<O-NAME> flies slowly by.");
			else
				msg.source()
						.location()
						.show(msg.source(),
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			...
			beneficialWordsFizzle(mob, target,
					"<S-NAME> attempt(s) to invoke a field of slowness, but fail(s).");
