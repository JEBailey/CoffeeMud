...
public class Spell_IceSheet extends Spell {
	...
	public void executeMsg(final Environmental myHost, final CMMsg msg) {
		...
		if ((msg.target() == affected)
			...
			MOB mob = msg.source();
			Room room = (Room) affected;
			msg.addTrailerMsg(CMClass.getMsg(mob, room, null,
					CMMsg.MSG_OK_VISUAL, "\n\r<T-NAME> is covered in ice.",
					null, null));
		}
	}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			...
			if (auto)
				msgStr = Character.toUpperCase(msgStr.charAt(0))
						+ msgStr.substring(1);
			CMMsg msg = CMClass.getMsg(mob, target, this,
					verbalCastCode(mob, target, auto), (auto ? ""
							: "^S<S-NAME> speak(s) and gesture(s) and ")
							+ msgStr + "^?");
			...
			return beneficialWordsFizzle(mob, null,
					"<S-NAME> speak(s) about the cold, but the spell fizzles.");
