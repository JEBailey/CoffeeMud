		...
		if ((msg.amISource((MOB) affected))
			...
			if (str != null) {
				...
				case 3:
					...
					break;
				case 4:
					lead = " In case I didn't mention it already, ";
					break;
				case 5:
					lead = " You might also be curious to know that ";
					break;
				case 6:
					lead = " ";
					break;
				...
				msg.modify(msg.source(), msg.target(), this, msg.sourceCode(),
						CMStrings.substituteSayInMessage(msg.sourceMessage(),
								smsg), msg.targetCode(), CMStrings
								.substituteSayInMessage(msg.targetMessage(),
										str), msg.othersCode(), CMStrings
								.substituteSayInMessage(msg.othersMessage(),
										str));
		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							(auto ? "!"
									: "^S<S-NAME> invoke(s) a spell upon the mind of <T-NAMESELF>, saying '"
											+ message + "'.^?"));
			if (mob.location().okMessage(mob, msg)) {
				mob.location().send(mob, msg);
				super.maliciousAffect(mob, target, asLevel, 0,
			...
			return maliciousFizzle(mob, target,
					"<S-NAME> incant(s) at <T-NAMESELF>, but flub(s) the spell.");
