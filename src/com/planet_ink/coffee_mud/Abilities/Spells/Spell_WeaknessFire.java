		...
		if (success) {
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "A shimmering flammable field appears around <T-NAMESELF>."
									: "^S<S-NAME> invoke(s) a flammable field around <T-NAMESELF>.^?");
			...
			maliciousFizzle(mob, target,
					"<S-NAME> attempt(s) to invoke weakness to fire, but fail(s).");
