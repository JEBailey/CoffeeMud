	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		if ((invoker != null) && (mob.isInCombat())
			...
			if ((msg.tool() != null) && (msg.tool() instanceof Ability)) {
				mob.tell("You cannot see through the wall of darkness to target "
						+ mob.getVictim().name() + ".");
				return false;
			}
		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "An eerie wall of darkness appears!"
									: "^S<S-NAME> conjur(s) up a eerie wall of darkness!^?");
