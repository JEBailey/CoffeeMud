		...
		if (success) {
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "<T-NAME> feel(s) filteringly protected."
									: "^S<S-NAME> invoke(s) a filtering field of protection around <T-NAMESELF>.^?");
			...
			beneficialWordsFizzle(mob, target,
					"<S-NAME> attempt(s) to invoke a filtering shield, but fail(s).");
