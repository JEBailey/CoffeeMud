...
public class Druid_GolemForm extends StdAbility {
	...
	private static String[] shapes = { "Steel Golem", "Quartz Golem",
			"Mithril Golem", "Diamond Golem", "Adamantite Golem" };
	private static String[] races = { "MetalGolem", "StoneGolem", "MetalGolem",
			"StoneGolem", "MetalGolem" };
		...
		if ((newRace != null) && (affected instanceof MOB)) {
			...
			case 3:
				...
				affectableStats.setSpeed(affectableStats.speed()
						/ (3.0 - bonus));
				affectableStats.setAttackAdjustment(affectableStats
						.attackAdjustment() + 80 + (8 * xlvl));
				affectableStats.setDamage(affectableStats.damage() + 40
						+ (xlvl * 4));
				break;
			case 4:
				...
				affectableStats.setSpeed(affectableStats.speed()
						/ (4.0 - bonus));
				affectableStats.setAttackAdjustment(affectableStats
						.attackAdjustment() + 160 + (16 * xlvl));
				affectableStats.setDamage(affectableStats.damage() + 80
						+ (xlvl * 8));
				break;
			}
		}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (qualClassLevel < 0)
			classLevel = 30;
		String choice = (mob.isMonster() || (commands.size() == 0)) ? getRaceName(classLevel - 1)
