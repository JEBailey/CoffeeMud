	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (target.fetchEffect(this.ID()) != null) {
			mob.tell(target, null, null,
					"<S-NAME> <S-IS-ARE> already friendly to animals.");
			return false;
		}
		...
		if (success) {
			...
			CMMsg msg = CMClass.getMsg(mob, target, this,
					...
					auto ? "<T-NAME> become(s) animal friendly!"
							: "^S<S-NAME> chant(s) for animal friendship.^?");
			...
			return beneficialWordsFizzle(mob, null,
					"<S-NAME> chant(s), the magic fades.");
