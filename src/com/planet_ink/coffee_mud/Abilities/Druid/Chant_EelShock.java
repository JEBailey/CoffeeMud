...
public class Chant_EelShock extends Chant {
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			if (mob.location()
					.show(mob, null, this, verbalCastCode(mob, null, auto),
							"^S<S-NAME> chant(s) and electrical sparks dance across <S-HIS-HER> skin.^?"))
			...
			return maliciousFizzle(
					mob,
					null,
					"<S-NAME> sees tiny sparks dance across <S-HIS-HER> skin, but nothing more happens.");
