	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (newRoom == null) {
			mob.tell("You can't seem to fixate on a place called '"
					...
					+ "', perhaps you have nothing growing there?");
			return false;
		}
		...
		if (success) {
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? ""
									: "^S<S-NAME> chant(s) to <T-NAMESELF> and <S-IS-ARE> drawn into it!^?");
