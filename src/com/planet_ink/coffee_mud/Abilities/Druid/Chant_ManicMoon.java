...
public class Chant_ManicMoon extends Chant {
	...
	public boolean tick(Tickable ticking, int tickID) {
		...
		if (affected instanceof Room) {
			...
			if ((CMLib.dice().rollPercentage() < 50) && (M != null)
					&& (M != invoker))
				switch (CMLib.dice().roll(1, 5, 0)) {
				case 1:
					room.show(M, null, CMMsg.MSG_NOISE,
							"<S-NAME> howl(s) at the moon!");
					break;
				case 2:
					room.show(M, null, CMMsg.MSG_NOISYMOVEMENT,
							"<S-NAME> wig(s) out!");
					break;
				case 3:
					room.show(M, null, CMMsg.MSG_QUIETMOVEMENT,
							"<S-NAME> get(s) confused!");
					break;
				case 4:
					room.show(M, null, CMMsg.MSG_NOISE,
							"<S-NAME> sing(s) randomly!");
					break;
				case 5:
