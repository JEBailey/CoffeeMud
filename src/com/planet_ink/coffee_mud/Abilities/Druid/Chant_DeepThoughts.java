			...
			if (!mob.amDead()) {
				if (mob.location() != null)
					mob.location().show(mob, null, CMMsg.MSG_OK_ACTION,
							"<S-NAME> end(s) <S-HIS-HER> deep thinking.");
				else
	...
	public void executeMsg(final Environmental myHost, final CMMsg msg) {
		...
		if ((msg.amISource(mob))
				...
				&& ((CMath.bset(msg.sourceMajor(), CMMsg.MASK_MOVE))
						...
						|| (CMath.bset(msg.sourceMajor(), CMMsg.MASK_MOUTH)) || (CMath
			...
			if (CMLib.factions().getAlignPurity(myAlignment,
				...
				case 0:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> contemplate(s) the great depths.");
					break;
				case 1:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> listen(s) to the wisdom of the stones.");
					break;
				case 2:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> stare(s) at a single stone.");
					break;
				case 3:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> mentally embrace(s) the earth.");
					break;
				case 4:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> inhale(s) wisdom and dust.");
					break;
				case 5:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> watch(es) the unchanging stones and feel(s) their history.");
					break;
				case 6:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> become(s) one with the earth.");
					break;
				case 7:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> feel(s) the inner warmth of the great deep.");
					break;
				case 8:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
				...
				case 9:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> find(s) clarity in the stones.");
					break;
				}
			}
		} else {
		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob, null, this, somanticCastCode(mob, null, auto),
							"^S<S-NAME> grow(s) very still and begin(s) to think deep thoughts...^?");
			...
			return beneficialVisualFizzle(mob, null,
					"<S-NAME> grow(s) very still, but lose(s) concentration.");
