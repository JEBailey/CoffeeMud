...
public class Chant_GroveWalk extends Chant {
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			CMMsg msg = CMClass.getMsg(mob, newRoom, this,
					verbalCastCode(mob, newRoom, auto), auto ? ""
							: "^S<S-NAME> chant(s) and walk(s) around.^?");
			...
			beneficialVisualFizzle(mob, newRoom,
