			...
			if (CMLib.factions().getAlignPurity(myAlignment,
				...
				case 0:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> whisper(s) to the wind.");
					break;
				case 1:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> lean(s) towards the sun.");
					break;
				case 2:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> feel(s) the life of the insects.");
					break;
				case 3:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> feed(s) on the moisture of the earth.");
					break;
				case 4:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> take(s) in the energy of the sun.");
					break;
				case 5:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
							"<S-NAME> feel(s) <S-HIM-HERSELF> grow.");
					break;
				case 6:
					room.show(mob, null, this, CMMsg.MSG_CONTEMPLATE,
		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob, null, this, somanticCastCode(mob, null, auto),
							"^S<S-NAME> plant(s) <S-HIM-HERSELF> in the earth while chanting softly...^?");
			...
			return beneficialVisualFizzle(mob, null,
					"<S-NAME> chant(s) to the earth, but lose(s) concentration.");
