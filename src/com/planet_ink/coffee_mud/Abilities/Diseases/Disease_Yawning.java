...
public class Disease_Yawning extends Disease {
	...
	protected String DISEASE_DONE() {
		return "You stop yawning.";
	}

	protected String DISEASE_START() {
		return "^G<S-NAME> seem(s) really tired.^?";
	}

	protected String DISEASE_AFFECT() {
		return "<S-NAME> stretch(es) and yawn(s).";
	}
	...
	public boolean tick(Tickable ticking, int tickID) {
		...
		if ((getTickDownRemaining() == 1)
			...
			CMMsg msg = CMClass.getMsg(mob, null, this, CMMsg.MSG_NOISE,
					DISEASE_AFFECT() + CMLib.protocol().msp("yawn.wav", 40));
