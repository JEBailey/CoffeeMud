		...
		if ((success) && (offensiveAffects.size() > 0)) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "<T-NAME> feel(s) purified of <T-HIS-HER> poisons."
									: "^S<S-NAME> "
											+ prayWord(mob)
											+ " that <T-NAME> be purified of <T-HIS-HER> poisons.^?");
			...
			beneficialWordsFizzle(
					...
					auto ? ""
							: "<S-NAME> "
									+ prayWord(mob)
									+ " that <T-NAME> be purified of <T-HIS-HER> poisons, but there is no answer.");
