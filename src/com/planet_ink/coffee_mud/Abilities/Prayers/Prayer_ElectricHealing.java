...
public class Prayer_ElectricHealing extends Prayer {
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		MOB mob = (MOB) affected;
		if ((msg.amITarget(mob)) && (msg.sourceMinor() == CMMsg.TYP_ELECTRIC)
			...
			mob.location().show(
					...
					null,
					CMMsg.MSG_OK_VISUAL,
					"The electric attack heals <S-NAME> " + recovery
							+ " points.");
			CMLib.combat().postHealing(mob, mob, this,
					CMMsg.MASK_ALWAYS | CMMsg.TYP_CAST_SPELL, recovery, null);
			return false;
		}
		return true;
	}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			...
			return beneficialWordsFizzle(
					...
					"<S-NAME> "
							+ prayWord(mob)
							+ " for electric healing, but <S-HIS-HER> plea is not answered.");
