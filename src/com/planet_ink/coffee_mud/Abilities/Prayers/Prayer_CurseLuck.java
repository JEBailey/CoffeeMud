	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (success) {
			...
			CMMsg msg = CMClass.getMsg(mob, target, this,
					...
					auto ? "<T-NAME> feel(s) <T-HIS-HER> luck become cursed!"
							: "^S<S-NAME> " + prayForWord(mob)
									+ " to curse the luck of <T-NAMESELF>!^?");
			...
			return maliciousFizzle(
					...
					"<S-NAME> "
							+ prayForWord(mob)
							+ " to curse the luck of <T-NAMESELF>, but nothing happens.");
