		...
		if (success) {
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? "<T-NAME> become(s) filled with righteous indignation!"
									: "^S<S-NAME> "
											+ prayWord(mob)
											+ " for <T-YOUPOSS> righteous indignation!^?");
			...
			return beneficialWordsFizzle(
					...
					"<S-NAME> "
							+ prayWord(mob)
							+ " <T-YOUPOSS> righteous indignation, but there is no answer.");
