		...
		if ((success)
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							this,
							verbalCastCode(mob, target, auto),
							(auto ? "<T-NAME> feel(s) completely different about the world."
									: "^S<S-NAME> "
											+ prayWord(mob)
											+ " to bring balance to <T-NAMESELF>!^?"));
