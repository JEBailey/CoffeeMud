	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (!success)
			beneficialVisualFizzle(
					mob,
					null,
					"<S-NAME> attempt(s) <S-HIS-HER> jailkey on "
							+ unlockThis.name() + " and fail(s).");
		else {
				...
				if (!unlockThis.isLocked())
					msg = CMClass
							.getMsg(mob,
									...
									CMMsg.MSG_LOCK,
									CMMsg.MSG_OK_VISUAL,
									auto ? unlockThis.name()
											+ " vibrate(s) and click(s)."
											: "<S-NAME> use(s) <S-HIS-HER> jailkey and relock(s) "
													+ unlockThis.name() + ".");
				else
					msg = CMClass
							.getMsg(mob,
									...
									auto ? unlockThis.name()
											+ " vibrate(s) and click(s)."
											: "<S-NAME> use(s) <S-HIS-HER> jailkey and unlock(s) "
													+ unlockThis.name() + ".");
