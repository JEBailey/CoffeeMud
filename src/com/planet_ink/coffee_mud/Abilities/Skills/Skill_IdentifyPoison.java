...
public class Skill_IdentifyPoison extends StdSkill {
	...
	private static final String[] triggerStrings = { "IDPOISON",
			"IDENTIFYPOISON" };
		...
		if ((success)
			...
			CMMsg msg = CMClass
					.getMsg(mob,
							...
							auto ? ""
									: "^S<S-NAME> carefully sniff(s) and taste(s) <T-NAME>.^?");
			...
			beneficialWordsFizzle(
					...
					target,
					auto ? ""
							: "<S-NAME> sniff(s) and taste(s) <T-NAME>, but receives no insight.");
