...
public class Ranger_WoodlandCreep extends StdAbility {
	...
	public String name() {
		return "Woodland Creep";
	}

	public String displayText() {
		return "(Creeping through foliage)";
	}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget,
		...
		if (!success)
			beneficialVisualFizzle(mob, null,
					"<S-NAME> attempt(s) to creep into the foliage and fail(s).");
		else {
			...
			if (mob.location().okMessage(mob, msg)) {
				...
				Ranger_WoodlandCreep newOne = (Ranger_WoodlandCreep) mob
						.fetchEffect(ID());
