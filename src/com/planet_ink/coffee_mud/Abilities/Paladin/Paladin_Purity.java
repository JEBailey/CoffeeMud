...
public class Paladin_Purity extends PaladinSkill {
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		if ((msg.sourceMinor() == CMMsg.TYP_FACTIONCHANGE)
				...
				&& (msg.othersMessage().equalsIgnoreCase(CMLib.factions()
						.AlignID()))) {
			msg.source()
					.location()
					.show(msg.source(), null, CMMsg.MSG_OK_VISUAL,
							"<S-YOUPOSS> purity protects <S-HIM-HER> from the evil influence.");
			return false;
		}
		return true;
	}
