...
public class Gigantic extends StdLanguage {
	...
	public List<String[]> translationVector(String language) {
		if (wordLists == null) {
			...
			String[] two = { "on", "dva", "sa", "is", "id", "et", "bo", "ja",
					"te", "me", "za", "ve" };
			String[] three = { "pet", "set", "tre", "mal", "maz", "mat", "ane",
					"dom" };
			String[] four = { "nast", "sest", "osam", "bedu", "beda", "mene",
					"mame", "maja", "beli", "nesi" };
			String[] five = { "sedam", "devat", "flanon", "dvade", "matke",
					"trede", "horat", "jesam", "taram", "anaht", "maram",
					"nezme" };
			String[] six = { "jedanast", "delalime", "veralim", "dvanast",
					"bahone", "zahedon", "prasad", "trenast", "staronast",
					"starde", "delaja" };
