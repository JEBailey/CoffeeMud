			...
			if ((sprung) && (affected != null) && (affected instanceof Room)
				...
				if (tickDown > 13)
					R.showHappens(CMMsg.MSG_OK_VISUAL,
							"The walls start closing in around you!");
				else if (tickDown > 4) {
								...
								CMLib.combat()
										.postDamage(
												...
												CMMsg.MASK_MALICIOUS
														...
														| CMMsg.TYP_JUSTICE,
												Weapon.TYPE_BASHING,
												"The crushing walls <DAMAGE> <T-NAME>!");
							}
					}
				} else {
					R.showHappens(CMMsg.MSG_OK_VISUAL,
							"The walls begin retracting...");
				}
			}
		}
			...
			if ((doesSaveVsTraps(target))
				...
				target.location()
						.showHappens(CMMsg.MSG_OK_VISUAL,
								"The exits are blocked off! The walls start closing in!");
			}
		}
	}
}
