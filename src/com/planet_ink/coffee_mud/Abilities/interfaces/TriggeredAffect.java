 ...
 */
/**
 * TriggeredAffect is an ability interface to denote those properties that are
 * typically non-removable inherent attributes of the things they affect.
 */
public interface TriggeredAffect extends Ability {
	...
	/**
	 * denotes a property whose affects are triggered by wearing/wielding the
	 * thing
	 */
	...
	/**
	 * denotes a property whose affects are triggered by using/eating/drinking
	 * the thing
	 */
	public final static int TRIGGER_USE = 32;
	/**
	 * denotes a property whose affects are triggered by putting the thing
	 * somewhere
	 */
	...
	/**
	 * denotes a property whose affects are triggered by putting something in or
	 * dropping the thing
	 */
	public final static int TRIGGER_DROP_PUTIN = 64;
	/**
	 * denotes a property whose affects are triggered by hitting somethign with
	 * the thing
	 */
	public final static int TRIGGER_HITTING_WITH = 128;

	/**
	 * This method returns a mask of TRIGGER_* constants denoting what triggers
	 * the properties
	 * 
	 * @see TriggeredAffect#TRIGGER_ALWAYS
	 * 
	 * @return a mask of TRIGGER_* constants denoting what triggers the
	 *         properties
	 */
