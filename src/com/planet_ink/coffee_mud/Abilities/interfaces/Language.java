 ...
 * languages. A single ability usually represents a single language, but may
 * support multiple simultaneously.
 */
public interface Language extends Ability {
	/**
	 * Returns the name of this language when it is in written form. This is
	 * usually the same as the spoken form.
	 * 
	 ...
	 * 
	 * @param language
	 *            the language to set (usually ID())
	 * @param beingSpoken
	 *            whether it is being spoken
	 */
	...
	/**
	 * Returns the word-length rough-translation vector of string arrays for the
	 * given language The first string array in the vector represents 1 letter
	 * words, the second 2, and so forth.
	 * 
	 * @param language
	 ...
	 * 
	 * @param language
	 *            the language to use (usually ID())
	 * @param word
