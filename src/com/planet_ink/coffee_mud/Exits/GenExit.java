...
public class GenExit extends StdExit implements Modifiable {
	...
	private static final String[] CODES = { "CLASS", "NAME", "DISPLAY",
			"DESCRIPTION", "DOOR", "LEVEL", "ABILITY", "ISREADABLE",
			"AFFBEHAV", "DISPOSITION", "READABLETEXT", "HASADOOR", "DEFCLOSED",
			"HASALOCK", "DEFLOCKED", "KEYNAME" };
	...
	public void setStat(String code, String val) {
		...
		case 8: { // affbehav
			...
			CMLib.coffeeMaker().setExtraEnvProperties(this,
					CMLib.xml().parseAllXML(val)); // affbehav
			break;
		} // affbehav
		case 9: { // disposition
