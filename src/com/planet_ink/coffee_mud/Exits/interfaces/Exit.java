 ...
 */
/**
 * An interface for all mechanisms or pathways through which a mob may travel
 * when trying to get from one Room to another.
 * 
...
public interface Exit extends PhysicalAgent, Readable {
	...
	/**
	 * Returns whether this exit is LOCKED, and must be unlocked before being
	 * used.
	 * 
	...
	/**
	 * Returns whether this exit has a door, and must be opened before being
	 * used.
	 * 
	...
	/**
	 * Returns whether this exit has a lock on its door, and, if locked, must be
	 * unlocked before being used.
	 * 
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#isOpen()
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#isLocked()
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#hasADoor()
	...
	/**
	 * For exits with a door and lock, this returns whether the door defaults in
	...
	/**
	 * For exits with a door, this returns whether the door defaults in a closed
	 * state.
	 * 
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#hasADoor()
	 ...
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#defaultsLocked()
	 * @param hasADoor
	 *            whether this exit has a door
	 * @param isOpen
	 *            whether this exit is open for travel
	 * @param defaultsClosed
	 *            whether this exit defaults closed
	 * @param hasALock
	 *            whether this exit has a door lock
	 * @param isLocked
	 *            whether this exit is presently locked
	 * @param defaultsLocked
	 *            whether this exit defaults closed and locked.
	 */
	...
	/**
	 * For Exits with doors and locks, this sets the unique string representing
	 * the key code required to unlock/lock the door.
	 * 
	...
	/**
	 * Returns the modified and qualified player-viewed description of this
	 * exit.
	 * 
	 * @param mob
	 *            the mob doing the viewing
	 * @param myRoom
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Exits.interfaces.Exit#setExitParams(String,
	...
	/**
	 * Returns the verb used for describing opening this exit, e.g. open, raise,
	 * lift, etc..
	 * 
	 ...
	 * @param newDoorName
	 *            short name of this door, e.g. door, gate
	 * @param newCloseWord
	 *            verb used to close this door, e.g. close, lower
	 * @param newOpenWord
	 *            verb used to open this door, e.g. open, raise
	 * @param newClosedText
	 *            description of this exit when in a closed state
	 */
	public void setExitParams(String newDoorName, String newCloseWord,
			String newOpenWord, String newClosedText);

	/**
	 * Returns the number of ticks that this exit remains open when a mob or
	 * player changes it from a closed to an open state, and the door defaults
	 * in a closed state.
	 * 
	...
	/**
	 * Sets the number of ticks that this exit will remain open when a mob or
	 * player changes it from a closed to an open state, and the door defaults
	 * in a closed state.
	 * 
	 ...
	 * @see com.planet_ink.coffee_mud.core.interfaces.Tickable#TICKID_EXIT_REOPEN
	 * @param numTicks
	 *            the number of ticks this exit will remain open
	 */
	public void setOpenDelayTicks(int numTicks);

	/**
	 * If this exit represents a route to a room not yet created, but whose room
	 * id is already known, this will return that designated room id.
	 * 
	...
	/**
	 * If this exit represents a route to a room not yet created, but whose room
	 * id is already known, this will set that designated room id.
	 * 
