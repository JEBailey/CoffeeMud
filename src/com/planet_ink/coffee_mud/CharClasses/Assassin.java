...
public class Assassin extends Thief {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 3, "Thief_SneakAttack",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 3, "Thief_KillLog",
				false);
		...
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 8, "Thief_Shadow", false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Thief_BackStab",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Thief_Spying",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 12, "Thief_UsePoison",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Thief_AnalyzeMark",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Thief_Observation",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 14, "Thief_Assassinate",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 14, "Thief_Shadowpass",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 15, "Skill_Attack2",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 15, "Fighter_TrueShot",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 15,
				"Specialization_Axe", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "Fighter_DualParry",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "Skill_AttackHalf",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 17,
				"Fighter_CriticalShot", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 17,
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 19, "Thief_HighMarks",
				true, CMParms.parseSemicolons("Thief_Mark", true));
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 20, "Skill_Stability",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 21,
				"Thief_MarkerSpying", false,
				CMParms.parseSemicolons("Thief_Mark;Thief_Spying", true), null);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 21, "Thief_TapRoom",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 22, "Thief_Ambush",
				false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 22, "Thief_Flank", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 23, "Thief_FrameMark",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 23, "Fighter_Cleave",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 24, "Fighter_Tumble",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 24, "Thief_Evesdrop",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 25,
				"Fighter_CalledShot", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 25, "Thief_Espionage",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 30,
				"Thief_Shadowstrike", true);
	}
