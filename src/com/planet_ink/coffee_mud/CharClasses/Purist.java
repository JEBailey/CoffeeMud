...
public class Purist extends Cleric {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 1, "Prayer_Extinguish",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 2, "Prayer_CreateWater",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 2, "Prayer_Purify",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 3, "Prayer_Sacrifice",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 3, "Prayer_Fidelity",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Prayer_CreateFood",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Prayer_ProtCold",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 6,
				"Prayer_RighteousIndignation", false);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 7, "Prayer_Bless", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Prayer_HuntEvil",
				false);
		...
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 9, "Prayer_Gills", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Prayer_CureFatigue",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Prayer_ProtPoison",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Prayer_Monolith",
				0, "ICE", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 12,
				"Prayer_ProtDisease", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 12,
				"Prayer_FountainLife", false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 15,
				"Prayer_FreezeMetal", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "Prayer_Calm", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "Prayer_Conviction",
				false);
		...
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 18, "Prayer_Wave", false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 25,
				"Prayer_SummonElemental", 0, "WATER", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 25, "Prayer_IceHealing",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 30,
				"Prayer_AuraIntolerance", false);
	}
	...
	public String getOtherBonusDesc() {
		return "Receives 1pt/level cold damage reduction.";
	}

	public String getOtherLimitsDesc() {
		return "Always fumbles evil prayers, and fumbles all prayers when alignment is below pure neutral.  Qualifies and receives good prayers, and bonus damage from good spells.  Using non-aligned prayers introduces failure chance.  Vulnerable to fire attacks.";
	}
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg) {
		...
		if (msg.amISource(myChar)
			...
			int pct = CMLib.factions().getPercent(CMLib.factions().AlignID(),
					alignment);
			if (pct < 50) {
		...
		if ((msg.amITarget(myChar))
				...
				&& ((msg.sourceMinor() == CMMsg.TYP_COLD) || (msg.sourceMinor() == CMMsg.TYP_WATER))) {
