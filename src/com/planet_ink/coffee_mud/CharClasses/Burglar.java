...
public class Burglar extends Thief {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 2,
				"Thief_UndergroundConnections", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 3, "Thief_Appraise",
				true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "Fighter_Intimidate",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Thief_TagTurf",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Thief_Observation",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Thief_Forgery",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Thief_Listen", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 10,
				"Thief_ImprovedHiding", false,
				CMParms.parseSemicolons("Thief_Hide", true));
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Thief_BackStab",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Thief_Steal", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Thief_TurfWar",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 12, "Thief_SlipItem",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 12,
				"Thief_ImprovedPeek", false,
				CMParms.parseSemicolons("Thief_Peek", true));

		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Thief_PlantItem",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Thief_Detection",
				true);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 14, "Thief_Bribe", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 14,
				"Thief_ImprovedSwipe", false,
				CMParms.parseSemicolons("Thief_Swipe", true));

		CMLib.ableMapper().addCharAbilityMapping(ID(), 15, "Spell_ReadMagic",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 15, "Thief_SilentGold",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 15, "Thief_HideOther",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 16,
				"Thief_Safecracking", false,
				CMParms.parseSemicolons("Thief_Pick", true));
		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "Thief_SilentLoot",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 17, "Thief_SilentDrop",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Thief_Robbery",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Skill_Map", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Thief_SilentOpen",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 19, "Thief_SenseLaw",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 19, "Thief_Mug", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 19, "Thief_Safehouse",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 20, "Skill_AttackHalf",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 20, "Thief_Footlocks",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 21, "Thief_Racketeer",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 21, "Thief_StripItem",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 22, "Thief_UsePoison",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 22,
				"Thief_ImprovedSteal", false,
				CMParms.parseSemicolons("Thief_Steal", true));

		CMLib.ableMapper().addCharAbilityMapping(ID(), 23,
				"Spell_AnalyzeDweomer", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 23, "Fighter_Tumble",
				true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 25, "Thief_Embezzle",
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 25,
				"Thief_HideInPlainSight", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 30, "Thief_ContractHit",
				true);
	}
