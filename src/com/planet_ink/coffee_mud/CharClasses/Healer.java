...
public class Healer extends Cleric {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 1, "Skill_Convert", 50,
				true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 1, "Skill_TurnUndead",
				0, true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 1,
				"Specialization_Natural", true);
		CMLib.ableMapper()
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 3,
				"Prayer_RemoveDeathMark", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "Prayer_ProtEvil",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "Prayer_CureFatigue",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 5,
				"Prayer_CureDeafness", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Prayer_Fidelity",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(
				...
				CMParms.parseSemicolons(
						"Prayer_HolyAura;Prayer_DeathsDoor;Prayer_Heal", true));
	...
	public int classLevelModifier(MOB myChar, Ability skill, int level) {
		if ((myChar.charStats().getCurrentClass() == this)
				&& (skill.ID().equals("Prayer_CureDisease") || skill.ID()
						.equals("Prayer_MassCureDisease"))) {
			return level + level;
		}
		return level;
	}
	...
	public String getOtherBonusDesc() {
		return "All healing prayers give bonus healing.  Attains healing aura after 30th level.";
	}
