...
public class Minstrel extends StdCharClass {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "Play_Background",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 5,
				"Skill_TuneInstrument", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Skill_WandUse",
				false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 5, "Play_Cymbals", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 5, "Play_Melody", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 6, "Thief_TrophyCount",
				false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 6, "Play_Guitars", false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 6, "Play_LoveSong", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 6, "Song_Armor", false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Play_Clarinets",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Play_Carol", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 8, "Fighter_Rescue",
				false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 8, "Play_Violins", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 8, "Play_Blues", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Skill_Dodge", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Song_Serenity",
				false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10,
				"Skill_InstrumentBash", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Play_Horns", false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 10, "Play_Retreat", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Play_Charge", true);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 12, "Thief_Listen", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 12, "Play_Xylophones",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 12, "Play_Reveille",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Play_Symphony",
				true);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 14, "Skill_Parry", false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 14, "Play_Trumpets",
				false);
		...
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 16, "Play_Pianos", false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Skill_Struggle",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Play_Harmonicas",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "Play_Lullabies",
				true);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 19, "Song_Thanks", false);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 20,
				"Play_Accompaniment", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 21, "Play_Spiritual",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 22, "Paladin_Defend",
				false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 22, "Play_Organs", false);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 22, "Play_Tribal", false);

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 23, "Play_Harmony", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 24, "Play_Trombones",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 24, "Play_Mystical",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 25, "Play_Battlehymn",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 30, "Skill_Conduct",
				true);
	}
	...
	public String getOtherBonusDesc() {
		return "Receives group bonus combat experience when in an intelligent group, and more for a group of players.  Receives exploration and pub-finding experience based on danger level.";
	}
