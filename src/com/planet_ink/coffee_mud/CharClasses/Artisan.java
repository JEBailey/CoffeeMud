...
public class Artisan extends StdCharClass {
	...
	public void initializeClass() {
		...
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 4, "Blacksmithing", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "Carpentry", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 4, "LeatherWorking",
				true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Armorsmithing",
				true, CMParms.parseSemicolons("Blacksmithing", true));
		CMLib.ableMapper().addCharAbilityMapping(ID(), 7, "Fletching", true,
				CMParms.parseSemicolons("Specialization_Ranged", true));
		CMLib.ableMapper()
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 8, "Shipwright", true,
				CMParms.parseSemicolons("Carpentry", true));
		CMLib.ableMapper().addCharAbilityMapping(ID(), 8, "Wainwrighting",
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 9, "Cobbling", false,
				CMParms.parseSemicolons("LeatherWorking", true));

		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Distilling", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Farming", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 10, "Skill_WandUse",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Speculate", true);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 11, "Painting", true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 12, "LockSmith", 0, "",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 13, "Construction",
				true, CMParms.parseSemicolons("Carpentry", true));

		CMLib.ableMapper().addCharAbilityMapping(ID(), 14, "Masonry", true,
				CMParms.parseSemicolons("Sculpting", true));
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(), 16, "AnimalHusbandry",
				true);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 17, "Skill_Stability",
				false);
		CMLib.ableMapper().addCharAbilityMapping(ID(), 17, "Thief_Appraise",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 18, "InstrumentMaking",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 19, "Skill_Haggle",
				false);

		CMLib.ableMapper().addCharAbilityMapping(ID(), 20, "MasterTailoring",
				false, CMParms.parseSemicolons("Tailoring(100)", true),
				"+DEX 16");

		CMLib.ableMapper().addCharAbilityMapping(ID(), 21, "MasterCostuming",
				false, CMParms.parseSemicolons("Costuming(100)", true),
				"+INT 16");

		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 22, "MasterLeatherWorking", false,
						CMParms.parseSemicolons("LeatherWorking(100)", true),
						"+CON 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 22, "MasterShearing",
				false, CMParms.parseSemicolons("Shearing(100)", true),
				"+WIS 16");

		CMLib.ableMapper().addCharAbilityMapping(ID(), 23,
				"MasterArmorsmithing", false,
				CMParms.parseSemicolons("Armorsmithing(100)", true), "+STR 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 23, "MasterDrilling",
				false, CMParms.parseSemicolons("Drilling(100)", true),
				"+INT 16");
		...
		CMLib.ableMapper().addCharAbilityMapping(
				...
				false,
				CMParms.parseSemicolons("Weaponsmithing(100);Specialization_*",
						true), "+STR 16");
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 24, "MasterFishing", false,
						CMParms.parseSemicolons("Fishing(100)", true),
						"+DEX 16");

		CMLib.ableMapper().addCharAbilityMapping(ID(), 25, "Scrapping", true);
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 25, "MasterFarming", false,
						CMParms.parseSemicolons("Farming(100)", true),
						"+WIS 16");

		CMLib.ableMapper().addCharAbilityMapping(ID(), 26, "MasterForaging",
				false, CMParms.parseSemicolons("Foraging(100)", true),
				"+CHA 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 26, "MasterDistilling",
				false, CMParms.parseSemicolons("Distilling(100)", true),
				"+CHA 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 27, "MasterChopping",
				false, CMParms.parseSemicolons("Chopping(100)", true),
				"+STR 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 27, "MasterFoodPrep",
				false, CMParms.parseSemicolons("FoodPrep(100)", true),
				"+DEX 16");
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 28, "MasterDigging", false,
						CMParms.parseSemicolons("Digging(100)", true),
						"+CON 16");
		CMLib.ableMapper()
				.addCharAbilityMapping(ID(), 28, "MasterCooking", false,
						CMParms.parseSemicolons("Cooking(100)", true),
						"+INT 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 29, "MasterMining",
				false, CMParms.parseSemicolons("Mining(100)", true), "+STR 16");
		CMLib.ableMapper().addCharAbilityMapping(ID(), 29, "MasterBaking",
				false, CMParms.parseSemicolons("Baking(100)", true), "+CON 16");
