 ...
 */
/**
 * Abstract area layout pattern node tags: nodetype: surround, leaf, offleaf,
 * street, square, interior nodeexits: n,s,e,w, n,s, e,w, n,e,w, etc nodeflags:
 * corner, gate, intersection, tee NODEGATEEXIT: (for gate, offleaf, square): n
 * s e w etc noderun: (for surround, street): n,s e,w
 * 
 * @author Bo Zimmerman
 */
