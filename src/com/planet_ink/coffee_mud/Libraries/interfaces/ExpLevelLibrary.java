...
public interface ExpLevelLibrary extends CMLibrary {
	 ...
	 * @param mob
	 *            the mob to distribute experience to
	 * @param victim
	 *            the mob killed, if any, to cause the experience gain
	 * @param homage
	 ...
	 * @param quiet
	 *            true if no messages should be given
	 */
	 ...
	 * @param mob
	 *            the mob to take experience away from
	 * @param amount
	 *            the amount of experience to take away
	 */
