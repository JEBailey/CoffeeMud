...
public interface AreaGenerationLibrary extends CMLibrary {
	...
	public String findString(String tagName, XMLLibrary.XMLpiece piece,
			Map<String, Object> defined) throws CMException;
	...
	public enum LayoutTags {
		NODERUN, NODEFLAGS, NODETYPE, NODEEXITS, NODEGATEEXIT
	}

	public enum LayoutTypes {
		surround, leaf, street, square, interior
	}

	public enum LayoutFlags {
		corner, gate, intersection, tee, offleaf
	}
