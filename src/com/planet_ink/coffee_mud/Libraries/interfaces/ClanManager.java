 ...
 */
/**
 * This library manages the list of Clans in the game, and helps administer
...
public interface ClanManager extends CMLibrary {
	...
	/**
	 * This method is used to determine the basic relationship between two
	 * clans. The two clans are evaluated, based on their declared relationship
	 * to each other, and the relations they inherit from allys. It is then
	 * compared with the passed in relationship constant. If they match, true is
	 * returned, and false otherwise.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#REL_DESCS
	 * @param clanName1
	 *            the first clan to evaluate
	 * @param clanName2
	 *            the second clan to evaluate
	 * @param relation
	 *            the clan relation to compare to
	 * @return true if the common relationship matches the given relation, and
	 *         false otherwise
	 */
	public boolean isCommonClanRelations(String clanName1, String clanName2,
			int relation);

	/**
	 * This method is used to determine the basic relationship between two clan
	 * members. The two mobs first rivalrous clans are evaluated, based on their
	 * declared relationship to each other, and the relations they inherit from
	 * allys. It is then compared with the passed the War status. If they match,
	 * true is returned, and false otherwise.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#REL_DESCS
	 * @param M1
	 *            the first mobs first rivalrous clan to evaluate
	 * @param M2
	...
	/**
	 * Returns whether the two mobs share ANY common clans, even non-rivalrous
	 * ones.
	 * 
	 * @param M1
	 *            first mob
	...
	/**
	 * This method is used to determine the basic relationship between two mobs
	 * clans. The two sets of clans are evaluated, based on their declared
	 * relationship to each other, and the relations they inherit from allys.
	 * This relationship is then checked against the given relation. If any
	 * pairing matches the relation, true is returned.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#REL_DESCS
	 * @param M1
	 *            the first mob whose clans to evaluate
	 * @param M2
	 *            the second mob whose clans to evaluate
	 * @param relation
	 ...
	 * This method is used to determine the basic relationship between two
	 * clans. The two clans are evaluated, based on their declared relationship
	 * to each other, and the relations they inherit from allys. This
	 * relationship is then returned as a relation constant number.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#REL_DESCS
	 * @param clanID1
	 *            the first clan to evaluate
	...
	/**
	 * Returns whether the given clan set contains a clan that allows the given
	 * mob to do the given function in the clan.
	 * 
	 * @param mob
	...
	/**
	 * Returns whether the given mob belongs to the given clan, and if so,
	 * whether they can do the given function in the clan.
	 * 
	 * @param mob
	 *            the mob to look for privileges for
	 * @param clanID
	 *            the clanID to check for to check for
	 * @param func
	 *            the function to check for
	 * @return true if allowed, false otherwise
	 */
	...
	/**
	 * If the given mob belongs to a clan, and if they can do the given function
	 * in a clan, this will return that clan object and the integer.
	 * 
	 * @param mob
	 *            the mob to check the clans of
	 * @param func
	...
	/**
	 * If the given mob belongs to a clan, and if they can do the given function
	 * in a clan, this will return those clan objects and their role integer.
	 * 
	 * @param mob
	 *            the mob to check the clans of
	 * @param func
	 ...
	 * 
	 * @param clanSourceMob
	 *            the mob to source the clan list from
	 * @param filterMob
	 ...
	 * 
	 * @param mob1
	 *            the first mob to check the clans of
	 * @param mob2
	...
	/**
	 * Returns the Clan object associated with the given clan name, or if the
	 * name is not found, the name that most closely matches it.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	 * @param id
	 * @return the Clan object associated with the given clan name
	...
	/**
	 * Returns all clans and their last-cached accept-positions The
	 * auto-positions may be inaccurate.
	 * 
	...
	/**
	 * Forces all clans to go through their maintenance process, which normally
	 * only occurs infrequently. This does things like handle automatic
	 * promotions, manage votes, and clean out inactive clans.
	 */
	public void tickAllClans();

	/**
	 * Sends a message to the games official CLAN chat channel. This is normally
	 * for messages that may interest all clans.
	 * 
	 * @param msg
	 *            the message to send
	 */
	 ...
	 * 
	 * @param mob
	 *            the viewer of the government type
	 * @param named
	 *            the possible name of the government
	 * @param exact
	...
	/**
	 * Returns a government definition object of the given internal stock
	 * clangovernments.xml id. See /resources/clangovernments.xml Also:
	 * 
	...
	/**
	 * Returns the default government definition object. See
	 * /resources/clangovernments.xml Also:
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ClanGovernment
	 * @return the clan government object
	 */
	...
	/**
	 * Returns all government definition objects from internal stock
	 * clangovernments.xml file. See /resources/clangovernments.xml Also:
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ClanGovernment
	 * @return the clan government object
	 */
	...
	/**
	 * Deletes the stock government.. confusing all the clans that currently use
	 * it.
	 * 
	 * @param government
	...
	/**
	 * Makes an announcement to the clan announcement channel from the given
	 * mob. These are channels marked in the coffeemud.ini file as receiving
	 * clan info messages. These messages are only seen by the authors clan
	 * members.
	 * 
	 * @param mob
	 *            the mob who is announcing the message
	 * @param msg
	 *            string message to send to the clan info channels
	 */
	public void clanAnnounce(MOB mob, String msg);

	/**
	 * Examines the given command string, which is based on the given clan
	 * function code. If the given Clan requires a vote to accomplish it, the
	 * vote will be created. If the given clan forbids the given mob from
	 * performing the given function, or from even starting a vote on it, the
	 * method will return false. If the mob is allowed to perform
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan.Function#ACCEPT
	 * @param mob
	 *            the player who wants to perform the function
	 * @param C
	 *            the clan that the player belongs to
	 * @param commands
	 *            the command list describing the function that wants to be
	 *            executed
	 * @param function
	 *            the function code described by the commands list
	 * @param voteIfNecessary
	 *            true to start a vote if one is needed, false to just return
	 *            true.
