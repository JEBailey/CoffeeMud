...
public interface TimeManager extends CMLibrary {
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String Mnth=getMonthName(m,GiveShort).charStats();
	 * 
	 * @param monthNum
	 *            Month number to convert
	 * @param giveShort
	 *            Give abbreviation if true
	 * @return String Month name
	 */
	public String getMonthName(int monthNum, boolean giveShort);

	/**
	 * Returns whether the given string would parse to a valid date. If true is
	 * returned, the change of getting a valid date from string2Date is much
	 * higher.
	 * 
	 * @param dateTimeStr
	 *            the strong to parse
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> string2Millis(GetRes(Results,"StartDateTime"));
	 * 
	 * @param dateTimeStr
	 *            The string to retrieve from
	...
	/**
	 * Returns the regular Hours given the hours in the international format
	 * (military time)
	 * 
	 * <br>
	 * <br>
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> GetTheZoneID(MeetTZ.getRawOffset())+"\n";
	 * 
	 * @param theRawOffset
	 *            The time zone's raw offset to convert
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> MEETZN = GetTheTimeZone(ID);
	 * 
	 * @param theID
	 *            The ID of the abbreviated time zone.
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDMM=date2MonthString(time,true);
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @param shortName
	 *            true to use shortened months
	 * @return String The month name
	 **/
	public String date2MonthString(long time, boolean shortName);

	/**
	 * Returns time in HH:MMap format, unless the day is other than today, in
	 * which case it prepends yy/m/d.
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDMM=date2BriefString(time,true);
	 * 
	 * @param time
	 *            The time in miliseconds
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDMM=date2MonthDateString();
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @param shortName
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDDD=date2DayOfMonthString();
	 * 
	 * @param time
	 *            The time in miliseconds
	...
	/**
	 * Returns the YYYY portion of a given date Returns the DD portion of a
	 * given date
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDYYYY=date2YYYYString();
	 * 
	 * @param time
	 *            The time in miliseconds
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDHR=date2HRString();
	 * 
	 * @param time
	 *            time used
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ENDMIN=date2MINString();
	 * 
	 * @param time
	 *            The time in miliseconds
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> smtpDateFormat(98374987234)
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @return String The minutes
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ST_AMPM=date2AMPMString(time);
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @return String AM or PM stamp
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2String()
	 * 
	 * @param C
	 *            The time in calendar
	...
	/**
	 * Converts a given number of milliseconds, into a number of rl years,
	 * months, days, hours, minutes, and seconds. If in short form, returns y,
	 * m, d, h, m, and s.
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2EllapsedTime(time)
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @param minUnit
	 *            The smallest unit to round down to
	 * @param shortest
	 *            true for short form, false otherwise
	 * @return String Formatted ellapsed time
	 */
	public String date2EllapsedTime(long time, TimeUnit minUnit,
			boolean shortest);

	/**
	 * Converts a given number of milliseconds, into a number of rl years,
	 * months, days, hours, minutes, and seconds. If in short form, returns y,
	 * m, d, h, m, and s. This method will automatically determine the smallest
	 * reasonable unit of time to show.
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2SmartEllapsedTime(time)
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @param shortest
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2SecondsString(time)
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @return String Formatted date/time
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2DateString(time)
	 * 
	 * @param time
	 *            The time in miliseconds
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> date2Date2String(time)
	 * 
	 * @param time
	 *            The time in miliseconds
	 * @return String Formatted date
	...
	/**
	 * Parses either a tick expression, or an expression ending with the word
	 * minutes, hours, seconds, days, mudhours, muddays, mudweeks, mudmonths, or
	 * mudyears
	 * 
	 * @param val
	 *            the expression
	...
	/**
	 * Parses whether a tick expression, or an expression ending with the word
	 * minutes, hours, seconds, days, mudhours, muddays, mudweeks, mudmonths, or
	 * mudyears
	 * 
	 * @param val
	...
	/**
	 * Returns the mud wide global time clock object as defined by the
	 * coffeemud.ini file.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock
	...
	public final static String[] SHORTMONTHS = { "Jan", "Feb", "Mar", "Apr",
