...
public interface CombatLibrary extends CMLibrary {
	...
	public String standardMissString(int weaponType, int weaponClassification,
			String weaponName, boolean useExtendedMissString);

	public String standardHitString(int weaponType, int weaponClass,
			int damageAmount, String weaponName);
	...
	/**
	 * For a valid set of killers who are benefitting from having killed the
	 * given killed mob, this method will make repeated postExperience calls
	 * after having calculated their exp bounty for the kill.
	 * 
	 * @see ExpLevelLibrary#postExperience(MOB, MOB, String, int, boolean)
	 * @param killers
	 *            a set of mobs to benefit from the kill
	 * @param dividers
	 *            a set of mobs who must divide the xp.. usually subset of
	 *            killers
	 * @param killed
	 *            the mob killed
	 */
