...
public interface TrackingLibrary extends CMLibrary {
	...
	public void getRadiantRooms(Room room, List<Room> rooms,
			TrackingFlags flags, Room radiateTo, int maxDepth,
	...
	public List<Room> getRadiantRooms(Room room, TrackingFlags flags,
			int maxDepth);

	public boolean beMobile(MOB mob, boolean dooropen, boolean wander,
			boolean roomprefer, boolean roomobject, long[] status,
			List<Room> rooms);
	...
	public List<List<Integer>> findAllTrails(Room from, Room to,
			List<Room> radiantTrail);

	public List<List<Integer>> findAllTrails(Room from, List<Room> tos,
			List<Room> radiantTrail);
	...
	public static abstract class RFilter {
		public abstract boolean isFilteredOut(final Room R, final Exit E,
				final int dir);
	}
	...
	public static enum TrackingFlag {
		NOHOMES(new RFilter() {
			public boolean isFilteredOut(final Room R, final Exit E,
					final int dir) {
