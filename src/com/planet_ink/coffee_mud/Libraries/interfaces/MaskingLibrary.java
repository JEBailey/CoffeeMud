...
public interface MaskingLibrary extends CMLibrary {
	...
	public static class CompiledZapperMask {
		...
		public CompiledZapperMask(final boolean[] flags,
				final CompiledZapperMaskEntry[] entries) {
			this.flags = flags;
		...
		public CompiledZapperMask(final boolean[] flags,
				final CompiledZapperMaskEntry[] entries, final boolean empty) {
			this.flags = flags;
			this.entries = entries;
			this.empty = empty;
		}
		...
		public static final CompiledZapperMask EMPTY() {
			return new CompiledZapperMask(new boolean[2],
					new CompiledZapperMaskEntry[0], true);
		}
	}
	...
	public static class SavedClass {
		...
		public SavedClass(final CharClass charClass, final int startChars) {
			...
			baseClassStart = CMStrings.safeLeft(baseClass.toUpperCase(),
					startChars);
	...
	public static class SavedRace {
		...
		public SavedRace(final Race race, final int startChars) {
			...
			catNameStart = CMStrings.safeLeft(racialCategory.toUpperCase(),
					startChars);
	...
	public final String DEFAULT_MASK_HELP = "+SYSOP (allow archons to bypass the rules)  <BR>"
