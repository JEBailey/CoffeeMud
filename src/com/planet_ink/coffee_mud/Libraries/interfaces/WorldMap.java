...
public interface WorldMap extends CMLibrary {
	...
	public List<SpaceObject> getSpaceObjectsWithin(SpaceObject ofObj,
	...
	public static class LocatedPair {
		...
		public LocatedPair(final Room room, final PhysicalAgent obj) {
			this.roomW = new WeakReference<Room>(room);
			this.objW = new WeakReference<PhysicalAgent>(obj);
		}
	}
	...
	public static class CrossExit {
		...
		public static CrossExit make(int xx, int xy, int xdir,
				String xdestRoomID, boolean xout) {
	...
	public class CompleteRoomIDEnumerator implements Enumeration<String> {
		...
		public CompleteRoomIDEnumerator(WorldMap map) {
			areaEnumerator = map.areas();
		}

		public boolean hasMoreElements() {
			if ((roomIDEnumerator == null)
					|| (!roomIDEnumerator.hasMoreElements()))
			...
			return ((roomIDEnumerator != null) && (roomIDEnumerator
					.hasMoreElements()));
		}

		public String nextElement() {
			return hasMoreElements() ? (String) roomIDEnumerator.nextElement()
					: null;
		}
	}
	...
	public static class MapCacheEntry implements CMObject {
		...
		public MapCacheEntry(final String ID, final List<Room> rooms) {
			this.ID = ID;
			this.rooms = rooms;
		}
