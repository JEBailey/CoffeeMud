...
public interface XMLLibrary extends CMLibrary {
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> Data+=XMLoTag("MODELOBJECTONE",VA.ModelObjectOne);
	 * 
	 * @param TName
	 *            Tag name to use
	 * @param Data
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String XML=returnXMLBlock(Response,"PDIModelErrors");
	 * 
	 * @param Blob
	 *            String to searh
	 * @param Tag
	...
	/**
	 * Returns the contents of a container tag, searched for in another
	 * container tags contents
	 * 
	 * @param V
	 *            the container tags contents
	 * @param tag
	 *            the tag to look for
	...
	/**
	 * Returns the xml tag node for the given tag name, if found in the given
	 * tag container contents
	 * 
	 * @param V
	 *            the tag container contents
	 * @param tag
	 *            the tag name
	 ...
	 * 
	 * @param V
	 *            the tag collection (container tag)
	 * @param tag
	 *            the tag to look for
	...
	/**
	 * Return the data value within a given XML block <TAG>Data</TAG>
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getBoolFromPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getShortFromPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getIntFromPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	...
	/**
	 * Return where the value is within a given XML block <TAG>Data</TAG>
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> boolean ThisColHead=isTagInPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getLongFromPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getDoubleFromPieces(ThisRow,"TD");
	 * 
	 * @param V
	 *            Pieces to search
	 * @param tag
	...
	/**
	 * Parses all xml inside the given string buffer and returns the root tags
	 * as a container collection.
	 * 
	 * @param buf
	 *            the string to parse
	...
	/**
	 * Parses all xml inside the given stringbuffer and returns the root tags as
	...
	/**
	 * Parses a list of single-level xml tags, together in string. This method
	 * assumes that the given string is a series of top level tags, with no
	 * child tags, and no attributes. It will parse the tags, and return their
	 * values (only) as a list of strings. Any deconversions for compatibility
	 * are also performed
	 * 
	 * @param numberedList
	...
	/**
	 * Converts the given list of strings into a set of top-level xml tags
	 * called simply <X>
	 * 
	 * @param V
	 *            the list of strings
	...
	/**
	 * Return the data value within the first XML block <TAG>Data</TAG>
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=returnXMLValue(ThisRow);
	 * 
	 * @param Blob
	 *            String to searh
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=returnXMLValue(ThisRow,"TD");
	 * 
	 * @param Blob
	 *            String to search
	 * @param Tag
	...
	/**
	 * Return a parameter value within an XML tag <TAG Parameter="VALUE">
	 * 
	 * <br>
	 * <br>
	 * <b>Usage:</b> String ThisColHead=getParmValue(parmSet,"TD");
	 * 
	 * @param parmSet
	 *            set of parms to search
	 * @param Tag
	 *            Tag to search for
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String val=parseOutAngleBrackets(ThisValue);
	 * 
	 * @param s
	 *            String to parse
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String val=parseOutAngleBracketsAndQuotes(ThisValue);
	 * 
	 * @param s
	 *            String to parse
	 * @return String parsed value
	 ...
	 * <br>
	 * <br>
	 * <b>Usage:</b> String val=restoreAngleBrackets(ThisValue);
	 * 
	 * @param s
	 *            String to parse
	...
	public static class XMLpiece implements Cloneable {
		...
		public String toString() {
			...
			for (String parm : parms.keySet())
				str.append(" ").append(parm).append("=\"")
						.append(parms.get(parms)).append("\"");
