...
public interface LanguageLibrary extends CMLibrary {
	...
	public String[][] ISO_LANG_CODES = { { "AA", "Afar" },
			...
			{ "FA", "Persian" }, { "FI", "Finnish" }, { "FJ", "Fiji" },
			{ "FO", "Faeroese" }, { "FR", "French" }, { "FY", "Frisian" },
			...
			{ "KU", "Kurdish" }, { "KY", "Kirghiz" }, { "LA", "Latin" },
			{ "LN", "Lingala" }, { "LO", "Laothian" }, { "LT", "Lithuanian" },
			...
			{ "NA", "Nauru" }, { "NE", "Nepali" }, { "NL", "Dutch" },
			{ "NO", "Norwegian" }, { "OC", "Occitan" }, { "OM", "Oromo" },
			{ "OR", "Oriya" }, { "PA", "Punjabi" }, { "PL", "Polish" },
			...
			{ "SR", "Serbian" }, { "SS", "Siswati" }, { "ST", "Sesotho" },
			{ "SU", "Sudanese" }, { "SV", "Swedish" }, { "SW", "Swahili" },
			{ "TA", "Tamil" }, { "TE", "Tegulu" }, { "TG", "Tajik" },
