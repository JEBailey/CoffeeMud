...
public interface JournalsLibrary extends CMLibrary {
	...
	public static class CommandJournal {
		private String name = "";
		private String mask = "";
		private Hashtable<CommandJournalFlags, String> flags = new Hashtable<CommandJournalFlags, String>(
				1);

		public CommandJournal(String name, String mask,
				Hashtable<CommandJournalFlags, String> flags) {
			this.name = name;
			this.mask = mask;
			this.flags = flags;
		}
	...
	public static class SMTPJournal {
		...
		public SMTPJournal(String name, boolean forward, boolean subscribeOnly,
				boolean keepAll, String criteriaStr) {
			this.name = name;
	...
	public static class ForumJournal {
		...
		private Hashtable<ForumJournalFlags, String> flags = new Hashtable<ForumJournalFlags, String>(
				1);

		public ForumJournal(String name,
				Hashtable<ForumJournalFlags, String> flags) {
			this.name = name;
			String mask;
