...
public interface TechLibrary extends CMLibrary {
	/**
	 * Unregisters an electronic component that belonged in a complex circuitry,
	 * like a panel or a generator.
	 * 
	 * @param E
	 *            the electronic component to unregister
	 * @param oldKey
	...
	/**
	 * Unregisters all electronic components that belonged in a complex
	 * circuitry, like a panel or a generator, of the given key.
	 * 
	 * @param oldKey
	 *            the last key registered to this device
	 */
	...
	/**
	 * Registers an electronic component that belongs in a complex circuitry,
	 * like a panel or a generator
	 * 
	 * @param E
	 *            the electronic component to register
	 * @param oldKey
	 *            the last key registered to this device
	...
	/**
	 * Returns whether the currents at the given key are still active. Some
	 * currents go inactive when players leave the game, or their areas may be
	...
	/**
	 * Returns a new exclusive list of all the registered electronics keys being
	 * processed.
	 * 
	...
	/**
	 * For the given key, return an eclusive list of all the electronics that
	 * belong to that key.
	 * 
	 * @param key
	...
	/**
	 * Certain Key Systems may automatically force batteries in their circuit to
	 * activate in order to provide that system with power. This will make that
	 * attempt.
	 * 
	 * @param E
	 *            the key device to seek power
	 * @param key
	 *            this devices key
	...
	/**
	 * Retrieves the manufacturer of the given name, or null if it is not found.
	 * If random is sent, it will find a random manufacturer for the given item.
	 * 
	 * @param E
	 *            for random manufacturers, the item to check
	 * @param name
	 *            the manufacturer to fetch
	 * @return the manufacturer found, or null
	 */
	...
	/**
	 * Returns a random gaussian-distributed tech level from the current low
	 * tech level bound to bound+10.
	 * 
	...
	/**
	 * "Fixes" the tech level of the given item by making sure it's manufacturer
	 * is non-random, and by assigning a random tech level within the valid
	 * range, and modifying its name and displaytext to reflect the new tech
	 * level
	 * 
	 * @param I
	 *            An electronics item that needs fixing
	 */
