...
public class CMGenEditor extends StdLibrary implements GenericEditor {
	...
	public void promptStatInt(MOB mob, Modifiable E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		promptStatInt(mob, E, null, showNumber, showFlag, FieldDisp, Field);
	}

	public void promptStatInt(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field)
			throws IOException {
		E.setStat(
				Field,
				""
						+ prompt(mob, CMath.s_long(E.getStat(Field)),
								showNumber, showFlag, FieldDisp, help));
	}

	public void promptStatBool(MOB mob, Modifiable E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		promptStatBool(mob, E, null, showNumber, showFlag, FieldDisp, Field);
	}

	public void promptStatBool(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field)
			throws IOException {
		E.setStat(
				Field,
				""
						+ prompt(mob, CMath.s_bool(E.getStat(Field)),
								showNumber, showFlag, FieldDisp, help));
	}

	public void promptStatStr(MOB mob, Modifiable E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		promptStatStr(mob, E, null, showNumber, showFlag, FieldDisp, Field,
				true);
	}

	public void promptStatStr(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field,
			boolean emptyOK) throws IOException {
		E.setStat(
				Field,
				prompt(mob, E.getStat(Field), showNumber, showFlag, FieldDisp,
						emptyOK, false, help, null, null));
	}

	public void promptRawStatStr(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field,
			boolean emptyOK) throws IOException {
		E.setStat(
				Field,
				prompt(mob, E.getStat(Field), showNumber, showFlag, FieldDisp,
						emptyOK, true, help, null, null));
	}
	...
	public void promptStatStr(MOB mob, Modifiable E, String help,
		...
		E.setStat(
				Field,
				prompt(mob, E.getStat(Field), showNumber, showFlag, FieldDisp,
						false, false, maxChars, help, null, null));
	}

	public void promptStatChoices(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field,
			Object[] choices) throws IOException {
		E.setStat(
				Field,
				prompt(mob, E.getStat(Field), showNumber, showFlag, FieldDisp,
						false, false, help, CMEvalStrChoice.INSTANCE, choices));
	}

	public void promptStatCommaChoices(MOB mob, Modifiable E, String help,
			int showNumber, int showFlag, String FieldDisp, String Field,
			Object[] choices) throws IOException {
		E.setStat(Field, this.promptCommaList(mob, E.getStat(Field),
				showNumber, showFlag, FieldDisp, help,
				CMEvalStrChoice.INSTANCE, choices));
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, false,
				false, null, null, null);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, String help) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, false,
				false, help, null, null);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, emptyOK,
				false, null, null, null);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK, String help) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, emptyOK,
				false, help);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK, boolean rawPrint)
			throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, emptyOK,
				rawPrint, null, null, null);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK, boolean rawPrint, String help)
			throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, emptyOK,
				rawPrint, help, null, null);
	}

	public boolean prompt(MOB mob, boolean oldVal, int showNumber,
			int showFlag, String FieldDisp) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, null);
	}

	public double prompt(MOB mob, double oldVal, int showNumber, int showFlag,
			String FieldDisp) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, null);
	}

	public int prompt(MOB mob, int oldVal, int showNumber, int showFlag,
			String FieldDisp) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, null);
	}

	public long prompt(MOB mob, long oldVal, int showNumber, int showFlag,
			String FieldDisp) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, null);
	}

	public boolean promptToggle(MOB mob, int showNumber, int showFlag,
			String FieldDisp) throws IOException {
	...
	public String promptCommaList(MOB mob, String oldVal, int showNumber,
			int showFlag, String FieldDisp, String help, CMEval eval,
			Object[] choices) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldVal;
		...
		if ((showFlag != showNumber) && (showFlag > -999))
			return oldVal;
		String newName = "?";
		String promptStr = "Enter a value to add/remove"
				+ (help != null ? " (?)" : "") + "\n\r:";
	...
	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK, boolean rawPrint, String help,
			CMEval eval, Object[] choices) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, emptyOK,
				rawPrint, 0, help, eval, choices);
	}

	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
			String FieldDisp, boolean emptyOK, boolean rawPrint, int maxChars,
			String help, CMEval eval, Object[] choices) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldVal;
		String showVal = oldVal;
		if ((maxChars > 0) && (showVal.length() > maxChars)
				&& (!((showFlag != showNumber) && (showFlag > -999))))
			showVal = showVal.substring(0, maxChars) + "...";
		if (rawPrint)
			mob.session().rawPrintln(
					showNumber + ". " + FieldDisp + ": '" + showVal + "'.");
		else
			mob.tell(showNumber + ". " + FieldDisp + ": '" + showVal + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return oldVal;
		String newName = "?";
		String promptStr = "Enter a new value " + (emptyOK ? "(or NULL)" : "")
				+ (help != null ? " (?)" : "") + "\n\r:";
		while (newName.equals("?") && (mob.session() != null)
				&& (!mob.session().isStopped())) {
			newName = mob.session().prompt(promptStr, "");
			if (newName.equals("?")
					&& ((help != null) || ((choices != null) && (choices.length > 0)))) {
				if (help != null)
					mob.tell(help);
				else
					mob.tell("You choices are: "
							+ CMParms.toStringList(choices));
			} else {
	...
	public boolean prompt(MOB mob, boolean oldVal, int showNumber,
			int showFlag, String FieldDisp, String help) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldVal;
		mob.tell(showNumber + ". " + FieldDisp + ": '" + oldVal + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
		...
		while (newName.equals("?") && (mob.session() != null)
			...
			newName = mob.session().prompt(
					"Enter true or false" + (help != null ? " (?)" : "") + ":",
					"");
			if (newName.equals("?") && (help != null))
				mob.tell(help);
			else if (newName.toUpperCase().startsWith("T")
					|| newName.toUpperCase().startsWith("F"))
				return newName.toUpperCase().startsWith("T");
			else if (newName.toUpperCase().startsWith("Y")
					|| newName.toUpperCase().startsWith("N"))
	...
	public double prompt(MOB mob, double oldVal, int showNumber, int showFlag,
			String FieldDisp, String help) throws IOException {
		return prompt(mob, oldVal, showNumber, showFlag, FieldDisp, help,
				Double.MIN_VALUE, Double.MAX_VALUE);
	}

	public double prompt(MOB mob, double oldVal, int showNumber, int showFlag,
			String FieldDisp, String help, double minValue, double maxValue)
			throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldVal;
		mob.tell(showNumber + ". " + FieldDisp + ": '" + oldVal + "'.");
	...
	public int promptMulti(MOB mob, int oldVal, int showNumber, int showFlag,
			String FieldDisp, DVector choices) throws IOException {
		return CMath.s_int(promptMultiOrExtra(mob, "" + oldVal, showNumber,
				showFlag, FieldDisp, choices));
	}

	public String promptMultiOrExtra(MOB mob, String oldVal, int showNumber,
			int showFlag, String FieldDisp, DVector choices) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldVal;
		Vector<String> oldVals = new Vector<String>();
		if (CMath.s_int(oldVal) > 0) {
			for (int c = 0; c < choices.size(); c++)
				if (CMath.bset(CMath.s_int(oldVal),
						CMath.s_int((String) choices.elementAt(c, 1))))
					oldVals.addElement((String) choices.elementAt(c, 2));
		} else if (choices.contains(oldVal.toUpperCase().trim()))
			oldVals.addElement(oldVal);
		mob.tell(showNumber + ". " + FieldDisp + ": '"
				+ CMParms.toStringList(oldVals) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return oldVal;
		String newVal = oldVal;
		String thisVal = "?";
		while (thisVal.equals("?") && (mob.session() != null)
				&& (!mob.session().isStopped())) {
			thisVal = mob.session()
					.prompt("Enter a new choice to add/remove (?):", "").trim();
			if (thisVal.equals("?"))
				...
				String foundVal = "";
				for (int c = 0; c < choices.size(); c++)
					if (((String) choices.elementAt(c, 2))
							.equalsIgnoreCase(thisVal)) {
				...
				if (foundChoice == null) {
					mob.tell("'"
							+ newVal
							+ "' is not an available option.  Use ? for a list.");
					thisVal = "?";
					...
					if (oldVals.contains(foundChoice)) {
						newVal = Integer.toString(CMath.s_int(newVal)
								- CMath.s_int(foundVal));
	...
	public String prompt(MOB mob, String oldVal, int showNumber, int showFlag,
		...
		if ((showFlag != showNumber) && (showFlag > -999))
			return oldVal;
		String newVal = "?";
		while (newVal.equals("?") && (mob.session() != null)
				&& (!mob.session().isStopped())) {
			newVal = mob.session()
					.prompt("Enter a new choice (? or NULL):", "").trim();
			if (newVal.equals("?"))
				mob.tell(CMParms.toStringList(choices.getDimensionVector(2)));
				...
				if (foundChoice == null)
					mob.tell("'"
							+ newVal
							+ "' is not an available choice.  Use ? for a list.");
				else {
					newVal = foundChoice;
					break;
				}
	...
	public void genName(MOB mob, Environmental E, int showNumber, int showFlag)
			throws IOException {
		String newName = prompt(mob, E.Name(), showNumber, showFlag, "Name",
				false, false);
		...
		if ((E instanceof Physical) && (CMLib.flags().isCataloged(E))) {
			...
			if (cataP == null) {
				...
				return;
					...
					.session()
					.confirm(
							"This object is cataloged.  Changing its name will detach it from the cataloged version, are you sure (y/N)?",
							"N")) {
				CMLib.catalog().changeCatalogUsage(P, false);
				P.setName(newName);
			}
	...
	protected void catalogCheckUpdate(MOB mob, Physical P) throws IOException {
		...
		if ((diffs != null) && (diffs.length() > 0)) {
			...
			for (int v = 0; v < V.size(); v++) {
				String stat = V.get(v);
				detailedDiff.append("CATALOG:" + stat + ":'"
						+ cataP.getStat(stat) + "'\n\r");
			...
			if (choice.equalsIgnoreCase("C")) {
				...
				Log.infoOut("BaseGenerics",
						mob.Name() + " updated catalog "
								+ ((P instanceof MOB) ? "MOB" : "ITEM") + " "
								+ P.Name());
				P.setMiscText(P.text());
	...
	protected void genImage(MOB mob, Environmental E, int showNumber,
			int showFlag) throws IOException {
		E.setImage(prompt(mob, E.rawImage(), showNumber, showFlag,
				"MXP Image filename", true, false,
				"This is the path/filename of your MXP image file for this object."));
	}

	protected void genCorpseData(MOB mob, DeadBody I, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Corpse Data: '" + I.mobName() + "/"
				+ I.killerName() + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		...
		if ((newName.length() > 0)
				&& (newName.equalsIgnoreCase("true") || newName
						.equalsIgnoreCase("false")))
			I.setPlayerCorpse(Boolean.valueOf(newName.toLowerCase())
					.booleanValue());
		else
			mob.tell("(no change)");
		...
		if ((newName.length() > 0)
				&& (newName.equalsIgnoreCase("true") || newName
						.equalsIgnoreCase("false")))
			I.setMobPKFlag(Boolean.valueOf(newName.toLowerCase())
					.booleanValue());
		else
			mob.tell("(no change)");
		...
		if ((newName.length() > 0)
				&& (newName.equalsIgnoreCase("true") || newName
						.equalsIgnoreCase("false")))
			I.setKillerPlayer(Boolean.valueOf(newName.toLowerCase())
					.booleanValue());
		else
			mob.tell("(no change)");
	...
	protected void genAuthor(MOB mob, Area A, int showNumber, int showFlag)
			throws IOException {
		A.setAuthorID(prompt(mob, A.getAuthorID(), showNumber, showFlag,
				"Author", true, false, "Area Author's Name"));
	}

	protected void genPanelType(MOB mob, Electronics.ElecPanel S,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		String componentType = CMStrings.capitalizeAndLower(S.panelType()
				.name().toLowerCase());
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (newName.length() > 0) {
				if (newName.equalsIgnoreCase("?")) {
					mob.tell("Component Types: "
							+ CMParms
									.toStringList(Electronics.ElecPanel.PANELTYPES));
					continueThis = true;
				} else {
					TechType newType = null;
					for (int i = 0; i < TechType.values().length; i++)
						if (TechType.values()[i].name().equalsIgnoreCase(
								newName))
							newType = TechType.values()[i];
					if (newType == null) {
						mob.tell("'" + newName
								+ "' is not recognized.  Try '?' for a list.");
						continueThis = true;
					} else
	...
	protected void genTimeClock(MOB mob, Area A, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			report.append("2. Dawn Hour: "
					+ TC.getDawnToDusk()[TimeClock.TIME_DAWN] + "\n\r");
			report.append("3. Day Hour: "
					+ TC.getDawnToDusk()[TimeClock.TIME_DAY] + "\n\r");
			report.append("4. Dusk Hour: "
					+ TC.getDawnToDusk()[TimeClock.TIME_DUSK] + "\n\r");
			report.append("5. Night Hour: "
					+ TC.getDawnToDusk()[TimeClock.TIME_NIGHT] + "\n\r");
			report.append("6. Weekdays: "
					+ CMParms.toStringList(TC.getWeekNames()) + "\n\r");
			report.append("7. Months: "
					+ CMParms.toStringList(TC.getMonthNames()) + "\n\r");
			report.append("8. Year Title(s): "
					+ CMParms.toStringList(TC.getYearNames()));
			...
			if ((which < 0) || (which > 8))
				...
				newName = "";
				String newNum = mob.session().prompt(
						"Enter a new list (comma delimited)\n\r:", "");
				if (newNum.length() == 0)
					mob.tell("(no change)");
				else
					switch (which) {
					case 6:
						TC.setDaysInWeek(CMParms.toStringArray(CMParms
								.parseCommas(newNum, true)));
						break;
					case 7:
						TC.setMonthsInYear(CMParms.toStringArray(CMParms
								.parseCommas(newNum, true)));
						break;
					case 8:
						TC.setYearNames(CMParms.toStringArray(CMParms
								.parseCommas(newNum, true)));
						break;
					}
			}
	...
	protected void genClan(MOB mob, MOB M, int showNumber, int showFlag)
		...
		if ((showFlag <= 0) || (showFlag == showNumber)) {
			boolean more = true;
			while (more && (mob.session() != null)
					&& (!mob.session().isStopped())) {
				more = false;
				StringBuilder clanList = new StringBuilder("");
				for (Pair<Clan, Integer> c : M.clans())
					clanList.append(c.first.getName())
							.append(" (")
							.append(c.first.getRoleName(c.second.intValue(),
									false, false)).append("), ");
				...
				if ((showFlag == showNumber) || (showFlag <= -999)) {
					more = true;
					String newName = mob.session().prompt(
							"Enter a new clan to add, remove, or change (?):",
							"");
					Clan C = null;
					if (newName.trim().length() == 0)
						...
						if (C != null) {
							if (M.getClanRole(C.clanID()) == null) {
								String role = C.getRoleName(C.getGovernment()
										.getAcceptPos(), false, false);
								String newRole = mob.session().prompt(
										"Enter role ["
												+ CMParms.toStringList(C
														.getRolesList())
												+ "]\n\r: (" + role + "):",
										role);
								if (newRole.trim().length() > 0) {
									...
									if (CMath.isInteger(newRole.trim()))
										...
										roleID = C.getRoleFromName(newRole
												.trim());
									if (roleID < 0)
							...
							StringBuilder list = new StringBuilder("(no clan '"
									+ newName + "', try: ");
							for (Enumeration<Clan> e = CMLib.clans().clans(); e
									.hasMoreElements();)
	...
	public Room changeRoomType(Room R, Room newRoom) {
		...
		synchronized (("SYNC" + R.roomID()).intern()) {
			...
			for (final Enumeration<Ability> a = oldR.effects(); a
					.hasMoreElements();) {
			...
			for (Enumeration<Behavior> e = oldR.behaviors(); e
					.hasMoreElements();) {
			...
			if (R.image().equalsIgnoreCase(
					CMLib.protocol().getDefaultMXPImage(oldR)))
				R.setImage(null);
			...
			for (int m = 0; m < allmobs.size(); m++) {
				...
				if (!R.isInhabitant(M)) {
					...
					M2.setStartRoom(R);
					M2.setLocation(R);
					long rejuv = CMProps.getTicksPerMinute()
							+ CMProps.getTicksPerMinute()
							+ (CMProps.getTicksPerMinute() / 2);
			...
			for (int i = 0; i < oldBehavsNEffects.size(); i++) {
				if (oldBehavsNEffects.elementAt(i) instanceof Behavior)
					...
					R.addNonUninvokableEffect((Ability) oldBehavsNEffects
							.elementAt(i));
			}
	...
	protected Room genRoomType(MOB mob, Room R, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (newName.trim().equals("?")) {
				mob.tell(CMLib.lister().reallyList2Cols(mob, CMClass.locales())
						.toString()
						+ "\n\r");
				newName = "";
			} else if (newName.length() > 0) {
				...
				if (newRoom == null)
					mob.tell("'" + newName + "' does not exist. No Change.");
						...
						.session()
						.confirm(
								"This will change the room type of room "
										+ R.roomID()
										+ ". It will automatically save any mobs and items in this room permanently.  Are you absolutely sure (y/N)?",
								"N"))
	...
	public void genDescription(MOB mob, Environmental E, int showNumber,
			int showFlag) throws IOException {
		E.setDescription(prompt(mob, E.description(), showNumber, showFlag,
	...
	protected void genNotes(MOB mob, MOB M, int showNumber, int showFlag)
		...
		if (M.playerStats() != null)
			M.playerStats().setNotes(
					prompt(mob, M.playerStats().notes(), showNumber, showFlag,
							"Private notes", true, false, null));
	}
	...
	protected void genPassword(MOB mob, MOB M, int showNumber, int showFlag)
		...
		if ((str.length() > 0) && (M.playerStats() != null)) {
			...
			CMLib.database().DBUpdatePassword(M.Name(),
					M.playerStats().getPasswordStr());
		} else
			mob.tell("(no change)");
	}

	protected void genEmail(MOB mob, AccountStats A, int showNumber,
			int showFlag) throws IOException {
		if (A == null)
			return;
		A.setEmail(prompt(mob, A.getEmail(), showNumber, showFlag, "Email",
				true, false, null));
	}

	protected void genBirthday(MOB mob, PlayerStats A, int showNumber,
			int showFlag) throws IOException {
		if (A == null)
			return;
		A.setStat(
				"BIRTHDAY",
				prompt(mob, A.getStat("BIRTHDAY"), showNumber, showFlag,
						"Birthday (m,d,y)", true, false, null));
	}

	public void genDisplayText(MOB mob, Environmental E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if (mob.session() != null)
			mob.session().rawPrintln(
					showNumber + ". Display: '" + E.displayText() + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = null;
		if (E instanceof Item)
			newName = mob.session().prompt(
					"Enter something new (null == blended)\n\r:", "");
		else if (E instanceof Exit)
			newName = mob.session().prompt(
					"Enter something new (null == see-through)\n\r:", "");
		else
			newName = mob.session().prompt(
					"Enter something new (null = empty)\n\r:", "");
		if (newName.length() > 0) {
	...
	protected void genClosedText(MOB mob, Exit E, int showNumber, int showFlag)
		...
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = mob.session().prompt(
				"Enter something new (null=blank)\n\r:", "");
	...
	protected void genDoorName(MOB mob, Exit E, int showNumber, int showFlag)
		...
		if (newName.length() > 0)
			E.setExitParams(newName, E.closeWord(), E.openWord(),
					E.closedText());
		else
			mob.tell("(no change)");
	}
	...
	protected void genBurnout(MOB mob, Light I, int showNumber, int showFlag) {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Is destroyed after burnout: '"
				+ I.destroyedWhenBurnedOut() + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
	...
	protected void genOpenWord(MOB mob, Exit E, int showNumber, int showFlag)
		...
		String newName = mob.session().prompt("Enter something new\n\r:", "");
		if (newName.length() > 0)
			E.setExitParams(E.doorName(), E.closeWord(), newName,
					E.closedText());
		else
			mob.tell("(no change)");
	}
	...
	protected void genSubOps(MOB mob, Area A, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			str = mob.session()
					.prompt("Enter a name to add or remove\n\r:", "");
			if (str.length() > 0) {
				if (A.amISubOp(str)) {
					A.delSubOp(str);
					...
					mob.tell("'" + str
							+ "' is not recognized as a valid user name.");
			}
		}
	}
	...
	protected void genParentAreas(MOB mob, Area A, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			newArea = mob.session().prompt(
					"Enter an area name to add or remove\n\r:", "");
					...
					if (lookedUp.isChild(A)) {
						...
						if (A.canParent(lookedUp)) {
							...
							mob.tell("Area '"
									+ lookedUp.Name()
									+ ""
									+ "' cannot be added because this would create a circular reference.");
						}
					}
				} else
					mob.tell("'" + newArea
							+ "' is not recognized as a valid area name.");
			}
		}
	}
			...
			if (newArea.equalsIgnoreCase("*clear*")) {
				...
				if (lookedUp != null) {
					if (lookedUp.isParent(A)) {
						// this area is already a child to A, they must want it
						// removed
		...
		if (E.hasALock()) {
			...
			if ((showFlag != showNumber) && (showFlag > -999)) {
				if (!E.isReadable())
					...
					mob.tell(showNumber + ". Door is readable: "
							+ E.readableText());
				return;
	...
	protected void genReadable1(MOB mob, Item E, int showNumber, int showFlag) {
		...
		if ((E instanceof Wand)
				...
				|| ((E instanceof ClanItem) && ((((ClanItem) E).ciType() == ClanItem.CI_GATHERITEM)
						|| (((ClanItem) E).ciType() == ClanItem.CI_CRAFTITEM) || (((ClanItem) E)
						.ciType() == ClanItem.CI_SPECIALAPRON)))
			...
			CMLib.flags().setReadable(
					E,
					genGenericPrompt(mob, showNumber
							+ ". Is this item readable", E.isReadable()));
	}
	...
	protected void genReadable2(MOB mob, Item E, int showNumber, int showFlag)
		...
		if (E.isReadable() || (E instanceof SpellHolder)
				|| (E instanceof Ammunition) || (E instanceof Recipe)
				|| (E instanceof Exit) || (E instanceof Wand)
				|| (E instanceof ClanItem) || (E instanceof Light)
				|| (E instanceof DoorKey)) {
			boolean ok = false;
			while ((mob.session() != null) && (!mob.session().isStopped())
					&& (!ok)) {
				if (CMClass.classID(E).endsWith("SuperPill")) {
					mob.tell(showNumber + ". Assigned Spell or Parameters: '"
							+ E.readableText() + "'.");
					ok = true;
				} else if (E instanceof SpellHolder)
					mob.tell(showNumber
							+ ". Assigned Spell(s) ( ';' delimited)\n: '"
							+ E.readableText() + "'.");
				else if (E instanceof Ammunition) {
					mob.tell(showNumber + ". Ammunition type: '"
							+ E.readableText() + "'.");
					ok = true;
				} else if (E instanceof Exit) {
					mob.tell(showNumber + ". Assigned Room IDs: '"
							+ E.readableText() + "'.");
					ok = true;
				} else if (E instanceof Wand)
					mob.tell(showNumber + ". Assigned Spell Name: '"
							+ E.readableText() + "'.");
				else if (E instanceof DoorKey) {
					mob.tell(showNumber + ". Assigned Key Code: '"
							+ E.readableText() + "'.");
					ok = true;
				} else if (E instanceof com.planet_ink.coffee_mud.Items.interfaces.RoomMap) {
					mob.tell(showNumber + ". Assigned Map Area(s): '"
							+ E.readableText() + "'.");
					ok = true;
				} else if (E instanceof Light) {
					mob.tell(showNumber
							+ ". Light duration (before burn out): '"
							+ CMath.s_int(E.readableText()) + "'.");
					ok = true;
				} else {
					mob.tell(showNumber + ". Assigned Read Text: '"
							+ E.readableText() + "'.");
					ok = true;
				}
				...
				if ((E instanceof Wand)
						|| ((E instanceof SpellHolder) && (!(CMClass.classID(E)
								.endsWith("SuperPill"))))) {
					newName = mob.session().prompt(
							"Enter something new (?)\n\r:", "");
					if (newName.length() == 0)
						...
						if (newName.equalsIgnoreCase("?"))
							mob.tell(CMLib.lister()
									.reallyList(mob, CMClass.abilities(), -1)
									.toString());
						else if (E instanceof Wand) {
							...
							while (x >= 0) {
								String spellName = newName.substring(0, x)
										.trim();
			...
			mob.session().println(
					showNumber + ". Current liquid type: "
							+ RawMaterial.CODES.NAME(((Drink) E).liquidType()));
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			boolean q = false;
			while ((mob.session() != null) && (!mob.session().isStopped())
					&& (!q)) {
				String newType = mob.session().prompt(
						"Enter a new type (?)\n\r:",
						RawMaterial.CODES.NAME(((Drink) E).liquidType()));
				if (newType.equals("?")) {
					StringBuffer say = new StringBuffer("");
					List<Integer> liquids = RawMaterial.CODES
							.COMPOSE_RESOURCES(RawMaterial.MATERIAL_LIQUID);
	...
	protected void genRecipe(MOB mob, final Recipe E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		StringBuilder str = new StringBuilder(showNumber + ". Recipe Data: "
				+ E.getCommonSkillID() + " (" + E.getTotalRecipePages() + "): ");
		...
		while (!S.isStopped()) {
			...
			if (newName.equalsIgnoreCase("?")) {
				...
				mob.tell("'" + newName
						+ "' is not a valid common skill.  Try ?.");
			else {
				mob.tell("(no change)");
				break;
			}
		}
		String newCount = mob.session().prompt(
				"Enter new maximum recipe count (" + E.getTotalRecipePages()
						+ "):", "");
		...
		if ((A != null)
			...
			C = (ItemCraftor) A;
			mob.tell("Params: "
					+ CMStrings.replaceAll(C.parametersFormat(), "\t", ","));
		} else
			C = null;
		while (!S.isStopped()) {
			...
			for (int i = 1; i <= recipes.length; i++)
				str.append(
						i
								+ ") "
								+ CMStrings.replaceAll(recipes[i - 1], "\t",
										",")).append("\n");
			...
			mob.tell(str.toString());
			String newName = mob.session().prompt(
					"Enter a number to add/edit/remove\n\r:", "");
			...
			class Checker {
				public String getErrors(String line) {
					if (C == null)
						return "Skill " + E.getCommonSkillID()
								+ " is not a crafting skill!";
					try {
						CMLib.ableParms().testRecipeParsing(
								new StringBuffer(CMStrings.replaceAll(line,
										",", "\t")), C.parametersFormat());
			...
			if (x <= recipes.length) {
				String newLine = mob.session().prompt(
						"Re-Enter this line, or NULL to delete (?).\n\r:", "");
				if (newLine.equalsIgnoreCase("?"))
					mob.tell((C == null) ? "?" : CMStrings.replaceAll(
							C.parametersFormat(), "\t", ","));
					...
					if ((errors == null) || (errors.length() == 0))
						recipeList.set(x - 1,
								CMStrings.replaceAll(newLine, ",", "\t"));
					else
						mob.tell("Error: " + errors + ", aborting change.");
				}
			} else {
				String newLine = mob.session().prompt(
						"Enter a new line, or enter to cancel (?).\n\r:", "");
	...
	protected void genGettable(MOB mob, Item I, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			mob.session().println(
					showNumber
							+ ". A) Is Gettable   : "
							+ (!CMath.bset(I.basePhyStats().sensesMask(),
									PhyStats.SENSE_ITEMNOTGET)));
			mob.session().println(
					"    B) Is Droppable  : "
							+ (!CMath.bset(I.basePhyStats().sensesMask(),
									PhyStats.SENSE_ITEMNODROP)));
			mob.session().println(
					"    C) Is Removable  : "
							+ (!CMath.bset(I.basePhyStats().sensesMask(),
			...
			mob.session()
					.println(
							"    D) Non-Locatable : "
									+ (((I.basePhyStats().sensesMask() & PhyStats.SENSE_UNLOCATABLE) > 0) ? "true"
											: "false"));
			if (I instanceof Weapon)
				mob.session().println(
						"    E) Is Two-Handed : " + I.rawLogicalAnd());
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			c = mob.session()
					.choose("Enter one to change, or ENTER when done:",
							"ABCDE\n", "\n").toUpperCase();
			...
			case 'A':
				...
				break;
			case 'B':
				CMLib.flags().setDroppable(
						I,
						(CMath.bset(I.basePhyStats().sensesMask(),
								PhyStats.SENSE_ITEMNODROP)));
				break;
			case 'C':
				CMLib.flags().setRemovable(
						I,
						(CMath.bset(I.basePhyStats().sensesMask(),
								PhyStats.SENSE_ITEMNOREMOVE)));
				break;
	...
	protected void genDisposition(MOB mob, PhyStats E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		int[] disps = { PhyStats.IS_INVISIBLE, PhyStats.IS_HIDDEN,
				PhyStats.IS_NOT_SEEN, PhyStats.IS_BONUS, PhyStats.IS_GLOWING,
				PhyStats.IS_LIGHTSOURCE, PhyStats.IS_FLYING,
				PhyStats.IS_CLIMBING, PhyStats.IS_SNEAKING,
				PhyStats.IS_SWIMMING, PhyStats.IS_EVIL, PhyStats.IS_GOOD };
		String[] briefs = { "invisible", "hide", "unseen", "magical",
				"glowing", "lightsrc", "fly", "climb", "sneak", "swimmer",
				"evil", "good" };
		if ((showFlag != showNumber) && (showFlag > -999)) {
						...
						mob.session()
								.println(
										"    "
												...
												+ ") "
												+ CMStrings.padRight(
														PhyStats.IS_DESCS[num],
														20)
												+ ":"
												+ ((E.disposition() & mask) != 0));
						letters += letter;
						break;
					}
				letter++;
	...
	protected void genClimateType(MOB mob, Places A, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if ((showFlag != showNumber) && (showFlag > -999)) {
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			mob.session().println(
					"    I) Inherited        : "
							+ (type == Places.CLIMASK_INHERIT));
			if (type == Places.CLIMASK_INHERIT)
				type = 0;
			mob.session().println(
					"    R) Wet and Rainy    : "
							+ ((type & Area.CLIMASK_WET) > 0));
			mob.session().println(
					"    H) Excessively hot  : "
							+ ((type & Area.CLIMASK_HOT) > 0));
			mob.session().println(
					"    C) Excessively cold : "
							+ ((type & Area.CLIMASK_COLD) > 0));
			mob.session().println(
					"    W) Very windy       : "
							+ ((type & Area.CLIMASK_WINDY) > 0));
			mob.session().println(
					"    D) Very dry         : "
							+ ((type & Area.CLIMASK_DRY) > 0));
			c = mob.session()
					.choose("Enter one to change, or ENTER when done: ",
							"RHCWDI\n", "\n").toUpperCase();
			switch (c.charAt(0)) {
			case 'I':
				...
				break;
			case 'C':
				toggleClimateMask(A, Area.CLIMASK_COLD);
				break;
			case 'H':
				toggleClimateMask(A, Area.CLIMASK_HOT);
				break;
			case 'R':
				toggleClimateMask(A, Area.CLIMASK_WET);
				break;
			case 'W':
				toggleClimateMask(A, Area.CLIMASK_WINDY);
				break;
			case 'D':
				toggleClimateMask(A, Area.CLIMASK_DRY);
				break;
			}
		}
	}

	protected void genCharStats(MOB mob, CharStats E) throws IOException {
		String c = "Q";
				...
				if (i != CharStats.STAT_GENDER)
					mob.session().println(
							"    "
									...
									+ ") "
									+ CMStrings.padRight(
											CharStats.CODES.DESC(i), 20) + ":"
									+ ((E.getStat(i))));
			c = mob.session()
					.choose("Enter one to change, or ENTER when done: ",
							commandStr.substring(0, CharStats.CODES.TOTAL())
									+ "\n", "\n").toUpperCase();
			int num = commandStr.indexOf(c);
			if (num >= 0) {
				String newVal = mob.session().prompt(
						"Enter a new value:  " + CharStats.CODES.DESC(num)
								+ " (" + E.getStat(num) + "): ", "");
	...
	protected void genCharStats(MOB mob, MOB E, int showNumber, int showFlag)
		...
		if ((showFlag != showNumber) && (showFlag > -999)) {
			...
			for (int i : CharStats.CODES.BASE())
				buf.append(CharStats.CODES.ABBR(i) + ":"
						+ E.baseCharStats().getStat(i) + " ");
			mob.tell(buf.toString());
			return;
		}
		String c = "Q";
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			int num = commandStr.indexOf(c);
			if (num >= 0) {
				String newVal = mob.session()
						.prompt("Enter a new value:  "
								+ CharStats.CODES.DESC(num) + " ("
								+ E.baseCharStats().getStat(num) + "): ", "");
				if (((CMath.s_int(newVal) > 0) || (newVal.trim().equals("0")))
						&& (num != CharStats.STAT_GENDER)) {
					E.baseCharStats().setStat(num, CMath.s_int(newVal));
					if ((num == CharStats.STAT_AGE)
							&& (E.playerStats() != null)
							&& (E.playerStats().getBirthday() != null))
						E.playerStats().getBirthday()[2] = CMLib.time()
								.globalClock().getYear()
								- CMath.s_int(newVal);
				} else
					mob.tell("(no change)");
	...
	protected void genCharState(MOB mob, MOB E, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (int i = 0; i < baseState.getStatCodes().length; i++) {
				...
				mob.session().println(
						"    " + commandStr.charAt(i) + ") "
								+ CMStrings.padRight(state, 20) + ":"
								+ ((baseState.getStat(state))));
			}
			c = mob.session()
					.choose("Enter one to change, or ENTER when done: ",
							commandStr.substring(0,
									baseState.getStatCodes().length) + "\n",
							"\n").toUpperCase();
			int num = commandStr.indexOf(c);
			if (num >= 0) {
				...
				String newVal = mob.session().prompt(
						"Enter a new value:  " + state + " ("
								+ baseState.getStat(state) + "): ", "");
				if (((CMath.s_int(newVal) > 0) || (newVal.trim().equals("0")))) {
					baseState.setStat(state,
							Integer.toString(CMath.s_int(newVal)));
				} else
					mob.tell("(no change)");
			}
		}
	...
	protected void genSensesMask(MOB mob, PhyStats E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		int[] senses = { PhyStats.CAN_SEE_DARK, PhyStats.CAN_SEE_HIDDEN,
				PhyStats.CAN_SEE_INVISIBLE, PhyStats.CAN_SEE_SNEAKERS,
				PhyStats.CAN_SEE_INFRARED, PhyStats.CAN_SEE_GOOD,
				PhyStats.CAN_SEE_EVIL, PhyStats.CAN_SEE_BONUS,
				PhyStats.CAN_NOT_SPEAK, PhyStats.CAN_NOT_HEAR,
				PhyStats.CAN_NOT_SEE };
		String[] briefs = { "darkvision", "hidden", "invisible", "sneakers",
				"infrared", "good", "evil", "magic", "MUTE", "DEAF", "BLIND" };
		if ((showFlag != showNumber) && (showFlag > -999)) {
	...
	protected void genDoorsNLocks(MOB mob, Exit E, int showNumber, int showFlag)
		...
		if (genGenericPrompt(mob, "Has a door", E.hasADoor())) {
			HasDoor = true;
			DefaultsClosed = genGenericPrompt(mob, "Defaults closed",
					E.defaultsClosed());
			Open = !DefaultsClosed;
			if (genGenericPrompt(mob, "Has a lock", E.hasALock())) {
				HasLock = true;
				DefaultsLocked = genGenericPrompt(mob, "Defaults locked",
						E.defaultsLocked());
			...
			int newLevel = CMath.s_int(mob.session().prompt(
					"Enter a new delay\n\r:", ""));
			if (newLevel > 0)
		...
		E.setDoorsNLocks(HasDoor, Open, DefaultsClosed, HasLock, Locked,
				DefaultsLocked);
	}
	...
	protected void genLidsNLocks(MOB mob, Container E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if ((showFlag != showNumber) && (showFlag > -999)) {
			...
			if (E instanceof Electronics)
				containStr = "";
			mob.tell(showNumber + ". " + containStr + "Has a lid   : "
					+ E.hasALid() + "\n\r   Has a lock  : " + E.hasALock()
					+ "\n\r   Key name    : " + E.keyName()); // portals use
																// keys as
																// roomids,
																// showing is OK
			return;
		...
		if (!(E instanceof Electronics))
			while ((mob.session() != null) && (!mob.session().isStopped())
				...
				change = mob.session().prompt(
						"Enter a type to add/remove (?)\n\r:", "");
				if (change.length() == 0)
					break;
				int found = -1;
				if (change.equalsIgnoreCase("?"))
					...
					for (int i = 0; i < Container.CONTAIN_DESCS.length; i++)
						if (Container.CONTAIN_DESCS[i].startsWith(change
								.toUpperCase()))
							found = i;
					if (found < 0)
						...
						E.setContainTypes(E.containTypes()
								- CMath.pow(2, found - 1));
					else
						E.setContainTypes(E.containTypes()
								| CMath.pow(2, found - 1));
	...
	protected void genLevel(MOB mob, Physical P, int showNumber, int showFlag)
		...
		P.basePhyStats().setLevel(
				prompt(mob, P.basePhyStats().level(), showNumber, showFlag,
						"Level"));
	}
	...
	protected void genRejuv(MOB mob, Physical P, int showNumber, int showFlag)
		...
		if (P instanceof Item)
			mob.tell(showNumber + ". Rejuv/Pct: '" + P.basePhyStats().rejuv()
					+ "' (0=special).");
		else
			mob.tell(showNumber + ". Rejuv Ticks: '" + P.basePhyStats().rejuv()
					+ "' (0=never).");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
	...
	protected void genUses(MOB mob, Item I, int showNumber, int showFlag)
			throws IOException {
		I.setUsesRemaining(prompt(mob, I.usesRemaining(), showNumber, showFlag,
				"Uses Remaining"));
	}

	protected void genMaxUses(MOB mob, Wand W, int showNumber, int showFlag)
			throws IOException {
		W.setMaxUses(prompt(mob, W.maxUses(), showNumber, showFlag,
				"Maximum Uses"));
	}
	...
	public void genMiscSet(MOB mob, Environmental E) throws IOException {
		try {
			...
			if (E instanceof ShopKeeper)
				...
				modifyGenMap(mob,
						(com.planet_ink.coffee_mud.Items.interfaces.RoomMap) E);
	...
	public void genMiscText(MOB mob, Environmental E, int showNumber,
			int showFlag) throws IOException {
		if (E.isGeneric())
			genMiscSet(mob, E);
		else {
			E.setMiscText(prompt(mob, E.text(), showNumber, showFlag,
					"Misc Text", true, false));
		}
	}

	protected void genTitleRoom(MOB mob, LandTitle L, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
	...
	public void genAbility(MOB mob, Physical P, int showNumber, int showFlag,
			String prompt) throws IOException {
		P.basePhyStats().setAbility(
				prompt(mob, P.basePhyStats().ability(), showNumber, showFlag,
						prompt));
	}
	...
	protected void genCoinStuff(MOB mob, Coins I, int showNumber, int showFlag)
		...
		mob.tell(showNumber
				...
				+ I.getNumberOfCoins()
				+ " x "
				+ CMLib.beanCounter().getDenominationName(I.getCurrency(),
						I.getDenomination()) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (oldCurrency.length() == 0)
				oldCurrency = "Default";
			oldCurrency = mob.session()
					.prompt("Enter currency code (?):", oldCurrency).trim()
					.toUpperCase();
			if (oldCurrency.equalsIgnoreCase("Default")) {
				if (I.getCurrency().length() > 0)
					...
					mob.tell("(no change)");
			} else if ((oldCurrency.length() == 0)
					|| (oldCurrency.equalsIgnoreCase(I.getCurrency())))
				mob.tell("(no change)");
			else if (!CMLib.beanCounter().getAllCurrencies()
					.contains(oldCurrency)) {
				List<String> V = CMLib.beanCounter().getAllCurrencies();
				for (int v = 0; v < V.size(); v++)
					if (V.get(v).length() == 0)
						V.set(v, "Default");
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			String newDenom = mob
					.session()
					.prompt("Enter denomination (?):", "" + I.getDenomination())
					.trim().toUpperCase();
			MoneyLibrary.MoneyDenomination[] DV = CMLib.beanCounter()
					.getCurrencySet(I.getCurrency());
			if ((newDenom.length() > 0) && (!CMath.isDouble(newDenom))
					&& (!newDenom.equalsIgnoreCase("?"))) {
				double denom = CMLib.english().matchAnyDenomination(
						I.getCurrency(), newDenom);
				if (denom > 0.0)
					newDenom = "" + denom;
			}
			if ((newDenom.length() == 0)
					|| (CMath.isDouble(newDenom)
							&& (!newDenom.equalsIgnoreCase("?")) && (CMath
							.s_double(newDenom) == I.getDenomination())))
				mob.tell("(no change)");
			else if ((newDenom.equalsIgnoreCase("?"))
					|| (!CMath.isDouble(newDenom))
					|| ((DV != null) && (CMLib.beanCounter()
							.getDenominationIndex(I.getCurrency(),
									CMath.s_double(newDenom)) < 0))) {
				StringBuffer allDenoms = new StringBuffer("");
				if (DV != null)
					for (int i = 0; i < DV.length; i++)
						allDenoms
								.append(DV[i].value + "(" + DV[i].name + "), ");
				if (allDenoms.toString().endsWith(", "))
					allDenoms = new StringBuffer(allDenoms.substring(0,
							allDenoms.length() - 2));
				mob.tell("'" + newDenom
						+ "' is not a defined denomination. Try one of these: "
						+ allDenoms.toString() + ".");
				gocontinue = true;
			} else
		...
		if ((mob.session() != null) && (!mob.session().isStopped()))
			I.setNumberOfCoins(CMath.s_int(mob.session().prompt(
	...
	protected void genHitPoints(MOB mob, MOB M, int showNumber, int showFlag)
		...
		if (M.isMonster())
			M.basePhyStats()
					.setAbility(
							prompt(mob, M.basePhyStats().ability(), showNumber,
									showFlag, "Hit Points Bonus Modifier",
									"Hit points = (level*level) + (random*level*THIS)"));
		else
			M.basePhyStats().setAbility(
					prompt(mob, M.basePhyStats().ability(), showNumber,
							showFlag, "Ability -- unused"));
	}

	protected void genValue(MOB mob, Item I, int showNumber, int showFlag)
			throws IOException {
		I.setBaseValue(prompt(mob, I.baseGoldValue(), showNumber, showFlag,
				"Base Value"));
	}

	protected void genWeight(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		P.basePhyStats().setWeight(
				prompt(mob, P.basePhyStats().weight(), showNumber, showFlag,
						"Weight"));
	}
	...
	protected void genClanItem(MOB mob, ClanItem I, int showNumber, int showFlag)
		...
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Clan: '" + I.clanID() + "', Type: "
				+ ClanItem.CI_DESC[I.ciType()] + ".");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
	...
	protected void genHeight(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		P.basePhyStats().setHeight(
				prompt(mob, P.basePhyStats().height(), showNumber, showFlag,
						"Height"));
	}

	protected void genSize(MOB mob, Armor A, int showNumber, int showFlag)
			throws IOException {
		A.basePhyStats().setHeight(
				prompt(mob, A.basePhyStats().height(), showNumber, showFlag,
						"Size"));
	}

	public void wornLayer(MOB mob, short[] layerAtt, short[] clothingLayer,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		boolean seeThroughBool = CMath.bset(layerAtt[0],
				Armor.LAYERMASK_SEETHROUGH);
		boolean multiWearBool = CMath.bset(layerAtt[0],
				Armor.LAYERMASK_MULTIWEAR);
		String seeThroughStr = (!seeThroughBool) ? " (opaque)"
				: " (see-through)";
		String multiWearStr = multiWearBool ? " (multi)" : "";
		mob.tell(showNumber + ". Layer: '" + clothingLayer[0] + "'"
				+ seeThroughStr + "" + multiWearStr + ".");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		if ((mob.session() != null) && (!mob.session().isStopped()))
			clothingLayer[0] = CMath.s_short(mob.session().prompt(
					"Enter a new layer\n\r:", "" + clothingLayer[0]));
		boolean newSeeThrough = seeThroughBool;
		if ((mob.session() != null) && (!mob.session().isStopped()))
			newSeeThrough = mob.session().confirm("Is see-through (Y/N)? ",
					"" + seeThroughBool);
		boolean multiWear = multiWearBool;
		if ((mob.session() != null) && (!mob.session().isStopped()))
			multiWear = mob.session().confirm("Is multi-wear (Y/N)? ",
					"" + multiWearBool);
		layerAtt[0] = (short) 0;
		layerAtt[0] = (short) (layerAtt[0] | (newSeeThrough ? Armor.LAYERMASK_SEETHROUGH
				: 0));
		layerAtt[0] = (short) (layerAtt[0] | (multiWear ? Armor.LAYERMASK_MULTIWEAR
				: 0));
	}
	...
	protected void genCapacity(MOB mob, Container E, int showNumber,
			int showFlag) throws IOException {
		E.setCapacity(prompt(mob, E.capacity(), showNumber, showFlag,
				"Capacity"));
	}

	protected void genAttack(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		P.basePhyStats().setAttackAdjustment(
				prompt(mob, P.basePhyStats().attackAdjustment(), showNumber,
						showFlag, "Attack Adjustment"));
	}

	protected void genDamage(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		P.basePhyStats().setDamage(
				prompt(mob, P.basePhyStats().damage(), showNumber, showFlag,
						"Damage"));
	}

	protected void genBanker1(MOB mob, Banker M, int showNumber, int showFlag)
			throws IOException {
		M.setCoinInterest(prompt(mob, M.getCoinInterest(), showNumber,
				showFlag, "Coin Interest [% per real day]"));
	}

	protected void genBanker2(MOB mob, Banker M, int showNumber, int showFlag)
			throws IOException {
		M.setItemInterest(prompt(mob, M.getItemInterest(), showNumber,
				showFlag, "Item Interest [% per real day]"));
	}

	protected void genBanker3(MOB mob, Banker M, int showNumber, int showFlag)
			throws IOException {
		M.setBankChain(prompt(mob, M.bankChain(), showNumber, showFlag,
				"Bank Chain", false, false));
	}

	protected void genBanker4(MOB mob, Banker M, int showNumber, int showFlag)
			throws IOException {
		M.setLoanInterest(prompt(mob, M.getLoanInterest(), showNumber,
				showFlag, "Loan Interest [% per mud month]"));
	}

	protected void genSpeed(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		P.basePhyStats().setSpeed(
				prompt(mob, P.basePhyStats().speed(), showNumber, showFlag,
	...
	protected void genArmor(MOB mob, Physical P, int showNumber, int showFlag)
			throws IOException {
		if (P instanceof MOB)
			P.basePhyStats().setArmor(
					prompt(mob, P.basePhyStats().armor(), showNumber, showFlag,
							"Armor (lower-better)"));
		else
			P.basePhyStats().setArmor(
					prompt(mob, P.basePhyStats().armor(), showNumber, showFlag,
	...
	protected void genMoney(MOB mob, MOB M, int showNumber, int showFlag)
		...
		CMLib.beanCounter().setMoney(M,
				prompt(mob, M.getMoney(), showNumber, showFlag, "Money"));
	}
	...
	protected void genWeaponAmmo(MOB mob, Weapon W, int showNumber, int showFlag)
		...
		if ((showFlag != showNumber) && (showFlag > -999)) {
			mob.tell(showNumber + ". Ammo required: " + AW.requiresAmmunition()
					+ " (" + AW.ammunitionType() + ")");
			return;
		}

		if (mob.session().confirm(
				"Does this weapon require ammunition (default=" + defaultAmmo
						+ ") (Y/N)?", defaultAmmo)) {
			mob.tell("\n\rAmmo type: '" + AW.ammunitionType() + "'.");
			String newName = mob.session().prompt("Enter a new one\n\r:", "");
			if (newName.length() > 0) {
				AW.setAmmunitionType(newName);
				mob.tell("(Remember to create a GenAmmunition item with '"
						+ AW.ammunitionType()
						+ "' in the secret identity, and the uses remaining above 0!");
			} else
				mob.tell("(no change)");
			mob.tell("\n\rAmmo capacity: '" + AW.ammunitionCapacity() + "'.)");
			int newValue = CMath.s_int(mob.session().prompt(
					"Enter a new value\n\r:", ""));
			if (newValue > 0)
	...
	protected void genWeaponRanges(MOB mob, Weapon W, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Minimum/Maximum Ranges: " + W.minRange() + "/"
				+ W.maxRange() + ".");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newMinStr = mob.session().prompt(
				"Enter a new minimum range\n\r:", "");
		String newMaxStr = mob.session().prompt(
				"Enter a new maximum range\n\r:", "");
		if ((newMinStr.length() == 0) && (newMaxStr.length() == 0))
			mob.tell("(no change)");
		else {
			W.setRanges(CMath.s_int(newMinStr), CMath.s_int(newMaxStr));
			if ((W.minRange() > W.maxRange()) || (W.minRange() < 0)
					|| (W.maxRange() < 0)) {
	...
	protected void genWeaponType(MOB mob, Weapon W, int showNumber, int showFlag)
		...
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Weapon Attack Type: '"
				+ Weapon.TYPE_DESCS[W.weaponType()] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean q = false;
		String sel = "NSPBFMR";
	...
	protected void getTheme(MOB mob, Area A, int showNumber, int showFlag)
		...
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Theme setting: '"
				+ Area.THEME_PHRASE[A.getThemeCode()] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean q = false;
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!q)) {
			...
			if (newType.equals("?")) {
				...
				if (CMath.s_int(newType) > 0)
					...
					for (int i = 0; i < Area.THEME_PHRASE.length; i++)
						if (Area.THEME_PHRASE[i].toUpperCase().startsWith(
								newType.toUpperCase()))
							newValue = i;
				if (newValue >= 0)
					A.setTheme(newValue);
	...
	protected void genConsumedMaterials(MOB mob, Electronics.FuelConsumer E,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		boolean q = false;
		...
		while ((S != null) && (!S.isStopped()) && (!q)) {
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newType = mob.session().prompt(
					"Enter a resource to add/remove (?)\n\r:", "");
			if ((newType == null) || (newType.length() == 0))
				...
				if (newValue >= 0) {
					if (CMParms.contains(E.getConsumedFuelTypes(), newValue)) {
						...
						int[] newSet = Arrays.copyOf(E.getConsumedFuelTypes(),
								E.getConsumedFuelTypes().length + 1);
						newSet[newSet.length - 1] = newValue;
						E.setConsumedFuelType(newSet);
					}
				} else
					mob.tell("Unknown resource: '" + newType
							+ "'.  Use ? for a list.");
			}
		}
	}
	...
	protected void genMaterialCode(MOB mob, Item E, int showNumber, int showFlag)
		...
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		E.setMaterial(genAnyMaterialCode(mob, "Material Type", E.material(),
				false, showNumber, showFlag));
	}

	protected int genAnyMaterialCode(MOB mob, String prompt, int currMat,
			boolean inheritOk, int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return currMat;
		String matName = (currMat < 0) ? "Inherited" : RawMaterial.CODES
				.NAME(currMat);
		...
		boolean q = false;
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!q)) {
			matName = (currMat < 0) ? "Inherited" : RawMaterial.CODES
					.NAME(currMat);
			String newType = mob.session().prompt(
	...
	protected void genBreathes(MOB mob, Race me, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!q)) {
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newType = mob.session().prompt(
					"Enter a material to add/remove, or ANYTHING (?)\n\r:", "");
			...
			if (newType.equals("?")) {
				...
				if (newValue >= 0) {
					...
					if (x >= 0) {
						...
						mob.tell("You've removed "
								+ RawMaterial.CODES.NAME(newValue));
					} else {
						StringBuilder str = new StringBuilder(
								CMParms.toStringList(me.getBreathables()));
						if (str.length() > 0)
	...
	protected void genInstrumentType(MOB mob, MusicalInstrument E,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Instrument Type: '"
				+ MusicalInstrument.TYPE_DESC[E.instrumentType()] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean q = false;
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!q)) {
			...
			if (newType.equals("?")) {
				...
				for (int i = 0; i < MusicalInstrument.TYPE_DESC.length - 1; i++)
					if (newType
							.equalsIgnoreCase(MusicalInstrument.TYPE_DESC[i]))
						newValue = i;
				if (newValue >= 0)
	...
	protected void genSpecialFaction(MOB mob, MOB E, int showNumber,
			int showFlag, Faction F) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if (F == null)
			return;
		Faction.FRange myFR = CMLib.factions().getRange(F.factionID(),
				E.fetchFaction(F.factionID()));
		mob.tell(showNumber + ". " + F.name() + ": "
				+ ((myFR != null) ? myFR.name() : "UNDEFINED") + " ("
				+ E.fetchFaction(F.factionID()) + ")");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		for (Enumeration<Faction.FRange> e = F.ranges(); e.hasMoreElements();) {
			Faction.FRange FR = e.nextElement();
			mob.tell(CMStrings.padRight(FR.name(), 20) + ": " + FR.low()
					+ " - " + FR.high() + ")");
		}
		...
		for (Enumeration<Faction.FRange> e = F.ranges(); e.hasMoreElements();) {
			...
			if (FR.name().toUpperCase().startsWith(newOne.toUpperCase())) {
				if (FR.low() == F.minimum())
					...
					E.addFaction(F.factionID(),
							FR.low() + ((FR.high() - FR.low()) / 2));
				return;
			}
		}
		mob.tell("(no change)");
	...
	protected void genFaction(MOB mob, MOB E, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if ((listing.length() > wrap)
					&& ((showFlag != showNumber) && (showFlag > -999)))
				listing = CMStrings.limit(listing, wrap)
						+ ((listing.length() > wrap) ? "..." : "");
			mob.tell(showNumber + ". Factions: " + listing);
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			newFact = mob.session().prompt(
					"Enter a faction name to add or remove\n\r:", "");
			if (newFact.length() > 0) {
				...
				if (lookedUp != null) {
					if (E.fetchFaction(lookedUp.factionID()) != Integer.MAX_VALUE) {
						// this mob already has this faction, they must want it
						// removed
						E.removeFaction(lookedUp.factionID());
						mob.tell("Faction '" + lookedUp.name() + "' removed.");
					} else {
						String howMuch = mob.session().prompt(
								"How much faction (" + lookedUp.findDefault(E)
										+ ")?",
					...
					mob.tell("'"
							+ newFact
							+ "' is not recognized as a valid faction name or file.");
			}
		}
	}
	...
	protected void genGender(MOB mob, MOB E, int showNumber, int showFlag)
		...
		mob.tell(showNumber
				+ ". Gender: '"
				+ Character.toUpperCase((char) E.baseCharStats().getStat(
						CharStats.STAT_GENDER)) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newType = mob.session().choose(
				"Enter a new gender (M/F/N)\n\r:", "MFN", "");
		int newValue = -1;
		if (newType.length() > 0)
	...
	protected void genWeaponClassification(MOB mob, Weapon E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Weapon Classification: '"
				+ Weapon.CLASS_DESCS[E.weaponClassification()] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean q = false;
	...
	protected void genSecretIdentity(MOB mob, Item E, int showNumber,
			int showFlag) throws IOException {
		E.setSecretIdentity(prompt(mob, E.rawSecretIdentity(), showNumber,
				showFlag, "Secret Identity", true, false));
	}

	protected void genNourishment(MOB mob, Food E, int showNumber, int showFlag)
			throws IOException {
		E.setNourishment(prompt(mob, E.nourishment(), showNumber, showFlag,
				"Nourishment/Eat"));
	}

	protected void genBiteSize(MOB mob, Food E, int showNumber, int showFlag)
			throws IOException {
		E.setBite(prompt(mob, E.bite(), showNumber, showFlag,
				"Bite/Eat (0=all)"));
	}
	...
	protected void genRace(MOB mob, MOB M, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
				&& (raceID.length() > 0)) {
			mob.tell(showNumber + ". Race: '"
					+ M.baseCharStats().getMyRace().ID() + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			raceID = mob.session().prompt("Enter a new race (?)\n\r:", "")
					.trim();
			if (raceID.equalsIgnoreCase("?"))
				mob.tell(CMLib.lister().reallyList(mob, CMClass.races(), -1)
						.toString());
	...
	protected void genCharClass(MOB mob, MOB M, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			classID = mob.session()
					.prompt("Enter a class to add/remove(?)\n\r:", "").trim();
			if (classID.equalsIgnoreCase("?"))
				mob.tell(CMLib.lister()
						.reallyList(mob, CMClass.charClasses(), -1).toString());
			else if (classID.length() == 0)
				mob.tell("(no change)");
			else {
				CharClass C = CMClass.getCharClass(classID);
				if ((C != null)
						&& ((C.availabilityCode() > 0) || CMSecurity
								.isASysOp(mob))) {
					if (M.baseCharStats().getClassLevel(C) >= 0) {
						if (M.baseCharStats().numClasses() < 2)
							...
							M.baseCharStats().setMyClasses(
									charClasses.toString());
							M.baseCharStats().setMyLevels(
									classLevels.toString());
						}
					} else {
						...
						if (levels > 0) {
							lvl = mob
									.session()
									.prompt("Levels to give this class ("
											+ levels + ")\n\r:", "" + levels)
									.trim();
							...
							if (lvl2 > highLvl)
								lvl2 = highLvl;
							M.baseCharStats().setClassLevel(highestC,
									highLvl - lvl2);
							M.baseCharStats().setClassLevel(C, lvl2);
						}
					}
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (behaviorstr.length() > 0)
				behaviorstr = behaviorstr
						.substring(0, behaviorstr.length() - 2);
			mob.tell(showNumber + ". Titles: '" + behaviorstr + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			behave = mob.session().prompt(
					"Enter a title to add or a number to remove\n\r:", "");
			if (behave.length() > 0) {
				String tattoo = behave;
				if ((tattoo.length() > 0)
						&& (CMath.isInteger(tattoo))
						&& (CMath.s_int(tattoo) > 0)
						&& (CMath.s_int(tattoo) <= M.playerStats().getTitles()
								.size()))
					tattoo = M.playerStats().getTitles()
							.get(CMath.s_int(tattoo) - 1);
				else if ((tattoo.length() > 0)
						&& (Character.isDigit(tattoo.charAt(0)))
						&& (tattoo.indexOf(' ') > 0)
						&& (CMath.isNumber(tattoo.substring(0,
								tattoo.indexOf(' ')))))
	...
	protected void genSecurity(MOB mob, MOB M, int showNumber, int showFlag)
		...
		if (P == null)
			return;
		String behave = "NO";
		List<String> secFlags = CMParms.parseSemicolons(
				P.getSetSecurityFlags(null), true);
		while ((mob.session() != null) && (!mob.session().isStopped())
				&& (behave.length() > 0)) {
			mob.tell(showNumber + ". Security Groups: '"
					+ CMParms.toStringList(secFlags) + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			...
			if (behave.length() > 0) {
				if (secFlags.contains(behave.trim().toUpperCase())) {
					...
					Object o = CMSecurity.instance().parseSecurityFlag(
							behave.trim().toUpperCase());
					CMSecurity.SecFlag flag = (CMSecurity.SecFlag) CMath
							.s_valueOf(CMSecurity.SecFlag.class, behave);
					boolean isFs = (o instanceof CMSecurity.SecPath);
					boolean isGroup = (o instanceof CMSecurity.SecGroup);
					boolean isFlag = (o instanceof CMSecurity.SecFlag)
							&& (flag != null);
					...
					if ((!isFlag) && (!isGroup) && (!isJournalFlag) && (!isFs)) {
						...
						for (Enumeration<SecGroup> g = CMSecurity
								.getSecurityGroups(); g.hasMoreElements();)
							grpNames.add(g.nextElement().getName()
									.toUpperCase());
						List<String> jFlagNames = new ArrayList<String>();
						for (Enumeration<String> j = CMSecurity
								.getJournalSecurityFlags(); j.hasMoreElements();)
							jFlagNames.add(j.nextElement());
						mob.tell("No such security flag: " + behave + ".");
						mob.tell("Value flags include: "
								+ CMParms.toStringList(CMSecurity.SecFlag
										.values()));
						mob.tell("Valid groups include: "
								+ CMParms.toStringList(grpNames));
						mob.tell("Value journal flags include: "
								+ CMParms.toStringList(jFlagNames));
					} else {
						if (flag != null) {
							if ((flag.getAreaAlias() == flag)
									&& (!CMSecurity
											.isAllowedAnywhere(mob, flag))) {
								mob.tell("You do not have clearance to add security code '"
										+ behave + "' to this class.");
								continue;
							} else if ((flag.getRegularAlias() == flag)
									&& (!CMSecurity.isAllowedEverywhere(mob,
											flag))) {
								mob.tell("You do not have clearance to add security code '"
										+ behave + "' to this class.");
								continue;
							...
							mob.tell("You do not have clearance to add security group '"
									+ behave + "' to this class.");
							continue;
						}
	...
	public void genBehaviors(MOB mob, final PhysicalAgent P, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		String behave = "NO";
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			behave = mob.session().prompt(
					"Enter a behavior to add/remove (?)\n\r:", "");
			if (behave.length() > 0) {
				if (behave.equalsIgnoreCase("?")) {
					...
					mob.tell(CMLib
							.lister()
							.reallyList(mob, CMClass.behaviors(), null,
									stringer).toString());
				} else {
					Behavior chosenOne = null;
					for (Enumeration<Behavior> e = P.behaviors(); e
							.hasMoreElements();) {
						Behavior B = e.nextElement();
					...
					if (chosenOne != null) {
						...
						if (chosenOne != null) {
							...
							while (parms.equals("?")) {
								...
								parms = mob.session().prompt(
										"Enter any behavior parameters (?)\n\r:"
												+ parms);
								if (parms.equals("?")) {
									StringBuilder s2 = CMLib.help()
											.getHelpText(chosenOne.ID(), mob,
													true);
									if (s2 != null)
	...
	public void genAffects(MOB mob, final Physical P, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		String behave = "NO";
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (behave.length() > 0) {
				if (behave.equalsIgnoreCase("?")) {
					...
					mob.tell(CMLib
							.lister()
							.reallyList(mob, CMClass.abilities(), null,
									stringer).toString());
				} else {
	...
	protected void genRideable1(MOB mob, Rideable R, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Rideable Type: '"
				+ Rideable.RIDEABLE_DESCS[R.rideBasis()] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean q = false;
		...
		while (!q) {
			...
			if (newType.equals("?")) {
				for (int i = 0; i < sel.length(); i++)
					mob.tell(sel.charAt(i) + ") "
							+ Rideable.RIDEABLE_DESCS[i].toLowerCase());
				q = false;
			} else {
				q = true;
				int newValue = -1;
	...
	protected void genRideable2(MOB mob, Rideable E, int showNumber,
			int showFlag) throws IOException {
		E.setRiderCapacity(prompt(mob, E.riderCapacity(), showNumber, showFlag,
				"Number of MOBs held"));
	}

	protected void genShopkeeper1(MOB mob, ShopKeeper M, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		long oldMask = M.getWhatIsSoldMask();
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			mob.tell(showNumber + ". Shopkeeper type: '"
					+ M.storeKeeperString() + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			...
			String newType = mob.session().choose(
					buf.toString() + "Enter a value to toggle on/off: ",
					codes.toString(), "");
			int newValue = -1;
			if (newType.trim().length() == 0) {
			...
			if (newValue <= 0)
				...
				for (Iterator<Environmental> i = M.getShop()
						.getStoreInventory(); i.hasNext();) {
	...
	protected void genShopkeeper2(MOB mob, ShopKeeper M, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		String itemstr = "NO";
		while (itemstr.length() > 0) {
			String inventorystr = "";
			for (Iterator<Environmental> i = M.getShop().getStoreInventory(); i
					.hasNext();) {
				Environmental E2 = i.next();
				if (E2.isGeneric())
					inventorystr += E2.name() + " ("
							+ M.getShop().numberInStock(E2) + "), ";
				else
					inventorystr += CMClass.classID(E2) + " ("
							+ M.getShop().numberInStock(E2) + "), ";
			}
			if (inventorystr.length() > 0)
				inventorystr = inventorystr.substring(0,
						inventorystr.length() - 2);
			mob.tell(showNumber + ". Inventory: '" + inventorystr + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			itemstr = mob.session().prompt(
					"Enter something to add/remove (?)\n\r:", "");
			if (itemstr.length() > 0) {
				if (itemstr.equalsIgnoreCase("?")) {
					mob.tell(CMLib.lister()
							...
							.toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.armor(), -1).toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.weapons(), -1).toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.miscMagic(), -1)
							.toString());
					mob.tell(CMLib.lister().reallyList(mob, CMClass.tech(), -1)
							.toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.clanItems(), -1)
							.toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.basicItems(), -1)
							.toString());
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.mobTypes(), -1).toString());
					...
					if (item != null) {
						...
						M.getShop().delAllStoreInventory(
								(Environmental) item.copyOf());
					} else {
						...
						if ((item != null)
								&& ((!(item instanceof ArchonOnly)) || (CMSecurity
										.isASysOp(mob)))) {
							...
							if ((item instanceof Ability)
									&& ((M.isSold(ShopKeeper.DEAL_TRAINER)) || (M
											.isSold(ShopKeeper.DEAL_CASTER))))
								ok = true;
							else if (M.isSold(ShopKeeper.DEAL_INVENTORYONLY))
								ok = true;
							if ((ok)
									|| ((mob.session() != null) && mob
											.session()
											.confirm(
													"This shopkeeper type does not sell that. Are you sure (y/N)?",
													"N"))) {
								boolean alreadyHasIt = false;

								if (M.getShop().doIHaveThisInStock(item.Name(),
										null))
									alreadyHasIt = true;
								...
								if (!alreadyHasIt) {
									...
									int num = 1;
									if (!(item instanceof Ability))
										num = CMath.s_int(mob.session().prompt(
												"How many? :", ""));
									int price = CMath.s_int(mob.session()
											.prompt("At what price? :", ""));
									M.getShop().addStoreInventory(item, num,
											price);
								}
							}
						} else {
	...
	protected void genEconomics1(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		E.setPrejudiceFactors(prompt(mob, E.prejudiceFactors(), showNumber,
				showFlag, "Prejudice", true, false));
	}

	protected void genEconomics2(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (int p = 0; p < prics.length; p++)
				mob.tell(CMStrings.SPACES.substring(0, header.length() - 3)
						+ (p + 1) + ") " + prics[p] + "\n\r");
			String newValue = mob.session().prompt(
					"Enter # to remove, or A to add:\n\r:", "");
			if (CMath.isInteger(newValue)) {
				...
				double dbl = CMath.s_double(mob.session().prompt(
						"Enter a price multiplier between 0.0 and X.Y\n\r: "));
				String mask = "?";
				while (mask.equals("?")) {
					mask = mob
							.session()
							.prompt("Now enter a mask that describes the item (? for syntax)\n\r: ");
					if (mask.equals("?"))
	...
	protected void genAreaBlurbs(MOB mob, Area A, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			String newValue = mob.session().prompt(
					"Enter flag to remove, or A to add:\n\r:", "");
			if (A.getBlurbFlag(newValue.toUpperCase().trim()) != null) {
				...
				if (flag.trim().length() == 0)
					continue;
				String desc = mob.session().prompt(
						"Enter a flag blurb (or nothing): ");
	...
	protected void genEconomics3(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		E.setBudget(prompt(mob, E.budget(), showNumber, showFlag, "Budget",
				true, false));
	}

	protected void genEconomics4(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		E.setDevalueRate(prompt(mob, E.devalueRate(), showNumber, showFlag,
				"Devaluation rate(s)", true, false));
	}

	protected void genEconomics5(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		E.setInvResetRate(prompt(mob, E.invResetRate(), showNumber, showFlag,
				"Inventory reset rate [ticks]"));
	}

	protected void genEconomics6(MOB mob, Economics E, int showNumber,
			int showFlag) throws IOException {
		E.setIgnoreMask(prompt(mob, E.ignoreMask(), showNumber, showFlag,
				"Ignore Mask", true, false));
	}
	...
	protected void genAbilities(MOB mob, MOB M, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (abilitiestr.length() > 0)
				abilitiestr = abilitiestr
						.substring(0, abilitiestr.length() - 2);
			if ((abilitiestr.length() > 50)
					&& ((showFlag != showNumber) && (showFlag > -999)))
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			behave = mob.session().prompt(
					"Enter an ability to add/remove (?)\n\r:", "");
			if (behave.length() > 0) {
				if (behave.equalsIgnoreCase("?"))
					mob.tell(CMLib.lister()
							.reallyList(mob, CMClass.abilities(), -1)
					...
					if (chosenOne != null) {
						...
						if ((chosenOne != null)
							...
							chosenOne = null;
						if (chosenOne != null) {
							boolean alreadyHasIt = (M.fetchAbility(chosenOne
									.ID()) != null);
							if (!alreadyHasIt)
								mob.tell(chosenOne.ID() + " added.");
							else
	...
	public void spells(MOB mob, List<Ability> V, int showNumber, int showFlag,
			boolean inParms) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		String behave = "NO";
		while ((mob.session() != null) && (!mob.session().isStopped())
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (Clan.MemberRecord member : members)
				memberStr += member.name + " ("
						+ E.getRoleName(member.role, true, false) + "), ";
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			behave = mob.session()
					.prompt("Enter a name to add/remove\n\r:", "");
			if (behave.length() > 0) {
				int chosenOne = -1;
				...
				if (chosenOne >= 0) {
					...
					if (M != null) {
						...
						for (int m = 0; m < membersCopy.size(); m++)
							if (behave
									.equalsIgnoreCase(membersCopy.get(m).name)) {
								oldNum = members.size();
						...
						if (index < 0) {
							index = members.size();
							members.add(new MemberRecord(M.name(), E
						...
						while ((mob.session() != null)
								&& (!mob.session().isStopped())
								&& (newRole < 0)) {
							String newRoleStr = mob.session().prompt(
									"Enter this members role (?) '"
											+ E.getRoleName(
													members.get(index).role,
													true, false) + "': ", "");
							newRole = E.getRoleFromName(newRoleStr);
							if (newRole < 0)
								mob.tell("That role is invalid.  Valid roles include: "
										+ CMParms.toStringList(E.getRolesList()));
							else
								break;
						}
						if (oldNum < 0)
						...
						mob.tell("'" + behave
								+ "' is an unrecognized player name.");
					}
				}
				...
				for (int m = 0; m < members.size(); m++) {
					...
					if (found) {
						MOB M = CMLib.players().getLoadPlayer(newName);
						Pair<Clan, Integer> oldClanRole = M.getClanRole(E
								.clanID());
						int newRole = members.get(m).role;
						if ((oldClanRole != null)
								&& (newRole != oldClanRole.second.intValue())) {
							CMLib.database().DBUpdateClanMembership(M.Name(),
									E.clanID(), newRole);
	...
	protected void genDeity1(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setClericRequirements(prompt(mob, E.getClericRequirements(),
				showNumber, showFlag, "Cleric Requirements", false, false));
	}

	protected void genDeity2(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setClericRitual(prompt(mob, E.getClericRitual(), showNumber,
				showFlag, "Cleric Ritual", false, false));
	}

	protected void genDeity3(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setWorshipRequirements(prompt(mob, E.getWorshipRequirements(),
				showNumber, showFlag, "Worshiper Requirements", false, false));
	}

	protected void genDeity4(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setWorshipRitual(prompt(mob, E.getWorshipRitual(), showNumber,
				showFlag, "Worshiper Ritual", false, false));
	}
					...
					if (chosenOne != null) {
						...
						if (chosenOne != null) {
							...
							for (int a = 0; a < E.numBlessings(); a++) {
								Ability A = E.fetchBlessing(a);
								if ((A != null)
										&& (A.ID().equals(chosenOne.ID())))
									alreadyHasIt = true;
							}
							boolean clericOnly = mob.session().confirm(
									"Is this for clerics only (y/N)?", "N");
							if (!alreadyHasIt)
								mob.tell(chosenOne.ID() + " added.");
							else
								mob.tell(chosenOne.ID() + " re-added.");
	...
	protected void genDeity8(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setClericSin(prompt(mob, E.getClericSin(), showNumber, showFlag,
				"Cleric Sin", false, false));
	}

	protected void genDeity9(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setWorshipSin(prompt(mob, E.getWorshipSin(), showNumber, showFlag,
				"Worshiper Sin", false, false));
	}

	protected void genDeity0(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setClericPowerup(prompt(mob, E.getClericPowerup(), showNumber,
				showFlag, "Cleric Power Ritual", false, false));
	}

	protected void genDeity11(MOB mob, Deity E, int showNumber, int showFlag)
			throws IOException {
		E.setServiceRitual(prompt(mob, E.getServiceRitual(), showNumber,
				showFlag, "Service Ritual", false, false));
	}

	protected void genGridLocaleX(MOB mob, GridZones E, int showNumber,
			int showFlag) throws IOException {
		E.setXGridSize(prompt(mob, E.xGridSize(), showNumber, showFlag,
				"Size (X)"));
	}

	protected void genGridLocaleY(MOB mob, GridZones E, int showNumber,
			int showFlag) throws IOException {
		E.setYGridSize(prompt(mob, E.yGridSize(), showNumber, showFlag,
				"Size (Y)"));
	}

	protected void genLocationCoords(MOB mob, LocationRoom E, int showNumber,
			int showFlag) throws IOException {
		double[] newDir = new double[2];
		newDir[0] = Math.toRadians(prompt(mob,
				Math.toDegrees(E.getDirectionFromCore()[0]), showNumber,
				showFlag, "Horiz. Dir From Core",
				"This is a horizontal direction in degrees from 0 to 360.", 0,
				360));
		newDir[1] = Math.toRadians(prompt(mob,
				Math.toDegrees(E.getDirectionFromCore()[1]), showNumber,
				showFlag, "Vert. Dir From Core",
				"This is a vertical direction in degrees from 0 to 360.", 0,
				360));
		E.setDirectionFromCore(newDir);
	}

	public void wornLocation(MOB mob, long[] oldWornLocation,
			boolean[] logicalAnd, int showNumber, int showFlag)
			throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if ((showFlag != showNumber) && (showFlag > -999)) {
			...
			for (int l = 0; l < codes.total(); l++) {
				...
				if (codes.name(wornCode).length() > 0) {
					String header = (l + 2)
							...
							+ codes.name(wornCode)
							+ ") : "
							+ (((oldWornLocation[0] & wornCode) == wornCode) ? "YES"
									: "NO");
					mob.tell(header);
				}
			}
			codeVal = CMath.s_int(mob.session().prompt(
					"Select an option number above to TOGGLE\n\r: "));
			if (codeVal > 0) {
				if (codeVal == 1)
	...
	protected void genThirstQuenched(MOB mob, Drink E, int showNumber,
			int showFlag) throws IOException {
		E.setThirstQuenched(prompt(mob, E.thirstQuenched(), showNumber,
				showFlag, "Quenched/Drink"));
	}

	protected void genDrinkHeld(MOB mob, Drink E, int showNumber, int showFlag)
			throws IOException {
		E.setLiquidHeld(prompt(mob, E.liquidHeld(), showNumber, showFlag,
				"Amount of Drink Held"));
		E.setLiquidRemaining(E.liquidHeld());
	}

	protected void genAttackAttribute(MOB mob, CharClass E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". " + FieldDisp + ": '"
				+ CharStats.CODES.DESC(CMath.s_int(E.getStat(Field))) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = mob.session().prompt("Enter a new one\n\r:", "");
		String newStat = "";
	...
	protected void genArmorCode(MOB mob, CharClass E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". " + FieldDisp + ": '"
				+ CharClass.ARMOR_LONGDESC[CMath.s_int(E.getStat(Field))]
				+ "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = mob.session().prompt(
				"Enter (" + CMParms.toStringList(CharClass.ARMOR_DESCS)
						+ ")\n\r:", "");
		String newStat = "";
	...
	protected void genQualifications(MOB mob, CharClass E, int showNumber,
			int showFlag, String FieldDisp, String Field) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". " + FieldDisp + ": '"
				+ CMLib.masking().maskDesc(E.getStat(Field)) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = "?";
		while ((mob.session() != null) && (!mob.session().isStopped())
	...
	protected void genClanAccept(MOB mob, Clan E, int showNumber, int showFlag)
			throws IOException {
		E.setAcceptanceSettings(prompt(mob, E.getAcceptanceSettings(),
				showNumber, showFlag, "Clan Qualifications", false, false,
				CMLib.masking().maskHelp("\n", "disallow")));
	}

	protected void genWeaponRestr(MOB mob, CharClass E, int showNumber,
			int showFlag, String FieldDisp, String FieldNum, String Field)
			throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		for (int v = 0; v < set.size(); v++)
			str.append(" "
					+ Weapon.CLASS_DESCS[CMath.s_int(set.get(v))].toLowerCase());
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
				&& (newName.equals("?"))) {
			newName = mob.session().prompt(
					"Enter a weapon class to add/remove (?)\n\r:", "");
			if (newName.equals("?"))
	...
	protected void genWeaponMaterials(MOB mob, CharClass E, int showNumber,
			int showFlag, String FieldDisp, String FieldNum, String Field)
			throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		for (int v = 0; v < set.size(); v++)
			str.append(" "
					+ CMLib.materials()
							.getMaterialDesc(CMath.s_int(set.get(v))));
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			newName = mob
					.session()
					.prompt("Enter a material type to add/remove to requirements (?)\n\r:",
							"");
			if (newName.equals("?"))
				mob.tell(CMParms.toStringList(RawMaterial.Material.values()));
			else if (newName.length() > 0) {
				int foundCode = CMLib.materials()
						.getMaterialCode(newName, true);
				if (foundCode < 0)
					foundCode = CMLib.materials().getMaterialCode(newName,
							false);
				if (foundCode < 0) {
					mob.tell("'" + newName + "' is not recognized.  Try '?'.");
					newName = "?";
	...
	protected void genRaceWearFlags(MOB mob, Race E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			newName = mob.session()
					.prompt("Enter a location to toggle (?)\n\r:", "")
					.toUpperCase();
			if (newName.length() == 0)
				mob.tell("(no change)");
	...
	protected void genRaceAvailability(MOB mob, Race E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Availability: '"
				+ Area.THEME_PHRASE_EXT[CMath.s_int(E.getStat("AVAIL"))] + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = "?";
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (newName.length() == 0)
				mob.tell("(no change)");
					...
					&& (CMath.s_int(newName) < Area.THEME_PHRASE_EXT.length))
	...
	protected void genClassAvailability(MOB mob, CharClass E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Availability: '"
				+ Area.THEME_PHRASE_EXT[CMath.s_int(E.getStat("PLAYER"))]
				+ "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = "?";
	...
	protected void genCat(MOB mob, Race E, int showNumber, int showFlag)
		...
		if (newName.length() > 0) {
			...
			if (!found) {
				StringBuffer str = new StringBuffer(
						"That category does not exist.  Valid categories include: ");
	...
	protected void genRaceBuddy(MOB mob, Race E, int showNumber, int showFlag,
			String prompt, String flag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		if (newName.length() > 0) {
			...
			if (R2 == null)
				R2 = (Race) CMClass.getLoadNewClassInstance(CMObjectType.RACE,
						newName, true);
			if ((R2 != null) && (R2.isGeneric()))
				R2 = null;
			if (R2 == null) {
				StringBuffer str = new StringBuffer(
						"That race name is invalid or is generic.  Valid races include: ");
				for (Enumeration<Race> r = CMClass.races(); r.hasMoreElements();) {
					Race R = r.nextElement();
					if (!R.isGeneric())
						str.append(R.ID() + ", ");
	...
	protected void genClassBuddy(MOB mob, CharClass E, int showNumber,
			int showFlag, String prompt, String flag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". " + prompt + ": '" + E.getStat(flag) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
		...
		if (newName.length() > 0) {
			...
			if (C2 == null)
				C2 = (CharClass) CMClass.getLoadNewClassInstance(
						CMObjectType.CHARCLASS, newName, true);
			if ((C2 != null) && (C2.isGeneric()))
				C2 = null;
			if (C2 == null) {
				StringBuffer str = new StringBuffer(
						"That char class name is invalid or is generic.  Valid char classes include: ");
	...
	protected void genClassRaceQuals(MOB mob, CharClass E, int showNumber,
			int showFlag, String prompt, String flag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		boolean cont = true;
		final List<String> newRaces = new XVector<String>(CMParms.parseCommas(
				E.getStat(flag), true));
		while ((!mob.session().isStopped()) && (cont)) {
			mob.tell(showNumber + ". " + prompt + ": '"
					+ CMParms.toStringList(newRaces) + "'.");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newName = mob.session().prompt(
					"Enter a race to add or remove\n\r:", "");
			if (newName.length() > 0) {
				...
				if (x >= 0) {
					...
					if (found)
						...
						if (R != null) {
							...
							for (Enumeration<Race> r = CMClass.races(); r
									.hasMoreElements();) {
								R = r.nextElement();
								if (R.racialCategory()
	...
	protected void genBodyParts(MOB mob, Race E, int showNumber, int showFlag)
		...
		for (int i = 0; i < Race.BODYPARTSTR.length; i++)
			if (E.bodyMask()[i] != 0)
				parts.append(Race.BODYPARTSTR[i].toLowerCase() + "("
						+ E.bodyMask()[i] + ") ");
		...
		if (newName.length() > 0) {
			...
			if (partNum < 0) {
				StringBuffer str = new StringBuffer(
						"That body part is invalid.  Valid parts include: ");
				for (int i = 0; i < Race.BODYPARTSTR.length; i++)
					str.append(Race.BODYPARTSTR[i] + ", ");
				mob.tell(str.toString().substring(0, str.length() - 2) + ".");
			} else {
				newName = mob.session().prompt(
						"Enter new number (" + E.bodyMask()[partNum]
	...
	protected void genPStats(MOB mob, Race R, int showNumber, int showFlag)
		...
		for (int i = 0; i < S.getStatCodes().length; i++)
			if (CMath.s_int(S.getStat(S.getStatCodes()[i])) != 0)
				parts.append(CMStrings.capitalizeAndLower(S.getStatCodes()[i])
						+ "(" + S.getStat(S.getStatCodes()[i]) + ") ");
		mob.tell(showNumber + ". PhysStat Adjustments: " + parts.toString()
				+ ".");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		boolean done = false;
		while ((!done) && (mob.session() != null)
				&& (!mob.session().isStopped())) {
			...
			if (newName.length() > 0) {
				...
				if (partName == null) {
					StringBuffer str = new StringBuffer(
							"That stat is invalid.  Valid stats include: ");
					for (int i = 0; i < S.getStatCodes().length; i++)
					...
					if (checkChange) {
						...
						if (zereoed)
							...
							R.setStat("ESTATS", CMLib.coffeeMaker()
									.getPhyStatsStr(S));
					}
				}
			} else {
	...
	protected void genAState(MOB mob, Race R, String field, String prompt,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		CharState S = (CharState) CMClass.getCommon("DefaultCharState");
		S.setAllValues(0);
				...
				if (partName == null) {
					...
					if (newName.length() > 0) {
						...
						if (zereoed)
							...
							R.setStat(field, CMLib.coffeeMaker()
									.getCharStateStr(S));
					} else
						mob.tell("(no change)");
				}
	...
	protected void genAStats(MOB mob, Race R, String Field, String FieldName,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		CharStats S = (CharStats) CMClass.getCommon("DefaultCharStats");
		S.setAllValues(0);
		CMLib.coffeeMaker().setCharStats(S, R.getStat(Field));
		StringBuffer parts = new StringBuffer("");
		for (int i : CharStats.CODES.ALL())
			if (S.getStat(i) != 0)
				parts.append(CMStrings.capitalizeAndLower(CharStats.CODES
						.DESC(i)) + "(" + S.getStat(i) + ") ");
	...
	protected void genPStats(MOB mob, CharClass R, int showNumber,
			int showFlag, boolean skipRejuv) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		PhyStats S = (PhyStats) CMClass.getCommon("DefaultPhyStats");
		S.setAllValues(0);
	...
	protected void genAState(MOB mob, CharClass R, String field, String prompt,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		CharState S = (CharState) CMClass.getCommon("DefaultCharState");
	...
	protected void genAStats(MOB mob, CharClass R, String Field,
			String FieldName, int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		CharStats S = (CharStats) CMClass.getCommon("DefaultCharStats");
		S.setAllValues(0);
	...
	protected void genResources(MOB mob, Race E, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
				...
				if (I != null) {
					...
					for (int v = 0; v < DV.size(); v++)
						if (I.sameAs((Environmental) DV.elementAt(v, 1))) {
							DV.setElementAt(v, 2, Integer.valueOf(((Integer) DV
									.elementAt(v, 2)).intValue() + 1));
							done = true;
							break;
						}
					if (!done)
			...
			String newName = mob
					.session()
					.prompt("Enter a resource name to remove or\n\rthe word new and an item name to add from your inventory\n\r:",
							"");
			if (newName.length() > 0) {
				int partNum = -1;
				for (int i = 0; i < DV.size(); i++)
					if (CMLib.english().containsString(
							((Item) DV.elementAt(i, 1)).name(), newName)) {
						partNum = i;
						break;
					}
				...
				if (partNum < 0) {
					if (!newName.toLowerCase().startsWith("new "))
						...
						Item I = mob.fetchItem(null,
								Wearable.FILTER_UNWORNONLY, newName
										.substring(4).trim());
						if (I != null) {
							I = (Item) I.copyOf();
							boolean done = false;
							for (int v = 0; v < DV.size(); v++)
								if (I.sameAs((Environmental) DV.elementAt(v, 1))) {
									DV.setElementAt(v, 2, Integer
											.valueOf(((Integer) DV.elementAt(v,
													2)).intValue() + 1));
									done = true;
									break;
								}
	...
	protected void genOutfit(MOB mob, Race E, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			String newName = mob
					.session()
					.prompt("Enter an item name to remove or\n\rthe word new and an item name to add from your inventory\n\r:",
							"");
			if (newName.length() > 0) {
				int partNum = -1;
				for (int i = 0; i < V.size(); i++)
					if (CMLib.english().containsString(V.elementAt(i).name(),
							newName)) {
						partNum = i;
						break;
					}
	...
	protected void genMinimumStatQualifications(MOB mob, CharClass E,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (int v = 0; v < numResources; v++) {
				Pair<String, Integer> p = new Pair<String, Integer>(
						E.getStat("GETMINSTAT" + v), Integer.valueOf(CMath
								.s_int(E.getStat("GETSTATMIN" + v))));
				V.add(p);
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newName = mob.session().prompt(
					"Enter a stat name to remove or add:", "");
			if (newName.length() > 0) {
				int statNum = -1;
				...
				boolean updateList = false;
				if (statNum < 0)
					mob.tell("That is not a stat, like one of these: "
							+ CMParms.toStringList(CharStats.CODES.BASENAMES()));
				else {
					int vNum = -1;
					for (int v = 0; v < V.size(); v++)
						if (newName.equalsIgnoreCase(V.get(v).first))
							vNum = v;
					if (vNum < 0) {
						String newMin = mob.session().prompt(
								"Enter a minimum stat value:", "");
						if ((newMin.length() > 0) && (CMath.isInteger(newMin))) {
							V.add(new Pair<String, Integer>(newName, Integer
									.valueOf(CMath.s_int(newMin))));
							mob.tell(newName + " added.");
							updateList = true;
						}
					} else {
	...
	protected void genWeapon(MOB mob, Race E, int showNumber, int showFlag)
		...
		String newName = mob
				.session()
				.prompt("Enter a weapon name from your inventory to change, or 'null' for human\n\r:",
						"");
		if (newName.equalsIgnoreCase("null")) {
	...
	protected void genAgingChart(MOB mob, Race E, int showNumber, int showFlag)
		...
		mob.tell(showNumber + ". Aging Chart: "
				+ CMParms.toStringList(E.getAgingChart()) + ".");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())
				&& (true)) {
			String newName = mob
					.session()
					.prompt("Enter a comma-delimited list of 9 numbers, running from infant -> ancient\n\r:",
							"");
			if (newName.length() == 0) {
				mob.tell("(no change)");
				return;
	...
	protected void genClassFlags(MOB mob, CharClass E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		String newName = mob.session().prompt(
				"Enter: 1) Classless, 2) Leveless, 3) Expless\n\r:", "");
	...
	protected void genDynamicAbilities(MOB mob, Modifiable E, String typeName,
			String levelName, int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())
				&& (true)) {
			...
			for (int v = 0; v < numResources; v++) {
				...
				if (A != null) {
					parts.append("(" + A.ID() + "/"
							+ E.getStat("GETRABLELVL" + v) + "/"
							+ E.getStat("GETRABLEQUAL" + v) + "/"
							+ E.getStat("GETRABLEPROF" + v) + "), ");
					ables.addElement(A);
					data.addElement(A.ID() + ";" + E.getStat("GETRABLELVL" + v)
							+ ";" + E.getStat("GETRABLEQUAL" + v) + ";"
							+ E.getStat("GETRABLEPROF" + v));
				}
			}
			...
			mob.tell(showNumber + ". " + typeName + " Abilities: "
					+ parts.toString() + ".");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newName = mob.session().prompt(
					"Enter an ability name to add or remove (?)\n\r:", "");
			if (newName.equalsIgnoreCase("?"))
				mob.tell(CMLib.lister()
						.reallyList(mob, CMClass.abilities(), -1).toString());
			else if (newName.length() > 0) {
				int partNum = -1;
				for (int i = 0; i < ables.size(); i++)
					if (CMLib.english().containsString(ables.elementAt(i).ID(),
							newName)) {
						partNum = i;
						break;
					}
				...
				if (partNum < 0) {
					...
					if (A == null)
						...
						mob.tell("'" + A.name()
								+ "' cannot be named, as it is autoinvoked.");
					else if ((A.triggerStrings() == null)
							|| (A.triggerStrings().length == 0))
						mob.tell("'"
								+ A.name()
								+ "' cannot be named, as it has no trigger/command words.");
					else {
						StringBuffer str = new StringBuffer(A.ID() + ";");
						String level = mob.session().prompt(
								"Enter the level of this skill (1): ", "1");
						str.append(("" + CMath.s_int(level)) + ";");
						if (mob.session().confirm(
								"Is this skill automatically gained (Y/n)?",
								"Y"))
							str.append("false;");
						else
							str.append("true;");
						String prof = mob.session().prompt(
								"Enter the (perm) proficiency level (100): ",
								"100");
				...
				if (updateList) {
					...
					for (int i = 0; i < data.size(); i++) {
						List<String> V = CMParms.parseSemicolons(
								data.elementAt(i), false);
	...
	protected void genDynamicEffects(MOB mob, Modifiable E, String typeName,
			String levelName, int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (int v = 0; v < numResources; v++) {
				...
				if (A != null) {
					parts.append("(" + A.ID() + "/"
							+ E.getStat("GETREFFLVL" + v) + "/"
							+ E.getStat("GETREFFPARM" + v) + "), ");
					ables.addElement(A);
					data.addElement(A.ID() + "~" + E.getStat("GETREFFLVL" + v)
							+ "~" + E.getStat("GETREFFPARM" + v));
				}
			}
			if (parts.toString().endsWith(", ")) {
			...
			mob.tell(showNumber + ". " + typeName + " Effects: "
					+ parts.toString() + ".");
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			String newName = mob.session().prompt(
					"Enter an effect name to add or remove\n\r:", "");
			if (newName.equalsIgnoreCase("?"))
				mob.tell(CMLib.lister()
						.reallyList(mob, CMClass.abilities(), -1).toString());
			else if (newName.length() > 0) {
				...
				if (updateList) {
					if (data.size() > 0)
						...
						E.setStat("NUMREFF", "");
					for (int i = 0; i < data.size(); i++) {
						List<String> V = CMParms.parseSquiggleDelimited(
								data.elementAt(i), false);
	...
	protected DVector genClassAbleMod(MOB mob, DVector sets, String ableID,
			int origLevelIndex, int origAbleIndex) throws IOException {
		Integer level = null;
		if (origLevelIndex >= 0) {
			if (mob.session().confirm(
					"Enter Y to DELETE, or N to modify (y/N)?", "N")) {
				List<AbilityMapper.AbilityMapping> set = (List<AbilityMapper.AbilityMapping>) sets
						.elementAt(origLevelIndex, 2);
		...
		level = Integer
				.valueOf(CMath.s_int(mob.session().prompt(
						"Enter the level of this skill (" + level + "): ",
						"" + level)));
		if (level.intValue() <= 0) {
			mob.tell("Aborted.");
			return null;
		...
		if (origLevelIndex < 0) {
			...
			List<AbilityMapper.AbilityMapping> levelSet = (List<AbilityMapper.AbilityMapping>) sets
					.elementAt(origLevelIndex, 2);
		...
		if (newlevelIndex < 0) {
			...
			levelSet = (List<AbilityMapper.AbilityMapping>) sets.elementAt(
					newlevelIndex, 2);
		aMAP.defaultProficiency = CMath.s_int(mob.session().prompt(
				"Enter the (default) proficiency level ("
						+ aMAP.defaultProficiency + "): ",
				aMAP.defaultProficiency + ""));
		aMAP.maxProficiency = CMath.s_int(mob.session().prompt(
				"Enter the (maximum) proficiency level (" + aMAP.maxProficiency
						+ "): ", aMAP.maxProficiency + ""));
		aMAP.autoGain = mob.session().confirm(
				"Is this skill automatically gained"
						+ (aMAP.autoGain ? "(Y/n)" : "(y/N)") + "?",
				"" + aMAP.autoGain);
		aMAP.isSecret = mob.session().confirm(
				"Is this skill secret " + (aMAP.isSecret ? "(Y/n)" : "(y/N)")
						+ "?", "" + aMAP.isSecret);
		aMAP.defaultParm = mob.session().prompt(
				"Enter any properties (" + aMAP.defaultParm + ")\n\r: ",
				aMAP.defaultParm);
		String s = "?";
		while (s.equalsIgnoreCase("?")) {
			s = mob.session().prompt(
					"Enter any pre-requisites (" + aMAP.originalSkillPreReqList
							+ ")\n\r(?) : ", aMAP.originalSkillPreReqList);
			if (s.equalsIgnoreCase("?"))
				mob.tell(""
						+ CMLib.help()
								.getHelpText("ABILITY_PREREQS", mob, true));
			else
		...
		while (s.equalsIgnoreCase("?")) {
			s = mob.session().prompt(
					"Enter any requirement mask (" + aMAP.extraMask
							+ ")\n\r(?) : ", aMAP.extraMask);
			if (s.equalsIgnoreCase("?"))
	...
	@SuppressWarnings("unchecked")
	protected void genClassAbilities(MOB mob, CharClass E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		if ((showFlag != showNumber) && (showFlag > -999)) {
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			for (int v = 0; v < numAbles; v++) {
				...
				if (A != null) {
					...
					aMAP.defaultProficiency = CMath.s_int(E
							.getStat("GETCABLEPROF" + v));
					aMAP.qualLevel = CMath.s_int(E.getStat("GETCABLELVL" + v));
					aMAP.isSecret = CMath.s_bool(E.getStat("GETCABLESECR" + v));
					aMAP.maxProficiency = CMath.s_int(E.getStat("GETCABLEMAXP"
							+ v));
					aMAP.defaultParm = E.getStat("GETCABLEPARM" + v);
					aMAP.originalSkillPreReqList = E
							.getStat("GETCABLEPREQ" + v);
					aMAP.extraMask = E.getStat("GETCABLEMASK" + v);
					int lvlIndex = levelSets.indexOf(Integer
							.valueOf(aMAP.qualLevel));
					Vector<AbilityMapper.AbilityMapping> set = null;
					if (lvlIndex < 0) {
						set = new Vector<AbilityMapper.AbilityMapping>();
						levelSets.addElement(Integer.valueOf(aMAP.qualLevel),
								set);
						if (aMAP.qualLevel > maxAbledLevel)
							maxAbledLevel = aMAP.qualLevel;
					} else
						set = (Vector<AbilityMapper.AbilityMapping>) levelSets
								.elementAt(lvlIndex, 2);
					set.addElement(aMAP);
				}
			}
			String header = showNumber + ". Class Abilities: ";
			String spaces = CMStrings.repeat(" ",
					2 + ("" + showNumber).length());
			parts.append("\n\r");
			...
			for (int i = 0; i <= maxAbledLevel; i++) {
				...
				if (index < 0)
					continue;
				List<AbilityMapper.AbilityMapping> set = (List<AbilityMapper.AbilityMapping>) levelSets
						.elementAt(index, 2);
				for (int s = 0; s < set.size(); s++) {
					AbilityMapper.AbilityMapping aMAP = set.get(s);
					parts.append(spaces
							+ CMStrings.padRight("" + i, 3)
							+ " "
							+ CMStrings.padRight("" + aMAP.abilityID, 25)
							+ " "
							+ CMStrings.padRight("" + aMAP.defaultProficiency,
									5)
							+ " "
							...
							+ " "
							+ CMStrings.padRight(""
									+ aMAP.originalSkillPreReqList, 7) + " "
			...
			if (newName.equalsIgnoreCase("?"))
				...
				for (int s = 0; s < levelSets.size(); s++) {
					List<AbilityMapper.AbilityMapping> lvls = (List<AbilityMapper.AbilityMapping>) levelSets
							.elementAt(s, 2);
					for (int l = 0; l < lvls.size(); l++)
						if (CMLib.english().containsString(
								lvls.get(l).abilityID, newName)) {
							lvlIndex = s;
							ableIndex = l;
							myLevelSet = lvls;
							break;
				...
				if (ableIndex < 0) {
					...
					if (genClassAbleMod(mob, levelSets, aID, lvlIndex,
							ableIndex) != null)
				...
				if (updateList) {
					...
					for (int s = 0; s < levelSets.size(); s++) {
						...
						for (int l = 0; l < lvls.size(); l++) {
							...
							E.setStat("GETCABLEPROF" + dex, ""
									+ aMAP.defaultProficiency);
							E.setStat("GETCABLESECR" + dex, "" + aMAP.isSecret);
							E.setStat("GETCABLEPARM" + dex, ""
									+ aMAP.defaultParm);
							E.setStat("GETCABLEPREQ" + dex,
									aMAP.originalSkillPreReqList);
							E.setStat("GETCABLEMASK" + dex, aMAP.extraMask);
							E.setStat("GETCABLEMAXP" + dex, ""
									+ aMAP.maxProficiency);
							// CABLE MUST BE LAST
	...
	protected void genCulturalAbilities(MOB mob, Race E, int showNumber,
			int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			if (newName.equalsIgnoreCase("?"))
				...
				if (partNum < 0) {
					...
					if (A == null)
						...
						StringBuffer str = new StringBuffer(A.ID() + ";");
						String prof = mob.session().prompt(
								"Enter the default proficiency level (100): ",
								"100");
						str.append(("" + CMath.s_int(prof)));
						data.addElement(str.toString());
						ables.addElement(A);
	...
	public void modifyGenClass(MOB mob, CharClass me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Number of Class Names: ", "NUMNAME");
			int numNames = CMath.s_int(me.getStat("NUMNAME"));
			if (numNames <= 1)
				promptStatStr(mob, me, ++showNumber, showFlag, "Class Name",
						"NAME0");
			else
				for (int i = 0; i < numNames; i++) {
					promptStatStr(mob, me, ++showNumber, showFlag,
							"Class Name #" + i + ": ", "NAME" + i);
					if (i > 0)
						while (!mob.session().isStopped()) {
							int oldNameLevel = CMath.s_int(me
									.getStat("NAMELEVEL" + i));
							promptStatInt(mob, me, ++showNumber, showFlag,
									"Class Name #" + i + " class level: ",
									"NAMELEVEL" + i);
							int previousNameLevel = CMath.s_int(me
									.getStat("NAMELEVEL" + (i - 1)));
							int newNameLevel = CMath.s_int(me
									.getStat("NAMELEVEL" + i));
							if ((oldNameLevel != newNameLevel)
									&& (newNameLevel < (previousNameLevel + 1))) {
								mob.tell("This level may not be less than "
										+ (previousNameLevel + 1) + ".");
								me.setStat("NAMELEVEL" + i, ""
										+ (previousNameLevel + 1));
								showNumber--;
							} else
								break;
			...
			promptStatInt(mob, me, "Use -1 to disable a class Level Cap",
					++showNumber, showFlag, "Level Cap (?)", "LEVELCAP");
			promptStatStr(mob, me, ++showNumber, showFlag, "Base Class", "BASE");
			genClassAvailability(mob, me, ++showNumber, showFlag);
			promptStatStr(mob, me, ++showNumber, showFlag, "HP/Level Formula",
					"HITPOINTSFORMULA");
			promptStatStr(mob, me, ++showNumber, showFlag,
					"Mana/Level Formula", "MANAFORMULA");
			promptStatInt(mob, me, ++showNumber, showFlag, "Prac/Level",
					"LVLPRAC");
			promptStatInt(mob, me, ++showNumber, showFlag, "Attack/Level",
					"LVLATT");
			genAttackAttribute(mob, me, ++showNumber, showFlag,
					"Attack Attribute", "ATTATT");
			promptStatInt(mob, me, ++showNumber, showFlag, "Practices/1stLvl",
					"FSTPRAC");
			promptStatInt(mob, me, ++showNumber, showFlag, "Trains/1stLvl",
					"FSTTRAN");
			promptStatInt(mob, me, ++showNumber, showFlag, "Levels/Dmg Pt",
					"LVLDAM");
			promptStatStr(mob, me, ++showNumber, showFlag,
					"Move/Level Formula", "MOVEMENTFORMULA");
			genArmorCode(mob, me, ++showNumber, showFlag, "Armor Restr.",
					"ARMOR");

			int armorMinorCode = CMath.s_int(me.getStat("ARMORMINOR"));
			boolean newSpells = prompt(mob, armorMinorCode > 0, ++showNumber,
					showFlag, "Armor restricts only spells");
			me.setStat("ARMORMINOR", ""
					+ (newSpells ? CMMsg.TYP_CAST_SPELL : -1));

			promptStatStr(mob, me, ++showNumber, showFlag, "Limitations",
					"STRLMT");
			promptStatStr(mob, me, ++showNumber, showFlag, "Bonuses", "STRBON");
			genQualifications(mob, me, ++showNumber, showFlag,
					"Qualifications", "QUAL");
			genMinimumStatQualifications(mob, me, ++showNumber, showFlag);
			genClassRaceQuals(mob, me, ++showNumber, showFlag,
					"Required Races", "RACQUAL");
			genPStats(mob, me, ++showNumber, showFlag, true);
			genAStats(mob, me, "ASTATS", "CharStat Adjustments", ++showNumber,
					showFlag);
			genAStats(mob, me, "CSTATS", "CharStat Settings", ++showNumber,
					showFlag);
			genAState(mob, me, "ASTATE", "CharState Adjustments", ++showNumber,
					showFlag);
			genAState(mob, me, "STARTASTATE", "New Player CharState Adj.",
					++showNumber, showFlag);
			genClassFlags(mob, me, ++showNumber, showFlag);
			genWeaponRestr(mob, me, ++showNumber, showFlag, "Weapon Restr.",
					"NUMWEP", "GETWEP");
			genWeaponMaterials(mob, me, ++showNumber, showFlag,
					"Weapon Materials", "NUMWMAT", "GETWMAT");
			genOutfit(mob, me, ++showNumber, showFlag);
			genClassBuddy(mob, me, ++showNumber, showFlag,
					"Stat-Modifying Class", "STATCLASS");
			genClassBuddy(mob, me, ++showNumber, showFlag,
					"Special Events Class", "EVENTCLASS");
			promptStatChoices(mob, me, null, ++showNumber, showFlag,
					"Sub Class Switch Rule", "SUBRUL",
					CMParms.toStringArray(CharClass.SubClassRule.values()));
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Max Non-Crafting Skills", "MAXNCS");
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Max Crafting Skills", "MAXCRS");
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Max All-Common Skills", "MAXCMS");
			promptStatInt(mob, me, ++showNumber, showFlag, "Max Languages",
					"MAXLGS");
			genClassAbilities(mob, me, ++showNumber, showFlag);
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Number of Security Code Sets: ", "NUMSSET");
			int numGroups = CMath.s_int(me.getStat("NUMSSET"));
			for (int i = 0; i < numGroups; i++) {
				promptStatStr(mob, me, ++showNumber, showFlag,
						"Security Codes in Set #" + i, "SSET" + i);
				while (!mob.session().isStopped()) {
					int oldGroupLevel = CMath
							.s_int(me.getStat("SSETLEVEL" + i));
					promptStatInt(mob, me, ++showNumber, showFlag,
							"Class Level for Security Set #" + i + ": ",
							"SSETLEVEL" + i);
					int previousGroupLevel = CMath.s_int(me.getStat("SSETLEVEL"
							+ (i - 1)));
					int newGroupLevel = CMath
							.s_int(me.getStat("SSETLEVEL" + i));
					if ((oldGroupLevel != newGroupLevel) && (i > 0)
							&& (newGroupLevel < (previousGroupLevel + 1))) {
						mob.tell("This level may not be less than "
								+ (previousGroupLevel + 1) + ".");
						me.setStat("SSETLEVEL" + i, ""
								+ (previousGroupLevel + 1));
						showNumber--;
					} else
						break;
	...
	public void modifyClanPosition(MOB mob, ClanPosition me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			int showNumber = 0;
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Simple ID",
					"ID", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Name",
					"NAME", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Name (Plural)", "PLURALNAME", false);
			promptStatInt(mob, me, ++showNumber, showFlag, "Rank (low=better)",
					"RANK");
			...
			promptStatStr(mob, me, CMLib.masking().maskHelp("\n", "disallow"),
					++showNumber, showFlag, "Position Mask", "INNERMASK", false);
			promptStatBool(mob, me, ++showNumber, showFlag, "Is Shown",
					"ISPUBLIC");
			promptStatCommaChoices(mob, me,
					CMParms.toStringList(Clan.Function.values()), ++showNumber,
					showFlag, "Powers", "FUNCTIONS", Clan.Function.values());
	...
	public void clanGovernmentPositions(MOB mob, ClanGovernment me,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		...
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			...
			if (word.trim().equalsIgnoreCase("ADD")) {
				...
				if (editMe == null) {
					...
					mob.tell("Position " + word
							+ " is not listed.  Try one of these: " + list);
				} else if (mob.session() != null) {
					String choice = mob.session().choose(
							"Edit or Delete position " + editMe.getID()
									+ " (E/D/)?", "ED", "");
	...
	public void modifyGovernment(MOB mob, ClanGovernment me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			int showNumber = 0;
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Type Name",
					"NAME", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Category",
					"CATEGORY", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Short Desc",
					"SHORTDESC", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Long Desc",
					"LONGDESC", 60);
			promptStatStr(mob, me, CMLib.masking().maskHelp("\n", "disallow"),
					++showNumber, showFlag, "Member Mask", "REQUIREDMASK", true);
			promptStatBool(mob, me, ++showNumber, showFlag, "Is Public",
					"ISPUBLIC");
			promptStatBool(mob, me, ++showNumber, showFlag, "Is Family",
					"ISFAMILYONLY");
			promptStatBool(mob, me, ++showNumber, showFlag, "Is Rivalrous",
					"ISRIVALROUS");
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Minimum Members", "OVERRIDEMINMEMBERS", true);
			if ((me.getOverrideMinMembers() != null)
					&& ((me.getOverrideMinMembers().intValue() < 0) || (me
							.getOverrideMinMembers().intValue() > 999)))
			...
			promptStatStr(mob, me, "Use @x1 for the clan level.\n\r"
					+ CMLib.help().getHelpText("FORMULA", mob, true),
					++showNumber, showFlag, "XP Per Level Formula",
					"XPLEVELFORMULA", true);
			promptStatBool(mob, me, ++showNumber, showFlag, "Conquest Enabled",
					"CONQUESTENABLED");
			if (CMath.s_bool(me.getStat("CONQUESTENABLED"))) {
				promptStatBool(mob, me, ++showNumber, showFlag,
						"Clan Item Loyalty", "CONQUESTITEMLOYALTY");
				promptStatBool(mob, me, ++showNumber, showFlag,
						"Conq. by Worship", "CONQUESTDEITYBASIS");
			}
			promptStatCommaChoices(mob, me,
					CMParms.toStringList(Clan.Function.values()), ++showNumber,
					showFlag, "Vote Approved", "VOTEFUNCS",
					Clan.Function.values());
			if (me.getStat("VOTEFUNCS").length() > 0) {
				promptStatInt(mob, me, ++showNumber, showFlag, "Max Vote Days",
						"MAXVOTEDAYS");
				if ((me.getMaxVoteDays() < 0) || (me.getMaxVoteDays() > 999999))
					me.setMaxVoteDays(10);
				promptStatInt(mob, me, ++showNumber, showFlag,
						"Vote Quorum (Pct%)", "VOTEQUORUMPCT");
				if ((me.getVoteQuorumPct() < 0)
						|| (me.getVoteQuorumPct() > 100))
					me.setVoteQuorumPct(100);
			}
			promptStatChoices(mob, me,
					CMParms.toStringList(Clan.AutoPromoteFlag.values()),
					++showNumber, showFlag, "Auto-Promotion", "AUTOPROMOTEBY",
					Clan.AutoPromoteFlag.values());
			promptStatChoices(mob, me, CMParms.toStringList(me.getPositions()),
					++showNumber, showFlag, "Apply Position", "AUTOROLE",
					me.getPositions());
			promptStatChoices(mob, me, CMParms.toStringList(me.getPositions()),
					++showNumber, showFlag, "Accept Position", "ACCEPTPOS",
					me.getPositions());
			promptStatStr(mob, me,
					CMLib.help().getHelpText("SCRIPTABLE", mob, true)
							.toString(), ++showNumber, showFlag,
					"Entry Scriptable", "ENTRYSCRIPT", true);
			promptStatStr(mob, me,
					CMLib.help().getHelpText("SCRIPTABLE", mob, true)
							.toString(), ++showNumber, showFlag,
					"Exit Scriptable", "EXITSCRIPT", true);
			genDynamicAbilities(mob, me, "Clan & Char", "clan", ++showNumber,
					showFlag);
	...
	public void modifyGenAbility(MOB mob, Ability me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Ability/Skill name", "NAME", false);
			promptStatStr(mob, me, CMParms.toStringList(Ability.ACODE_DESCS)
					+ "," + CMParms.toStringList(Ability.DOMAIN_DESCS),
					++showNumber, showFlag, "Type, Domain", "CLASSIFICATION",
					false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Command Words (comma sep)", "TRIGSTR", false);
			promptStatStr(mob, me, CMParms.toStringList(Ability.RANGE_CHOICES),
					++showNumber, showFlag, "Minimum Range", "MINRANGE", false);
			promptStatStr(mob, me, CMParms.toStringList(Ability.RANGE_CHOICES),
					++showNumber, showFlag, "Maximum Range", "MAXRANGE", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Ticks Between Casts", "TICKSBETWEENCASTS", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Affect String", "DISPLAY", true);
			promptStatBool(mob, me, ++showNumber, showFlag, "Is Auto-invoking",
					"AUTOINVOKE");
			promptStatStr(mob, me,
					"0," + CMParms.toStringList(Ability.FLAG_DESCS),
					++showNumber, showFlag, "Skill Flags (comma sep)", "FLAGS",
					true);
			promptStatInt(mob, me, "-1,x," + Integer.MAX_VALUE + ","
					+ Integer.MAX_VALUE + "-(1 to 100)", ++showNumber,
					showFlag, "Override Cost", "OVERRIDEMANA");
			promptStatStr(mob, me, CMParms.toStringList(Ability.USAGE_DESCS),
					++showNumber, showFlag, "Cost Type", "USAGEMASK", false);
			promptStatStr(mob, me,
					"0," + CMParms.toStringList(Ability.CAN_DESCS),
					++showNumber, showFlag, "Can Affect", "CANAFFECTMASK", true);
			promptStatStr(mob, me,
					"0," + CMParms.toStringList(Ability.CAN_DESCS),
					++showNumber, showFlag, "Can Target", "CANTARGETMASK", true);
			promptStatStr(mob, me, CMParms.toStringList(Ability.QUALITY_DESCS),
					++showNumber, showFlag, "Quality Code", "QUALITY", true);
			promptStatStr(
					mob,
					me,
					"The parameters for this field are LIKE the parameters for this property:\n\r\n\r"
							+ CMLib.help()
									.getHelpText("Prop_HereAdjuster", mob, true)
									.toString(), ++showNumber, showFlag,
					"Affect Adjustments", "HERESTATS", true);
			promptStatStr(mob, me, CMLib.masking().maskHelp("\n", "disallow"),
					++showNumber, showFlag, "Caster Mask", "CASTMASK", true);
			promptStatStr(mob, me,
					CMLib.help().getHelpText("Scriptable", mob, true)
							.toString(), ++showNumber, showFlag,
					"Scriptable Parm", "SCRIPT", true);
			promptStatStr(mob, me, CMLib.masking().maskHelp("\n", "disallow"),
					++showNumber, showFlag, "Target Mask", "TARGETMASK", true);
			promptRawStatStr(mob, me, null, ++showNumber, showFlag,
					"Fizzle Message", "FIZZLEMSG", true);
			promptRawStatStr(mob, me, null, ++showNumber, showFlag,
					"Auto-Cast Message", "AUTOCASTMSG", true);
			promptRawStatStr(mob, me, null, ++showNumber, showFlag,
					"Normal-Cast Message", "CASTMSG", true);
			promptRawStatStr(mob, me, null, ++showNumber, showFlag,
					"Post-Cast Message", "POSTCASTMSG", true);
			promptStatStr(mob, me, CMParms.toStringList(CMMsg.TYPE_DESCS),
					++showNumber, showFlag, "Attack-Type", "ATTACKCODE", true);
			promptStatStr(
					mob,
					me,
					"The parameters for this field are LIKE the parameters for this property:\n\r\n\r"
							+ CMLib.help()
									.getHelpText("Prop_HereSpellCast", mob,
											true).toString(), ++showNumber,
					showFlag, "Silent affects", "POSTCASTAFFECT", true);
			promptStatStr(
					mob,
					me,
					"The parameters for this field are LIKE the parameters for this property:\n\r\n\r"
							+ CMLib.help()
									.getHelpText("Prop_HereSpellCast", mob,
											true).toString(), ++showNumber,
					showFlag, "Extra castings", "POSTCASTABILITY", true);
			promptStatStr(
					mob,
					me,
					"Enter a damage or healing formula. Use +-*/()?. @x1=caster level, @x2=target level.  Formula evaluates >0 for damage, <0 for healing. Requires Can Target!",
					++showNumber, showFlag, "Damage/Healing Formula",
					"POSTCASTDAMAGE", true);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Help Text",
					"HELP", true);
	...
	public void modifyGenLanguage(MOB mob, Language me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			// genText(mob,me,null,++showNumber,showFlag,"Enter the class","CLASS");
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Language name", "NAME", false);
			for (int i = 0; i <= me.translationVector(me.ID()).size(); i++) {
				promptStatStr(mob, me, null, ++showNumber, showFlag, (i + 1)
						+ " letter words", "WORDS" + (i + 1), true);
			}
			++showNumber;
			if ((showFlag <= 0) || (showFlag == showNumber)) {
				mob.tell(showNumber + ". Hashed words: "
						+ me.getStat("HASHEDWORDS"));
				if ((showFlag == showNumber) || (showFlag <= -999)) {
					...
					while ((mob.session() != null)
						...
						if ((val == null)
								&& (!me.translationHash(me.ID()).containsKey(
										word.toUpperCase().trim())))
							mob.tell("You can not remove " + word
									+ ", it is not on the current list.");
						else if (me.translationHash(me.ID()).containsKey(
								word.toUpperCase().trim())) {
							me.translationHash(me.ID()).remove(
									word.toUpperCase().trim());
							mob.tell("Word '" + word + "' removed.");
						} else {
							me.translationHash(me.ID()).put(
									word.toUpperCase().trim(), val);
	...
	public void modifyGenCraftSkill(MOB mob, Ability me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			// id is bad to change.. make them delete it.
			// genText(mob,me,null,++showNumber,showFlag,"Enter the class","CLASS");
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Skill name",
					"NAME", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Skill verb",
					"VERB", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Command Words (comma sep)", "TRIGSTR", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag,
					"Recipe filename", "FILENAME", false);
			++showNumber;
			if ((showFlag <= 0) || (showFlag == showNumber)) {
				mob.tell(showNumber + ". Raw materials: "
						+ me.getStat("MATLIST"));
				if ((showFlag == showNumber) || (showFlag <= -999)) {
					...
					while ((mob.session() != null)
						...
						if (word.equalsIgnoreCase("?")) {
							StringBuilder str = new StringBuilder(
									CMParms.toStringList(RawMaterial.Material
											.values()));
							str.append(", ").append(
									CMParms.toStringList(RawMaterial.CODES
											.NAMES()));
							mob.tell(str.toString());
							continue;
						}
						List<String> curSet = CMParms.parseCommas(
								me.getStat("MATLIST").toUpperCase(), true);
						if (curSet.contains(word.toUpperCase().trim())) {
							curSet.remove(word.toUpperCase().trim());
							me.setStat("MATLIST", CMParms.toStringList(curSet
									.toArray(new String[0])));
							mob.tell("Resource or Material '" + word
									+ "' removed.");
						} else if ((RawMaterial.Material.findIgnoreCase(word) != null)
								|| CMParms.containsIgnoreCase(
										RawMaterial.CODES.NAMES(), word)) {
							...
							mob.tell("'" + word
									+ "' is not a material or resource.  Try ?");
					}
				}
			}
			promptStatBool(mob, me, null, ++showNumber, showFlag, "Can mend",
					"CANMEND");
			promptStatBool(mob, me, null, ++showNumber, showFlag, "Can refit",
					"CANREFIT");
			promptStatBool(mob, me, null, ++showNumber, showFlag, "Can bundle",
					"CANBUNDLE");
			promptStatBool(mob, me, null, ++showNumber, showFlag, "Can sit",
					"CANSIT");
			promptStatStr(mob, me, null, ++showNumber, showFlag, "MSP file",
					"SOUND", false);
			promptStatStr(mob, me, null, ++showNumber, showFlag, "Help Text",
					"HELP", true);
	...
	protected boolean genText(MOB mob, DVector set, String[] choices,
			String help, int showNumber, int showFlag, String FieldDisp,
			String Field) throws IOException {
		int setDex = set.indexOf(Field);
		if (((showFlag > 0) && (showFlag != showNumber)) || (setDex < 0))
			return true;
		mob.tell(showNumber + ". " + FieldDisp + ": '"
				+ ((String) set.elementAt(setDex, 2) + "'."));
		if ((showFlag != showNumber) && (showFlag > -999))
			return true;
		String newName = mob.session().prompt("Enter a new one\n\r:", "");
		if (newName.trim().length() == 0) {
		...
		if ((newName.equalsIgnoreCase("?")) && (help != null)) {
			if ((mob.session() == null) || (mob.session().isStopped()))
				return false;
			mob.tell(help);
			return genText(mob, set, choices, help, showNumber, showFlag,
					FieldDisp, Field);
		}
		if (newName.equalsIgnoreCase("null"))
			newName = "";
	...
	protected boolean modifyComponent(MOB mob, AbilityComponent comp)
			throws IOException {
		DVector decoded = CMLib.ableMapper().getAbilityComponentDecodedDVector(
				comp);
		if (mob.isMonster())
			return true;
		boolean ok = false;
		...
		String allComponents = CMParms.toStringList(RawMaterial.Material
				.values())
				+ ","
				+ CMParms.toStringList(RawMaterial.CODES.NAMES());
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			int showNumber = 0;
			genText(mob, decoded, (new String[] { "&&", "||", "X" }), choices
					+ " &&, ||, X", ++showNumber, showFlag,
					"Conjunction (X Deletes) (?)", "ANDOR");
			if (((String) decoded.elementAt(0, 2)).equalsIgnoreCase("X"))
				return false;
			genText(mob, decoded,
					(new String[] { "INVENTORY", "HELD", "WORN" }), choices
							+ " INVENTORY, HELD, WORN", ++showNumber, showFlag,
					"Component position (?)", "DISPOSITION");
			genText(mob, decoded, (new String[] { "KEPT", "CONSUMED" }),
					choices + " KEPT, CONSUMED", ++showNumber, showFlag,
					"Component fate (?)", "FATE");
			genText(mob, decoded, null, null, ++showNumber, showFlag,
					"Amount of component", "AMOUNT");
			genText(mob, decoded, null, allComponents, ++showNumber, showFlag,
					"Type of component (?)", "COMPONENTID");
			genText(mob, decoded, null,
					CMLib.masking().maskHelp("\n", "disallow"), ++showNumber,
					showFlag, "Component applies-to mask (?)", "MASK");
			if (showFlag < -900) {
				ok = true;
				break;
			}
		...
		CMLib.ableMapper().setAbilityComponentCodedFromDecodedDVector(decoded,
				comp);
		return true;
	}
	...
	public void modifyComponents(MOB mob, String componentID)
		...
		if (CMProps.getIntVar(CMProps.Int.EDITORTYPE) > 0)
			showFlag = -999;
		List<AbilityComponent> codedDV = CMLib.ableMapper()
				.getAbilityComponentDVector(componentID);
		if (codedDV != null)
			while ((mob.session() != null) && (!mob.session().isStopped())
					&& (!ok)) {
				int showNumber = 0;
				for (int v = 0; v < codedDV.size(); v++)
					if ((mob.session() != null) && (!mob.session().isStopped())) {
						...
						mob.tell(showNumber
								+ ": '"
								+ CMLib.ableMapper().getAbilityComponentDesc(
										null, codedDV, v) + "'.");
						if ((showFlag != showNumber) && (showFlag > -999))
							continue;
				...
				while ((mob.session() != null) && (!mob.session().isStopped())) {
					...
					if ((showFlag == showNumber) || (showFlag <= -999)) {
						AbilityComponent comp = CMLib.ableMapper()
				...
				showFlag = CMath
						.s_int(mob.session().prompt("Edit which? ", ""));
				if (showFlag <= 0) {
					showFlag = -1;
					ok = true;
				}
	...
	public void modifyGenRace(MOB mob, Race me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			promptStatInt(mob, me, ++showNumber, showFlag, "Base Weight",
					"BWEIGHT");
			promptStatInt(mob, me, ++showNumber, showFlag, "Weight Variance",
					"VWEIGHT");
			promptStatInt(mob, me, ++showNumber, showFlag, "Base Male Height",
					"MHEIGHT");
			promptStatInt(mob, me, ++showNumber, showFlag,
					"Base Female Height", "FHEIGHT");
			promptStatInt(mob, me, ++showNumber, showFlag, "Height Variance",
					"VHEIGHT");
			...
			promptStatStr(mob, me, ++showNumber, showFlag, "Leaving text",
					"LEAVE");
			promptStatStr(mob, me, ++showNumber, showFlag, "Arriving text",
					"ARRIVE");
			genRaceBuddy(mob, me, ++showNumber, showFlag, "Health Race",
					"HEALTHRACE");
			genRaceBuddy(mob, me, ++showNumber, showFlag, "Event Race",
					"EVENTRACE");
			...
			genRaceBuddy(mob, me, ++showNumber, showFlag, "Weapons Race",
					"WEAPONRACE");
			genDynamicAbilities(mob, me, "Racial", "char", ++showNumber,
					showFlag);
	...
	protected void modifyGenItem(MOB mob, Item me) throws IOException {
		boolean ok = false;
		int showFlag = -1;
		if (CMProps.getIntVar(CMProps.Int.EDITORTYPE) > 0)
			showFlag = -999;
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			if (me instanceof Electronics) {
				...
				E.setManufacturerName(prompt(mob, E.getManufacturerName(),
						++showNumber, showFlag, "Manufacturer"));
				E.setPowerCapacity(prompt(mob, E.powerCapacity(), ++showNumber,
						showFlag, "Pow Capacity"));
				E.setPowerRemaining(prompt(mob, E.powerRemaining(),
						++showNumber, showFlag, "Pow Remaining"));
				E.activate(prompt(mob, E.activated(), ++showNumber, showFlag,
						"Activated"));
			}
			if (me instanceof ShipComponent.ShipEngine) {
				ShipComponent.ShipEngine E = (ShipComponent.ShipEngine) me;
				E.setMaxThrust(prompt(mob, E.getMaxThrust(), ++showNumber,
						showFlag, "Max thrust"));
				E.setSpecificImpulse(prompt(mob, E.getSpecificImpulse(),
						++showNumber, showFlag, "Max velocity"));
				E.setFuelEfficiency(prompt(mob, E.getFuelEfficiency() * 100.0,
						++showNumber, showFlag, "Fuel Effic. %") / 100.0);
			}
			if (me instanceof ShipComponent) {
				ShipComponent E = (ShipComponent) me;
				E.setInstalledFactor((float) prompt(mob,
						E.getInstalledFactor(), ++showNumber, showFlag,
						"Installed Factor"));
			}
			if (me instanceof PackagedItems)
				((PackagedItems) me).setNumberOfItemsInPackage(prompt(mob,
						((PackagedItems) me).numberOfItemsInPackage(),
						++showNumber, showFlag,
			...
			for (int x = me.getSaveStatIndex(); x < me.getStatCodes().length; x++)
				me.setStat(
						me.getStatCodes()[x],
						prompt(mob,
								me.getStat(me.getStatCodes()[x]),
								++showNumber,
								showFlag,
								CMStrings.capitalizeAndLower(me.getStatCodes()[x])));
			if (showFlag < -900) {
				ok = true;
				break;
			}
		...
		if (me.text().length() >= maxLength)
			mob.tell("\n\rThe data entered exceeds the string limit of "
					+ maxLength + " characters.");
	}

	protected void modifyGenFood(MOB mob, Food me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
	...
	protected void genScripts(MOB mob, MOB E, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())
			...
			String behaviorstr = "";
			int b = 1;
			for (Enumeration<ScriptingEngine> e = E.scripts(); e
					.hasMoreElements(); b++) {
			...
			if ((showFlag != showNumber) && (showFlag > -999))
				return;
			behave = mob.session().prompt(
					"Enter a script number to remove\n\r:", "");
			if (behave.length() > 0) {
				String tattoo = behave;
				if ((tattoo.length() > 0) && (CMath.isInteger(tattoo))
						&& (CMath.s_int(tattoo) > 0)
	...
	protected void modifyGenDrink(MOB mob, Drink me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			if (me instanceof Perfume)
				((Perfume) me).setSmellList(prompt(mob,
						((Perfume) me).getSmellList(), ++showNumber, showFlag,
						"Smells list (; delimited)"));
			genImage(mob, me, ++showNumber, showFlag);
			for (int x = me.getSaveStatIndex(); x < me.getStatCodes().length; x++)
				me.setStat(
						me.getStatCodes()[x],
	...
	protected void modifyGenWallpaper(MOB mob, Item me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
	...
	protected void modifyGenMap(MOB mob,
			com.planet_ink.coffee_mud.Items.interfaces.RoomMap me)
			throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
	...
	protected void modifyGenContainer(MOB mob, Container me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			if ((me instanceof Electronics.ElecPanel)
					&& (!(me instanceof Electronics.Computer)))
				genPanelType(mob, (Electronics.ElecPanel) me, ++showNumber,
						showFlag);
			if (me instanceof Electronics.PowerGenerator) {
				Electronics.PowerGenerator E = (Electronics.PowerGenerator) me;
				E.setGenerationAmountPerTick(prompt(mob,
						E.getGeneratedAmountPerTick(), ++showNumber, showFlag,
						"Gen Amt/Tick"));
			}
	...
	protected void modifyGenWeapon(MOB mob, Weapon me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			genRejuv(mob, me, ++showNumber, showFlag);
			if (((!(me instanceof AmmunitionWeapon)) || (!((AmmunitionWeapon) me)
					.requiresAmmunition())) && (!(me instanceof Wand)))
	...
	protected void modifyGenArmor(MOB mob, Armor me) throws IOException {
		if (mob.isMonster())
			return;
		boolean ok = false;
		int showFlag = -1;
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			// genReadable1(mob,me,++showNumber,showFlag); // since they can
			// have keys, no readability for you.
			// genReadable2(mob,me,++showNumber,showFlag);
			if (me instanceof Light)
				genBurnout(mob, (Light) me, ++showNumber, showFlag);
			genValue(mob, me, ++showNumber, showFlag);
	...
	protected MOB possibleCatalogSwap(final MOB editorMOB, final MOB me)
			throws IOException {
		...
		if (cataM != null) {
			...
			for (final Enumeration<Item> i = cataM.items(); i.hasMoreElements();) {
				...
				if ((I != null) && (I.basePhyStats().rejuv() > 0)
						&& (I.basePhyStats().rejuv() != PhyStats.NO_REJUV)
						&& (session != null)) {
					if (session
							.confirm(
									"\n\r**This mob has variable equipment in the catalog, would you like to reset it first (Y/n)? ",
									"Y")) {
						CMLib.coffeeMaker().setPropertiesStr(me, cataM.text(),
								false);
	...
	protected void modifyGenMOB(MOB mob, MOB me) throws IOException {
		if (mob.isMonster())
			return;
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			Faction F = null;
			for (Enumeration<Faction> e = CMLib.factions().factions(); e
					.hasMoreElements();) {
				F = e.nextElement();
				if (F.showInEditor())
			...
			if ((oldLevel < 2) && (me.basePhyStats().level() > 1))
				me.basePhyStats().setDamage(
						(int) Math.round(CMath.div(me.basePhyStats().damage(),
								me.basePhyStats().speed())));
			genAttack(mob, me, ++showNumber, showFlag);
			genDamage(mob, me, ++showNumber, showFlag);
			genArmor(mob, me, ++showNumber, showFlag);
			genHitPoints(mob, me, ++showNumber, showFlag);
			genMoney(mob, me, ++showNumber, showFlag);
			me.setMoneyVariation(CMath.s_double(prompt(mob,
					"" + me.getMoneyVariation(), ++showNumber, showFlag,
					"Money Variation")));
	...
	public void modifyPlayer(MOB mob, MOB me) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			if (CMProps.getIntVar(CMProps.Int.COMMONACCOUNTSYSTEM) > 1) {
				String oldAccountName = ((me.playerStats() != null) && (me
						.playerStats().getAccount() != null)) ? me
						.playerStats().getAccount().accountName() : "";
				String accountName = CMStrings.capitalizeAndLower(prompt(mob,
						oldAccountName, ++showNumber, showFlag, "Account",
						true, false, null));
				while ((!accountName.equals(oldAccountName))
						&& (CMLib.players().getLoadAccount(accountName) == null)
						&& (mob.session() != null)
						&& (!mob.session().isStopped())) {
					mob.tell("The account can not be used, as it does not exist.");
					accountName = CMStrings.capitalizeAndLower(prompt(mob,
							oldAccountName, showNumber, showFlag, "Account",
							true, false, null));
				}
				if (!oldAccountName.equals(accountName)) {
					PlayerAccount newAccount = CMLib.players().getLoadAccount(
							accountName);
					me.playerStats().setAccount(newAccount);
					newAccount.addNewPlayer(me);
					PlayerAccount oldAccount = CMLib.players().getLoadAccount(
							oldAccountName);
					if (oldAccount != null) {
				...
				if (CMProps.getBoolVar(CMProps.Bool.ACCOUNTEXPIRATION))
					genAccountExpiration(mob, me.playerStats().getAccount(),
							++showNumber, showFlag);
			} else if (CMProps.getBoolVar(CMProps.Bool.ACCOUNTEXPIRATION))
				genAccountExpiration(mob, me.playerStats(), ++showNumber,
						showFlag);
			...
			genArmor(mob, me, ++showNumber, showFlag);
			genHitPoints(mob, me, ++showNumber, showFlag);
			me.setTrains(prompt(mob, me.getTrains(), ++showNumber, showFlag,
					"Training Points"));
			me.setPractices(prompt(mob, me.getPractices(), ++showNumber,
					showFlag, "Practice Points"));
			me.setQuestPoint(prompt(mob, me.getQuestPoint(), ++showNumber,
					showFlag, "Quest Points"));
			genAbilities(mob, me, ++showNumber, showFlag);
			genAffects(mob, me, ++showNumber, showFlag);
			genBehaviors(mob, me, ++showNumber, showFlag);
			genDisposition(mob, me.basePhyStats(), ++showNumber, showFlag);
			...
			if (me.playerStats() != null)
				for (int x = me.playerStats().getSaveStatIndex(); x < me
						.playerStats().getStatCodes().length; x++)
					me.playerStats()
							.setStat(
									me.playerStats().getStatCodes()[x],
									prompt(mob,
											me.playerStats().getStat(
													me.playerStats()
															.getStatCodes()[x]),
											++showNumber, showFlag, CMStrings
													.capitalizeAndLower(me
															.playerStats()
															.getStatCodes()[x])));
			if (showFlag < -900) {
				ok = true;
		...
		if (!oldName.equals(me.Name())) {
			if (mob.session() != null)
				mob.session().print("Changing player name...");
			CMLib.players().renamePlayer(me, oldName);
			if (mob.session() != null)
				mob.session().println(".");
			Log.sysOut("CMGenEditor", mob.Name() + " changed user " + oldName
					+ " to " + me.name());
		}
	...
	protected void genClanStatus(MOB mob, Clan C, int showNumber, int showFlag) {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Clan Status: "
				+ Clan.CLANSTATUS_DESC[C.getStatus()]);
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		switch (C.getStatus()) {
		case Clan.CLANSTATUS_ACTIVE:
			C.setStatus(Clan.CLANSTATUS_PENDING);
			mob.tell("Clan '" + C.name()
					+ "' has been changed from active to pending!");
			break;
		case Clan.CLANSTATUS_PENDING:
			C.setStatus(Clan.CLANSTATUS_ACTIVE);
			mob.tell("Clan '" + C.name()
					+ "' has been changed from pending to active!");
			break;
		case Clan.CLANSTATUS_FADING:
			C.setStatus(Clan.CLANSTATUS_ACTIVE);
			mob.tell("Clan '" + C.name()
					+ "' has been changed from fading to active!");
			break;
		default:
	...
	protected void genClanGovt(MOB mob, Clan C, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			...
			if (newGovt < 0)
				mob.tell("That government type is invalid.  Valid types include: "
						+ gvts.toString());
			else {
	...
	protected double genAuctionPrompt(MOB mob, double oldVal, int showNumber,
			int showFlag, String msg, boolean pct) throws IOException {
		String oldStr = (oldVal < 0) ? "" : (pct ? "" + (oldVal * 100.0) + "%"
				: "" + oldVal);
	...
	protected int genAuctionPrompt(MOB mob, int oldVal, int showNumber,
			int showFlag, String msg) throws IOException {
	...
	protected void genClanRole(MOB mob, Clan C, int showNumber, int showFlag)
		...
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Apply Role: '"
				+ C.getRoleName(C.getAutoPosition(), true, false) + "'.");
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			String newName = mob.session().prompt("Enter a new one (?)\n\r:",
	...
	protected void genClanClass(MOB mob, Clan C, int showNumber, int showFlag)
		...
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			...
			for (Enumeration<CharClass> e = CMClass.charClasses(); e
					.hasMoreElements();) {
				CC = e.nextElement();
				clss.append(CC.name() + ", ");
				if (newName.equalsIgnoreCase(CC.name())
						|| (newName.equalsIgnoreCase(CC.ID())))
					newC = CC;
			}
			clss = new StringBuffer(clss.substring(0, clss.length() - 2));
			if ((newC == null) || (newC.availabilityCode() == 0))
				mob.tell("That class name is invalid.  Valid names include: "
						+ clss.toString());
			else {
	...
	protected String genClanRoom(MOB mob, Clan C, String oldRoomID,
			String promptCode, int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return oldRoomID;
		mob.tell(showNumber
				+ CMStrings.replaceAll(promptCode, "@x1", oldRoomID));
		if ((showFlag != showNumber) && (showFlag > -999))
			return oldRoomID;
		while ((mob.session() != null) && (!mob.session().isStopped())) {
			String newName = mob.session().prompt(
	...
	public void modifyClan(MOB mob, Clan C) throws IOException {
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			C.setCategory(prompt(mob, C.getCategory(), ++showNumber, showFlag,
					"Category", true));
			C.setPremise(prompt(mob, C.getPremise(), ++showNumber, showFlag,
					"Clan Premise", true));
			C.setMinClanMembers(prompt(mob, C.getMinClanMembers(),
					++showNumber, showFlag, "Minimum members"));
			C.setExp(prompt(mob, C.getExp(), ++showNumber, showFlag,
					"Clan Experience"));
			C.setTaxes(prompt(mob, C.getTaxes(), ++showNumber, showFlag,
					"Clan Tax Rate (X 100%)"));
			C.setMorgue(genClanRoom(mob, C, C.getMorgue(),
					". Morgue RoomID: '@x1'.", ++showNumber, showFlag));
			C.setRecall(genClanRoom(mob, C, C.getRecall(),
					". Clan Home RoomID: '@x1'.", ++showNumber, showFlag));
			C.setDonation(genClanRoom(mob, C, C.getDonation(),
					". Clan Donate RoomID: '@x1'.", ++showNumber, showFlag));
			...
			C.setRivalrous(prompt(mob, C.isRivalrous(), ++showNumber, showFlag,
					"Rivalrous Clan"));
	...
	protected void modifyGenShopkeeper(MOB mob, ShopKeeper me)
		...
		while ((mob.session() != null) && (!mob.session().isStopped()) && (!ok)) {
			...
			if ((oldLevel < 2) && (M.basePhyStats().level() > 1))
				M.basePhyStats().setDamage(
						(int) Math.round(CMath.div(M.basePhyStats().damage(), M
								.basePhyStats().speed())));
			...
			M.setMoneyVariation(CMath.s_double(prompt(mob,
					"" + M.getMoneyVariation(), ++showNumber, showFlag,
					"Money Variation")));
			...
			if (me instanceof Banker) {
				...
				((PostOffice) me).setPostalChain(prompt(mob,
						((PostOffice) me).postalChain(), ++showNumber,
						showFlag, "Postal chain"));
				((PostOffice) me).setFeeForNewBox(prompt(mob,
						((PostOffice) me).feeForNewBox(), ++showNumber,
						showFlag, "Fee to open a new box"));
				((PostOffice) me).setMinimumPostage(prompt(mob,
						((PostOffice) me).minimumPostage(), ++showNumber,
						showFlag, "Minimum postage cost"));
				((PostOffice) me).setPostagePerPound(prompt(mob,
						((PostOffice) me).postagePerPound(), ++showNumber,
						showFlag, "Postage cost per pound after 1st pound"));
				((PostOffice) me).setHoldFeePerPound(prompt(mob,
						((PostOffice) me).holdFeePerPound(), ++showNumber,
						showFlag, "Holding fee per pound per month"));
				((PostOffice) me).setMaxMudMonthsHeld(prompt(mob,
						((PostOffice) me).maxMudMonthsHeld(), ++showNumber,
						showFlag, "Maximum number of months held"));
			} else if (me instanceof Auctioneer) {
				((Auctioneer) me).setAuctionHouse(prompt(mob,
						((Auctioneer) me).auctionHouse(), ++showNumber,
						showFlag, "Auction house"));
				((Auctioneer) me).setTimedListingPrice(genAuctionPrompt(mob,
						((Auctioneer) me).timedListingPrice(), ++showNumber,
						showFlag, "Flat fee per auction", false));
				((Auctioneer) me).setTimedListingPct(genAuctionPrompt(mob,
						((Auctioneer) me).timedListingPct(), ++showNumber,
						showFlag, "Listing Cut/%Pct per day", true));
				((Auctioneer) me).setTimedFinalCutPct(genAuctionPrompt(mob,
						((Auctioneer) me).timedFinalCutPct(), ++showNumber,
						showFlag, "Cut/%Pct of final price", true));
				((Auctioneer) me).setMaxTimedAuctionDays(genAuctionPrompt(mob,
						((Auctioneer) me).maxTimedAuctionDays(), ++showNumber,
						showFlag, "Maximum number of auction mud-days"));
				((Auctioneer) me).setMinTimedAuctionDays(genAuctionPrompt(mob,
						((Auctioneer) me).minTimedAuctionDays(), ++showNumber,
						showFlag, "Minimum number of auction mud-days"));
			} else {
		...
		while (!ok) {
			...
			for (int x = R.getSaveStatIndex(); x < R.getStatCodes().length; x++)
				R.setStat(
						R.getStatCodes()[x],
						prompt(mob,
								R.getStat(R.getStatCodes()[x]),
								++showNumber,
								showFlag,
								CMStrings.capitalizeAndLower(R.getStatCodes()[x])));
			if (showFlag < -900) {
				ok = true;
				break;
			}
	...
	protected void genAccountExpiration(MOB mob, AccountStats A,
			int showNumber, int showFlag) throws IOException {
		if ((showFlag > 0) && (showFlag != showNumber))
			return;
		mob.tell(showNumber + ". Expires: "
				+ CMLib.time().date2String(A.getAccountExpiration()));
		if ((showFlag != showNumber) && (showFlag > -999))
			return;
	...
	public void modifyAccount(MOB mob, PlayerAccount A) throws IOException {
		...
		while (!ok) {
			int showNumber = 0;
			String acctName = CMStrings.capitalizeAndLower(prompt(mob,
					A.accountName(), ++showNumber, showFlag, "Name", true,
					false, null));
			while ((!acctName.equals(A.accountName()))
					&& (CMLib.players().getLoadAccount(acctName) != null)
					&& (mob.session() != null) && (!mob.session().isStopped())) {
				mob.tell("The name given cannot be chosen, as it is already being used.");
				acctName = CMStrings.capitalizeAndLower(prompt(mob, acctName,
						showNumber, showFlag, "Name", true, false, null));
			}
			...
			promptStatStr(mob, A,
					CMParms.toStringList(PlayerAccount.FLAG_DESCS),
					++showNumber, showFlag, "Flags (?)", "FLAGS", true);
			promptStatStr(mob, A, ++showNumber, showFlag, "Notes: ", "NOTES");
			for (int x = A.getSaveStatIndex(); x < A.getStatCodes().length; x++)
				A.setStat(
						A.getStatCodes()[x],
						prompt(mob,
								A.getStat(A.getStatCodes()[x]),
								++showNumber,
								showFlag,
								CMStrings.capitalizeAndLower(A.getStatCodes()[x])));
			if (showFlag < -900) {
				ok = true;
				break;
			}
	...
	public void modifyGenArea(MOB mob, Area myArea) throws IOException {
		...
		while (!ok) {
			...
			myArea.setAtmosphere(genAnyMaterialCode(mob, "Atmosphere",
					myArea.getAtmosphereCode(), true, ++showNumber, showFlag));
			...
			if (myArea instanceof AutoGenArea) {
				promptStatStr(mob, myArea, ++showNumber, showFlag,
						"AutoGen Xml File Path", "GENERATIONFILEPATH");
				promptStatStr(mob, myArea, ++showNumber, showFlag,
						"AutoGen Variables (VAR=VAL format)", "OTHERVARS");
			}
			...
			for (int x = myArea.getSaveStatIndex(); x < myArea.getStatCodes().length; x++)
				myArea.setStat(
						myArea.getStatCodes()[x],
						prompt(mob, myArea.getStat(myArea.getStatCodes()[x]),
								++showNumber, showFlag, CMStrings
										.capitalizeAndLower(myArea
												.getStatCodes()[x])));
			if ((showFlag <= 0)
					|| ((showFlag >= showNumber) && (showFlag <= showNumber + 7)))
	...
	public AbilityMapper.AbilityMapping modifyAllQualifyEntry(MOB mob,
			String eachOrAll, Ability me) throws IOException {
		int showFlag = -1;
		if (CMProps.getIntVar(CMProps.Int.EDITORTYPE) > 0)
			showFlag = -999;
		Map<String, Map<String, AbilityMapper.AbilityMapping>> map = CMLib
				.ableMapper().getAllQualifiesMap(null);
		Map<String, AbilityMapper.AbilityMapping> subMap = map.get(eachOrAll
				.toUpperCase().trim());
		AbilityMapper.AbilityMapping mapped = subMap.get(me.ID().toUpperCase());
		if (mapped == null)
			mapped = CMLib.ableMapper().makeAbilityMapping(me.ID(), 1, me.ID(),
					0, 100, "", true, false, true, new Vector<String>(), "",
					null);
		boolean ok = false;
		while (!ok) {
			int showNumber = 0;
			mob.tell("* Ability Mapping for " + me.ID());
			mapped.qualLevel = prompt(mob, mapped.qualLevel, ++showNumber,
					showFlag, "Qualifying Level: ");
			mapped.autoGain = prompt(mob, mapped.autoGain, ++showNumber,
					showFlag, "Auto-Gained: ");
			mapped.defaultProficiency = prompt(mob, mapped.defaultProficiency,
					++showNumber, showFlag, "Def. Proficiency: ");
			mapped.extraMask = prompt(mob, mapped.extraMask, ++showNumber,
					showFlag, "Qualifying Mask (?): ", true, CMLib.masking()
							.maskHelp("\n\r", "disallow"));
			mapped.originalSkillPreReqList = prompt(
					mob,
					mapped.originalSkillPreReqList,
					++showNumber,
					showFlag,
					"Required Skills (?): ",
					true,
		...
		return CMLib.ableMapper()
				.makeAbilityMapping(
						mapped.abilityID,
						mapped.qualLevel,
						mapped.abilityID,
						mapped.defaultProficiency,
						100,
						"",
						mapped.autoGain,
						false,
						true,
						CMParms.parseSpaces(
								mapped.originalSkillPreReqList.trim(), true),
	...
	public void modifyManufacturer(MOB mob, Manufacturer me) throws IOException {
		...
		while (!ok) {
			int showNumber = 0;
			String newName = prompt(mob, me.name(), ++showNumber, showFlag,
					"Name: ");
			...
			me.setEfficiencyPct(CMath.div(
					prompt(mob, Math.round(me.getEfficiencyPct() * 100),
							++showNumber, showFlag, "Efficiency % (50-150): "),
					100.0));
			me.setReliabilityPct(CMath.div(
					prompt(mob, Math.round(me.getReliabilityPct() * 100),
							++showNumber, showFlag, "Reliability % (0-100): "),
					100.0));
			me.setItemMask(prompt(mob, me.getItemMaskStr(), ++showNumber,
					showFlag, "Item Mask (?): "));
			me.setMinTechLevelDiff((byte) prompt(mob, me.getMinTechLevelDiff(),
					++showNumber, showFlag, "Min Tech Diff: "));
			me.setMaxTechLevelDiff((byte) prompt(mob, me.getMaxTechLevelDiff(),
					++showNumber, showFlag, "Max Tech Diff: "));
			if (me.getMaxTechLevelDiff() < me.getMinTechLevelDiff())
				me.setMaxTechLevelDiff(me.getMinTechLevelDiff());
			me.setManufactureredTypesList(promptCommaList(mob,
					me.getManufactureredTypesList(), ++showNumber, showFlag,
					"Manufact. Types: ",
					"Choices: " + CMParms.toStringList(TechType.values()),
					CMEvalStrChoice.INSTANCE, TechType.values()));
			if (showFlag < -900) {
				ok = true;
				break;
			}
