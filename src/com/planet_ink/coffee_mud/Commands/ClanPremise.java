...
public class ClanPremise extends StdCommand {
	...
	public boolean execute(final MOB mob, Vector commands, int metaFlags)
		...
		final Clan C = chkC;
		if (C == null) {
			mob.tell("You aren't allowed to set a premise for "
		...
		if ((!skipChecks)
			...
			mob.tell("You aren't in the right position to set the premise to your "
					+ C.getGovernmentName() + ".");
			return false;
		}
	...
	public void setClanPremise(MOB mob, Clan C, String premise) {
		...
		CMLib.clans().clanAnnounce(
				mob,
				"The premise of " + C.getGovernmentName() + " " + C.clanID()
						+ " has been changed.");
	}
