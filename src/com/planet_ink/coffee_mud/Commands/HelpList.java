...
public class HelpList extends StdCommand {
	...
	public boolean execute(MOB mob, Vector commands, int metaFlags)
		...
		StringBuilder thisTag = CMLib.help().getHelpList(
				helpStr,
