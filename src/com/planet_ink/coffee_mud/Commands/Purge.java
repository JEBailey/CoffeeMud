...
public class Purge extends StdCommand {
	...
	public boolean items(MOB mob, Vector commands) {
		...
		if (deadItem == null)
			deadItem = (srchRoom == null) ? null : srchRoom.findItem(
					srchContainer, itemID);
		while (deadItem != null) {
	...
	public boolean execute(MOB mob, Vector commands, int metaFlags)
		...
		if (commandType.equals("ITEM")) {
			...
			Environmental thang = mob.location().fetchFromMOBRoomFavorsItems(
					mob, null, allWord, Wearable.FILTER_ANY);
