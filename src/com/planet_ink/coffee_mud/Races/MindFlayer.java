...
public class MindFlayer extends Humanoid {
	...
	private String[] racialAbilityNames = { "Spell_DetectSentience",
	...
	public void affectCharStats(MOB affectedMOB, CharStats affectableStats) {
		...
		affectableStats.setStat(CharStats.STAT_SAVE_MAGIC,
				affectableStats.getStat(CharStats.STAT_SAVE_MAGIC) + 50);
		...
		affectableStats.setStat(CharStats.STAT_INTELLIGENCE,
				affectableStats.getStat(CharStats.STAT_INTELLIGENCE) + 5);
	}
	...
	public List<RawMaterial> myResources() {
		synchronized (resources) {
			if (resources.size() == 0) {
				...
				resources.add(makeResource("a " + name().toLowerCase()
						+ " tenticle", RawMaterial.RESOURCE_MEAT));
			}
		}
		return resources;
	}
