...
public class Goblin extends StdRace {
	...
	public void affectCharStats(MOB affectedMOB, CharStats affectableStats) {
		...
		if (affectedMOB.isMonster()) {
			...
			affectableStats
					.setStat(CharStats.STAT_MAX_DEXTERITY_ADJ, affectableStats
			...
			affectableStats
					.setStat(CharStats.STAT_MAX_STRENGTH_ADJ, affectableStats
							.getStat(CharStats.STAT_MAX_STRENGTH_ADJ) - 1);
			affectableStats.setStat(CharStats.STAT_CHARISMA,
					affectableStats.getStat(CharStats.STAT_CHARISMA) - 1);
			affectableStats
					.setStat(CharStats.STAT_MAX_CHARISMA_ADJ, affectableStats
							.getStat(CharStats.STAT_MAX_CHARISMA_ADJ) - 1);
			...
			affectableStats.setStat(CharStats.STAT_MAX_INTELLIGENCE_ADJ,
					affectableStats
