	...
	public String healthText(MOB viewer, MOB mob) {
		...
		if (pct < .10)
			return "^r" + mob.name(viewer)
					+ "^r is squealing in bloody pain!^N";
		else if (pct < .20)
			...
			return "^p" + mob.name(viewer)
					+ "^p has a bloody snout and some wounds.^N";
		else if (pct < .70)
			...
			return "^g" + mob.name(viewer)
					+ "^g has a few small pink bruises.^N";
		else
