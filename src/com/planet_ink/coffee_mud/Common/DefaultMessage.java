...
public class DefaultMessage implements CMMsg {
	...
	protected SLinkedList<CMMsg> trailMsgs = null;
	...
	public final void setSource(final MOB mob) {
		myAgent = mob;
	}
	...
	public final void setTarget(final Environmental E) {
		myTarget = E;
	}
	...
	public final void setTool(final Environmental E) {
		myTool = E;
	}
	...
	protected static final boolean matches(final int major, final int minor,
			final int code) {
	...
	public boolean equals(Object o) {
		if (o instanceof CMMsg) {
			...
			return (m.sourceCode() == sourceCode())
					...
					&& (m.target() == target())
					&& (m.tool() == tool())
					&& ((m.sourceMessage() == sourceMessage()) || ((sourceMessage() != null) && (sourceMessage()
							.equals(m.sourceMessage()))))
					&& ((m.targetMessage() == targetMessage()) || ((targetMessage() != null) && (targetMessage()
							.equals(m.targetMessage()))))
					&& ((m.othersMessage() == othersMessage()) || ((othersMessage() != null) && (othersMessage()
							.equals(m.othersMessage()))));
		} else
