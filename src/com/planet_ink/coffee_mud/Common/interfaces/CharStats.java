 ...
 */
/**
 * An object to access and change fields representing the varias aspects of a
 * MOB
 * 
...
public interface CharStats extends CMCommon, Modifiable {
	...
	/**
	 * A method that simply calculates the nomimal max of the given ordinary
	 * stat code from available data.
	 * 
	 * @param abilityCode
	 *            (str, int, etc)
	 * @return the max stat.
	 ...
	 * Using this method will also update the STAT_MAX_* attributes to make sure
	 * that they are not able to be modifed upwards.
	 * 
	 * @see CharStats
	 * @param statNum
	 *            which STAT_ constant to get a value for
	 ...
	 * are defined as the first 6 STAT_ constants from the CharStats interface.
	 * Using this method will also update the STAT_MAX_* attributes to make sure
	 * that they are not able to be trained upwards.
	 * 
	 * @see CharStats
	 * @param statNum
	 *            which STAT_ constant to get an approx value for
	 * @param value
	 *            the value of the max, and approxvalue of the given STAT
	 */
	 ...
	 * @see CharStats
	 * @param mob
	 *            the mob to get adjustments for
	 * @param statNum
	...
	/**
	 * This method cross-references the given stat name string with the
	 * STAT_DESCS string list in the CharStats interface to return the STAT_
	 * constant which the given string represents.
	 * 
	 * @see CharStats
	 * @param abilityName
	...
	/**
	 * Uses the saving throw stats stored here the the mob, modified by basic
	 * attributes, to return a final Saving Throw value for this mob.
	 * 
	 * @see CharStats
	 * @param which
	...
	/**
	 * Return the number of a given body part which this mob has. The racial
	 * part number comes from the Race interface BODY_ constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 * @param racialPartNumber
	...
	/**
	 * Alter the number of a given body part which this mob has. The racial part
	 * number comes from the Race interface BODY_ constants. The number is
	 * positive or negative reflecting the change.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 * @param racialPartNumber
	 *            the BODY_ constant from Race interface
	 * @param number
	 *            the amount to change by, positive or negative
	 */
	public void alterBodypart(int racialPartNumber, int number);

	/**
	 * Check the difference between the number of a given body part which this
	 * mob has and the number he or she should have. The racial part number
	 * comes from the Race interface BODY_ constants. The return value is
	 * positive or negative reflecting the change.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 * @param racialPartNumber
	...
	/**
	 * Sets the body part situation for this mob from a string list. The name is
	 * a reminder to make sure the mobs Race is established first.
	 * 
	 * @param str
	 *            the string list representing the body part situation
	 */
	...
	/**
	 * Returns the CharClass object for this mob which corresponds to the the
	 * given index. The oldest class is always indexed at 0, with next newest at
	 * 1, and the current one last.
	 * 
	...
	/**
	 * Returns the CharClass object for this mob which corresponds to the the
	 * final index. The oldest class is always indexed at 0, with next newest at
	 * 1, and the current one last.
	 * 
	 * @see #numClasses()
	 * @see #getCharClasses()
	...
	/**
	 * Returns all CharClass objects for this mob. The oldest class is always
	 * indexed at 0, with next newest at 1, and the current one last.
	 * 
	 * @see #numClasses()
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	...
	/**
	 * Returns the number of levels that this mob has in the CharClass object
	 * which corresponds to the final index. The oldest class is always indexed
	 * at 0, with next newest at 1, and the current one last.
	 * 
	 * @see #numClasses()
	...
	/**
	 * Creates the enumerated set of character class objects stored here from a
	 * semicolon list of string names
	 * 
	 * @param classes
	...
	/**
	 * Creates the enumerated set of character class levels stored here from a
	 * semicolon list of levels.
	 * 
	 * @param levels
	 *            the semicolon list of levels
	 */
	public void setMyLevels(String levels);

	/**
	 * Returns the enumerated set of character class names stored here as a
	 * semicolon list of string names
	 * 
	...
	/**
	 * Returns the enumerated set of character class levels stored here as a
	 * semicolon list of levels.
	 * 
	 ...
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 * @param aClass
	 *            The charclass object to set the current class to
	 */
	 ...
	 * 
	 * @param level
	 *            The chararacter class level to set the current class to
	 */
	...
	/**
	 * Returns the number of levels this mob has in the given character class by
	 * name. -1 means the mob has NO levels in that class.
	 * 
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 * @param aClass
	...
	/**
	 * Returns the combined number of class levels the mob has in all of his
	 * classes, except for the current one.
	 * 
	...
	/**
	 * Returns true if this user is capped by the given classes level cap (if
	 * one exists)
	 * 
	...
	/**
	 * Changes the number of class levels the mob has in the given character
	 * class to the given level. If the mob does not have any levels in the
	 * given class, then setCurrentClass will be called first.
	 * 
	 * @see #setCurrentClass(CharClass)
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 * @param aClass
	 *            the character class to set a level for
	 * @param level
	 *            the level to set for the given character class
	 */
	...
	/**
	 * Sets the race of the mob. Race.startRacing should be called after this
	 * method is.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race#startRacing(MOB,
	 *      boolean)
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 * @param newVal
	 *            the Race of the mob
	...
	/**
	 * Returns the displayable name of this mobs current race. If this method is
	 * called on the mobs charStats() object, as opposed to baseCharStats(), it
	 * may return something different than charStats().getMyRace().name(). For
	 * this reason, you should ONLY use this method when you want to display the
	 * mobs current race.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 ...
	 * The list is guarenteed sorted. If the list is empty, the race can breathe
	 * anything at all.
	 * 
	...
	/**
	 * Sets resource codes of what this race can breathe as an atmosphere. The
	 * list MUST BE sorted. If the list is empty, the race can breathe anything
	 * at all.
	 * 
	 * @see com.planet_ink.coffee_mud.Items.interfaces.RawMaterial
	 * @see #getBreathables()
	...
	/**
	 * Changes the apparant race of ths mob by setting a new name. A value of
	 * null will reset this setting, allowing the mobs TRUE race to be displayed
	 * through the raceName method instead of the string set through this one.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	 * @see #setRaceName(String)
	 * @param newRaceName
	 *            the name of the mobs apparant race
	 */
	public void setRaceName(String newRaceName);

	/**
	 * Changes the apparant char class of ths mob by setting a new name. A value
	 * of null will reset this setting, allowing the mobs TRUE current class to
	 * be displayed through the displayClassName method instead of the string
	 * set through this one.
	 * 
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 ...
	 * @param newname
	 *            the name of the mobs apparant current class
	 */
	public void setDisplayClassName(String newname);

	/**
	 * Changes the apparant level of ths mob by setting a new name. A value of
	 * null will reset this setting, allowing the mobs TRUE level to be
	 * displayed through the displayClassLevel method instead of the string set
	 * through this one.
	 * 
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 * @see #displayClassName()
	 ...
	 * @param newlevel
	 *            the name of the mobs apparant level
	 */
	public void setDisplayClassLevel(String newlevel);

	/**
	 * Returns the displayable name of this mobs current class. If this method
	 * is called on the mobs charStats() object, as opposed to baseCharStats(),
	 * it may return something different than
	 * charStats().getCurrentClass().name(). For this reason, you should ONLY
	 * use this method when you want to display the mobs current class.
	 * 
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 * @see #setDisplayClassName(String)
	 * @see #displayClassLevel(MOB, boolean)
	...
	/**
	 * Returns either the given mobs authentic classlevel/total level, or the
	 * value set through setDisplayClassLevel method.
	 * 
	 * @see com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass
	 ...
	 * and the mobs real gender name will be displayed through the genderName
	 * method instead of the one set here.
	 * 
	 * @see #genderName()
	 * @param gname
	 *            the name of the mobs gender to display
	 */
	public void setGenderName(String gname);

	/**
	 * Returns the apparant gender of the mob. If this method is called on the
	 * mobs charStats() object, as opposed to baseCharStats(), it may return
	 * something different than charStats().getStat(GENDER) For this reason, you
	 * should ONLY use this method when you want to display the mobs current
	 * gender.
	 * 
	...
	/**
	 * Based on the apparant gender of the mob, return the appropriate word
	 * "him", "her", or "it".
	 * 
	...
	/**
	 * Returns the age category for this mob, based on the age stat constant
	 * stored here. The age categories are defined in the Race interface as AGE_
	 * constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Races.interfaces.Race
	...
	/**
	 * Returns the string name of the age category for this mob, based on the
	 * age stat constant stored here. The age category names are defined in the
	 * Race interface in the AGE_DESCS_ constant.
	 * 
	 ...
	 */
	public static final String[] DEFAULT_STAT_ABBR = { "S", "I", "D", "C",
			"CH", "W", "G", "vPY", "vF", "vC", "vW", "vG", "vMI", "V", "vJ",
			"vA", "vE", "vP", "vU", "vM", "vD", "vT", "mS", "mI", "mD", "mC",
			"mCH", "mW", "A", "vH", "vO", "vC", "Wa" };

	/** string array of descriptions of each stat code, ordered by numeric value */
	public static final String[] DEFAULT_STAT_DESCS = { "STRENGTH",
			"INTELLIGENCE", "DEXTERITY", "CONSTITUTION", "CHARISMA", "WISDOM",
			"GENDER", "PARALYSIS SAVE", "SAVE VS FIRE", "SAVE VS COLD",
			"SAVE VS WATER", "SAVE VS GAS", "SAVE VS MIND", "GENERAL SAVE",
			"JUSTICE SAVE", "SAVE VS ACID", "SAVE VS ELECTRICITY",
			"SAVE VS POISON", "SAVE VS UNDEAD", "SAVE VS MAGIC",
			"SAVE VS DISEASE", "SAVE VS TRAPS", "MAX STRENGTH ADJ.",
			"MAX INTELLIGENCE ADJ.", "MAX DEXTERITY ADJ.",
			"MAX CONSTITUTION ADJ.", "MAX CHARISMA ADJ.", "MAX WISDOM ADJ.",
			"AGE", "SAVE VS DETECTION", "SAVE VS OVERLOOKING",
			"SAVE VS CONVERSIONS", "WEIGHT ADJUSTMENT" };

	/** string array of descriptions of each stat code, ordered by numeric value */
	public static final String[] DEFAULT_STAT_NAMES = { "STRENGTH",
			"INTELLIGENCE", "DEXTERITY", "CONSTITUTION", "CHARISMA", "WISDOM",
			"GENDER", "PARALYSIS", "FIRE", "COLD", "WATER", "GAS", "MIND",
			"GENERAL", "JUSTICE", "ACID", "ELECTRICITY", "POISON", "UNDEAD",
			"MAGIC", "DISEASE", "TRAPS", "MAXSTRENGTH", "MAXINTELLIGENCE",
			"MAXDEXTERITY", "MAXCONSTITUTION", "MAXCHARISMA", "MAXWISDOM",
			"AGE", "DETECTION", "OVERLOOKING", "CONVERSION", "WEIGHTADJ" };

	/**
	 * string array of attributable descriptions of each stat code, ordered by
	 * numeric value
	 */
	public static final String[] DEFAULT_STAT_DESC_ATTS = { "STRONG",
			"INTELLIGENT", "DEXTEROUS", "HEALTHY", "CHARISMATIC", "WISE", "",
			"RESISTANT TO PARALYSIS", "RESISTANT TO FIRE", "RESISTANT TO COLD",
			"RESISTANT TO WATER", "RESISTANT TO GAS",
			"RESISTANT TO MIND ATTACKS", "RESISTANT",
			"RESISTANT TO UNDIGNIFIED ATTACKS", "RESISTANT TO ACID",
			"RESISTANT TO ELECTRICITY", "RESISTANT TO POISON",
			"RESISTANT TO UNDEAD", "RESISTANT TO MAGIC",
			"RESISTANT TO DISEASE", "RESISTANT TO TRAPS", "POTENTIALLY STRONG",
			"POTENTIALLY INTELLIGENT", "POTENTIALLY DEXTROUS",
			"POTENTIALLY HEALTHY", "POTENTIALLY CHARISMATIC",
			"POTENTIALLY WISE", "OLD", "CONCEALED", "WATCHFUL", "DOUBTFUL", "" };

	/**
	 * an appropriate CMMsg MSG type to correspond to the given saving throw,
	 * indexed as STAT_SAVE_ constant
	 */
	public static int[] DEFAULT_STAT_MSG_MAP = {
			...
			-1, // wisdom
			-1, // gender
			CMMsg.TYP_PARALYZE, CMMsg.TYP_FIRE, CMMsg.TYP_COLD,
			CMMsg.TYP_WATER, CMMsg.TYP_GAS, CMMsg.TYP_MIND, CMMsg.TYP_GENERAL,
			CMMsg.TYP_JUSTICE, CMMsg.TYP_ACID, CMMsg.TYP_ELECTRIC,
			CMMsg.TYP_POISON, CMMsg.TYP_UNDEAD, CMMsg.TYP_CAST_SPELL,
			CMMsg.TYP_DISEASE, -1, // traps
			-1, // max str
			-1, // max int
			-1, // max
			-1, // max dex
	...
	public class CODES {
		...
		public CODES() {
			super();
			char c = Thread.currentThread().getThreadGroup().getName()
					.charAt(0);
			if (insts == null)
				insts = new CODES[256];
			if (insts[c] == null)
			...
			String[][] addExtra = CMProps.instance().getStrsStarting(
					"ADDCHARSTAT_");
			String[][] repExtra = CMProps.instance().getStrsStarting(
					"REPLACECHARSTAT_");
			for (int i = 0; i < 6; i++)
				addBaseStat(DEFAULT_STAT_ABBR[i], DEFAULT_STAT_DESCS[i],
						DEFAULT_STAT_NAMES[i], DEFAULT_STAT_DESC_ATTS[i],
						DEFAULT_STAT_MSG_MAP[i]);
			addAllStat(DEFAULT_STAT_ABBR[6], DEFAULT_STAT_DESCS[6],
					DEFAULT_STAT_NAMES[6], DEFAULT_STAT_DESC_ATTS[6],
					DEFAULT_STAT_MSG_MAP[6], false);
			for (int i = 7; i < 22; i++)
				addSavingThrow(DEFAULT_STAT_ABBR[i], DEFAULT_STAT_DESCS[i],
						DEFAULT_STAT_NAMES[i], DEFAULT_STAT_DESC_ATTS[i],
						DEFAULT_STAT_MSG_MAP[i]);
			int baseCtr = 0;
			for (int i = 22; i < 28; i++)
				addMaxStat(baseStatCodes[baseCtr++], DEFAULT_STAT_ABBR[i],
						DEFAULT_STAT_DESCS[i], DEFAULT_STAT_NAMES[i],
						DEFAULT_STAT_DESC_ATTS[i], DEFAULT_STAT_MSG_MAP[i]);
			addAllStat(DEFAULT_STAT_ABBR[28], DEFAULT_STAT_DESCS[28],
					DEFAULT_STAT_NAMES[28], DEFAULT_STAT_DESC_ATTS[28],
					DEFAULT_STAT_MSG_MAP[28], false);
			for (int i = 29; i < 31; i++)
				addSavingThrow(DEFAULT_STAT_ABBR[i], DEFAULT_STAT_DESCS[i],
						DEFAULT_STAT_NAMES[i], DEFAULT_STAT_DESC_ATTS[i],
						DEFAULT_STAT_MSG_MAP[i]);
			for (int i = 31; i < DEFAULT_NUM_STATS; i++)
				addAllStat(DEFAULT_STAT_ABBR[i], DEFAULT_STAT_DESCS[i],
						DEFAULT_STAT_NAMES[i], DEFAULT_STAT_DESC_ATTS[i],
						DEFAULT_STAT_MSG_MAP[i], false);
			for (int i = 0; i < addExtra.length + repExtra.length; i++) {
				String[] array = (i >= addExtra.length) ? repExtra[i
						- addExtra.length] : addExtra[i];
				boolean replace = i >= addExtra.length;
				String stat = array[0].toUpperCase().trim();
				String p = array[1];
				List<String> V = CMParms.parseCommas(p, false);
				if (V.size() != 4) {
					Log.errOut("CharStats",
							"Bad coffeemud.ini charstat row, requires 4 ; separated entries: "
									+ p);
					continue;
				}
				...
				if (replace) {
					...
					if (oldStatCode < 0)
						oldStatCode = CMParms.indexOf(DEFAULT_STAT_DESCS,
								repStat);
					if (oldStatCode >= 0)
						type = "REPLACE";
					else {
						Log.errOut("CharStats",
								"Bad coffeemud.ini charstat row, bad stat name: "
										+ repStat);
						continue;
					}
				}
				...
				if (type.equalsIgnoreCase("BASE")) {
					...
					addMaxStat(baseStatCode, "m" + abbr, "MAX " + stat
							+ " ADJ.", "MAX" + stat, "POTENTIALLY " + adj, -1);
					...
					if (stat.length() > 3)
						shortNames[oldStatCode] = CMStrings.capitalizeAndLower(
								stat).substring(0, 3);
					else
						shortNames[oldStatCode] = CMStrings
								.capitalizeAndLower(stat);
					statAttributionDescriptions[oldStatCode] = adj;
					statCMMsgMapping[oldStatCode] = -1;
				} else
					Log.errOut("CharStats",
							"Bad coffeemud.ini charstat row, bad type: " + type);
			}
		}

		private static CODES c() {
			return insts[Thread.currentThread().getThreadGroup().getName()
					.charAt(0)];
		}
		...
		public static CODES instance() {
			CODES c = insts[Thread.currentThread().getThreadGroup().getName()
					.charAt(0)];
			if (c == null)
				c = new CODES();
			return c;
		...
		/**
		 * Returns the code for the base code that matches the given max adj
		 * code Returns the code for the max adj code that matches the given
		 * base code Returns -1 if the code is not a max adj code.
		 * 
		...
		public int find(String name, boolean exactOnly) {
			...
			if (exactOnly)
				return -1;
			for (int i = 0; i < total(); i++) {
				if ((name(i).toLowerCase().startsWith(name))
						|| (desc(i).toLowerCase().startsWith(name)))
					return i;
			}
			return -1;
		}
		 ...
		 * 
		 * @param abbr
		 *            1-3 letter short code for this stat
		 * @param desc
		 *            longer description of this stat
		 * @param name
		 *            space-free coded name of this stat
		 * @param attDesc
		 *            description of someone with this stat in abundance
		 * @param cmmsgMap
		 *            a CMMsg message code that saves with this stat
		 */
		public void addBaseStat(String abbr, String desc, String name,
				String attDesc, int cmmsgMap) {
			baseStatCodes = Arrays.copyOf(baseStatCodes,
					baseStatCodes.length + 1);
			baseStatCodes[baseStatCodes.length - 1] = allStatCodes.length;
			baseStatNames = Arrays.copyOf(baseStatNames,
					baseStatNames.length + 1);
		 ...
		 *            a CMMsg message code that saves with this stat
		 */
		public void addMaxStat(int baseCode, String abbr, String desc,
				String name, String attDesc, int cmmsgMap) {
			...
			MaxBaseCrossCodes = Arrays.copyOf(MaxBaseCrossCodes,
					allStatCodes.length);
		...
		/**
		 * Adds a new saving throw stat to this object for all mobs and players
		 * to share
		 * 
		 * @param abbr
		 *            1-3 letter short code for this stat
		 ...
		 *            a CMMsg message code that saves with this stat
		 */
		public void addSavingThrow(String abbr, String desc, String name,
				String attDesc, int cmmsgMap) {
			savingThrowCodes = Arrays.copyOf(savingThrowCodes,
					savingThrowCodes.length + 1);
			savingThrowCodes[savingThrowCodes.length - 1] = allStatCodes.length;
			addAllStat(abbr, desc, name, attDesc, cmmsgMap, false);
		}

		/**
		 * Adds a new miscellaneous stat to this object for all mobs and players
		 * to share
		 * 
		 * @param abbr
		 *            1-3 letter short code for this stat
		 ...
		 *            a CMMsg message code that saves with this stat
		 */
		public void addAllStat(String abbr, String desc, String name,
				String attDesc, int cmmsgMap, boolean base) {
			...
			statAbbreviations = Arrays.copyOf(statAbbreviations,
					allStatCodes.length);
			statAbbreviations[allStatCodes.length - 1] = abbr;
			statDescriptions = Arrays.copyOf(statDescriptions,
					allStatCodes.length);
			statDescriptions[allStatCodes.length - 1] = desc.toUpperCase()
					.trim();
			statNames = Arrays.copyOf(statNames, allStatCodes.length);
			statNames[allStatCodes.length - 1] = name.toUpperCase().trim()
					.replace(' ', '_');
			shortNames = Arrays.copyOf(shortNames, allStatCodes.length);
			if (name.length() > 3)
				shortNames[allStatCodes.length - 1] = CMStrings
						.capitalizeAndLower(name.trim().replace(' ', '_'))
						.substring(0, 3);
			else
				shortNames[allStatCodes.length - 1] = CMStrings
						.capitalizeAndLower(name.trim().replace(' ', '_'));
			statAttributionDescriptions = Arrays.copyOf(
					statAttributionDescriptions, allStatCodes.length);
			statAttributionDescriptions[allStatCodes.length - 1] = attDesc
					.toUpperCase();
			statCMMsgMapping = Arrays.copyOf(statCMMsgMapping,
					allStatCodes.length);
