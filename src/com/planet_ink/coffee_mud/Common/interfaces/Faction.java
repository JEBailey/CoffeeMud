...
public interface Faction extends CMCommon, MsgListener, Contingent {
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#initializeFaction(StringBuffer,
	 *      String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	 * @param aname
	 *            the factionID (and default name)
	 */
	public void initializeFaction(String aname);

	/**
	 * Initializes a new faction from a faction.ini properties formatted
	 * document, and a given new faction ID
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#initializeFaction(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#getINIDef(String,
	 *      String)
	 * @param file
	 *            the ini properties style document
	 * @param fID
	 *            the new factionID
	 */
	...
	/**
	 * Retreives an entry for an ini properties definition document that
	 * describes this faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#getINIDef(String,
	 *      String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#initializeFaction(StringBuffer,
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#TAG_NAMES
	 * @param tag
	 *            the tag to retreive a properties definition for
	 * @param delimeter
	 *            if the tag represents a list, this is the delimiter for
	 *            entries.
	 ...
	 * information in. It will contain all the affects and behaviors, and other
	 * information necessary to maintain a relationship between the given mob
	 * and this faction. Any parameters should be set on the affects or
	 * behaviors before returning them.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FData
	 * @param mob
	 *            the mob to generate affects and behaviors for
	 * @return a FactionData object with all the appropriate affects and
	 *         behaviors
	 */
	public FData makeFactionData(MOB mob);

	/**
	 * Updates the given FactionData object that the given mob to store his
	 * faction information in. It will contain all the affects and behaviors,
	 * and other information necessary to maintain a relationship between the
	 * given mob and this faction. Any parameters should be set on the affects
	 * or behaviors before returning them.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FData
	 * @param mob
	 *            the mob to generate affects and behaviors for
	 * @param data
	 *            the old faction data object
	 */
	 ...
	 * the CoffeeMud VFS path from the resources directory, of the properties
	 * ini file that defines the faction. The ID (and therefore the properties
	 * file location) should not be changed once a faction is "deployed".
	 * 
	...
	/**
	 * Sets the official, unique faction id of this faction. FactionIDs are
	 * usually the CoffeeMud VFS path from the resources directory, of the
	 * properties ini file that defines the faction. The ID (and therefore the
	 * properties file location) should not be changed once a faction is
	 * "deployed".
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	 * @param newStr
	 *            the new unique id of this faction
	 */
	 ...
	 * @param newStr
	 *            the new name of this faction
	 */
	public void setName(String newStr);

	/**
	 * Gets the filename of a file, from the resources directory, that is
	 * displayed to users when they are given the choice of a starting value to
	 * this faction. Requires more than one choice range be available.
	 * 
	...
	/**
	 * Sets the filename of a file, from the resources directory, that is
	 * displayed to users when they are given the choice of a starting value to
	 * this faction. Requires more than one choice range be available.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#findChoices(MOB)
	 * @param newStr
	 *            the new filename of the choice description file
	 */
	...
	/**
	 * Sets the string code describing how a faction-holders experience changes
	 * from killing another faction holder affect his own faction value.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#EXPAFFECT_NAMES
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#EXPAFFECT_DESCS
	 * @param newStr
	 *            the new string code for xp changes->faction changes
	 */
	...
	/**
	 * Returns whether this factions value is shown in certain special admins
	 * commands.
	 * 
	...
	/**
	 * Sets whether this factions value is shown in certain special admins
	 * commands.
	 * 
	 * @param truefalse
	...
	/**
	 * Returns whether this factions value is shown as a line item in mob
	 * editors
	 * 
	...
	/**
	 * Returns the default faction mask/value list, which is applied whenever a
	 * Faction Change Event applies a Faction Add command. A default faction
	 * mask/value is defined as a number, along with an optional Zapper mask
	 * describing to whom the value is applied.
	 * 
	...
	/**
	 * Returns the default faction value that applies to the given mob. This
	 * method is called when a Faction Change event applies a Faction Add
	 * command. Returns Integer.MAX_VALUE if no default value applies to this
	 * mob. Each list item is a string.
	 * 
	...
	/**
	 * Sets the default faction mask/value list, which is applied whenever a
	 * Faction Change Event applies a Faction Add command. A default faction
	 * mask/value is defined as a number, along with an optional Zapper mask
	 * describing to whom the value is applied. Each list item is a string.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#changeEventKeys()
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#defaults()
	 * @param v
	 *            the new default faction mask/value list
	 */
	public void setDefaults(List<String> v);

	/**
	 * Returns the automatic default faction mask/value list, which is possibly
	 * applied whenever a mob or player is brought to life for the first time.
	 * An automatic default faction mask/value is defined as a number, along
	 * with an optional Zapper mask describing to whom the value is applied.
	...
	/**
	 * Returns the automatic default faction value that applies to the given
	 * mob. This method is called when a mob is brought into the world. Returns
	 * Integer.MAX_VALUE if no default value applies to this mob.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#defaults()
	 * @param mob
	...
	/**
	 * Sets the automatic default faction mask/value list, which is possibly
	 * applied whenever a mob or player is brought to life for the first time.
	 * An automatic default faction mask/value is defined as a number, along
	 * with an optional Zapper mask describing to whom the value is applied.
	 * Each list item is a string.
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 * @param v
	 *            the new automatic default faction mask/value list
	 */
	 ...
	 * @param d
	 *            the new modifier of the base amount of faction value change
	 */
	public void setRateModifier(double d);

	/**
	 * Returns the player choosable faction mask/value list, which is possibly
	 * presented whenever a player creates a new character. An faction
	 * mask/value is defined as a number, along with an optional Zapper mask
	 * describing to whom the value is applied. Each list item is a string.
	 * 
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	...
	/**
	 * Returns a vector of Integer objects representing the choosable faction
	 * values available to the given mob when they create a new character.
	 * 
	...
	/**
	 * Sets the player choosable faction mask/value list, which is possibly
	 * presented whenever a player creates a new character. An faction
	 * mask/value is defined as a number, along with an optional Zapper mask
	 * describing to whom the value is applied. Each list item is a string.
	 * 
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#choices()
	 * @param v
	 *            the list of choosable faction mask/values
	 */
	...
	/**
	 * Returns the name of the Faction.FactionRange object that applies to the
	 * given faction value.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ranges()
	 * @param faction
	...
	/**
	 * Adds a new Faction.FactionRange object to this faction using an encoded
	 * key. The key is encoded as semicolon separated values of low, high, name,
	 * code name, and alignment flag.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FRange
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ranges()
	 * @param key
	 ...
	 *      eventID)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#delChangeEvent(Faction.FactionChangeEvent
	 *      event)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ALL_CHANGE_EVENT_TYPES()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#executeChange(MOB,
	 *      MOB,
	 *      com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent)
	...
	/**
	 * Returns a FactionChangeEvent that applies when the given event name (a
	 * trigger code) occurs in the game.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#changeEventKeys()
	...
	/**
	 * Adds a new FactionChangeEvent object to this faction using the given
	 * event code name, or fully encoded event string. The key must be either a
	 * single event trigger code (an ability name, event code name), or a fully
	 * encoded string which is a semicolon delimited field consisting of event
	 ...
	 * @return the FactionChangeEvent object created and added to this faction,
	 *         or null
	 */
	...
	/**
	 * Executes a Faction change event for the given event source and target,
	 * and the applicable FactionChangeEvent event object for this faction
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#changeEventKeys()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ALL_CHANGE_EVENT_TYPES()
	 ...
	 * @param event
	 *            the applicable event object for this faction
	 */
	public void executeChange(MOB source, MOB target, FactionChangeEvent event);

	/**
	 * Computed completed at runtime, this method returns all possible valid
	 * FactionChangeEvent event ids that can be used to define triggers.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#changeEventKeys()
	...
	/**
	 * Returns an enumeration of Object arrays referring to the a factor to
	 * multiply times the base amount (100) of faction change (up or down) for
	 * particular mobs who match a given Zapper mask. Each Object array consists
	 * of a factor to apply on faction gains, a factor to apply on factor drops,
	 * and the zapper mask to decide which mobs it applies to (or mob states).
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addFactor(double,
	 *      double, String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#delFactor(Faction.FZapFactor)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#findFactor(MOB,
	 *      boolean)
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 ...
	 * dependent multiplier by a change in faction. It consists of a Zapper mask
	 * to determine whether the factor applies to the given mob/player state,
	 * and a factor to apply on gains in faction or losses in faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factors()
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 * @param gain
	 *            the factor to apply on gains in faction
	 * @param loss
	 *            the factor to apply on losses of faction
	 * @param mask
	 *            the zapper mask to use to determine if this factor applies to
	 *            a mob
	...
	/**
	 * Returns the applicable change factor for the given mob, and the whether
	 * the faction change was a gain or loss (not a gain).
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factors()
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 * @param mob
	 *            the mob to compare against the zapper masks of the various
	 *            factors
	 * @param gain
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addRelation(String,
	 *      double)
	...
	/**
	 * Removes the give faction relation from this faction. Requires a faction
	 * id of another faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	...
	/**
	 * Adds a new faction relation factor to this faction. The faction id is the
	 * id of another complementary or rival faction, and the relation is a
	 * number multiplied by thge change in this faction to determine the amount
	 * the given faction id faction is changed by. The relation factor can be
	 * positive or negative to cause the faction id faction to rise or fall.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factionID()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#relationFactions()
	 * @param factionID
	 *            the faction id of the other faction
	 * @param relation
	 ...
	 * automatically but conditionally added to mobs (not players) with this
	 * faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addAffectBehav(String,
	 *      String, String)
	...
	/**
	 * Removes the given ability or behavior from this Faction. It will require
	 * the mob be reset or rejuved in order for this to take affect.
	 * 
	 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 ...
	 * parameters required by the Behavior or Ability. The gainMask is a simple
	 * mask to further narrow what kind of mobs receive the given Ability or
	 * Behavior when first receiving this Faction. It will require the mob be
	 * reset or rejuved in order for this to take affect.
	 * 
	 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#affectsBehavs()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#delAffectBehav(String)
	 * @param ID
	 *            the Abilities or Behavior ID to add
	 * @param parms
	 *            the parameters for the new affect or behavior
	 * @param gainMask
	...
	/**
	 * Returns a string array containing the parms at index 0, and the gainMask
	 * at 1. See addAffectBehav for more information.
	 * 
	 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#affectsBehavs()
	 ...
	 * @return a string array containing the parms at index 0, and the gainMask
	 *         at 1
	 */
	public String[] getAffectBehav(String ID);

	/**
	 * Returns an enumeration of Faction.FactionReaction items associated with
	 * this faction. These are automatically added to mobs in the presence of
	 * one with this faction.
	 * 
	...
	/**
	 * Returns an enumeration of Faction.FactionReaction items associated with
	 * this faction and the given range code. These are automatically added to
	 * mobs in the presence of one with this faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addReaction(String,
	 *      String, String, String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#delReaction(Faction.FReactionItem)
	 ...
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 * @param range
	 *            the faction range to use as a determinate
	 * @param abilityID
	 *            the ability/Behavior/or command ID
	 * @param parms
	 *            the parameters for the new affect or behavior or command
	 * @param mask
	 *            the zapper mask to check to see which mob qualifies
	 * @return whether the new reaction was successfully added
	 */
	public boolean addReaction(String range, String mask, String abilityID,
			String parms);

	/**
	 * Set this faction to use the light-reaction system, which is easier on
	 * resources, but not as powerful.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#useLightReactions()
	 * @param truefalse
	 *            true to use the light reaction system, false otherwise
	 */
	public void setLightReactions(boolean truefalse);

	/**
	 * Return whether this faction uses the light-reaction system, which is
	 * easier on resources, but not as powerful.
	 * 
	...
	/**
	 * Returns an enumeration of Faction.FactionAbilityUsage objects for this
	 * Faction. A FactionAbilityUsage object defines restrictions on the use of
	 * a mob or players abilities based on values in this faction and other
	 * variables.
	 * 
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#canUse(MOB,
	 *      Ability)
	 * @return an enumeration of Faction.FactionAbilityUsage objects for this
	 *         Faction
	 */
	public Enumeration<Faction.FAbilityUsage> abilityUsages();

	/**
	 * Returns the list of faction ranges that apply based on
	 * Faction.FactionAbilityUsage usage factor that apply to the given ability.
	 * An empty string means it does not apply.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FRange
	 * @param A
	 *            the ability to find a usage factor for, and then use to find
	 *            applicable ranges
	 * @return the list of faction range names that apply to this ability from
	 *         usage factors
	 */
	public String usageFactorRangeDescription(Ability A);

	/**
	 * Returns whether any of the Faction.FactionAbilityUsage objects for this
	 * Faction apply to the given ability.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	 * @param A
	...
	/**
	 * Returns whether the given player/mob is prevented from using the given
	 * Ability based on any of the Faction.FactionAbilityUsage (faction ability
	 * usage) criterium defined for this Faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	 * @param mob
	 *            the mob/player to evaluate
	 * @param A
	...
	/**
	 * Adds a new Faction.FactionAbilityUsage object to this Faction based on
	 * the given definitional key. The key is NULL to create an empty usage, or
	 * a definitional string that consists of one or more ability names,
	 * domains, flags, etc followed by a semicolon and a minimum faction value,
	 * and another semicolon and a maximum faction value.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#delAbilityUsage(com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage)
	...
	/**
	 * Returns the enumerated Faction.FactionAbilityUsage object at the given
	 * index.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	...
	/**
	 * A Faction Change Event is an event that triggers an automatic change in a
	 * mob or players faction value. Triggers can be the use of abilities, or
	 * certain specific coded events (such as killing another mob).
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ALL_CHANGE_EVENT_TYPES()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#executeChange(MOB,
	 *      MOB,
	...
	public static interface FactionChangeEvent {
		...
		/**
		 * A derivative of the event id, this will return a value of 0 or above
		 * if the event id was of a particular Ability FLAG_. Returns -1 if this
		 * value does not apply, or an index into FLAG_DESCS.
		 * 
		 ...
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#just100()
		 * @param newFlagCache
		 *            the new list of applicable flags
		 */
		public void setFlags(String newFlagCache);

		/**
		 * A derivative of the flag cache, this method returns whether the flag
		 * was set that allows this event to trigger when the target of the
		 * event does not have any value with this faction
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#flagCache()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#selfTargetOK()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#just100()
		 * @return true if the target does not have to have this faction, false
		 *         otherwise
		 */
		...
		/**
		 * A derivative of the flag cache, this method returns whether the flag
		 * was set that allows this event to trigger when the target and source
		 * of the event are the same.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#flagCache()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#outsiderTargetOK()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#just100()
		...
		/**
		 * A derivative of the flag cache, this method returns whether the flag
		 * was set that causes the determination of the amount of faction move
		 * to apply to NOT take the difference between the source and targets
		 * levels into account.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#flagCache()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#outsiderTargetOK()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#selfTargetOK()
		 * @return true to NOT take level into account when determining amount
		 *         of faction change
		 */
		public boolean just100();

		/**
		 * Returns a code for a description of how an event, if applicable, will
		 * affect this factions value. The direction is an index into
		 * CHANGE_DIRECTION_DESCS, or one of the CHANGE_DIRECTION_ constants.
		 * 
		...
		/**
		 * Sets a code for a description of how an event, if applicable, will
		 * affect this factions value. The direction is an index into
		 * CHANGE_DIRECTION_DESCS, or one of the CHANGE_DIRECTION_ constants.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#CHANGE_DIRECTION_DESCS
		 ...
		 * @param newVal
		 *            a new FactionChangeEvent#CHANGE_DIRECTION_ constant
		 */
		public void setDirection(int newVal);

		/**
		 * Returns the factor to multiply the base faction change amount (100)
		 * by, to determine the amount of this faction changed by this event, in
		 * accordance with the given direction.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#direction()
		...
		/**
		 * Sets the factor to multiply the base faction change amount (100) by,
		 * to determine the amount of this faction changed by this event, in
		 * accordance with the given direction.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#direction()
		...
		/**
		 * Returns the zapper mask that is used to see if the target of the
		 * event qualifies in order to trigger a faction change by this defined
		 * event.
		 * 
		...
		/**
		 * Returns the zapper mask that is used to see if the source of the
		 * event qualifies in order to trigger a faction change by this defined
		 * event.
		 * 
		...
		/**
		 * Sets the zapper mask that is used to see if the target of the event
		 * qualifies in order to trigger a faction change by this defined event.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#targetZapper()
		 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
		 * @param newVal
		 *            the new zapper mask string
		 */
		public void setTargetZapper(String newVal);

		/**
		 * Returns any trigger parameters defined that modify the way the
		 * trigger behaves.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FactionChangeEvent#setTriggerParameters(String)
		...
		/**
		 * Sets any trigger parameters defined that modify the way the trigger
		 * behaves.
		 * 
		 ...
		 * @param x
		 *            which internal state variable to set
		 * @param newVal
		 *            the state variable
		 */
		...
		/**
		 * Returns a semicolon delimited list of all the settings in this change
		 * event
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#createChangeEvent(String)
		 * @return a semicolon delimited list of all the settings in this change
		 *         event
		 */
		public String toString();

		/**
		 * Returns whether the given mob is a valid source and target of this
		 * event.
		 * 
		 * @param source
		...
		/**
		 * a direction constant meaning this event changes the factions value
		 * upward
		 */
		...
		/**
		 * a direction constant meaning this event changes the factions value
		 * opposite of targets faction leanings
		 */
		public static final int CHANGE_DIRECTION_OPPOSITE = 2;
		/**
		 * a direction constant meaning this event changes the factions value
		 * directly to lowest value
		 */
		public static final int CHANGE_DIRECTION_MINIMUM = 3;
		/**
		 * a direction constant meaning this event changes the factions value
		 * directly to highest value
		 */
		public static final int CHANGE_DIRECTION_MAXIMUM = 4;
		/**
		 * a direction constant meaning this event removes the faction
		 * altogether
		 */
		public static final int CHANGE_DIRECTION_REMOVE = 5;
		/**
		 * a direction constant meaning this event adds the faction with a
		 * default value
		 */
		public static final int CHANGE_DIRECTION_ADD = 6;
		/**
		 * a direction constant meaning this event changes the factions value
		 * away from targets value
		 */
		public static final int CHANGE_DIRECTION_AWAY = 7;
		/**
		 * a direction constant meaning this event changes the factions value
		 * towards the targets value
		 */
		public static final int CHANGE_DIRECTION_TOWARD = 8;
		/**
		 * the code words for the various direction flags that describe the
		 * direction and amount of faction change
		 */
		public static final String[] CHANGE_DIRECTION_DESCS = { "UP", "DOWN",
				"OPPOSITE", "MINIMUM", "MAXIMUM", "REMOVE", "ADD", "AWAY",
				"TOWARD" };
		/**
		 * the code words for the various evaluation flags to decide if this
		 * event applies and other things
		 */
		public static final String[] FLAG_DESCS = { "OUTSIDER", "SELFOK",
				"JUST100" };
		/** some non-ability-related event trigger ids */
		public static final String[] MISC_TRIGGERS = { "MURDER", "TIME",
				"ADDOUTSIDER", "KILL", "BRIBE", "TALK", "MUDCHAT", "ARRESTED" };
	}

	/**
	 * The foundation of any Faction, the Faction Range represents a range of
	 * values that constitutes a single named group of numeric values for the
	 * faction. A factions total range is determined by the high value of the
	 * highest range and the low value of the lowest range.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addRange(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#ranges()
	 * 
	...
	public static interface FRange {
		/**
		 * Returns the unique code name that describes this range of faction
		 * values
		 * 
		 * @return the unique code name that describes this range of faction
		 *         values
		 */
		...
		/**
		 * Sets the nice friendly displayable name of this faction range, which
		 * need not be unique.
		 * 
		 ...
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.Align
		 * @param newVal
		 *            a new alignment constant
		 */
		public void setAlignEquiv(Align newVal);

		/**
		 * Returns a semicolon-delimited representation of this faction range,
		 * which can be used to create a new one later.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addRange(String)
	...
	/**
	 * A FactionData object is stored inside other objects that keep track of
	 * their own faction. The object stores the faction value, any event
	 * listeners or tickers, and a method to determine when it is time to
	 * refresh the object.
	 * 
	...
	public static interface FData extends MsgListener, StatsAffecting {
		/**
		 * Cleans out the internal data structures of this faction to denote
		 * that a new context is entered. Is called by the constructor.
		 * 
		 * @param F
		 *            the faction to which this data belongs.
		 */
		public void resetFactionData(Faction F);

		/**
		 * Returns true if this object requires updating by the parent faction
		 * for some reason.
		 * 
		 ...
		 * 
		 * @param abilities
		 *            a vector of abilities
		 * @param behaviors
		 *            a vector of behaviors
		 */
		public void addHandlers(Vector<Ability> abilities,
				Vector<Behavior> behaviors);
	}

	/**
	 * A Faction Ability Usage object represents a set of criterium that can be
	 * used to determine whether this faction allows a mob or player to use a
	 * particular ability, or class of abilities.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addAbilityUsage(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#abilityUsages()
	 * @author Bo Zimmerman
	...
	public static interface FAbilityUsage {
		/**
		 * The unconverted ability mask, denoting ability ids, domains, flags,
		 * etc. Is parsed for benefit of other methods below
		 * 
		...
		/**
		 * Sets the ability usage masks and methods from an ability id, domain,
		 * flags, etc. Parses the string sent to set many of the methods below.
		 * 
		 ...
		 * @param str
		 *            the ability usage mask
		 * @return A vector of words inside the given string that are not valid
		 *         or were not understood.
		 */
		public List<String> setAbilityFlag(String str);

		/**
		 * A bitmask of ability flags that must NOT be set for this usage to
		 * apply to an ability
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#flag()
		 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability#FLAG_DESCS
		 * @return a bitmask of Ability flags that must not be set by the
		 *         ability
		 */
		public int notflag();

		/**
		 * A bitmask of ability flags that MUST be set for this usage to apply
		 * to an ability
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#notflag()
		...
		/**
		 * An ability code that an ability must be in order for this usage to
		 * apply, or -1
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability#ACODE_DESCS
		 * @return an ability code that an ability must be in order for this
		 *         usage to apply, or -1
		 */
		public int type();

		/**
		 * An ability domain that an ability must be in order for this usage to
		 * apply, or -1
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability#DOMAIN_DESCS
		 * @return an ability domain that an ability must be in order for this
		 *         usage to apply, or -1
		 */
		public int domain();

		/**
		 * The minimum value that a player must have in the faction to be able
		 * to use the selected ability referred to by the ability flags of this
		 * usage criterium.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		...
		/**
		 * Sets the minimum value that a player must have in the faction to be
		 * able to use the selected ability referred to by the ability flags of
		 * this usage criterium.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#low()
		 * @param newVal
		 *            a new minimum faction value
		 */
		public void setLow(int newVal);

		/**
		 * Returns the maximum value that a player must have in the faction to
		 * be able to use the selected ability referred to by the ability flags
		 * of this usage criterium.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		...
		/**
		 * Sets the maximum value that a player must have in the faction to be
		 * able to use the selected ability referred to by the ability flags of
		 * this usage criterium.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FAbilityUsage#abilityFlags()
		 ...
		 * @param newVal
		 *            a new maximum faction value
		 */
		public void setHigh(int newVal);

		/**
		 * Returns a semicolon-delimited string of the values of this ability
		 * usage, suitable for using to create a new one later.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addAbilityUsage(String)
		 * @return a semicolon-delimited string of the values of this ability
		 *         usage
		 */
		public String toString();
	}
	...
	/**
	 * A factor defines how modifications of faction value, up or down, are
	 * modified on a mob by mob basis.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addFactor(double,
	 *      double, String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#factors()
	...
	public static interface FZapFactor {
		 ...
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FZapFactor#setMOBMask(String)
		 * @return the compiled mask to tell which mobs to apply this reaction
		 *         to
		 */
		public MaskingLibrary.CompiledZapperMask compiledMOBMask();

		/**
		 * Set the mask to determine which mobs in the players presence will be
		 * affected. This is a zappermask.
		 * 
		 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FZapFactor#MOBMask()
		 * @param str
		 *            the mask to determine which mobs in the players presence
		 *            will be affected
		 */
		public void setMOBMask(String str);

		/**
		 * Returns a semicolon-delimited string of the values of this factpr,
		 * suitable for using to create a new one later.
		 * 
	...
	/**
	 * Adds very temporary affects and behaviors to mobs who match the reaction
	 * zapper mask, and who are in the same room as someone with standing in
	 * this faction.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addReaction(String,
	 *      String, String, String)
	...
	public static interface FReactionItem {
		...
		/**
		 * The code name of the range which determines which folks with this
		 * faction get a reaction
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FReactionItem#setRangeName(String)
		 * @return the range which determines which folks with this faction get
		 *         a reaction
		 */
		public String rangeCodeName();

		/**
		 * Set the code name of the range which determines which folks with this
		 * faction get a reaction
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction.FReactionItem#rangeCodeName()
		 * @param str
		 *            the range which determines which folks with this faction
		 *            get a reaction
		 */
		...
		/**
		 * Returns a semicolon-delimited string of the values of this reaction,
		 * suitable for using to create a new one later.
		 * 
		 * @see com.planet_ink.coffee_mud.Common.interfaces.Faction#addReaction(String,
		 *      String, String, String)
	...
	/**
	 * internal flag masks meaning to skip standard auto system, retrieved by
	 * {@link Faction#getInternalFlags()}
	 */
	public static final long IFLAG_IGNOREAUTO = 1;
	/**
	 * internal flag masks meaning to never save to a file, retrieved by
	 * {@link Faction#getInternalFlags()}
	 */
	public static final long IFLAG_NEVERSAVE = 2;
	/**
	 * internal flag masks meaning to skip normal ticking, retrieved by
	 * {@link Faction#getInternalFlags()}
	 */
	public static final long IFLAG_CUSTOMTICK = 4;

	/**
	 * legacy enumerator constant for {@link FRange#alignEquiv()} denoting that
	 * the range does not reflect alignment
	 */
	public enum Align {
	...
	public final static String[] EXPAFFECT_NAMES = { "NONE", "EXTREME",
			"HIGHER", "LOWER", "FOLLOWHIGHER", "FOLLOWLOWER" };
	/**
	 * String descriptions for the valid {@link Faction#experienceFlag()}
	 * constants
	 */
	public final static String[] EXPAFFECT_DESCS = { "None",
			"Proportional (Extreme)", "Higher (mine)", "Lower (mine)",
			"Higher (other)", "Lower (other)" };

	/**
	 * index constant for tag names in {@link Faction#TAG_NAMES} denoting the
	 * NAME tag
	 */
	...
	/**
	 * list of valid tag names for internal faction data, retrieved by
	 * {@link Faction#getTagValue(String)}
	 */
	public final static String[] TAG_NAMES = { "NAME", "MINIMUM", "MAXIMUM",
			"SCOREDISPLAY", "SPECIALREPORTED", "EDITALONE", "DEFAULT",
			"AUTODEFAULTS", "AUTOCHOICES", "CHOICEINTRO", "RATEMODIFIER",
			"EXPERIENCE", "RANGE*", "CHANGE*", "ABILITY*", "FACTOR*",
			"RELATION*", "SHOWINFACTIONSCMD", "AFFBEHAV*", "REACTION*",
			"USELIGHTREACTIONS" };
}
