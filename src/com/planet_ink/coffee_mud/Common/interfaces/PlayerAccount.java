 ...
 * represents essentially a "container" for various characters, who share a
 * login and potentially an expiration date.
 */
public interface PlayerAccount extends CMCommon, AccountStats, Modifiable {
	/**
	 * Return an enumeration of the fully loaded players that belong to this
	 * account.
	 * 
	...
	/**
	 * Return an enumeration of the semi-loaded players that belong to this
	 * account.
	 * 
	...
	/**
	 * Removes a player from this account. This is typically a precursor to
	 * deleting the player.
	 * 
	 * @param mob
	...
	/**
	 * Retrieves a fake account mob, for forum and other access systems not
	 * directly relayed to gameplay.
	 * 
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PlayerAccount#setFlag(String,
	 *      boolean)
	 * @param flagName
	 *            the flag name
	...
	public final static String[] FLAG_DESCS = { FLAG_NUMCHARSOVERRIDE,
			FLAG_NOEXPIRE, FLAG_CANEXPORT, FLAG_MAXCONNSOVERRIDE, FLAG_ANSI,
