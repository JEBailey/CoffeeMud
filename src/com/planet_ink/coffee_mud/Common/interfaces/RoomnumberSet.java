 ...
 */
/**
 * A class for holding CoffeeMud-style room IDs of the form AreaName#[NUMBER],
 * for instance, Midgaard#3001 This class is totally awesome because it stores
 * them in an efficient way (holding room ids 5-10 not as 5,6,7,8,9,10, but as
 * 5,10), but sorts them for quick reads.
 * 
...
public interface RoomnumberSet extends CMCommon {
	 ...
	 * 
	 * @param xml
	 *            contents for this object as an xml
	 */
	 ...
	 * 
	 * @param str
	 *            the room id to remove from this object
	 */
	...
	/**
	 * Returns the number parts of the room ids stored in this object for a
	 * given area.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.CMIntegerGrouper
	 * @param areaName
