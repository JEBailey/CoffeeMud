 ...
 */
/**
 * This class represents an efficient representation of a group of room numbers
 * with optional xy grid coords. It maintains a compact list by ordering the
 * digits and then tagging the groups without missing members.
 */
public interface CMIntegerGrouper extends CMCommon {
	 ...
	 * 
	 * @param x
	 *            the number to look for, coded as a room number
	 ...
	 * 
	 * @param x
	 *            the coded digit pair to remove.
