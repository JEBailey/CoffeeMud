...
/**
 * Descriptor class for ability components. These are managed by by the Ability
 * library.
 * 
 * @see com.planet_ink.coffee_mud.Libraries.interfaces.AbilityMapper#addAbilityComponent(String,
 *      java.util.Map)
 * @see com.planet_ink.coffee_mud.Libraries.interfaces.AbilityMapper#componentCheck(com.planet_ink.coffee_mud.MOBS.interfaces.MOB,
 *      List)
...
public interface AbilityComponent extends CMCommon {
	 ...
	 * following component logically. As in, is it required WITH the following
	 * component, or instead of?
	 * 
	...
	/**
	 * Sets an enum describing how this component "connects" with the following
	 * component logically. As in, is it required WITH the following component,
	 * or instead of?
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent.CompConnector
	...
	/**
	 * Returns an enum value describing where an item must be to be considered a
	 * valid component.
	 * 
	...
	/**
	 * Sets an enum value describing where an item must be to be considered a
	 * valid component.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent.CompLocation
	...
	/**
	 * Returns the number of items matching this component which must be
	 * present.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#setAmount(int)
	 * @return the number of items matching this component which must be
	 *         present.
	 */
	 ...
	 * @param amount
	 *            the number of items matching this component which must be
	 *            present
	 */
	public void setAmount(int amount);

	/**
	 * Returns the item filter type for determining whether an item is a
	 * component. This type can designate a resource, material, or an item name
	 * string.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent.CompType
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#setType(CompType,
	 *      Object)
	 ...
	 * This type can designate a resource, material, or an item name string.
	 * Also sent is either the resource mask, material mask, a string for a name
	 * filter, or a string with a long number in it.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent.CompType
	 ...
	 *            the CompType enum
	 * @param typeObj
	 *            either a Integer object or a String
	 */
	public void setType(CompType type, Object typeObj);

	/**
	 * For resource and material type item component filters, this will return
	 * the type comparison object as a long value. This is typically a resource
	 * or material mask value.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#setType(CompType,
	 *      Object)
	...
	/**
	 * For resource and material type item component filters, this will return
	 * the type comparison object as a String value. This is typically a item
	 * name filter.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#setType(CompType,
	 *      Object)
	...
	/**
	 * Returns the raw zapper mask to determine whether a given agent qualifies
	 * this item as a component.
	 * 
	...
	/**
	 * Sets the raw zapper mask to determine whether a given agent qualifies
	 * this item as a component.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#getCompiledMask()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.AbilityComponent#getMaskStr()
	...
	/**
	 * An component type item filter for determining how to interpret the kind
	 * of item to compare
	 * 
	 * @author Bo Zimmerman
	 * 
