...
/**
 * The interface for the main CoffeeMud scripting engine, which implements a
 * scripting engine descended from the old mud codebases of the 90's usually
 * called MOBPROG. Its main features include easy to understand event-oriented
 * triggers, making all mud commands implicit scripting commands. It also
 * includes methods for embedding javascript.
 * 
 * @see com.planet_ink.coffee_mud.Behaviors.Scriptable
 */
public interface ScriptingEngine extends CMCommon, Tickable, MsgListener {
	/**
	 * Executes a script in response to an event The scripts are formatted as a
	 * 2 dimensional DVector with the first row being the trigger information.
	 * Each row consists of the String command, and a parsed String[] array as
	 * dimension 2.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine.ScriptableResponse
	 * @param scripted
	 *            the object that is scripted
	 * @param source
	 *            the source of the event
	 * @param target
	 *            the target of the event
	 * @param monster
	 *            a mob representation of the scripted object
	 * @param primaryItem
	 *            an item involved in the event
	 * @param secondaryItem
	 *            a second item involved in the event
	 * @param script
	 *            2 dimensional DVector, the script to execute
	 * @param msg
	...
	/**
	 * Uses this scripting engines variable parsing system to replace any script
	 * variables $XXXX with their script determined values. This is a powerful
	 * mechanism for getting at the script functions in order to access stat
	 * data about specific objects, do math, etc.
	 * 
	 * @param source
	 *            the source of the event
	 * @param target
	...
	/**
	 * Creates a mob from the Tickable object sent, possibly saving it locally
	 * to this object for use later.
	 * 
	 * @param ticking
	...
	/**
	 * Receives a string for evaluation by the eval function, and stores it as
	 * the first element in the given 2 dimensional string array.
	 * 
	 * @param evaluable
	 *            the eval expression
	...
	/**
	 * Evaluates a scripting function. Is called by the execute command to
	 * resolve IF, WHILE, and similar expressions that utilize the MOBPROG
	 * functions. The expressions are passed in as a String array stored in a
	 * single string array entry (for replacement) in element 0.
	 * 
	 * @param scripted
	 *            the object that is scripted
	 * @param source
	...
	/**
	 * Evaluates one of the boolean functions as a string variable expression,
	 * which gives different and informative results. See the Green Table in the
	 * Scripting Guide.
	 * 
	 * @param scripted
	 *            the object that is scripted
	...
	/**
	 * Calling this method forces this script to look for a trigger dealing with
	 * the end of a quest (QUEST_TIME_PROG -1).
	 * 
	 * @param hostObj
	 *            the scripted object
	 * @param mob
	 *            a mob representation of the host object
	 * @param quest
	...
	/**
	 * If the script is a load command, this will return the list of loaded
	 * script files referenced by the load command
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getScript()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setScript(String)
	...
	/**
	 * If this script is associated with a particular quest, this method is
	 * called to register that quest name.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#defaultQuestName()
	 * @param questName
	 *            the quest associated with this script
	 */
	public void registerDefaultQuest(String questName);

	/**
	 * If this script is associated with a particular quest, this method is
	 * called to return that quest name.
	 * 
	...
	/**
	 * Sets the scope of any variables defined within the script. Although the
	 * scope is somewhat modified if this script is quest-bound, it is usually
	 * honored. Valid scopes include: "" for global, "*" for local, or a shared
	 * named scope.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVarScope()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVar(String,
	 *      String)
	...
	/**
	 * Returns the scope of any variables defined within the script. Although
	 * the scope is somewhat modified if this script is quest-bound, it is
	 * usually honored. Valid scopes include: "" for global, "*" for local, or a
	 * shared named scope.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVarScope(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVar(String,
	 *      String, String)
	...
	/**
	 * If the variable scope of this script is local, this will return all the
	 * variables and values defined as an xml document for easy storage.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVarScope(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVar(String,
	 *      String, String)
	...
	/**
	 * If the variable scope of this script is local, this will set all the
	 * variables and values defined from a passed in xml document.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVarScope()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVar(String,
	 *      String)
	...
	/**
	 * Returns whether this script is a temporary attributed of the scripted
	 * object, or a permanent on that should be saved with the object.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setSavable(boolean)
	 * @return whether this script is a saveable attribute of the scripted
	 *         object
	 */
	public boolean isSavable();

	/**
	 * Sets whether this script is a temporary attributed of the scripted
	 * object, or a permanent on that should be saved with the object.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#isSavable()
	 * @param truefalse
	 *            true if this script is a saveable attribute of the scripted
	 *            object
	 */
	public void setSavable(boolean truefalse);

	/**
	 * Returns the value of one of the internal variables, determined by the
	 * scope of the script, the context of the variable, and the name of the
	 * variable.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVarScope(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVarScope()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVar(String,
	 *      String, String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#isVar(String,
	 *      String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getLocalVarXML()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setLocalVarXML(String)
	 * @param context
	 *            the context of the variable, usually a mob or object name
	 * @param variable
	...
	/**
	 * Returns whether an internal variables, determined by the scope of the
	 * script, the context of the variable, and the name of the variable, is
	 * defined.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#setVarScope(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine#getVarScope()
	...
	/**
	 * An object that holds the information about an event until it is time to
	 * execute its associated script.
	 * 
	 * @author bzimmerman
	 */
	public static class ScriptableResponse {
		 ...
		 * 
		 * @param host
		 *            the object being scripted
		 * @param source
		 *            the source of the event
		 * @param target
		 *            the target of the event
		 * @param monster
		 *            a mob representation of the host
		 * @param primaryItem
		 *            an item associated with this event
		 * @param secondaryItem
		 *            a second item associated with this event
		 * @param script
		 *            the actual script to execute for this event
		 * @param ticks
		 *            how many ticks to wait before executing the script
		 * @param msg
		 *            a string associated with this event
		 */
		public ScriptableResponse(PhysicalAgent host, MOB source,
				Environmental target, MOB monster, Item primaryItem,
		...
		/**
		 * Decrements the internal tick counter and returns true if the tick
		 * counter has dropped to or below 0
		 * 
	...
	public static final String[] progs = { "GREET_PROG", // 1
			"ALL_GREET_PROG", // 2
			"SPEECH_PROG", // 3
			"GIVE_PROG", // 4
			"RAND_PROG", // 5
	...
	/**
	 * String list of all valid mobprog functions for logical expressions or
	 * string functions
	 */
	public static final String[] funcs = { "RAND", // 1
			"HAS", // 2
			"WORN", // 3
			"ISNPC", // 4
			"ISPC", // 5
	...
	public static final String[] methods = { "MPASOUND", // 1
			"MPECHO", // 2
			"MPSLAY", // 3
			"MPJUNK", // 4
			"MPMLOAD", // 5
	...
	public final static String[] GSTATCODES_ADDITIONAL = { "DEITY", "CLAN",
			"CLANROLE" };
	...
	public final static String[] DATETIME_ARGS = { "HOUR", "TIME", "DAY",
			"DATE", "MONTH", "YEAR" };
	...
	public final static String[] CONNECTORS = { "AND", "OR", "NOT", "ANDNOT",
			"ORNOT" };
	...
	/**
	 * A table to describe what happens when connectors are found sequentially
	 * (and and not or not and and, etc)
	 */
	public final static int[][] CONNECTOR_MAP = {
			{ CONNECTOR_AND, CONNECTOR_OR, CONNECTOR_ANDNOT, CONNECTOR_AND,
					CONNECTOR_ORNOT }, // and
			{ CONNECTOR_OR, CONNECTOR_OR, CONNECTOR_ORNOT, CONNECTOR_ORNOT,
					CONNECTOR_ORNOT }, // or
			{ CONNECTOR_ANDNOT, CONNECTOR_ORNOT, CONNECTOR_AND, CONNECTOR_AND,
					CONNECTOR_OR }, // not
			{ CONNECTOR_ANDNOT, CONNECTOR_ORNOT, CONNECTOR_AND, CONNECTOR_AND,
					CONNECTOR_ORNOT }, // andnot
			{ CONNECTOR_ORNOT, CONNECTOR_ORNOT, CONNECTOR_OR, CONNECTOR_ORNOT,
					CONNECTOR_ORNOT }, // ornot
	};
}
