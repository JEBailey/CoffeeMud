 ...
 */
/**
 * The Law interface defines an object containing the various infractions that
 * are recognized for a given LegalObject, the officials that enforce the
 * infractions, some guidelines on their behavior, and information their
...
public interface Law extends CMCommon {
	/**
	 * Initializes a new Law object with information from a given Properties
	 * file, along with the LegalBehavior which will enforce the laws, and flags
	 * denoting how maleable these laws are. Principally calls resetLaw.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior
	 ...
	 * 
	 * @param details
	 *            the behavior governing this law
	 * @param laws
	 *            the properties file containing all the legal definitions
	 * @param modifiableNames
	 *            whether officials (judges/officers) are modifiable
	 * @param modifiableLaws
	 *            whether the laws themselves are modifiable
	 */
	public void initialize(LegalBehavior details, Properties laws,
			boolean modifiableNames, boolean modifiableLaws);

	/**
	 * Changes the action state of the given warrant (and all dependent
	 * warrants)
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 ...
	 * 
	 * @param W
	 *            the warrant to change the state of
	 * @param state
	...
	/**
	 * Forces the legal definitions to be re-read from their primary storage,
	 * usually an INI file, or the database, depending on how the legalbehavior
	 * is defined.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#initialize(LegalBehavior,
	 *      Properties, boolean, boolean)
	 */
	public void resetLaw();

	/**
	 * Returns whether this legal system allows mobs to be arrested (as opposed
	 * to just players)
	 * 
	...
	/**
	 * Returns one of the raw property entries used to construct the legal
	 * definitions.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#initialize(LegalBehavior,
	 *      Properties, boolean, boolean)
	 * 
	 * @param msg
	 *            the name of the raw property to return
	 * @return the value of the raw legal property
	 */
	public String getInternalStr(String msg);

	/**
	 * Returns whether or not the given property name is one of the raw property
	 * entries used to construct the legal definitions.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#initialize(LegalBehavior,
	 *      Properties, boolean, boolean)
	 * 
	 * @param msg
	 *            the name of the raw property to look for
	 * @return true if the property is found, false otherwise
	 */
	public boolean isInternalStr(String msg);

	/**
	 * Sets one of the raw property entries used to construct the legal
	 * definitions.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#initialize(LegalBehavior,
	 *      Properties, boolean, boolean)
	 * 
	 * @param tag
	 *            the name of the raw property to set
	 * @param value
	...
	/**
	 * Returns a warrant if the given mob or player mob object represents
	 * someone accused of killing an officer.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior
	 * 
	 * @param A
	 *            the Legal Area governed by the Legal Behavior
	 * @param behav
	 *            the legal behavior governing the law
	 * @param mob
	 *            the mob or player to inspect
	...
	/**
	 * Returns a warrant if the given mob or player mob object represents
	 * someone accused of resisting arrest.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior
	 * 
	 * @param A
	...
	/**
	 * Called by an Area periodically to update its records on property taxes
	 * owed, to withdraw money from accounts to pay said taxes if applicable,
	 * and issue a warrant if necessary.
	 * 
	 * @param A
	 *            the Legal Area governed by this law for property taxes
	 * @param debugging
	 *            whether internal debugging msgs should be generated
	 */
	public void propertyTaxTick(Area A, boolean debugging);

	/**
	 * If defined and found, this method returns an Environmental array with two
	 * elements. The first element (0) is a Room object denoting the place where
	 * taxes are stored, and the second element (1) is a container in that room
	 * for the taxes. If the second element is not found or defined, the taxes
	 * are dropped on the floor.
	 * 
	 * @param A
	 *            the legal Area to look for a treasury in.
	 * @return the two dimensional array of objects (or nulls)
	 */
	public TreasurySet getTreasuryNSafe(Area A);

	/**
	 * Combined with otherBits, this method returns the definition of
	 * "miscellaneous" crimes involving emotes and similar random phenomenon.
	 * This method in particular returns a Vector of String words and phrases
	 * which, when encountered in a player or mobs activity, denote the
	 * commission of an "other" crime. This Vectors entries match one for one
	 * with the Vector returned by otherBits()
	 * 
	...
	/**
	 * Combined with otherCrimes, this method returns the definition of
	 * "miscellaneous" crimes involving emotes and similar random phenomenon.
	 * This method in particular returns a Vector of String[] array objects
	 * definitioning the various limitations, flags, and consequences of
	 * committing each "other" crime. This Vectors entries match one for one
	 * with the Vector returned by otherBits()
	 * 
	 * The entries in each String[] array are indexed by the constants BIT_*
	 * 
	...
	/**
	 * Combined with bannedBits, this method returns the definition of
	 * "illegal substance carrying" crimes. This method in particular returns a
	 * Vector of raw resource names or item names which, when encountered in a
	 * player or mobs activity, denote the commission of an "substance" crime.
	 * This Vectors entries match one for one with the Vector returned by
	 * bannedBits()
	 * 
	...
	/**
	 * Combined with bannedSubstances, this method returns the definition of
	 * "substance" crimes involving manipulating an illegal substance in public.
	 * This method in particular returns a Vector of String[] array objects
	 * definitioning the various limitations, flags, and consequences of
	 * committing each "substance" crime. This Vectors entries match one for one
	 * with the Vector returned by bannedSubstances()
	 * 
	 * The entries in each String[] array are indexed by the constants BIT_*
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#BIT_CRIMENAME
	...
	/**
	 * Method for accessing the crimes, flags, and consequences involving the
	 * use of spells, chants, skills, etc. The returned Hashtable is indexed by
	 * the Ability ID of the potentially banned skill. The associated hashed
	 * element is a String[] array of various flags and information about the
	...
	/**
	 * Method for accessing the crimes, flags, and consequences defined as the
	 * most basic law. The returned Hashtable is indexed by the basic crimes ID,
	 * and includes NUDITY, ARMED, TRESPASSING, MURDER, ASSAULT,
	 * RESISTINGARREST, and PROPERTYROB. The associated hashed element is a
	 * String[] array of various flags and information about the consequences of
	 * the act.
	 * 
	 * The entries in each String[] array are indexed by the constants BIT_*
	 * 
	 ...
	 * associated with the tax laws. The Hashtable keys are all string IDs
	 * denoting the property, while the associated element is an object whose
	 * type differs by key. TAXEVASION - a String[] array index by the constant
	 * BIT_* PROPERTYTAX - a String representing the property tax rate CITTAX -
	 * a String representing the citizen tax rate SALESTAX - a String
	 * representing the sales tax rate TREASURY - a String of semicolon
	 * delimited info about treasury room/ - safe room.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#BIT_CRIMENAME
	 * 
	...
	/**
	 * A Vector of strings denoting random things an officer will say while
	 * taking an arrested criminal to the judge.
	 * 
	...
	/**
	 * A Vector of strings denoting random things an officer will say while
	 * taking an arrested criminal to the jail.
	 * 
	 * @return a vector of cute sayings.
	 */
	...
	/**
	 * A Vector of strings denoting random things an officer will say while
	 * taking an arrested criminal to the detention center.
	 * 
	 * @return a vector of cute sayings.
	 */
	...
	/**
	 * A Vector of strings denoting which rooms are considered jails. They
	 * better have a locked door somewhere!
	 * 
	...
	/**
	 * A Vector of strings denoting which rooms are considered release rooms for
	 * after a prisoner has served jail time.
	 * 
	...
	/**
	 * A Vector a strings denoting which mobs are considered officers of the law
	 * in the legal area.
	 * 
	...
	/**
	 * A Vector a strings denoting which mobs are considered judges of the law
	 * in the legal area.
	 * 
	...
	/**
	 * Returns a list of all old LegalWarrant objects for all criminals and
	 * crimes since the last MUD reboot. These are kept track of so the
	 * punishments can be escalated properly.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#getOldWarrant(MOB,
	 *      String, boolean)
	 * 
	...
	/**
	 * Returns an old warrant object matching the given criteria. Old warrants
	 * are kept track of so the punishments can be escalated.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 ...
	 *            the old criminal
	 * @param crime
	 *            the old crime ID (from taxlaw, basiclaw, or other)
	 * @param pull
	 *            true to remove the old warrant from the list, false no
	 * @return the old legal warrant, or null
	 */
	public LegalWarrant getOldWarrant(MOB criminal, String crime, boolean pull);

	/**
	 * Returns a list of all current LegalWarrant objects still considered to be
	 * active and relevant. Officers can act on these.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 ...
	 * 
	 * @param mob
	 *            the mob to get a warrant for
	 * @param which
	 *            the iteration number (from 0)
	 * @return the LegalWarrant object to use, or NULL if last was returned
	 */
	public LegalWarrant getWarrant(MOB mob, int which);

	/**
	 * A String array of various messages given by officers and or judges during
	 * various stages of the legal adjudication process. These are indexed by
	 * the MSG_* constants.
	 * 
	...
	/**
	 * Returns a string of one of the messages given by officers and or judges
	 * during various stages of the legal adjudication process. These are
	 * indexed by the MSG_* constants.
	 * 
	 ...
	 * 
	 * @param which
	 *            a number, as indexed by the MSG_* constants
	 * @return a string of an important thing said by the officers
	 */
	public String getMessage(int which);

	/**
	 * Returns a 4-dimensional String[] array for each of the 4 levels of
	 * Parole. Each string is a message given by the judge detailing the
	 * punishment.
	 * 
	...
	/**
	 * Returns one of the 4 messages given by the judge for each of the four
	 * parole punishments.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#paroleMessages()
	 * 
	 * @param which
	 *            which of the 4 messages to return (0-3)
	 * @return the message given by the judge
	 */
	public String paroleMessages(int which);

	/**
	 * A parole time is a number of ticks for each of the four levels of parole
	 * punishments. This method returns an Integer array of all four times.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENT_PAROLE1
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENT_PAROLE2
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENT_PAROLE3
	...
	/**
	 * A parole time is a number of ticks for each of the four levels of parole
	 * punishments. This method returns the appropriate parol time for the given
	 * number.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#paroleTimes()
	 * 
	 * @param which
	 *            which of the four to return (0-3)
	 ...
	 * Each string is a message given by the judge detailing the punishment.
	 * 
	...
	/**
	 * A parole time is a number of ticks for each of the four levels of jail
	 * punishments. This method returns an Integer array of all four times.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENT_JAIL1
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENT_JAIL2
	...
	/**
	 * A parole time is a number of ticks for each of the four levels of jail
	 * punishments. This method returns the appropriate jail time for the given
	 * number.
	 * 
	...
	/**
	 * For the getTreasuryNSafe, this class stores the location of the treasury,
	 * for taxing purposes.
	 * 
	 * @author bzimmerman
	 * 
	...
	public static final String[] PUNISHMENT_DESCS = { "WARNING", "THREAT",
			"PAROLE1", "PAROLE2", "PAROLE3", "PAROLE4", "JAIL1", "JAIL2",
			"JAIL3", "JAIL4", "DEATH", };

	/**
	 * a bitmask, added to a base punishment, denoting this crime be separated
	 * from others
	 */
	public static final int PUNISHMENTMASK_SEPARATE = 256;
	/**
	 * a bitmask, added to a base punishment type, denoting that the officer
	 * enforces
	 */
	...
	/**
	 * a bitmask, added to a base punishment type, denoting criminal not walked
	 * to releaseroom
	 */
	public static final int PUNISHMENTMASK_NORELEASE = 4096;
	/** a string array for each of the punishment bitmasks */
	public static final String[] PUNISHMENTMASK_DESCS = { "SEPARATE",
			"SKIPTRIAL", "DETAIN=", "FINE=", "NORELEASE" };
	/** an array of the various bitmask values added to punishment codes */
	public static final int[] PUNISHMENTMASK_CODES = { PUNISHMENTMASK_SEPARATE,
			PUNISHMENTMASK_SKIPTRIAL, PUNISHMENTMASK_DETAIN,
			PUNISHMENTMASK_FINE, PUNISHMENTMASK_NORELEASE };
	...
	/**
	 * a state of adjudication meaning officer is waiting for a judgement from
	 * judge
	 */
	...
	/**
	 * a state of adjudication meaning officer is to release the criminal from
	 * jail
	 */
	public static final int STATE_RELEASE = 10;
	/**
	 * a state of adjudication meaning officer is releasing the criminal from
	 * jail
	 */
	public static final int STATE_MOVING3 = 11;
	/**
	 * a state of adjudication meaning officer is taking the criminal to
	 * detension
	 */
	public static final int STATE_DETAINING = 12;

	/**
	 * an index to crime-definition flags denoting types of places the law
	 * applies to
	 */
	public static final int BIT_CRIMELOCS = 0;
	/**
	 * an index to crime-definition flags denoting circumstances the law applies
	 * to
	 */
	...
	/**
	 * an index to crime-definition flags denoting the warning message for
	 * breaking the law
	 */
	public static final int BIT_WARNMSG = 4;
	/**
	 * an index to crime-definition flags denoting the number of parts of a
	 * crime definition
	 */
	public static final int BIT_NUMBITS = 5;

	/**
	 * an index to messages said to criminals by officers, denotes a previous
	 * offence
	 */
	public final static int MSG_PREVOFF = 0;
	/**
	 * an index to messages said to criminals by officers, denotes a warning is
	 * forthcoming
	 */
	public final static int MSG_WARNING = 1;
	/**
	 * an index to messages said to criminals by officers, denotes a threat is
	 * forthcoming
	 */
	public final static int MSG_THREAT = 2;
	/**
	 * an index to messages said to criminals by officers, denotes an execution
	 * is forthcoming
	 */
	public final static int MSG_EXECUTE = 3;
	/**
	 * an index to messages said to criminals by officers, denotes the criminal
	 * is a protected citizen
	 */
	...
	/**
	 * an index to messages said to criminals by officers, denotes resisting
	 * arrest
	 */
	public final static int MSG_RESISTFIGHT = 6;
	/**
	 * an index to messages said to criminals by officers, denotes an order not
	 * to resist
	 */
	public final static int MSG_NORESIST = 7;
	/**
	 * an index to messages said to criminals by officers, denotes a warning not
	 * to resist
	 */
	public final static int MSG_RESISTWARN = 8;
	/**
	 * an index to messages said to criminals by officers, denotes a parole
	 * sentence is ready
	 */
	public final static int MSG_PAROLEDISMISS = 9;
	/**
	 * an index to messages said to criminals by officers, denotes a jail
	 * sentence is done
	 */
	...
	public static final String defaultLaw = "OFFICERS=@\n"
			+ "JUDGE=@\n"
			+ "JAIL=@\n"
			+ "RELEASEROOM=@\n"
