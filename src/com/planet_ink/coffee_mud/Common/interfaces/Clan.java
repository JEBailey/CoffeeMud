...
public interface Clan extends Cloneable, Tickable, CMCommon, Modifiable {
	/**
	 * Returns whether the given roleID is allowed to perform the given
	 * function. The return value can designate that they may do it now, that
	 * they may not do it, or that it requires a vote. A return value 1 means
	 * they can do it now, 0 means it requires a vote, and -1 means they can
	 * never do it. The functions are defined in the Clan interface as FUNC_*
	 * constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan.Authority
	 * @param roleID
	 *            the roleID whose priviledges to check.
	 * @param function
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan.ClanVote
	 * @param CV
	 *            the clanvote object to remove
	 */
	public void delVote(ClanVote CV);

	/**
	 * Returns the number of members allowed to vote on the given function. The
	 * function is one of the FUNC_* constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	 * @param function
	 *            the FUNC_* constant
	...
	/**
	 * Returns the name of the clan, which is almost always the same as the ID,
	 * which is why clans can't change their names.
	 * 
	 ...
	 * @param newName
	 *            the new name of this clan
	 */
	public void setName(String newName);

	/**
	 * Returns the category of the clan, which is almost always the same as the
	 * government category. This is significant since a player can only belong
	 * to N clans of a given category. See also MAXCLANS in coffeemud.ini.
	 * 
	...
	/**
	 * Sets a new category for this, which is almost always the same as the
	 * government category. This is significant since a player can only belong
	 * to N clans of a given category. See also MAXCLANS in coffeemud.ini.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#getCategory()
	 * @param newCategory
	 *            the new cata of this clan
	 */
	...
	/**
	 * This method is called when a given mobs clan status changes, for instance
	 * if they are added to the clan, removed from it, or change their rank.
	 * 
	 * @param mob
	...
	/**
	 * Return a vector of skills, spells, and other abilities granted to the
	 * given mob of the given mobs level.
	 * 
	...
	/**
	 * Return size of a vector of skills, spells, and other effects granted to
	 * the given mob of the given mobs level. Much more efficient than getting
	 * the whole list and checking its size.
	 * 
	 * @see com.planet_ink.coffee_mud.Abilities.interfaces.Ability
	 * @param mob
	 *            the mob to grant the abilities to
	...
	/**
	 * Retrieves this Clan's basic story. This is to make the Clan's more RP
	 * based and so we can provide up-to-date information on Clans on the web
	 * server.
	 * 
	...
	/**
	 * Retrieves this Clan's enforced character class. All players who join this
	 * clan become this class.
	 * 
	...
	/**
	 * Creates the string for the 'clandetail' command, based on the security of
	 * the given mob who will view the details.
	 * 
	 * @param mob
	...
	/**
	 * Returns a mask used to identify whether a player is allowed to join a
	 * particular
	 * 
	...
	/**
	 * Sets a mask used to identify whether a player is allowed to join a
	 * particular
	 * 
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	...
	/**
	 * Returns an XML string used to identify the political relations between
	 * this clan and others.
	 * 
	...
	/**
	 * Sets an XML string used to identify the political relations between this
	 * clan and others.
	 * 
	...
	/**
	 * Returns whether membership is automatically approved to this And if so,
	 * what the default position for members are.
	 * 
	...
	/**
	 * Sets whether membership is automatically approved to this And if so, what
	 * the default position for members are.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan#getAutoPosition()
	 * @param pos
	 *            the positition to give to applicants
	 */
	public void setAutoPosition(int pos);

	/**
	 * Returns one of the CLANSTAT_* constants describing the pending status of
	 * this clan for acceptable, or whether its one its way out.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	...
	/**
	 * Sets one of the CLANSTAT_* constants describing the pending status of
	 * this clan for acceptable, or whether its one its way out.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	 ...
	 * meaning that pvp is enabled between them, and war can be declared between
	 * them.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	...
	/**
	 * Set to true if this clan is rivalrous with other rivalrous clans, meaning
	 * that pvp is enabled between them, and war can be declared
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	...
	/**
	 * Returns a bitmap representing the trophies won by this The bitmap is made
	 * up of TROPHY_* constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	...
	/**
	 * Sets a bitmap representing the trophies won by this The bitmap is made up
	 * of TROPHY_* constants.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Clan
	...
	/**
	 * Returns the inner (government usually) requirements to even apply to this
	 * clan
	 * 
	 ...
	 * 
	 * @param howMuch
	 *            the experience adjustment, + or -
	 */
	public void adjExp(int howMuch);

	/**
	 * Adjusts the amount of experience earned by a player based on the tax
	 * rate. Will automatically adjust the exp of the clan and save it.
	 * 
	 * @param exp
	 *            the old experience
	 */
	...
	/**
	 * Called when a member of this clan kills a member of another Will update
	 * the clan in the database.
	 */
	...
	/**
	 * Returns the maximum number of players who can hold the given role in this
	...
	/**
	 * Returns the friendly descriptive name of a given role in a clan, based on
	 * very specific criteria.
	 * 
	 * @param roleID
	 *            the role code of the role to describe
	 * @param titleCase
	 *            whether or not to uppercase the first word
	 * @param plural
	...
	/**
	 * For the clan government type, this function will return the clan role
	 * that most closely matches the given string "position". It will return -1
	 * if no position is found that matches the string. The returned value will
	 * an an official role bitmask.
	 * 
	 * @param position
	...
	/**
	 * Returns whether this clan gets listed with the clanlist command. Does not
	 * affect clanlog messaging.
	 * 
	 * @param mob
	 *            the person viewing
	...
	/**
	 * Returns whether this clan only accepts applicants from people who are
	 * family of current members/founder.
	 * 
	 * @return true if it is, false otherwise.
	 */
	...
	/**
	 * Returns the list of roles for people in this clan, from lowest rank to
	 * the highest. Must correspond with roleIDs
	 * 
	...
	/**
	 * Returns a REL_* constant denoting the relationship between this clan and
	 * the clan of the given name.
	 * 
	...
	/**
	 * Returns the time/date stamp when this clan last changed its relations
	 * with the given
	 * 
	 * @see Clan#setClanRelations(String, int, long)
	 ...
	 *            another clan
	 * @param rel
	 *            the REL_* constant for the new relationship
	 * @param time
	 *            a current date/time stamp for this change
	 */
	...
	/**
	 * Returns the minimum clan members for the clan to become active, or to
	 * prevent being purged. A value of 0 keeps the clan alive forever
	 * 
	...
	/**
	 * Sets the minimum clan members for the clan to become active, or to
	 * prevent being purged. A value of 0 keeps the clan alive forever
	 * 
	 * @param amt
	 *            the new min clan members
	 */
	public void setMinClanMembers(int amt);

	/**
	 * Returns whether this clan attains conquest loyalty through giving out
	 * clan items.
	 * 
	...
	/**
	 * Returns whether this clan attains conquest loyalty through mobs
	 * worshiping the same deity as their leader.
	 * 
	 * @return true if if does, false otherwise
	 */
	...
	/**
	 * Returns the roleid constant representing the highest rank in this clan
	 * type that can perform the given function or null.
	 * 
	 * @see ClanPosition
	 * @see Function
	 * @param func
	 *            the function (or null) they must be able to do
	 * @param mob
	...
	/**
	 * Returns the roleid(s) constant representing the highest rank roleid(s) in
	 * this clan type that can perform the given function.
	 * 
	 * @see ClanPosition
	 * @see Function
	 * @param func
	 *            the function to perform, or null just to return privileged
	 *            rank
	...
	public static class ClanVote {
		...
		/**
		 * A 2 dimentional vector of the votes, where each row is a vote, with
		 * dimension 1 being the member name and dimension 2 being a Boolean
	...
	/**
	 * A internal membership record, as returned by the database, plus extra
	 * fields from cmchar
	 * 
	 * @author Bo Zimmerman
	 */
	...
	/**
	 * Vote just started constant for the ClanVote.voteStatus member. @see
	 * ClanVote#voteStatus
	 */
	public final static int VSTAT_STARTED = 0;
	/**
	 * Vote has failed constant for the ClanVote.voteStatus member. @see
	 * ClanVote#voteStatus
	 */
	public final static int VSTAT_FAILED = 1;
	/**
	 * Vote has passed constant for the ClanVote.voteStatus member. @see
	 * ClanVote#voteStatus
	 */
	public final static int VSTAT_PASSED = 2;
	/**
	 * Descriptors for the values of ClanVote.voteStatus member. @see
	 * ClanVote#voteStatus
	 */
	public final static String[] VSTAT_DESCS = { "In Progress", "Failed",
			"Passed" };

	/** Stat variables associated with clan objects. */
	public final static String[] CLAN_STATS = { "ACCEPTANCE", // 0
			"DETAIL", // 1
			"DONATEROOM", // 2
			"EXP", // 3
			"GOVT", // 4
	...
	/**
	 * constant for the getStatus() method, denoting normal status. @see
	 * Clan#getStatus() .
	 */
	public static final int CLANSTATUS_ACTIVE = 0;
	/**
	 * constant for the getStatus() method, denoting unapproved status. @see
	 * Clan#getStatus() .
	 */
	public static final int CLANSTATUS_PENDING = 1;
	/**
	 * constant for the getStatus() method, denoting fading status. @see
	 * Clan#getStatus() .
	 */
	public static final int CLANSTATUS_FADING = 2;
	/**
	 * constant descriptor strings for the CLANSTATUS_* constants, ordered by
	 * their value. @see Clan .
	 */
	public static final String[] CLANSTATUS_DESC = { "ACTIVE", "PENDING",
			"FADING" };

	/**
	 * constant for getClanRelations method, denoting neutral status towards. @see
	 * Clan#getClanRelations(String)
	 */
	public static final int REL_NEUTRAL = 0;
	/**
	 * constant for getClanRelations method, denoting at war with. @see
	 * Clan#getClanRelations(String)
	 */
	public static final int REL_WAR = 1;
	/**
	 * constant for getClanRelations method, denoting hostile to. @see
	 * Clan#getClanRelations(String)
	 */
	public static final int REL_HOSTILE = 2;
	/**
	 * constant for getClanRelations method, denoting friendly to. @see
	 * Clan#getClanRelations(String)
	 */
	public static final int REL_FRIENDLY = 3;
	/**
	 * constant for getClanRelations method, denoting ally with. @see
	 * Clan#getClanRelations(String)
	 */
	public static final int REL_ALLY = 4;
	/** constant used to determine something about clan relations */
	public static final int[] REL_NEUTRALITYGAUGE = {/* REL_NEUTRAL */0,/* REL_WAR */
			4, /* REL_HOSTILE */1,/* REL_FRIENDLY */1,/* REL_ALLY */4 };
	/**
	 * table used to determine how two clans are related when their declared
	 * relations differ. both axis are REL_* constants. @see Clan
	 */
	...
	/**
	 * descriptor strings for the REL_* constants, ordered by their value. @see
	 * Clan
	 */
	public static final String[] REL_DESCS = { "NEUTRAL", "WAR", "HOSTILE",
			"FRIENDLY", "ALLY" };

	/**
	 * long descriptor strings for the REL_* constants, ordered by their value. @see
	 * Clan
	 */
	public static final String[] REL_STATES = { "NEUTRALITY TOWARDS",
			"WAR WITH", "HOSTILITIES WITH", "FRIENDSHIP WITH",
			"AN ALLIANCE WITH" };
	...
	public static enum Trophy {
		Points("Most control points", "Control Points"), Experience(
				"Most clan experience", "Experience"), Areas(
				"Most controlled areas", "Areas Controlled"), PlayerKills(
				"Most rival player-kills", "PlayerKills"), Members(
				"Most members", "Most Members"), MemberLevel(
				"Highest median level", "Highest Levels");
	...
	/**
	 * An enumeration of relationships between a clan position and a particular
	 * power of clans.
	 * 
	 * @author bzimmerman
	 */
	public static enum Authority {
		CAN_NOT_DO, CAN_DO, MUST_VOTE_ON
	}
	...
	public static enum AutoPromoteFlag {
		NONE, LEVEL, RANK, LEVEL_OVERWRITE, RANK_OVERWRITE
	}
	...
	public static enum Function {
		/**
		 * constant for the clan function of accepting new members. @see
		 * Clan#getAuthority(int,Function)
		 */
		ACCEPT,
		/**
		 * constant for the clan function of promoting or demoting members. @see
		 * Clan#getAuthority(int,Function)
		 */
		ASSIGN,
		/**
		 * constant for the clan function of exihiling members. @see
		 * Clan#getAuthority(int,Function)
		 */
		EXILE,
		/**
		 * constant for the clan function of setting a new clan home. @see
		 * Clan#getAuthority(int,Function)
		 */
		SET_HOME,
		/**
		 * constant for the clan function of setting a new donation room. @see
		 * Clan#getAuthority(int,Function)
		 */
		SET_DONATE,
		/**
		 * constant for the clan function of rejecting an applicant. @see
		 * Clan#getAuthority(int,Function)
		 */
		REJECT,
		/**
		 * constant for the clan function of writing a new clan premise. @see
		 * Clan#getAuthority(int,Function)
		 */
		PREMISE,
		/**
		 * constant for the clan function of acting as owner of clan property. @see
		 * Clan#getAuthority(int,Function)
		 */
		PROPERTY_OWNER,
		/**
		 * constant for the clan function of withdrawing from clan bank
		 * accounts. @see Clan#getAuthority(int,Function)
		 */
		WITHDRAW,
		/**
		 * constant for the clan function of depositing into clan bank accounts. @see
		 * Clan#getAuthority(int,Function)
		 */
		DEPOSIT,
		/**
		 * constant for the clan function of ordering lower ranked clan members. @see
		 * Clan#getAuthority(int,Function)
		 */
		ORDER_UNDERLINGS,
		/**
		 * constant for the clan function of ordering mobs in clan conquered
		 * areas. @see Clan#getAuthority(int,Function)
		 */
		ORDER_CONQUERED,
		/**
		 * constant for the clan function of voting on promotions. @see
		 * Clan#getAuthority(int,Function)
		 */
		VOTE_ASSIGN,
		/**
		 * constant for the clan function of voting on non-promotion questions . @see
		 * Clan#getAuthority(int,Function)
		 */
		VOTE_OTHER,
		/**
		 * constant for the clan function of depositing and listing clan bank
		 * accounts. @see Clan#getAuthority(int,Function)
		 */
		DEPOSIT_LIST,
		/**
		 * constant for the clan function of declaring war and peace . @see
		 * Clan#getAuthority(int,Function)
		 */
		DECLARE,
		/**
		 * constant for the clan function of changing the clans tax rate. @see
		 * Clan#getAuthority(int,Function)
		 */
		TAX,
		/**
		 * constant for the clan function of clanenchanting items. @see
		 * Clan#getAuthority(int,Function)
		 */
		ENCHANT,
		/**
		 * constant for the clan function of channeling with @see
		 * Clan#getAuthority(int,Function)
		 */
		CHANNEL,
		/**
		 * constant for the clan function of using the morgue. @see
		 * Clan#getAuthority(int,Function)
		 */
		MORGUE,
		/**
		 * constant for the clan function of seeing private members. @see
		 * Clan#getAuthority(int,Function)
		 */
		LIST_MEMBERS,
		/**
		 * constant for the clan function of enjoying clan homes. @see
		 * Clan#getAuthority(int,Function)
		 */
		HOME_PRIVS,
		/**
