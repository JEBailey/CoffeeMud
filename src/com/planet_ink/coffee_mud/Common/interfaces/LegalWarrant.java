 ...
 */
/**
 * A LegalWarrant is an important object in the triad of LegalBehavior and Law
 * objects, as a part of the CoffeeMud legal system. A LegalWarrant is created
 * by the LegalBehavior in response to the Law definitions, when it has
 * determined that a mob or player has broken one of the Laws. The Warrant is
 * then used as a state object following the specific circumstances around the
 * violated law, and its adjudication. After adjudication, the object is
 * transferred into an Old Warrants cue under the Law to use as a reference for
 * repeat offenders.
 * 
...
public interface LegalWarrant extends CMCommon {
	/**
	 * If the criminal has been identified by an otherwise unoccupied officer,
	 * this will be that officer.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant#setArrestingOfficer(Area,
	 *      MOB)
	 * 
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant#addPunishmentParm(int,
	 *      String)
	 ...
	 * 
	 * @param code
	 *            the punishment mask bitmap code
	 * @return any parameters needed, or null
	 */
	public String getPunishmentParm(int code);

	/**
	 * If applicable, sets any parameters associated with a particular bitmask
	 * on the punishment.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant#getPunishmentParm(int)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant#punishment()
	...
	/**
	 * If applicable, returns the number of ticks the punishment calls for the
	 * criminal to remain in jail.
	 * 
	...
	/**
	 * If applicable, sets the number of ticks the punishment calls for the
	 * criminal to remain in jail.
	 * 
	...
	/**
	 * Returns the number of times this criminal has done this crime. This is
	 * usually 0 unless it also exists in the old warrants list.
	 * 
	...
	/**
	 * Sets the number of times this criminal has done this crime. This is
	 * usually 0 unless it also exists in the old warrants list.
	 * 
	...
	/**
	 * Sets the last time, in miliseconds since 1970, the criminal has committed
	 * this crime. Very useful in oldWarrants
	 * 
	...
	/**
	 * Returns the time, in milis since 1970, that a trip to the judge or to the
	 * jail was started. For housekeeping purposes.
	 * 
	...
	/**
	 * Sets the time, in milis since 1970, that a trip to the judge or to the
	 * jail was started. For housekeeping purposes.
	 * 
