 ...
 */
/**
 * The PhyStats interface is a state object that holds some basic information
 * about just about every Physical object in the game. Not all stats are
 * relevant for ALL Physicals, but most, especially the big ones.
 * 
 * Physicals always keep two instances of this object, a base one, representing
 * his base unmodified state, and current one, representing his state after
 * spells and other affects have had their say.
 * 
...
public interface PhyStats extends CMCommon, Modifiable {
	/**
	 * Constant shortcut for setting the rejuvination rate on a mob so that it
	 * will NOT rejuv.
	 */
	 ...
	 * miscellaneous runtime flags for items and other Physicals (SENSE_
	 * constants).
	 * 
	...
	/**
	 * Returns a bitmask for disposition related flags of Physicals (IS_
	 * constants).
	 * 
	...
	/**
	 * Sets a bitmask for disposition related flags of Physicals (IS_
	 * constants).
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#IS_BONUS
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#disposition()
	 * @param newDisposition
	 *            a bitmask of disposition flags
	 */
	 ...
	 * @param newAdjustment
	 *            the new ability level (or misc integer)
	 */
	public void setAbility(int newAdjustment);

	/**
	 * Returns the number of ticks before a Physical removed from the game (due
	 * to death, destruction, or just removal from home) is restored.
	 * 
	...
	/**
	 * Sets the number of ticks before a Physical removed from the game (due to
	 * death, destruction, or just removal from home) is restored.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#rejuv()
	 * @param newRejuv
	 *            the new number of ticks before rejuv (0==never)
	 */
	 ...
	 * @param newWeight
	 *            the new weight of this Physical
	 */
	 ...
	 * @param newHeight
	 *            the new height of this Physical, in inches (0=indeterminate)
	 */
	 ...
	 * @param newArmor
	 *            the defensive capability number of this Physical
	 */
	 ...
	 * @param newDamage
	 *            the new maximum damaging ability of this Physical
	 */
	 ...
	 * @param newSpeed
	 *            the new number of actions this mob can do per tick
	 */
	public void setSpeed(double newSpeed);

	/**
	 * Returns the rawcombat attack prowess of this Physical Usually mobs or
	 * weapons
	 * 
	...
	/**
	 * Sets the rawcombat attack prowess of this Physical Usually mobs or
	 * weapons
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#attackAdjustment()
	 * @param newAdjustment
	 *            the new raw combat attack prowess of this Physical
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#isAmbiance(String)
	 * @param ambiance
	 *            a new ambiance string
	 */
	public void addAmbiance(String ambiance);

	/**
	 * Removes an ambiance (extra word, visible field) from the list that are
	 * tacked onto the display text of this Physical.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#ambiances()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#addAmbiance(String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.PhyStats#isAmbiance(String)
	 * @param ambiance
	 *            the old ambiance string
	 */
	public void delAmbiance(String ambiance);

	/**
	 * Returns a single string summary of several important stats from this
	 * object.
	 * 
	 * @return a single string summary of several important stats from this
	 *         object.
	 */
	 ...
	 * 
	 * @param def
	 *            a value to set all the stats to
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this mob as able to see
	 * hidden
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this mob as unable to
	 * breathe
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this mob as unable to think
	 * clearly
	 */
	public final static int CAN_NOT_THINK = 131072;
	/**
	 * a bit setting, as from sensesMask(), flagging this mob as unable to
	 * engage in long tasks
	 */
	public final static int CAN_NOT_WORK = 262144;

	// sensemask stuff not applicable to mobs
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room as being
	 * unlocatable
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room as
	 * ungettable
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room as having
	 * unseeable contents
	 */
	public final static int SENSE_CONTENTSUNSEEN = 128;
	/**
	 * a bit setting, as from sensesMask(), flagging this room as allowing GET
	 * even when sitting
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room as not
	 * allowing movement
	 */
	...
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room being
	 * unwishable for
	 */
	public final static int SENSE_ITEMNOWISH = 16384;
	/**
	 * a bit setting, as from sensesMask(), flagging this room contains
	 * electronic circuitry
	 */
	// public final static int SENSE_ROOMCIRCUITED=32768;
	/**
	 * a bit setting, as from sensesMask(), flagging this item/room and unable
	 * to be destroyed
	 */
	public final static int SENSE_UNDESTROYABLE = 65536;

	/**
	 * STAT codes list, indexed by the 2nd root of the various sensesMask()
	 * SENSE_ bitmasks
	 */
	public static final String[] SENSE_CODES = { "UNLOCATABLE",
			"ITEMNOMINRANGE", "ITEMNOMAXRANGE", "ITEMREADABLE", "ITEMNOTGET",
			"ITEMNODROP", "ITEMNOREMOVE", "CONTENTSUNSEEN", "ROOMCRUNCHEDIN",
			"ROOMUNEXPLORABLE", "ROOMNOMOVEMENT", "ROOMUNMAPPABLE",
			"ROOMGRIDSYNC", "ITEMNORUIN", "ITEMNOWISH", "UNUSEDMASK",
			"UNDESTROYABLE", };
	...
	// dispositions
	/**
	 * a bit setting, as from disposition(), flagging this object as not being
	 * seen
	 */
	public final static int IS_NOT_SEEN = 1;
	/**
	 * a bit setting, as from disposition(), flagging this object as being
	 * hidden
	 */
	...
	/**
	 * a bit setting, as from disposition(), flagging this object as being in
	 * the dark
	 */
	public final static int IS_DARK = 128;
	/**
	 * a bit setting, as from disposition(), flagging this object as being a
	 * golem
	 */
	...
	/**
	 * a bit setting, as from disposition(), flagging this object as
	 * sitting/crawling
	 */
	 ...
	 * CAN_SEE bitmasks
	 */
	public static final String[] CAN_SEE_CODES = { "CANNOTSEE", "CANSEEHIDDEN",
			"CANSEEINVISIBLE", "CANSEEEVIL", "CANSEEGOOD", "CANSEESNEAKERS",
			"CANSEEBONUS", "CANSEEDARK", "CANSEEINFRARED", "CANNOTHEAR",
			"CANNOTMOVE", "CANNOTSMELL", "CANNOTTASTE", "CANNOTSPEAK",
			"CANNOTBREATHE", "CANSEEVICTIM", "CANSEEMETAL", "CANNOTTHINK",
			"CANNOTWORK" };

	/**
	 * Descriptions, indexed by the 2nd root of the various CAN_SEE sensesMask()
	 * bitmasks
	 */
	public static final String[] CAN_SEE_DESCS = { "Is Blind",
			"Can see hidden", "Can see invisible", "Can see evil",
			"Can see good", "Can detect sneakers", "Can see magic",
			"Can see in the dark", "Has infravision", "Is Deaf",
			"Is Paralyzed", "Can not smell", "Can not eat", "Is Mute",
			"Can not breathe", "Can detect victims", "Can detect metal",
			"Can not concentrate", "Is too busy" };

	/**
	 * Descriptive verbs, indexed by the 2nd root of the various CAN_SEE
	 * sensesMask() bitmasks
	 */
	public static final String[] CAN_SEE_VERBS = { "Causes Blindness",
			"Allows see hidden", "Allows see invisible", "Allows see evil",
			"Allows see good", "Allows detect sneakers", "Allows see magic",
			"Allows darkvision", "Allows infravision", "Causes Deafness",
			"Causes Paralyzation", "Deadens smell", "Disallows eating",
			"Causes Mutemess", "Causes choking", "Allows detect victims",
			"Allows detect metal", "Befuddles the mind", "Occupies time" };

	/**
	 * STAT codes, indexed by the 2nd root of the various IS_ disposition()
	 * bitmasks
	 */
	public static final String[] IS_CODES = { "ISSEEN", "ISHIDDEN",
			"ISINVISIBLE", "ISEVIL", "ISGOOD", "ISSNEAKING", "ISBONUS",
			"ISDARK", "ISGOLEM", "ISSLEEPING", "ISSITTING", "ISFLYING",
			"ISSWIMMING", "ISGLOWING", "ISCLIMBING", "ISFALLING", "ISLIGHT",
			"ISBOUND", "ISCLOAKED", "ISUNSAVABLE", "ISCATALOGED",
			"ISUNATTACKABLE" };

	/**
	 * Descriptions, indexed by the 2nd root of the various IS_ disposition()
	 * bitmasks
	 */
	public static final String[] IS_DESCS = { "Is never seen", "Is hidden",
			"Is invisible", "Evil aura", "Good aura", "Is sneaking",
			"Is magical", "Is dark", "Is golem", "Is sleeping", "Is sitting",
			"Is flying", "Is swimming", "Is glowing", "Is climbing",
			"Is falling", "Is a light source", "Is binding", "Is Cloaked",
			"Is never saved", "Is cataloged", "Is unattackable" };

	/**
	 * Descriptive verbs, indexed by the 2nd root of the various IS_
	 * disposition() bitmasks
	 */
	public static final String[] IS_VERBS = { "Causes Nondetectability",
			"Causes hide", "Causes invisibility", "Creates Evil aura",
			"Creates Good aura", "Causes sneaking", "Creates magical aura",
			"Creates dark aura", "Creates golem aura", "Causes sleeping",
			"Causes sitting", "Allows flying", "Causes swimming",
			"Causes glowing aura", "Allows climbing", "Causes falling",
			"Causes a light source", "Causes binding", "Causes cloaking",
			"Causes disappearance", "Causes unsavability",
			"Created from a template", "Prevents attackability" };
}
