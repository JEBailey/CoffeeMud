...
/**
 * A class defining the characteristics of a clan government, and its
 * membership.
 * 
 * @author bzimmerman
 */
public interface ClanGovernment extends Modifiable, CMCommon {
	 ...
	 * 
	 * @param requiredMaskStr
	 *            the new required mask str
	 */
	 ...
	 * 
	 * @param conquestByWorship
	 *            the new conquest by worship
	 */
	 ...
	 * 
	 * @param xpCalculationFormulaStr
	 *            the new xp calculation formula
	 */
	...
	/**
	 * Return the list of abilities owned by someone who is part of a clan of
	 * the given level.
	 * 
	 * @param level
	 *            clan level
	...
	/**
	 * Return the list of effects owned by someone who is part of a clan of the
	 * given level.
	 * 
	 * @param mob
	 *            the mob affected
	 * @param clan
	 *            the clan the effects come from
	 * @param level
	 *            clan level
	 * @return list of abilities
	 */
	public ChameleonList<Ability> getClanLevelEffects(MOB mob, Clan clan,
			Integer level);

	/**
	 * Return the size of the list of effects owned by someone who is a part of
	 * this clan of the given level. Much more efficient than getting the whole
	 * list and checking its size.
	 * 
	 * @param mob
	 *            the mob affected
	 * @param level
