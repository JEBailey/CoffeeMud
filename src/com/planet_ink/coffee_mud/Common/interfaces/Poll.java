 ...
 */
/**
 * A Poll object manages the data and processes for all of the public and
 * private voting polls available through the CoffeeMud POLL CREATE POLL, LIST
 * POLLS, etc.. commands.
 * 
...
public interface Poll extends CMCommon {
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary#maskCheck(String,
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Poll.PollOption
	 * @param V
	 *            a Vector of PollOption objects denoting the poll choices.
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Poll.PollResult
	 * @param V
	 *            a Vector of PollResult objects renoting all poll votes.
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 * @return true returns true if this object is fully populated from the
	 *         database
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 * @param truefalse
	 *            set to true if this object is fully populated from the
	 *            database
	 */
	 ...
	 * object that represents the given mobs vote in this Poll, or NULL
	 * otherwise.
	 * 
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Poll.PollResult
	 * @param R
	 *            the particular vote by a particular mob to add
	 */
	public void addVoteResult(PollResult R);

	/**
	 * Returns true if the given mob is allowed to vote in this poll, false
	 * otherwise. Always returns false if getMyVote(mob)!=null.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Poll#getMyVote(MOB)
	 ...
	 * @return true if the given mob is allowed to vote in this poll, false
	 *         otherwise.
	 */
	public boolean mayIVote(MOB mob);

	/**
	 * Returns true if the given mob may not see the poll results, false
	 * otherwise.
	 * 
	 ...
	 * @param mob
	 *            the mob to check for elligibility
	 * @return true if the given mob can not see the poll results, false
	 *         otherwise
	 */
	...
	public static class PollResult {
		...
		/**
		 * Create a poll result object denoting the vote of a particular user
		 * for a particular poll option.
		 * 
		 * @param usr
		 *            user name of the user who has voted
		 * @param ipaddr
		 *            user name of the user who has voted
		 * @param ans
		 *            cardinal order number of the option chosen by this user in
		 *            the poll
		 */
	...
	/**
	 * bitmask poll flag denoting that a player is considered to have voted if
	 * ips match
	 */
	public static final int FLAG_VOTEBYIP = 8;
	/**
	 * bitmask poll flag denoting that players may never seen the results of the
	 * poll
	 */
	public static final int FLAG_HIDERESULTS = 16;
	/**
	 * bitmask poll flag denoting that players will not be given a chance to
	 * vote at logon
	 */
