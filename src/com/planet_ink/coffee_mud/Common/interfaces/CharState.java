 ...
 */
/**
 * An object to access and change fields representing the most variable aspects
 * of a MOB
 * 
...
public interface CharState extends CMCommon, Modifiable {
	...
	/**
	 * constant for how many fatigue points are required to be considered
	 * fatigued
	 */
	...
	/**
	 * Set the number of fatigue points, respecting boundaries. 0 is always
	 * lowest.
	 * 
	 * @param byThisMuch
	 *            a positive or negative change in value
	 * @param max
	...
	/**
	 * Set the number of hunger points, respecting boundaries. 0 is always
	 * lowest.
	 * 
	 * @param byThisMuch
	 *            a positive or negative change in value
	...
	/**
	 * This method is used to recalculate the maximum thirhungerst for a mob,
	 * based on their weight and the default maximum hunger
	 * 
	 * @param baseWeight
	...
	/**
	 * Set the number of thirst points, respecting boundaries. 0 is always
	 * lowest.
	 * 
	 * @param byThisMuch
	 *            a positive or negative change in value
	...
	/**
	 * This method is used to recalculate the maximum thirst for a mob, based on
	 * their weight and the default maximum thirst
	 * 
	 * @param baseWeight
	 *            the base weight of the mob
	...
	/**
	 * Set the number of movement points, respecting boundaries. 0 is always
	 * lowest.
	 * 
	 * @param byThisMuch
	 *            a positive or negative change in value
	...
	/**
	 * During rest, and even standing still, this method will be called to allow
	 * the fields in this object to recover some of their value. It is called by
	 * the mob tick(Tickable,int) method every CMProps.getTickMillis()
	 * milliseconds
	 * 
	 * @see com.planet_ink.coffee_mud.MOBS.interfaces.MOB
	 * @param mob
	 *            the mob recovering
	 * @param maxState
	 *            The CharState objects which represents the maximum values for
	 *            these fields
	 */
	 ...
	 * movement to be expended and hunger/thirst to occur. It is called by
	 * methods executing the appropriate events when they are performed and by
	 * the mob tick(Tickable,int) method
	 * 
	 * @see com.planet_ink.coffee_mud.MOBS.interfaces.MOB
	 * @param mob
	 *            the mob expending
	 ...
	 *            The CharState objects which represents the maximum values for
	 *            these fields
	 * @param expendMovement
	 *            whether to skip movement expending
	 */
