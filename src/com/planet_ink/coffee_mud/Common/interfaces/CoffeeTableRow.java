 ...
 */
/**
 * A CoffeeTableRow object represents a period of sustained statistics
 * gathering. The CoffeeMud engine keeps counters on all manner of different
 * game events, such as logins, new players, levels, deaths, and others.
 * CoffeeTableRows are managed by the CoffeeTables library.
 * 
...
public interface CoffeeTableRow extends CMCommon {
	...
	/**
	 * Returns the cumulative number online during this period per poll. Used to
	 * calulate the avg online for the period.
	 * 
	...
	/**
	 * Returns the number of times the number of players online has been polled
	 * during this period.
	 * 
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.CoffeeTableRow#populate(long,
	 *      long, String)
	...
	/**
	 * Populates this object from an xml document containing relevant
	 * statistics.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.CoffeeTableRow#data()
	 * @param start
	 *            the start time, in millis, for this row of data
	 * @param end
	 *            the end time, in millis, for this row of data
	 * @param data
	 *            the statistics and data for this row, as xml
	 */
	public void populate(long start, long end, String data);

	/**
	 * Finds a named statistic of the given name, and increments the value of
	 * that long statistic by 1. Requires the event being recorded.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.CoffeeTableRow#STAT_LOGINS
	 * @param s
	 *            the named statistic to record for the given event
	 * @param type
	 *            the type of event to tabulate
	 */
	public void bumpVal(String s, int type);

	/**
	 * Gathers relevant information about the given Environmental object
	 * (usually MOB or Ability) and adds to the relevant statistics. Requires
	 * the Environmental object to query, and the event being recorded.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.CoffeeTableRow#STAT_LOGINS
	 * @param E
	 *            the mob or ability
	...
	/**
	 * Simple method that replaces a strings spaces with _ characters, and makes
	 ...
	 * @param code
	 *            the code string to use, or *
	 * @param tot
	 *            the running total of all events stats
	 */
