 ...
 */
/**
 * A simple utility for making HTTP requests, which is implemented as a
 * builder-type object.
 */
public interface HttpClient extends Tickable, CMCommon {
	 ...
	 *            the url to fetch
	 * @param maxLength
	 *            the maximum size of the content, or 0 for any size
	 * @param readTimeout
	 *            the maximum time, in ms, to wait for connects, and reads
	 ...
	 *            the url to fetch
	 * @param cookieStr
	 *            cookies to send, or "", or null for none
	 * @return null or a completed byte array of the returned content
	 */
	...
	/**
	 * Calls GET on the given url, waiting no more than a few seconds for
	 * connection, and returns the headers from the response.
	 * 
	 * @param urlStr
	 *            the url to GET
	...
	/**
	 * An http request builder method that sets the maximum number of bytes that
	 * can be read by the request processor.
	 * 
	 * @param bytes
	 *            max bytes to read, or 0 for no limit
	 * @return this
	 */
	 ...
	 * milliseconds that the reader will remain idle waiting for a byte of data.
	 * 
	 * @param ms
	 *            the maximum number of ms to wait, or 0 for unlimited
	 * @return this
	 */
	...
	/**
	 * An http request builder method that sets the maximum number of
	 * milliseconds that the reader will remain idle waiting for a connection to
	 * occur.
	 * 
	 * @param ms
	 *            the maximum number of ms to wait, or 0 for unlimited
	...
	/**
	 * An http request builder method that resets the client obj so that the
	 * connection can be used for another request.
	 * 
	 * @return this
	 */
	...
	/**
	 * An http request builder method that causes this request to occur as a
	 * HEAD
	 * 
	 * @param url
	 *            the url to use
