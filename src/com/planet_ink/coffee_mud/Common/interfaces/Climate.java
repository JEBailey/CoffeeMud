 ...
 */
/**
 * A climate represents the entire weather pattern of an area It does most of
 * the mundane things related to weather changes based on season, area, and
 * other factors.
 */
public interface Climate extends Tickable, CMCommon {
	/**
	 * Returns the specific weather situation for the given room. Returns one of
	 * the Climate.WEATHER_* constants. It always returns WEATHER_CLEAR for
	 * indoor locales.
	 * 
	 * @see Climate
	 ...
	 * Returns one of the Climate.WEATHER_* constants. It always returns
	 * WEATHER_CLEAR for indoor locales. Climate objects always calculate
	...
	/**
	 * Sets the upcoming specific weather situation for this area. Takes one of
	 * the Climate.WEATHER_* constants. Climate objects always calculate weather
	 * 1 step ahead for predictive purposes.
	 * 
	 * @see Climate
	...
	/**
	 * Sets the current specific weather situation for this area. Takes one of
	 * the Climate.WEATHER_* constants. Climate objects always calculate weather
	 * 1 step ahead for predictive purposes.
	 * 
	 * @see Climate
	...
	/**
	 * Returns a readable description of the weather that will be upcoming for
	 * the given room.
	 * 
	 * @param room
	 *            the room to evaluate
	...
	/**
	 * Returns a readable string describing the weather conditions in the given
	 * area, assuming this climate is the correct one.
	 * 
	 * @param A
	...
	/**
	 * Returns a readable string describing the upcoming weather conditions in
	 * the given area, assuming this climate is the correct one.
	 * 
	 * @param A
	 *            the area to evaluate
	...
	/**
	 * This method forces the weather to change to what is designated by the
	 * nextWeatherType(). The Area is required to calculate a new
	 * nextWeatherType.
	 * 
	 * @param A
	 *            the area to calculate next weather for.
	 */
	public void forceWeatherTick(Area A);

	/**
	 * If applicable, thies method will return the base water thirstiness of the
	 * given mob, modified up or down based on the room given.
	 * 
	 * @param base
	 *            the water thirst gain to start with
	 * @param mob
	 *            the mob getting thirsty
	 * @param room
	...
	/**
	 * If applicable, thies method will return the base movement cost of the
	 * given mob, modified up or down based on the room given.
	 * 
	 * @param base
	 *            the movement loss to start with
	 * @param mob
	 *            the mob moving
	 * @param room
	...
	/**
	 * constant describing drought condition weather. @see
	...
	/**
	 * constant describing the number of weather types. @see
	 * Climate#weatherType(Room)
	 */
	public final static int NUM_WEATHER = 13;
	/** constant defining how often weather changes in the climates */
	public static final int WEATHER_TICK_DOWN = 300; // 300 = 20 minutes * 60
														// seconds / 4
	/**
	 * descriptive strings for the Climate.WEATHER_* constants, ordered by their
	 * value. @see Climate
	 */
	public final static String[] WEATHER_DESCS = { "CLEAR", "CLOUDY", "WINDY",
			"RAIN", "THUNDERSTORM", "SNOW", "HAIL", "HEAT", "SLEET",
			"BLIZZARD", "DUST", "DROUGHT", "COLD" };
