 ...
 */
/**
 * This interface represents more than a "Time Zone", but a complete calendar, a
 * complete lunar cycle, and schedule for days and nights. Oh, and it also
...
public interface TimeClock extends Tickable, CMCommon {
	/**
	 * Returns a complete description of the date, time, and lunar orientation,
	 * and day of the week in a full sentence word format.
	 * 
	 ...
	 * 
	 * @param mob
	 *            the mob who wants to know the time
	 * @param room
	...
	/**
	 * Gets a shorter time description, showing the date and time in full
	 * sentence format, but skipping lunar orientation.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#timeDescription(MOB,
	 *      Room)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#getShortestTimeDescription()
	 * 
	...
	/**
	 * Gets the shortest time description, showing only the date and time in
	 * brief numeric format.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#timeDescription(MOB,
	 *      Room)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#getShortTimeDescription()
	 ...
	 * 
	 * @return true, if the new time denotes a change of sun-orientation, false
	 *         otherwise
	 */
	 ...
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#setTimeOfDay(int)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#setDawnToDusk(int,
	 *      int, int, int)
	 ...
	 * 
	 * @param howManyHours
	 *            the how many hours to alter the time by
	 */
	public void tickTock(int howManyHours);

	/**
	 * Saves the current time/date information where ever its supposed to be
	 * saved. Requires that setLoadName be called before.
	 * 
	 ...
	 * 
	 * @param months
	 *            the new month names in a year
	 */
	public void setMonthsInYear(String[] months);

	/**
	 * Gets the dawn to dusk values, indexed by the TOD constants. Each entry is
	 * an hour when the TOD starts. The order of the values is DAWN, DAY, DUSK,
	 * NIGHT.
	 * 
	...
	/**
	 * Sets the dawn to dusk values as absolute hours when that particular time
	 * of day begins.
	 * 
	...
	/**
	 * Gets the week names, which is the names of the days of each week, a
	 * string array indexed by the day of the week - 1.
	 * 
	...
	/**
	 * Sets the number of days in each week by naming each of them in a string
	 * array
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#getDaysInWeek()
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#getWeekNames()
	 * 
	 * @param days
	 *            the new days in each week string array
	 */
	...
	/**
	 * This method will discover the difference in mud hours between this time
	 * clock and the given EARLIER clock, assuming they use the same scale of
	 * measurement. It will then return the number of actual milliseconds would
	 * have elapsed, assuming constant running and perfect timing.
	 * 
	 ...
	 * describing the number of mud days, hours, etc that is represented by that
	 * amount of real time, assuming constant running and perfect timing.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#deriveMillisAfter(TimeClock)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.TimeClock#deriveClock(long)
	 * 
	...
	/**
	 * Initialize ini clock by reading calendar values from the given properties
	 * page. Does not load current values from anywhere.
	 * 
	 * @param page
	 *            the properties page
	 */
	...
	/**
	 * The Moon Phase Constant MOON_PHASES, with long sentence descriptions of
	 * the various phases.
	 */
	...
	/**
	 * The Moon Phase Constant PHASE_DESC, holding the coded short values of the
	 * moon phases.
	 */
	public final static String[] PHASE_DESC = { "NEW", "WAXCRESCENT",
			"WAXQUARTER", "WAXGIBBOUS", "FULL", "WANEGIBBOUS", "WANEQUARTER",
			"WANECRESCENT", "BLUE" };

	/**
	 * The Constant TOD_DESC, with a sentence description of each
	 * sun-orientation (time of day).
	 */
	public final static String[] TOD_DESC = { "It is dawn ", "It is daytime ",
			"It is dusk ", "It is nighttime " };
	...
	/**
	 * The Season Constant SEASON_DESCS, with the string word name of each
	 * season.
	 */
	public final static String[] SEASON_DESCS = { "SPRING", "SUMMER", "FALL",
			"WINTER" };
