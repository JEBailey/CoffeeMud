 ...
 */
/**
 * An interface for a base player account. Shared by PlayerAccount and
 * PlayerStats (since the account system is optional)
 */
public interface AccountStats extends CMCommon {
	 ...
	 * 
	 * @param C
	 *            the time, in milis since 1970, that the player last logged
	 *            off.
	 */
	...
	/**
	 * Returns the players password, perhaps encoded, perhaps plain text. Use
	 * matchesPassword(String) to do actual checks.
	 * 
	 ...
	 * 1970, that this account will expire (meaning the player will no longer be
	 * able to log in)
	 * 
	...
	/**
	 * If the ACCOUNT system is used, this sets the time, in milis since 1970,
	 * that this account will expire (meaning the player will no longer be able
	 * to log in)
	 * 
	...
	/**
	 * Returns a modifiable HashSet that contains the set of player Names that
	 * constitutes this players friends.
	 * 
	...
	/**
	 * Returns a modifiable HashSet that contains the set of player Names that
	 * constitutes this players ignored player list.
	 * 
