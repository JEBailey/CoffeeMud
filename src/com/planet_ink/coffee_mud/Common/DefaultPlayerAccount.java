...
public class DefaultPlayerAccount implements PlayerAccount {
	...
	protected static String[] CODES = { "CLASS", "FRIENDS", "IGNORE", "LASTIP",
			"LASTDATETIME", "NOTES", "ACCTEXPIRATION", "FLAGS", "EMAIL" };
	...
	public String getStat(String code) {
		...
		case 7:
			return CMParms.toStringList(acctFlags);
		case 8:
			return email;
		default:
	...
	public void setStat(String code, String val) {
		...
		case 6:
			...
			break;
		case 7:
			acctFlags = new SHashSet<String>(CMParms.parseCommandFlags(
					val.toUpperCase(), PlayerAccount.FLAG_DESCS));
			break;
		case 8:
			email = val;
			break;
	...
	public MOB getAccountMob() {
		...
		synchronized (this) {
			...
			fakePlayerM.setPlayerStats((PlayerStats) CMClass
	...
	public String getXML() {
		...
		for (int x = 0; x < codes.length; x++) {
			...
			if (value.length() == 0)
				...
				rest.append("<" + code + ">"
						+ libXML.parseOutAngleBrackets(value) + "</" + code
						+ ">");
		}
