...
public class DefaultPhyStats implements PhyStats {
	...
	public String getCombatStats() {
		return "L" + stats[STAT_LEVEL] + ":A" + stats[STAT_ARMOR] + ":K"
				+ stats[STAT_ATTACK] + ":D" + stats[STAT_DAMAGE];
	}
	...
	public void addAmbiance(String ambiance) {
		...
		if ((ambiances != null)
				&& (Arrays.binarySearch(ambiances, ambiance, ambiComp) >= 0))
			return;
		if (ambiances == null)
	...
	private final static String[] CODES = { "SENSES", "DISPOSITION", "LEVEL",
			"ABILITY", "REJUV", "WEIGHT", "HEIGHT", "ARMOR", "DAMAGE",
			"ATTACK", "AMBIANCES" };
	...
	public void setStat(String code, String val) {
		...
		case 10: {
			if (val.trim().length() == 0)
				...
				ambiances = CMParms.toStringArray(CMParms
	...
	public String getStat(String code) {
		...
		case 10:
			return CMParms.toStringList(ambiances());
		default:
			return "";
		}
	}
