...
public class DefaultManufacturer implements Manufacturer {
	...
	public void setManufactureredTypesList(String list) {
		...
		for (String s : CMParms.parseCommas(list, true)) {
			TechType t = (TechType) CMath.s_valueOf(TechType.class, s
					.toUpperCase().trim());
			if (t != null)
				newTypes.add(t);
		}
	...
	public String getXml() {
		...
		xml.append("<NAME>" + CMLib.xml().parseOutAngleBrackets(name)
				+ "</NAME>");
		...
		xml.append("<MASK>"
				+ CMLib.xml().parseOutAngleBrackets(getItemMaskStr())
				+ "</MASK>");
	...
	public void setXml(String xml) {
		...
		setName(CMLib.xml().restoreAngleBrackets(
				CMLib.xml().getValFromPieces(xpc, "NAME")));
		setMaxTechLevelDiff((byte) CMath.s_short(CMLib.xml().getValFromPieces(
				xpc, "MAXTECHDIFF")));
		setMinTechLevelDiff((byte) CMath.s_short(CMLib.xml().getValFromPieces(
				xpc, "MINTECHDIFF")));
		...
		setItemMask(CMLib.xml().restoreAngleBrackets(
				CMLib.xml().getValFromPieces(xpc, "MASK")));
