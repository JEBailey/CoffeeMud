...
public class WimpyAggressive extends Aggressive {
	...
	public String accountForYourself() {
		if (getParms().trim().length() > 0)
			return "wimpy aggression against "
	...
	public static void pickAWimpyFight(MOB observer, boolean mobKiller,
			boolean misBehave, String attackMsg, String zapStr) {
	...
	public static void tickWimpyAggressively(Tickable ticking,
			boolean mobKiller, boolean misBehave, int tickID, String attackMsg,
			String zapStr) {
