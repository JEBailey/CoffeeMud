...
public interface LegalBehavior extends Behavior {
	...
	public static final long EXPIRATION_MILLIS = ONE_REAL_DAY * 7; // 7 real
																	// days
	/**
	 * constant for the number of miliseconds before an area is under legal
	 * control
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 * @param W
	 *            the legal warrant to inspect
	 * @param debugging
	 *            whether debug information should be sent to the log
	...
	/**
	 * Inspects the circumstances of, and if necessary, assigns a warrant to be
	 * handled by local law enforcement and judges. Call this method if you want
	 * to add a warrant for a custom crime with your own qualifying flags. For
	 * recognized crimes with crime keys, however, use the accuse command.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#accuse(Area,
	 *      MOB, MOB, String[])
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law
	 * @see com.planet_ink.coffee_mud.Common.interfaces.Law#PUNISHMENTMASK_DESCS
	 * @param mob
	 *            the accused character
	 * @param laws
	 *            the system of laws to use as a basis
	 * @param myArea
	 *            the geographical domain that the laws apply to
	 * @param target
	 *            the victim of a crime, if any
	 * @param crimeLocs
	 *            string of location flags, e.g. !indoors !home keyword !keyword
	 * @param crimeFlags
	 *            string of crime situation flags, e.g. !recently !combat
	 * @param crime
	 *            string description of the crime, e.g. robbing <T-NAME>
	 * @param sentence
	 *            string sentence action, e.g. warn, parole1, jail1, death
	 * @param warnMsg
	 *            string the officer will say to explain the seriousness of the
	 *            crime
	 ...
	 * 
	 * @param myArea
	 *            the geographical legal area
	 * @param accused
	 *            the mob with actual warrants out on him/her
	 * @param framed
	 *            the person to transfer the first warrant to.
	 * @return whether warrants were actually transferred from the accused to
	 *         the framed
	 */
	 ...
	 * @param officer
	 *            the mob to assign as the arresting officer
	 * @param mob
	 *            the mob to arrest
	 ...
	 *            the geographic legal area
	 * @param mob
	 *            the mob to test for officerhood
	 ...
	 *            the geographic legal area
	 * @param mob
	 *            the mob to test for judgehood
	 * @return true if the mob is a judge, false otherwise
	 */
	public boolean isJudge(Area myArea, MOB mob);

	/**
	 * A method to change the amount of base currency currently listed as fines
	 * owed by the given mob. A value of 0 erases.
	 * 
	 * @param d
	 *            the amount of base currency the mob owes
	 * @param mob
	 *            the mob who owes money to the state
	 */
	 ...
	 * 
	 * @param mob
	 *            the mob who might owe money
	 * @return the amount owed, or 0 if none.
	 */
	public double finesOwed(MOB mob);

	/**
	 * This method notifies the legal behavior that its laws have changed and
	 * need to be updated. Call this method whenever the behaviors/ areas laws
	 * have changed.
	 * 
	 * @param myArea
	 *            the geographic legal area
	 ...
	 * @return Empty string if the area is unruled, or ruled by the system.
	 *         ClanID otherwise.
	 */
	public String rulingOrganization();

	/**
	 * If the legal behavior and area are conquerable by clans or foreign
	 * organizations, this method will return the name of the current
	 * controlling clan, and some information about the state of the conquest,
	 * such as control points achieved.
	 * 
	 * @param myArea
	 *            the geographic legal area
	 ...
	 * legally stable. Unconquerable areas are always stable, and areas
	 * conquered and controlled for a sufficient amount of time are also stable.
	 * 
	...
	/**
	 * Returns the number of control points necessary to conquer the area
	 * governed by this legal behavior. Not applicable if the legal behavior
	 * doesn't permit government changes or conquest.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#setControlPoints(String,
	 *      int)
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#getControlPoints(String)
	 * @return the number of control points needed to control this legal
	 *         behavior
	 */
	 ...
	 * remove itself from control. Not applicable if the legal behavior doesn't
	 * permit government changes or conquest.
	 * 
	 ...
	 * applicable if the legal behavior doesn't permit government changes or
	 * conquest.
	 * 
	 ...
	 * match the search string, and still have legal warrants available for
	 * them. Use a search name of NULL to return all criminals.
	 * 
	 * @see com.planet_ink.coffee_mud.MOBS.interfaces.MOB
	 * @param myArea
	 *            the geographic legal area
	 * @param searchStr
	 *            the name/search string to use
	 ...
	 *            the geographic legal area
	 * @param accused
	 *            the mob to look for warrants for
	 ...
	 * This method is called by other methods to finish off their work. Any
	 * WARRANTS channels are also notified.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#fillOutWarrant(MOB,
	 *      Law, Area, Environmental, String, String, String, String, String)
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#addWarrant(Area,
	 *      MOB, MOB, String, String, String, String, String)
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 * @param myArea
	 *            the geographic legal area
	 * @param W
	 *            the LegalWarrant to put on the docket
	...
	/**
	 * Removes the given warrants from the list of issued warrants. Does not
	 * update the old-warrants (prior convictions) record, but erases the
	 * warrant completely.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.LegalWarrant
	 * @param myArea
	 ...
	 *            the geographic legal area
	 * @param accused
	 *            the mob possible accused of one of the crimes
	 * @param acquittableLaws
	 *            the list of crime keys.
	...
	/**
	 * Returns whether any of the given Room objects in the jails Vector is
	 * indeed an official Jail room as defined by this legal behavior.
	 * 
	 * @see com.planet_ink.coffee_mud.Locales.interfaces.Room
	 * @param myArea
	 *            the geographic legal area
	 * @param jails
	 *            a Vector of Room objects to inspect
	 * @return whether any one of the room objects is, in fact, a jail
	 */
	public boolean isJailRoom(Area myArea, List<Room> jails);

	/**
	 * Issues a LegalWarrant against the accused on behalf of the given victim,
	 * for a crime listed in the list of crime keys. Calls fillOutWarrant after
	 * retreiving the remaining information about the crime key described by the
	 * parameter accusableLaws.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.LegalBehavior#fillOutWarrant(MOB,
	 *      Law, Area, Environmental, String, String, String, String, String)
	 * @param myArea
	 ...
	 * @param accusableLaws
	 *            a crime key, such as TAXEVASION
	 * @return whether one of the laws was found, and a warrant successfully
	 *         filled out
	 */
