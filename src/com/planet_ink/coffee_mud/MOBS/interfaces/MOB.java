...
public interface MOB extends Rider, DBIdentifiable, PhysicalAgent,
		ItemPossessor, AbilityContainer {
	...
	/**
	 * Some general statistics about MOBs. See the CharStats class (in
	...
	public void tell(MOB source, Environmental target, Environmental tool,
			String msg);
	...
	/**
	 * Manipulation of inventory, which includes held, worn, wielded, and
	 * contained items
	 */
	...
	/**
	 * Extra functions on ability objects, which includes spells, traits,
	 * skills, etc.
	 */
	...
	/**
	 * Adds a new expertise, or updates an existing one. Requires a coded
	 * expertise name (string followed by roman or decimal number)
	 * 
	 * @param code
	 *            the expertise to add or update
	 */
	...
	/**
	 * Returns an enumerator of all the expertise names with their numbers if
	 * any .
	 * 
	...
	public static final boolean[] AUTOREV = { false, false, false, true, false,
			false, true, false, false, false, false, false, false, false,
			false, false, false, true, true, false, false, false, false, true };
	public static final String[] AUTODESC = { "AUTOGOLD", "AUTOLOOT",
			"AUTOEXITS", "AUTOASSIST", "ANSI COLOR", "SYSMSGS", "AUTOMELEE",
			"PLAYERKILL", "BRIEF", "NOFOLLOW", "AUTOWEATHER", "AUTODRAW",
