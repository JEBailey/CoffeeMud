...
/**
 * An exception that gets thrown on persistence operations. If it was triggered
 * by a specific exception, that exception will be added to the exception chain
 * so any class catching this exception can get detailed information on what
 * went wrong.
 * 
...
public class PersistenceException extends Exception {
	...
	/**
	 * Constructs a new PersistenceException with the specified exception
	 * explanation.
	 * 
	 * @param reason
	...
	/**
	 * Constructs a new PersistenceException that occured because another
	 * exception was encountered during a persistence operation such as a save
	 * or restore.
	 * 
	 * @param e
	 *            the exception causing this exception to be created
	 */
	...
	/**
	 * Constructs a new PersistenceException based on a previous exception
	 * during a persistence operation with the specified exception explanation.
	 * 
	 * @param reason
