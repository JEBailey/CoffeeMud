...
/**
 * This extension of the Packet class handles incoming and outgoing intermud
 * tells. To use it in a services object, simply grab the data out of its public
 * members. To use it to send a tell, set all of its public data members and
 * call the send() method.<BR>
...
public class TellPacket extends Packet {
	 ...
	 * 
	 * @exception com.planet_ink.coffee_mud.core.intermud.i3.packets.InvalidPacketException
	 *                thrown if the incoming packet is bad
	 * @param v
	 *            the I3 mud mode vector containing the incoming tell
	 */
	 ...
	 * 
	 * @param u
	 *            the interactive sending the tell
	 * @param who
	 *            the person whom they are sending the tell to
	 * @param mud
	 *            the mud the target is on
	 * @param msg
	 ...
	 * 
	 * @exception com.planet_ink.coffee_mud.core.intermud.i3.packets.InvalidPacketException
	 *                thrown if this packet was not properly constructed
	...
	/**
	 * This method is used by the I3 system to turn the packet into a mud mode
	 * string. To see the proper format for an I3 tell, see the <A
	 * HREF="http://www.imaginary.com/intermud/intermud3.html"> Intermud 3</A>
	 * documentation.
	 * 
	...
	public String toString() {
		return "({\"tell\",5,\"" + I3Server.getMudName() + "\",\""
				+ sender_name + "\",\"" + target_mud + "\",\"" + target_name
