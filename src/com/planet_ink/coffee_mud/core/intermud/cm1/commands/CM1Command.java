...
public abstract class CM1Command implements Runnable, Cloneable {
	protected final String className = "CM1"
	...
	public static CM1Command newInstance(Class<? extends CM1Command> cls,
			RequestHandler req, String parms) {
		try {
			if (cls == null)
				return null;
			return cls.getConstructor(RequestHandler.class, String.class)
					.newInstance(req, parms);
		} catch (Exception e) {
