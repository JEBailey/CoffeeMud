...
public class Directions {
	...
	private final static int[] DIRECTIONS_11_BASE = { NORTH, SOUTH, EAST, WEST,
	...
	public static final String[] DIRECTION_CHARS = { "N", "S", "E", "W", "U",
			"D", "V", "NE", "NW", "SE", "SW" };

	public static final Object[][] DIRECTIONS_COMPASS_CHART = {
			{ "UP", Integer.valueOf(UP) }, { "ABOVE", Integer.valueOf(UP) },
	...
	public static final Object[][] DIRECTIONS_FULL_CHART = concat(
			DIRECTIONS_COMPASS_CHART, DIRECTIONS_SHIP_CHART);
	...
	public static final int[] adjustXYByDirections(int x, int y,
			final int direction) {
		switch (direction) {
