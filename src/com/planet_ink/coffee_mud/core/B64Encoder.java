...
public class B64Encoder {
	...
	{ (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F',
			...
			(byte) '9', (byte) '+', (byte) '/' };
	public static final byte[] DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9,
			-9, // Decimal 0 - 8
	...
	public static final byte WHITE_SPACE_ENC = -5; // Indicates white space in
													// encoding
	public static final byte EQUALS_SIGN_ENC = -1; // Indicates equals sign in
													// encoding
	...
	public static String B64encodeObject(
	...
	public static boolean B64encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new B64OutputStream(new java.io.FileOutputStream(filename),
					ENCODE);
	...
	public static byte[] B64decodeFromFile(String filename) {
		...
		try {
			...
			bis = new B64InputStream(new java.io.BufferedInputStream(
