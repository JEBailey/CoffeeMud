 ...
 */
/**
 * The core of most object types in CoffeeMud. Much of the most common fields
 * and data are derived from this. It represents something that appears in the
 * environment, either physically, or as energy or other phenomenon.
 * 
 * @author Bo Zimmerman
 * 
 */
public interface Environmental extends Tickable, StatsAffecting, MsgListener,
		Contingent, Modifiable {
	/**
	 * The raw unmodified name of this object as stored in the database. This is
	 * the name set by builders and used as a basis for the name() method.
	 * 
	 ...
	 * This is the name set by builders and used as a basis for the name()
	 * method.
	 * 
	 * @see Environmental#Name()
	 * @param newName
	 ...
	 * what an exit looks like when open. The value for Items may be null if the
	 * item is not displayed when the room is seen.
	 * 
	...
	/**
	 * The basic description of this object, as shown when the item is directly
	 * LOOKed at.
	 * 
	...
	/**
	 * Sets the basic description of this object, as shown when the item is
	 * directly LOOKed at.
	 * 
	...
	/**
	 * Returns the fully qualified and determined name of the image file
	 * displayed for this object when MXP is used. If rawImage() is non-empty,
	 * it will return rawImage, and otherwise use the mxp default data file.
	 * 
	...
	/**
	 * Returns the raw name of the image file to display for this object when
	 * MXP is used. This is the value set by the builder, and may be returned by
	 * image() if it is non-empty.
	 * 
	...
	/**
	 * Sets the raw name of the image file to display for this object when MXP
	 * is used. This is the value set by the builder, and may be returned by
	 * image() if it is non-empty.
	 * 
	 * @param newImage
	 ...
	 * Generic means that they are set by builders, in which case XML is
	 * returned by the text() method containing all of the values for all the
	 * fields.
	 * 
	...
	/**
	 * For objects which have false for their isGeneric method, this is used to
	 * set any internally coded strings to change the nature or behavior of the
	 * object. For objects which have true for their isGeneric method, this is
	 * used to set and parse the XML which will be used to fill out the fields
	 * in this object. Since Ability objects are never Generic, this will always
	...
	/**
	 * If this object expires, it should have a timestamp saying when it
	 * expires, in real time. When it expires, a MSG_EXPIRE message will be sent
	 * to it.
	 * 
	...
	/**
	 * the maximum range of this object, if applicable. Can refer to the size of
	 * a room, the range of a weapon, or the calculated range of a mob in
	 * combat.
	 * 
	...
	/**
	 * the minimum range of this object, if applicable. Can refer to the size of
	 * a room, the range of a weapon, or the calculated range of a mob in
	 * combat. Usually 0.
	 * 
