 ...
 */
/**
 * This class represents a thread, consisting of a group of Tickable objects
 * receiving periodic calls to their tick(Tickable,int) methods by this thread
 * object
 * 
 * @see Tickable
...
public interface TickableGroup extends CMRunnable {
	/**
	 * Returns the current or last TickClient object which this thread made a
	 * tick(Tickable,int) method call to.
	 * 
	 * @see Tickable
	 * @see Tickable#tick(Tickable, int)
	 ...
	 * 
	 * @param T
	 *            the tickable object to look for
	 * @param tickID
	 *            the tickid to match, or -1 for all
	 ...
	 * 
	 * @param itemTypes
	 *            0=mobs or items, 1=items, 2=mobs
	 * @param R
	 *            the room to look in
	...
	/**
	 * Returns true if this group contains the given ticking object with the
	 * given tickID.
	 * 
	 * @param T
	 *            the tickable object
	 * @param tickID
	 *            the tickid to match, or -1 for any
	...
	/**
	 * Returns the name of the thread group that this ticking group belongs to
	 * (and thus, under which it should run later)
	 * 
	...
	/**
	 * If this group is currently getting thread time, this will return a
	 * reference to that thread object, or null otherwise.
	 * 
