...
public interface Behavable {
	 ...
	 * recoverPhyStats() should be called next in case this behavior object
	 * modifies the stats. A Behavior with a given ID() can only be added once
	 * per object.
	 * 
	...
	/**
	 * Returns a behavior object on this object. May return null even if the
	 * index is correct to mark a race condition.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	...
	/**
	 * Returns a behavior object listed on this object. The object will be the
	 * one with the same ID() string as passed in.
	 * 
	 * @see com.planet_ink.coffee_mud.Behaviors.interfaces.Behavior
	 * @see CMObject#ID()
	 * @return the behavior object
	...
	/**
	 * Add a new runnable script to this object. Objects which are not mobs or
	 * areas will gain a temporary tick service for this script.
	 * 
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine
	 * @param s
	 *            the scripting engine, fully populated, to add
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Common.interfaces.ScriptingEngine
	 * @param s
	 *            the specific scripting engine to remove
	 */
