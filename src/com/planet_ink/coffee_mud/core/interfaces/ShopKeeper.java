 ...
 */
/**
 * An interface for objects capable of being a shopkeeper, usually a MOB or an
 * Ability.
 * 
 * @author Bo Zimmerman
 * 
...
public interface ShopKeeper extends Environmental, Economics {
	...
	/**
	 * shopkeeper type constant, means they buy items not covered by other
	 * constants
	 */
	...
	/**
	 * shopkeeper type constant, means they are a banker for players, and
	 * implement the Banker interface
	 */
	public final static int DEAL_BANKER = 12;
	/**
	 * shopkeeper type constant, means they buy and sell property in their area
	 * to players
	 */
	...
	/**
	 * shopkeeper type constant, means they are a banker for clans, and
	 * implement the Banker interface
	 */
	...
	/**
	 * shopkeeper type constant, means they buy and sell SpaceShip areas to
	 * players
	 */
	...
	/**
	 * shopkeeper type constant, means they buy and sell intelligent mobs as
	 * slaves
	 */
	public final static int DEAL_SLAVES = 27;
	/**
	 * shopkeeper type constant, means they handle mail for players, and
	 * implement the Postman interface
	 */
	public final static int DEAL_POSTMAN = 28;
	/**
	 * shopkeeper type constant, means they handle mail for clans, and implement
	 * the Postman interface
	 */
	public final static int DEAL_CLANPOSTMAN = 29;
	/**
	 * shopkeeper type constant, means they handle auctions, and implement the
	 * Auctioneer interface
	 */
	public final static int DEAL_AUCTIONEER = 30;

	/**
	 * shopkeeper integer sets denoting the DEAL_* constants which conflict with
	 * each other
	 */
	public final static int[][] DEAL_CONFLICTS = {
			{ DEAL_POSTMAN, DEAL_CLANPOSTMAN },
			{ DEAL_CLANBANKER, DEAL_BANKER },
			{ DEAL_SHIPSELLER, DEAL_CSHIPSELLER, DEAL_LANDSELLER,
					DEAL_CLANDSELLER }, { DEAL_TRAINER, DEAL_CASTER }, };

	/**
	 * A list of strings describing the DEAL_* constants, in their numeric value
	 * order.
	 */
	public final static String[] DEAL_DESCS = { "ANYTHING", "GENERAL", "ARMOR",
			"MAGIC", "WEAPONS", "PETS", "LEATHER", "INVENTORY ONLY", "TRAINER",
			"CASTER", "JEWELRY", "POTIONS", "BANKER", "LAND", "ANY TECHNOLOGY",
			"CLAN LAND", "FOODS", "MEATS", "VEGETABLES", "HIDES", "LUMBER",
			"METALS", "ROCKS", "CLAN BANKER", "INN KEEPER", "SHIP SELLER",
			"CLAN SHIP SELLER", "SLAVES", "POSTMAN", "CLAN POSTMAN",
			"AUCTIONEER" };

	/**
	 * This class represents a given price for a given item in the shopkeepers
	 * inventory. It is usually calculated for a given buyer.
	 */
	...
	/**
	 * Returns the ShopKeeper DEAL_* mask describing what is sold or bought by
	 * this ShopKeeper
	 * 
	 ...
	 *      return the dealer type constants to the 2nd power, shifted 8 bits
	 *      left
	 */
	 ...
	 * 
	 * @param deal
	 *            the ShopKeeper DEAL_* constant describing what is sold or
	 *            bought by this ShopKeeper
	 * @see com.planet_ink.coffee_mud.core.interfaces.ShopKeeper#DEAL_DESCS
	...
	/**
	 * Sets the encoded ShopKeeper DEAL_* constants describing what is sold or
	 * bought by this ShopKeeper
	 * 
	 * @see com.planet_ink.coffee_mud.core.interfaces.ShopKeeper#DEAL_DESCS
	 * @see com.planet_ink.coffee_mud.core.interfaces.ShopKeeper#addSoldType(int)
	 * @param newSellCode
	 *            the dealer type constants to the 2nd power, shifted 8 bits
	 *            left
	 */
	public void setWhatIsSoldMask(long newSellCode);

	/**
	 * Adds the ShopKeeper DEAL_* constants describing what is sold or bought by
	 * this ShopKeeper to the existing shopkeeper mask. A value of 0 will clear
	 * the whole mask.
	 * 
	 * @see com.planet_ink.coffee_mud.core.interfaces.ShopKeeper#DEAL_DESCS
	 * @see com.planet_ink.coffee_mud.core.interfaces.ShopKeeper#isSold(int)
	 * @param dealType
	 *            the ShopKeeper DEAL_* constants describing what is sold or
	 *            bought by this ShopKeeper
	 */
	public void addSoldType(int dealType);

	/**
	 * Based on the value of this ShopKeepers whatIsSold() method, this will
	 * return a displayable string describing that type.
	 * 
	...
	/**
	 * Returns whether this ShopKeeper deals in the type of item passed in. The
	 * determination is based on the whatIsSold() code.
	 * 
	 * @see ShopKeeper#isSold(int)
	 * @param thisThang
