...
public interface Physical extends Environmental, Affectable {
	/**
	 * Returns the displayText, but as seen by the given viewer. Can differ from
	 * displayText() without being saved to the DB. Display Texts are normally
	 * the way something appears in a room, or is the roomTitle of rooms.
	 * 
	...
	/**
	 * Returns the name, but as seen by the given viewer. Can differ from name()
	...
	/**
	 * Returns the description, but as seen by the given viewer. Can differ from
	 * description() without being saved to the DB. Descriptions are normally
	 * the way something appears when looked at, or is the long description of
	 * rooms.
	 * 
