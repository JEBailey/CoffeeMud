...
public interface Rideable extends PhysicalAgent {
	...
	/**
	 * constant for the rideType() method. Means it is climbed and travels with
	 * player
	 */
	public final static String[] RIDEABLE_DESCS = { "LAND-BASED",
			"WATER-BASED", "AIR-FLYING", "FURNITURE-SIT", "FURNITURE-SLEEP",
			"FURNITURE-TABLE", "ENTER-IN", "LADDER", "WAGON" };
	...
	/**
	 * Returns a particular Rider mounted on this Rideable. May return null in
	 * the case of a race condition
	 * 
	 * @see Rider
	 * @see Rideable
	 * @see Rideable#numRiders()
	 * @param which
	 *            which rider to detch
	 ...
	 * @see Rideable
	 * @param mob
	 *            Rider object, either an item or a mob
	 */
	 ...
	 * @see Rideable
	 * @param mob
	 *            the Rider to check this Rideable for
	 * @return true if the Rider is mounted on this Rideable
	 */
	public boolean amRiding(Rider mob);

	/**
	 * Returns a string grammatically correct for the given rider when they are
	 * mounted on this Rideable
	 * 
	 * @see Rider
	 * @see Rideable
	 * @param R
	...
	/**
	 * Returns a string grammatically correct for the given rider when they are
	 * putting something on this Rideable
	 * 
	 * @see Rider
	 * @see Rideable
	 * @param R
	 *            The rider object to make grammatically correct.
	 * @return a string describing the riders state of putting something on this
	 *         Rideable
	 */
	public String putString(Rider R);

	/**
	 * Returns a string grammatically correct for this Rideable when Riders are
	 * mounted
	 * 
	 * @see Rider
	 * @see Rideable
	...
	/**
	 * Whether this Rideable moves when the Rider wants to move it. Largely
	 * derived from rideBasis().
	 * 
	...
	/**
	 * Adds all of the MOB Riders on this Rideable to the given HashSet and
	 * returns it
	 * 
	 * @param list
