...
public interface ItemCollection extends CMObject {
	/**
	 * Adds a new item to its possessor. By default, the item is added in a
	 * default resting state -- no containers, timeouts, or other modifiers are
	 * set. Duplicates will not be permitted.
	 * 
	...
	/**
	 * Returns the total number of items at this possessor, regardless of
	 * container status.
	 * 
	...
	/**
	 * Returns the item in the given container that matches the given itemID,
	 * whether by full name, description, class ID, or partial name (if no
	 * fuller name is found). Handles indexing for duplicate-named items.
	 * 
	 * @param goodLocation
	 *            the container to look in, or null for none
	 * @param itemID
	...
	/**
	 * Returns the item in this possessor that matches the given itemID, whether
	 * by full name, description, class ID, or partial name (if no fuller name
	 * is found). Handles indexing for duplicate-named items.
	 * 
	 * @param itemID
	 *            the name or partial name of the item to fetch
	 * @return the item found, or null
	...
	/**
	 * Returns all items in the given container that matches the given itemID,
	 * whether by full name, description, class ID, or partial name (if no
	 * fuller names are found).
	 * 
	 * @param goodLocation
	 *            the container to look in, or null for none
	 * @param itemID
	...
	/**
	 * Returns all items in this possessor that matches the given itemID,
	 * whether by full name, description, class ID, or partial name (if no
	 * fuller names are found).
	 * 
	 * @param itemID
	 ...
	 * 
	 * @param destroy
	 *            true to also destroy the items
	 */
