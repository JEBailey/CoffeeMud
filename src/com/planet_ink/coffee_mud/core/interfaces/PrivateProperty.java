 ...
 * be found implemented by Abilities which are placed as effects on the room
...
public interface PrivateProperty extends Environmental {
	...
	/**
	 * Returns a unique id for this particular title and the rooms is
	 * represents, even if the contents change.
	 * 
	 * @return a unique id
	 */
