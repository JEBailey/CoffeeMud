 ...
 */
/**
 * Encapsulates, manages, and collects statistics about a single ticking object
 * in the game. These clients are grouped together in TickableGroup objects,
 * which are in turn called by the ServiceEngine to get thread time.
 * 
 * @author Bo Zimmerman
 * 
 */
public interface TickClient extends Comparable<TickClient> {
	...
	/**
	 * Returns the status of this ticking client as a displayable String,
	 * usually just a translation of the {@link Tickable#getTickStatus()}
	 * 
	...
	/**
	 * Returns the name of this ticking client as a displayable String, usually
	 * just a translation of the {@link Tickable#name()}
	 * 
	 * @return the TICKID_ constant assigned to this object
	 */
	...
	/**
	 * Sets the status of this ticking client as a displayable String
	 * 
	...
	/**
	 * Potentially allows the internal object to be ticked. This will cause the
	 * current tick down, which starts at totaltickdown to be decremented by
	 * one. When it reaches 0, the internal object will be "ticked".
	 * 
	 * @see Tickable#tick(Tickable, int)
	 * @param forceTickDown
	 *            true to override the currentTickDown
	...
	/**
	 * Returns the number of ticks total before the internal object is allowed
	 * to get thread time.
	 * 
