 ...
 */
/**
 * The interface implemented by the main mud application. Includes several
 * timing constants.
 * 
 * @author Bo Zimmerman
 * 
...
public interface MudHost {
	...
	public final static long TIME_SAVETHREAD_SLEEP = 60 * 60000; // 60 minutes,
																	// right
																	// now.
	 ...
	 * 
	 * @param S
	 *            a player session to send status messages to. May be null.
	 * @param keepItDown
	 *            true to shutdown, false to restart
	 * @param externalCommand
	 *            if keepItDown is false, an external command to execute
	 */
	...
	/**
	 * Flexible interface for tinkering with mud-host settings. Commands to be
	 * defined later, or now, or whatever.
	 * 
	 * @param cmd
	 *            space-delimited (parsable) command/parm list
	...
	/**
	 * Because thread groups are used to track configurations, here is a way to
	 * get it.
	 * 
	 ...
	 * 
	 * @param sock
	 *            the socket the connection was made on
	 */
