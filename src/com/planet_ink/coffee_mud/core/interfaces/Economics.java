...
public interface Economics extends Environmental {
	/**
	 * A string describing how pricing for this ShopKeeper will differ based on
	 * customer attributes such as race.
	 * 
	...
	/**
	 * Sets the string describing how pricing for this ShopKeeper will differ
	 * based on customer attributes such as race.
	 * 
	 * @param factors
	...
	/**
	 * A string set describing how pricing for this ShopKeeper will differ based
	 * on item masks The format for each string is a floating point number
	 * followers by a space and a zapper mask
	 * 
	...
	/**
	 * Sets the string set describing how pricing for this ShopKeeper will
	 * differ based on item masks The format for each string is a floating point
	 * number followers by a space and a zapper mask
	 * 
	 * @param factors
	 *            the string describing price prejudicing
	 */
	...
	/**
	 * Returns the mask used to determine if a customer is ignored by the
	 * ShopKeeper.
	 * 
	...
	/**
	 * Sets the mask used to determine if a customer is ignored by the
	 * ShopKeeper.
	 * 
	 * @see com.planet_ink.coffee_mud.Libraries.interfaces.MaskingLibrary
	 * @param factors
	...
	/**
	 * Sets a description of the buying budget of the shopkeeper. Format is an
	 * amount of base currency followed by HOUR,WEEK,DAY,MONTH or YEAR.
	 * 
	 * @param factors
	 ...
	 * which this ShopKeeper will buy back items based on the number already in
	 * his inventory. The format is a number representing the percentage price
	 * drop per normal item followed by a space, followed by a number
	 * representing the percentage price drop per raw resource item. A value of
	 * "0 0" would mean no drop in price for either, ever.
	 * 
	...
	/**
	 * Sets a string describing the percentage in the drop of the price at which
	 * this ShopKeeper will buy back items based on the number already in his
	 * inventory. The format is a number representing the percentage price drop
	 * per normal item followed by a space, followed by a number representing
	 * the percentage price drop per raw resource item. A value of "0 0" would
	 * mean no drop in price for either, ever.
	 * 
	 * @param factors
