...
public class STreeSet<K> implements Serializable, Iterable<K>, Collection<K>,
		NavigableSet<K>, Set<K>, SortedSet<K> {
	...
	@Override
	public synchronized NavigableSet<K> subSet(K fromElement,
