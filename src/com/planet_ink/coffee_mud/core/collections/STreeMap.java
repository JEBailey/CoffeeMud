 ...
 */
public class STreeMap<K, V> implements Serializable, Map<K, V>,
	...
	@Override
	public synchronized NavigableMap<K, V> subMap(K fromKey,
			boolean fromInclusive, K toKey, boolean toInclusive) {
		return new ReadOnlyNavigableMap<K, V>(T.subMap(fromKey, fromInclusive,
				toKey, toInclusive));
	}
