...
public class TrackingVector<T> extends Vector<T> {
	...
	private final WeakReference<TrackingVector<T>> myRef = new WeakReference<TrackingVector<T>>(
			this);
	...
	public TrackingVector(
			Map<T, List<WeakReference<TrackingVector<T>>>> tracker, int sz) {
		super(sz);
		this.tracker = tracker;
		trackBackRef = null;
	}
	...
	public TrackingVector(
			Map<T, List<WeakReference<TrackingVector<T>>>> tracker,
			TrackBack<T> obj) {
		super();
		this.tracker = tracker;
