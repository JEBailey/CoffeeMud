 ...
 */
public class QuintVector<T, K, L, M, N> extends Vector<Quint<T, K, L, M, N>>
		implements List<Quint<T, K, L, M, N>> {
	...
	public Enumeration<T> firstElements() {
		return new ConvertingEnumeration<Quint<T, K, L, M, N>, T>(elements(),
				getFirstConverter());
	}

	public Enumeration<K> secondElements() {
		return new ConvertingEnumeration<Quint<T, K, L, M, N>, K>(elements(),
				getSecondConverter());
	}

	public Enumeration<L> thirdElements() {
		return new ConvertingEnumeration<Quint<T, K, L, M, N>, L>(elements(),
				getThirdConverter());
	}

	public Enumeration<M> fourthElements() {
		return new ConvertingEnumeration<Quint<T, K, L, M, N>, M>(elements(),
				getFourthConverter());
	}

	public Enumeration<N> fifthElements() {
		return new ConvertingEnumeration<Quint<T, K, L, M, N>, N>(elements(),
				getFifthConverter());
	}

	public Iterator<T> firstIterator() {
		return new ConvertingIterator<Quint<T, K, L, M, N>, T>(iterator(),
				getFirstConverter());
	}

	public Iterator<K> secondIterator() {
		return new ConvertingIterator<Quint<T, K, L, M, N>, K>(iterator(),
				getSecondConverter());
	}

	public Iterator<L> thirdIterator() {
		return new ConvertingIterator<Quint<T, K, L, M, N>, L>(iterator(),
				getThirdConverter());
	}

	public Iterator<M> fourthIterator() {
		return new ConvertingIterator<Quint<T, K, L, M, N>, M>(iterator(),
				getFourthConverter());
	}

	public Iterator<N> fifthIterator() {
		return new ConvertingIterator<Quint<T, K, L, M, N>, N>(iterator(),
				getFifthConverter());
	}
