...
public class MXP {
	...
	public void initMXP() {
		...
		addElement(new MXPElement("UNDERLINE", "<U>", "", "",
				MXPElement.BIT_HTML));
		...
		addElement(new MXPElement("STRIKEOUT", "<S>", "", "",
				MXPElement.BIT_HTML));
		...
		addElement(new MXPElement("HR", "<HR>", "", "", MXPElement.BIT_HTML
				| MXPElement.BIT_COMMAND));
		addElement(new MXPElement("SMALL", "<SMALL>", "", "",
				MXPElement.BIT_HTML));
		addElement(new MXPElement("TT", "<PRE>", "", "", MXPElement.BIT_HTML));
		addElement(new MXPElement("BR", "<BR>", "", "", MXPElement.BIT_HTML
				| MXPElement.BIT_COMMAND));
		addElement(new MXPElement("SBR", "&nbsp;", "", "", MXPElement.BIT_HTML
				| MXPElement.BIT_COMMAND | MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("P", "", "", "", MXPElement.BIT_HTML
				| MXPElement.BIT_SPECIAL)); // special done
		addElement(new MXPElement("C", "<FONT COLOR=&fore; BACK=&back;>",
				"FORE BACK", "", 0));
		addElement(new MXPElement("COLOR", "<FONT COLOR=&fore; BACK=&back;>",
				"FORE BACK", "", 0));
		addElement(new MXPElement("HIGH", "", "", "",
				MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("H", "", "", "", MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement(
				"FONT",
				"<FONT STYLE=\"color: &color;;background-color: &back;;font-family: &face;;font-size: &size;;\">",
				"FACE SIZE COLOR BACK STYLE", "", MXPElement.BIT_SPECIAL));
		addElement(new MXPElement("NOBR", "", "", "", MXPElement.BIT_SPECIAL
				| MXPElement.BIT_COMMAND)); // special done
		addElement(new MXPElement(
				"A",
				"<A STYLE=\"&lcc;\" ONMOUSEOVER=\"&onmouseover;\" ONCLICK=\"&onclick;\" HREF=\"&href;\" TITLE=\"&hint;\">",
				"HREF HINT EXPIRE TITLE=HINT STYLE ONMOUSEOUT ONMOUSEOVER ONCLICK",
				"", 0, "EXPIRE"));
		addElement(new MXPElement(
				"SEND",
				"<A STYLE=\"&lcc;\" HREF=\"&href;\" ONMOUSEOUT=\"delayhidemenu();\" ONCLICK=\"&onclick;\" TITLE=\"&hint;\">",
				"HREF HINT PROMPT EXPIRE STYLE", "", MXPElement.BIT_SPECIAL,
				"EXPIRE")); // special done
		addElement(new MXPElement("EXPIRE", "", "NAME", "",
				MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("VERSION", "", "", "", MXPElement.BIT_SPECIAL
				| MXPElement.BIT_COMMAND)); // special done
		addElement(new MXPElement("SUPPORT", "", "", "", MXPElement.BIT_SPECIAL
				| MXPElement.BIT_COMMAND)); // special done
		addElement(new MXPElement("GAUGE", "", "ENTITY MAX CAPTION COLOR", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND));
		addElement(new MXPElement("STAT", "", "ENTITY MAX CAPTION", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND
						| MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement(
				"FRAME",
				...
				"", MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND
						| MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("DEST", "", "NAME", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("DESTINATION", "", "NAME", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("RELOCATE", "", "URL PORT", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND
						| MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("USER", "", "", "", MXPElement.BIT_COMMAND
				| MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("PASSWORD", "", "", "",
				MXPElement.BIT_COMMAND | MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("IMAGE",
				"<IMG SRC=&url;&fname; HEIGHT=&h; WIDTH=&w; ALIGN=&align;>",
				"FNAME URL T H W HSPACE VSPACE ALIGN ISMAP", "",
				MXPElement.BIT_COMMAND, "HSPACE VSPACE ISMAP"));
		addElement(new MXPElement("IMG",
				"<IMG SRC=&src; HEIGHT=&height; WIDTH=&width; ALIGN=&align;>",
				"SRC HEIGHT=70 WIDTH=70 ALIGN", "", MXPElement.BIT_COMMAND));
		addElement(new MXPElement("FILTER", "", "SRC DEST NAME", "",
				MXPElement.BIT_COMMAND | MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("SCRIPT", "", "", "", MXPElement.BIT_COMMAND
				| MXPElement.BIT_NOTSUPPORTED));
		addElement(new MXPElement("ENTITY", "",
				"NAME VALUE DESC PRIVATE PUBLISH DELETE ADD", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND,
				"PRIVATE PUBLISH ADD")); // special done
		addElement(new MXPElement("EN", "",
				"NAME VALUE DESC PRIVATE PUBLISH DELETE ADD", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND,
				"PRIVATE PUBLISH ADD")); // special done
		addElement(new MXPElement("TAG", "",
				"INDEX WINDOWNAME FORE BACK GAG ENABLE DISABLE", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND, "WINDOWNAME"));
		addElement(new MXPElement("VAR", "",
				"NAME DESC PRIVATE PUBLISH DELETE ADD REMOVE", "",
				MXPElement.BIT_SPECIAL, "PRIVATE PUBLISH ADD REMOVE")); // special
																		// done
		addElement(new MXPElement("V", "",
				"NAME DESC PRIVATE PUBLISH DELETE ADD REMOVE", "",
				MXPElement.BIT_SPECIAL, "PRIVATE PUBLISH ADD REMOVE")); // special
																		// done
		addElement(new MXPElement("ELEMENT", "",
				"NAME DEFINITION ATT TAG FLAG OPEN DELETE EMPTY", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND)); // special
																	// done
		addElement(new MXPElement("EL", "",
				"NAME DEFINITION ATT TAG FLAG OPEN DELETE EMPTY", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND)); // special
																	// done
		addElement(new MXPElement("ATTLIST", "", "NAME ATT", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND));
		addElement(new MXPElement("AT", "", "NAME ATT", "",
				MXPElement.BIT_SPECIAL | MXPElement.BIT_COMMAND));
		addElement(new MXPElement("SOUND",
				"!!SOUND(&fname; V=&v; L=&l; P=&p; T=&t; U=&u;)",
				"FNAME V=100 L=1 P=50 T U", "", MXPElement.BIT_COMMAND));
		addElement(new MXPElement("MUSIC",
	...
	public int newlineDetected(StringBuffer buf, int i, boolean[] eatEOL) {
		if ((mode() == MXP.MODE_LINE_LOCKED)
				|| (mode() == MXP.MODE_LOCK_LOCKED)) {
			eatEOL[0] = false;
			return 0;
		}
	...
	private String closeTag(MXPElement E) {
		...
		for (int e = endTags.size() - 1; e >= 0; e--)
			if (elements.containsKey((((String) endTags.elementAt(e)))
					.toUpperCase().trim()))
				newEnd.append("</"
						+ ((String) endTags.elementAt(e)).toUpperCase().trim());
	...
	public int escapeTranslate(String escapeString, StringBuffer buf, int i) {
		if (escapeString.endsWith("z") || escapeString.endsWith("Z")) {
			...
			int code = Util.s0_int(escapeString.substring(0,
					escapeString.length() - 1));
			if (code < 20) {
				setModeAndExecute(code, buf, i);
				return -1;
			} else if (code < 100) {
				MXPElement replace = (MXPElement) tags.get(Integer
						.valueOf(code));
	...
	public int processTag(StringBuffer buf, int i) {
		...
		if (tagDebug) {
			System.out.println("/***:::!!!TAG/" + oldI + "/"
					+ substr(buf, oldI, oldI + 10));
			System.out.flush();
		}
		if (tagDebugLong) {
		...
		while ((bit != null) && ((++i) < buf.length())) {
			...
			case '\'':
				if (lastC == '\\') {
					if ((quotes != '\0') || (bit.length() > 0))
						...
						if (tagDebug) {
							System.out
									.println("/TAG*/****/Tag has wierd quote!!!!");
							System.out.flush();
						}
						return 3;
					}
			...
			case '>':
				...
				break;
			default:
				if ((quotes != '\0') || (Character.isLetter(buf.charAt(i)))
						|| (bit.length() > 0))
					bit.append(buf.charAt(i));
				else {
					// DANGER WILL ROBINSON! DANGER!
		...
		// nothing doin
		String tag = (parts.size() > 0) ? ((String) parts.firstElement())
				.toUpperCase().trim() : "";
		...
		if (endTag) {
			...
			String close = closeTag(E);
			if (tagDebug) {
				System.out.println("/TAG/ENDENTITY=" + E.name() + "/CLOSE="
						+ close);
				System.out.flush();
			}
			if (close.length() > 0)
				...
				if (!E.needsText()) {
					if (tagDebugLong)
						System.out.println("/TAG>"
								+ substr(buf, 0, buf.length()));
					System.out
							.println("/TAG/END/!2!/"
									+ substr(buf, oldI + 1 + close.length(),
											oldI + 40));
					System.out.flush();
				}
			}
			if (E.needsText()) {
				if ((E.getBufInsert() < 0) || (oldI < E.getBufInsert())) {
					...
					oldI = E.getBufInsert();
					if (tagDebug) {
						System.out.println("/TAG/END/text="
								+ substr(text, 0, 100));
						System.out.flush();
					}
				}
				...
				if (tagDebug) {
					System.out.println("/TAG*/END/3/adji=!2.5!/"
							+ (close.length() - 1));
					System.out.flush();
				}
				return close.length();
				...
				if (tagDebug) {
					System.out.println("/TAG*/END/4/adji=!2.5!/"
							+ (close.length() - 1));
					System.out.flush();
				}
				return close.length();
				...
				if (tagDebug) {
					System.out.println("/TAG/END/5/adji="
							+ (-((oldI - E.getBufInsert()) + 1)));
					System.out.flush();
				}
				if (tagDebug) {
					System.out.println("/TAG*/END/6/willbe="
							+ substr(buf, oldI - ((oldI - E.getBufInsert())),
									oldI + 80));
					System.out.flush();
				}
				...
				if (tagDebug) {
					System.out.println("/TAG*/END/6/adji=!2.5!/"
							+ (close.length() - 1));
					System.out.flush();
				}
				return close.length();
			...
			if (E.needsText()) {
				...
				if (tagDebug) {
					System.out
							.println("/TAG*/Entity needs text, so purge and look for close.");
					System.out.flush();
				}
		...
		if ((endTag) && (!E.isCommand()) && (E.getFlag() != null)
				&& (E.getFlag().length() > 0)) {
		...
		if ((E.isHTML()) || (totalDefinition.equalsIgnoreCase(oldString))) {
			...
			if ((endTag) && (oldI < oldOldI)) {
				if (tagDebug) {
					System.out.println("/TAG*/ENDEND1/"
							+ substr(buf,
									(oldOldI + 1 + (-((oldOldI - oldI) + 1))),
									oldOldI + 80));
					System.out.flush();
				}
			...
			if (tagDebug) {
				System.out.println("/TAG*/THEEND1/"
						+ substr(buf,
								(oldOldI + (totalDefinition.length() - 1)) + 1,
								oldOldI + 80));
				System.out.flush();
			}
		...
		if ((endTag) && (oldI < oldOldI)) {
			if (tagDebug) {
				System.out.println("/TAG*/ENDEND2/"
						+ oldI
						+ "/"
						+ oldOldI
						+ "/"
						+ substr(buf, oldOldI + 1 + (-((oldOldI - oldI) + 1)),
								oldOldI + 80));
				System.out.flush();
			}
			return -((oldOldI - oldI) + 1);
		...
		if ((def.toString().equalsIgnoreCase(oldString))
				|| (E.name().toUpperCase().trim().equals(getFirstTag(def
						.toString().trim())))) {
			if (tagDebug) {
				System.out.println("/TAG*/THEEND2/"
						+ substr(buf, oldOldI + 1
								+ (def.toString().length() - 1), oldOldI + 80));
				System.out.flush();
			}
			return def.toString().length() - 1;
		}
		if (tagDebug) {
			System.out.println("/TAG*/THEEND3/"
					+ substr(buf, (oldOldI - 1) + 1, oldOldI + 80));
			System.out.flush();
		}
		return -1;
	}
	...
	private void specialProcessorElements(MXPElement E, boolean endTag) {
		if (E.name().equals("FONT")) {
			...
			if ((style != null) && (color == null) && (back == null)
					&& (face == null) && (size == null)) {
				String s = null;
				String v = null;
			...
			hint = Util
					.replaceAllIgnoreCase(hint, "RIGHT-MOUSE", "click mouse");
			...
			if (hrefV.size() == 1) {
				href = Util.replaceAll(((String) hrefV.firstElement()), "'",
						"\\'");
				E.setAttributeValue("HREF", "javascript:addToPrompt('" + href
						+ "'," + prompt + ")");
				if (hintV.size() > 1)
				...
				E.setAttributeValue("ONCLICK",
						"return dropdownmenu(this, event, getSendMenu(this,'"
								+ href + "','" + hint + "','" + prompt
								+ "'), '200px');");
			} else {
			...
			MXPElement L = new MXPElement(name.toUpperCase().trim(),
					definition, attributes, flags, bitmap);
			L.setNotBasicElement();
			elements.remove(L.name());
			elements.put(L.name(), L);
			if ((tag != null) && (Util.isInteger(tag))
					&& (Util.s_int(tag) > 19) && (Util.s_int(tag) < 100)) {
			...
			responses
					.append("\033[1z<VERSION MXP=1.0 STYLE=1.0 CLIENT=Siplet VERSION="
							+ TelnetFilter.getSipletVersion()
							+ " REGISTERED=NO>\n");
			...
			if (initValue > 0)
				initValue = (int) Math.round(Util.mul(100.0, initValue
						/ maxValue));
			synchronized (jscriptBuffer) {
				jscriptBuffer.append("createGauge('" + ENTITY + "','" + CAPTION
						+ "','" + COLOR + "'," + initValue + "," + maxValue
						+ ");");
		...
		} else if (E.name().equalsIgnoreCase("ATTLIST")
				|| E.name().equalsIgnoreCase("ATT")) {
			String name = E.getAttributeValue("NAME");
			String value = E.getAttributeValue("ATT");
			if ((name == null) || (value == null))
				return;
			MXPElement E2 = (MXPElement) elements
					.get(name.toUpperCase().trim());
			if (E2 == null)
				return;
					...
					if (!E2.isGenerallySupported())
						...
						if (unsupportedParms.size() > 0) {
							for (int x = 0; x < unsupportedParms.size(); x++)
								supportResponse.append(" -"
										+ E2.name()
										+ "."
										+ ((String) unsupportedParms
												.elementAt(x)));
						}
					}
				}
	...
	public String getEntityValue(String tag, MXPElement currentE) {
		...
		if (tag.equalsIgnoreCase("lcc"))
			val = "color: " + lastForeground + "; background-color: "
					+ lastBackground;
		if (val == null)
		...
		for (int g = 0; g < gauges.size(); g++) {
			...
			if ((gauge[0].equalsIgnoreCase(name))
				...
				if (maxValue < initValue)
					maxValue = (initValue <= 0) ? 100 : initValue;
				if (initValue > 0)
					initValue = (int) Math.round(Util.mul(100.0,
							Util.div(initValue, maxValue)));
				synchronized (jscriptBuffer) {
					jscriptBuffer.append("modifyGauge('" + gauge[0] + "',"
							+ initValue + "," + maxValue + ");");
				}
			}
		}
	...
	public void shutdownMXP() {
		...
		while (gauges.size() > 0) {
			synchronized (jscriptBuffer) {
				jscriptBuffer.append("removeGauge('"
						+ ((String[]) gauges.elementAt(0))[0] + "');");
			}
	...
	public int processEntity(StringBuffer buf, int i, MXPElement currentE,
		...
		if ((i < buf.length() - 3) && (buf.charAt(i + 1) == '#')
				&& (Character.isDigit(buf.charAt(i + 2)))) {
		...
		if (val != null) {
			if ((currentE != null)
					&& (currentE.name().equalsIgnoreCase("FONT"))) {
